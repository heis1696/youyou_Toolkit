/**
 * YouYou Toolkit - Worldbook Preset IO Handler
 *
 * 包装 worldbook-preset-store.js 的导出/导入。
 * 导入总是 append（生成新 ID），不做去重。
 */

import { logger } from '../../core/logger-service.js';
import store from '../../worldbook-preset-store.js';

const log = logger.createScope('WorldbookPresetIO');

export const worldbookPresetHandler = {
  kind: 'worldbookPreset',
  displayName: '世界书预设',
