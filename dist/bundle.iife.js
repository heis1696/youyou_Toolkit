var YouYouToolkit=(()=>{var Qo=Object.defineProperty;var sd=Object.getOwnPropertyDescriptor;var rd=Object.getOwnPropertyNames;var od=Object.prototype.hasOwnProperty;var B=(t,e)=>()=>(t&&(e=t(t=0)),e);var be=(t,e)=>{for(var s in e)Qo(t,s,{get:e[s],enumerable:!0})},ad=(t,e,s,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of rd(e))!od.call(t,o)&&o!==s&&Qo(t,o,{get:()=>e[o],enumerable:!(r=sd(e,o))||r.enumerable});return t};var nd=t=>ad(Qo({},"__esModule",{value:!0}),t);var C,Zo,P,ve=B(()=>{C={STORAGE_CHANGED:"storage:changed",STORAGE_CLEARED:"storage:cleared",PRESET_CREATED:"preset:created",PRESET_UPDATED:"preset:updated",PRESET_DELETED:"preset:deleted",PRESET_ACTIVATED:"preset:activated",PRESET_IMPORTED:"preset:imported",PRESET_EXPORTED:"preset:exported",API_CONFIG_UPDATED:"api:configUpdated",API_REQUEST_START:"api:requestStart",API_REQUEST_SUCCESS:"api:requestSuccess",API_REQUEST_ERROR:"api:requestError",API_CONNECTION_TESTED:"api:connectionTested",TOOL_REGISTERED:"tool:registered",TOOL_UNREGISTERED:"tool:unregistered",TOOL_UPDATED:"tool:updated",TOOL_RUNTIME_UPDATED:"tool:runtimeUpdated",TOOL_ENABLED:"tool:enabled",TOOL_DISABLED:"tool:disabled",TOOL_EXECUTING:"tool:executing",TOOL_EXECUTED:"tool:executed",TOOL_ERROR:"tool:error",TOOL_EXECUTION_STARTED:"tool:executionStarted",TOOL_EXECUTION_FAILED:"tool:executionFailed",REGEX_RULE_ADDED:"regex:ruleAdded",REGEX_RULE_UPDATED:"regex:ruleUpdated",REGEX_RULE_DELETED:"regex:ruleDeleted",REGEX_RULES_CLEARED:"regex:rulesCleared",REGEX_PRESET_LOADED:"regex:presetLoaded",REGEX_EXTRACTED:"regex:extracted",UI_INITIALIZED:"ui:initialized",UI_RENDER_REQUESTED:"ui:renderRequested",UI_TAB_CHANGED:"ui:tabChanged",UI_SUBTAB_CHANGED:"ui:subTabChanged",UI_POPUP_OPENED:"ui:popupOpened",UI_POPUP_CLOSED:"ui:popupClosed",UI_WINDOW_CREATED:"ui:windowCreated",UI_WINDOW_CLOSED:"ui:windowClosed",APP_INITIALIZING:"app:initializing",APP_INITIALIZED:"app:initialized",APP_ERROR:"app:error",SETTINGS_UPDATED:"settings:updated",TOOL_CONTEXT_INJECTED:"tool:contextInjected",TOOL_CONTEXT_CLEARED:"tool:contextCleared",BYPASS_PRESET_CREATED:"bypass:presetCreated",BYPASS_PRESET_UPDATED:"bypass:presetUpdated",BYPASS_PRESET_DELETED:"bypass:presetDeleted",BYPASS_PRESET_ACTIVATED:"bypass:presetActivated",TOOL_OUTPUT_MODE_CHANGED:"tool:outputModeChanged"},Zo=class{constructor(){this.listeners=new Map,this.onceCallbacks=new Map,this.history=[],this.maxHistorySize=100,this.debugMode=!1}on(e,s,r={}){if(!e||typeof s!="function")return console.warn("[EventBus] \u65E0\u6548\u7684\u4E8B\u4EF6\u6216\u56DE\u8C03"),()=>{};let{priority:o=0}=r;this.listeners.has(e)||this.listeners.set(e,new Set);let a={callback:s,priority:o};return this.listeners.get(e).add(a),this.debugMode&&console.log(`[EventBus] \u8BA2\u9605: ${e}`),()=>this.off(e,s)}off(e,s){let r=this.listeners.get(e);if(r){for(let o of r)if(o.callback===s){r.delete(o);break}this.debugMode&&console.log(`[EventBus] \u53D6\u6D88\u8BA2\u9605: ${e}`)}}emit(e,s){this.debugMode&&console.log(`[EventBus] \u53D1\u5E03: ${e}`,s),this._addToHistory(e,s);let r=this.listeners.get(e);if(!r||r.size===0)return;let o=Array.from(r).sort((a,n)=>n.priority-a.priority);for(let{callback:a}of o)try{a(s)}catch(n){console.error(`[EventBus] \u4E8B\u4EF6\u5904\u7406\u9519\u8BEF (${e}):`,n)}}once(e,s){let r=o=>{this.off(e,r),s(o)};return this.on(e,r)}wait(e,s=0){return new Promise((r,o)=>{let a=null,n=this.once(e,i=>{a&&clearTimeout(a),r(i)});s>0&&(a=setTimeout(()=>{n(),o(new Error(`\u7B49\u5F85\u4E8B\u4EF6\u8D85\u65F6: ${e}`))},s))})}hasListeners(e){let s=this.listeners.get(e);return s&&s.size>0}listenerCount(e){let s=this.listeners.get(e);return s?s.size:0}removeAllListeners(e){e?this.listeners.delete(e):this.listeners.clear()}setDebugMode(e){this.debugMode=e}_addToHistory(e,s){this.history.push({event:e,data:s,timestamp:Date.now()}),this.history.length>this.maxHistorySize&&this.history.shift()}getHistory(e){return e?this.history.filter(s=>s.event===e):[...this.history]}clearHistory(){this.history=[]}},P=new Zo});var $n={};be($n,{LOG_LEVEL:()=>Y,LoggerService:()=>jr,default:()=>id,logger:()=>N});var Y,Cn,jr,N,id,ae=B(()=>{ve();Y=Object.freeze({DEBUG:0,INFO:1,WARN:2,ERROR:3}),Cn=Object.freeze({[Y.DEBUG]:"DEBUG",[Y.INFO]:"INFO",[Y.WARN]:"WARN",[Y.ERROR]:"ERROR"}),jr=class{constructor(){this._entries=[],this._maxSize=2e3,this._nextId=1,this._minLevel=Y.INFO,this._eventKey="logger:entry",this._statsEventKey="logger:statsChanged",this._pendingFlush=!1}_write(e,s,r,o){let a={id:this._nextId++,timestamp:Date.now(),level:e,scope:s,message:r,data:o};this._entries.push(a),this._entries.length>this._maxSize&&this._entries.shift(),this._forwardToConsole(a),this._pendingFlush||(this._pendingFlush=!0,queueMicrotask(()=>{this._pendingFlush=!1,this._emitEntry(a)}))}_forwardToConsole(e){let s=`[${e.scope}]`;switch(e.level){case Y.DEBUG:console.debug(s,e.message,e.data??"");break;case Y.INFO:console.log(s,e.message,e.data??"");break;case Y.WARN:console.warn(s,e.message,e.data??"");break;case Y.ERROR:console.error(s,e.message,e.data??"");break}}_emitEntry(e){try{P?.emit(this._eventKey,e)}catch{}}debug(e,s,r){Y.DEBUG<this._minLevel||this._write(Y.DEBUG,e,s,r)}info(e,s,r){Y.INFO<this._minLevel||this._write(Y.INFO,e,s,r)}log(e,s,r){this.info(e,s,r)}warn(e,s,r){Y.WARN<this._minLevel||this._write(Y.WARN,e,s,r)}error(e,s,r){Y.ERROR<this._minLevel||this._write(Y.ERROR,e,s,r)}createScope(e){return{debug:(s,r)=>this.debug(e,s,r),info:(s,r)=>this.info(e,s,r),log:(s,r)=>this.log(e,s,r),warn:(s,r)=>this.warn(e,s,r),error:(s,r)=>this.error(e,s,r)}}getEntries(e={}){let{level:s,scope:r,search:o,limit:a=500,offset:n=0}=e,i=this._entries;if(s!=null&&(i=i.filter(c=>c.level>=s)),r&&(i=i.filter(c=>c.scope===r)),o){let c=o.toLowerCase();i=i.filter(d=>d.scope.toLowerCase().includes(c)||d.message.toLowerCase().includes(c))}let l=i.length;return i=i.slice(n,n+a),{entries:i,total:l}}getStats(){let e={total:this._entries.length,byLevel:{DEBUG:0,INFO:0,WARN:0,ERROR:0},byScope:{}};for(let s of this._entries){let r=Cn[s.level]||"UNKNOWN";e.byLevel[r]=(e.byLevel[r]||0)+1,e.byScope[s.scope]=(e.byScope[s.scope]||0)+1}return e}setLevel(e){this._minLevel=e}getLevel(){return this._minLevel}setMaxSize(e){this._maxSize=Math.max(100,Math.min(1e4,e))}clear(){this._entries=[],this._nextId=1}levelLabel(e){return Cn[e]||"UNKNOWN"}},N=new jr,id=N});function Pn(){let t=k;return t._getStorage(),t._storage}function On(){return k.get("settings",{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}})}function Dn(t){k.set("settings",t)}var ea,Mt,k,se,Rn,tr,He=B(()=>{ae();ea=N.createScope("StorageService"),Mt=class t{constructor(e="youyou_toolkit"){this.namespaceKey=e,this._storage=null,this._cache=new Map}_getStorage(){if(this._storage)return this._storage;try{let e=typeof window.parent<"u"&&window.parent!==window?window.parent:window;if(e.SillyTavern?.getContext){let s=e.SillyTavern.getContext();if(s?.extensionSettings)return s.extensionSettings[this.namespaceKey]||(s.extensionSettings[this.namespaceKey]={}),this._storage={_target:s.extensionSettings[this.namespaceKey],getItem:r=>{let o=s.extensionSettings[this.namespaceKey][r];return typeof o=="string"?o:o?JSON.stringify(o):null},setItem:(r,o)=>{s.extensionSettings[this.namespaceKey][r]=o,this._saveSettings(s)},removeItem:r=>{delete s.extensionSettings[this.namespaceKey][r],this._saveSettings(s)},_isTavern:!0},this._storage}}catch{ea.warn("SillyTavern\u5B58\u50A8\u4E0D\u53EF\u7528\uFF0C\u4F7F\u7528localStorage")}return this._storage={getItem:e=>{try{return localStorage.getItem(e)}catch{return null}},setItem:(e,s)=>{try{localStorage.setItem(e,s)}catch(r){ea.error("localStorage\u5199\u5165\u5931\u8D25:",r)}},removeItem:e=>{try{localStorage.removeItem(e)}catch{}},_isTavern:!1},this._storage}_saveSettings(e){if(typeof e.saveSettings=="function")try{e.saveSettings()}catch{}else if(typeof e.saveSettingsDebounced=="function")try{e.saveSettingsDebounced()}catch{}}get(e,s=null){let r=`${this.namespaceKey}:${e}`;if(this._cache.has(r))return this._cache.get(r);let o=this._getStorage(),a=this._getFullKey(e),n=o.getItem(a);if(n===null)return s;try{let i=JSON.parse(n);return this._cache.set(r,i),i}catch{return n}}set(e,s){let r=this._getStorage(),o=this._getFullKey(e),a=`${this.namespaceKey}:${e}`;this._cache.set(a,s);try{r.setItem(o,JSON.stringify(s))}catch(n){ea.error("\u5B58\u50A8\u5931\u8D25:",n)}}remove(e){let s=this._getStorage(),r=this._getFullKey(e),o=`${this.namespaceKey}:${e}`;this._cache.delete(o),s.removeItem(r)}has(e){let s=this._getStorage(),r=this._getFullKey(e);return s.getItem(r)!==null}clear(){if(this._getStorage()._isTavern){let s=typeof window.parent<"u"?window.parent:window;if(s.SillyTavern?.getContext){let r=s.SillyTavern.getContext();r?.extensionSettings?.[this.namespaceKey]&&(r.extensionSettings[this.namespaceKey]={},this._saveSettings(r))}}else{let s=`${this.namespaceKey}_`,r=[];for(let o=0;o<localStorage.length;o++){let a=localStorage.key(o);a&&a.startsWith(s)&&r.push(a)}r.forEach(o=>localStorage.removeItem(o))}this._cache.clear()}_getFullKey(e){return this._getStorage()._isTavern?e:`${this.namespaceKey}_${e}`}namespace(e){return new t(`${this.namespaceKey}:${e}`)}getMultiple(e){let s={};return e.forEach(r=>{s[r]=this.get(r)}),s}setMultiple(e){Object.entries(e).forEach(([s,r])=>{this.set(s,r)})}exportAll(){let e=this._getStorage(),s={};if(e._isTavern){let r=typeof window.parent<"u"?window.parent:window;if(r.SillyTavern?.getContext){let a=r.SillyTavern.getContext()?.extensionSettings?.[this.namespaceKey]||{};Object.entries(a).forEach(([n,i])=>{s[n]=typeof i=="string"?JSON.parse(i):i})}}else{let r=`${this.namespaceKey}_`;for(let o=0;o<localStorage.length;o++){let a=localStorage.key(o);if(a&&a.startsWith(r)){let n=a.slice(r.length);try{s[n]=JSON.parse(localStorage.getItem(a))}catch{s[n]=localStorage.getItem(a)}}}}return s}},k=new Mt("youyou_toolkit"),se=new Mt("youyou_toolkit:tools"),Rn=new Mt("youyou_toolkit:presets"),tr=new Mt("youyou_toolkit:windows")});var Nn={};be(Nn,{DEFAULT_API_PRESETS:()=>cd,DEFAULT_SETTINGS:()=>ld,STORAGE_KEYS:()=>sr,StorageService:()=>Mt,deepMerge:()=>Ln,getCurrentPresetName:()=>yd,getStorage:()=>Pn,loadApiPresets:()=>dd,loadSettings:()=>On,presetStorage:()=>Rn,saveApiPresets:()=>ud,saveSettings:()=>Dn,setCurrentPresetName:()=>pd,storage:()=>k,toolStorage:()=>se,windowStorage:()=>tr});function dd(){return k.get(sr.API_PRESETS)||[]}function ud(t){k.set(sr.API_PRESETS,t)}function yd(){return k.get(sr.CURRENT_PRESET)||""}function pd(t){k.set(sr.CURRENT_PRESET,t||"")}function Ln(t,e){let s=o=>o&&typeof o=="object"&&!Array.isArray(o),r={...t};return s(t)&&s(e)&&Object.keys(e).forEach(o=>{s(e[o])?o in t?r[o]=Ln(t[o],e[o]):Object.assign(r,{[o]:e[o]}):Object.assign(r,{[o]:e[o]})}),r}var sr,ld,cd,Bn=B(()=>{He();He();sr={SETTINGS:"settings",API_PRESETS:"api_presets",CURRENT_PRESET:"current_preset",TOOLS:"tools",TOOL_PRESETS:"tool_presets",CURRENT_TOOL_PRESET:"current_tool_preset",BYPASS_PRESETS:"bypass_presets",CURRENT_BYPASS_PRESET:"current_bypass_preset",BYPASS_ENABLED:"bypass_enabled"},ld={apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}},cd=[]});var Kn={};be(Kn,{API_STATUS:()=>xd,fetchAvailableModels:()=>aa,getApiConfig:()=>mt,getEffectiveApiConfig:()=>rr,hasEffectiveApiPreset:()=>or,sendApiRequest:()=>ar,sendWithPreset:()=>ra,testApiConnection:()=>Id,updateApiConfig:()=>As,validateApiConfig:()=>Es});function bd(){return{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,stream:!1,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}}}function sa(){return k.get(Un,bd())}function hd(t){k.set(Un,t)}function jn(){return k.get(fd,[])}function vd(){return k.get(md,"")}function ta(t,e={}){let s=new Error(t);return s.allowDirectFallback=e.allowDirectFallback===!0,s}function zn(t,e="chat_completions"){let s=String(t||"").trim();if(!s)return"";let r=null;try{r=new URL(s)}catch{return s}let o=r.pathname.replace(/\/+$/,""),a=o;return e==="chat_completions"?!/\/chat\/completions$/i.test(o)&&!/\/completions$/i.test(o)&&(a=`${o||""}/chat/completions`):e==="models"&&(/\/chat\/completions$/i.test(o)?a=o.replace(/\/chat\/completions$/i,"/models"):/\/completions$/i.test(o)?a=o.replace(/\/completions$/i,"/models"):/\/models$/i.test(o)||(a=`${o||""}/models`)),r.pathname=a.replace(/\/+/g,"/"),r.toString()}function wd(t){let e=String(t||"").trim();if(!e)return"";try{let s=new URL(e);return s.pathname=s.pathname.replace(/\/chat\/completions$/i,"").replace(/\/completions$/i,"").replace(/\/models$/i,"").replace(/\/+$/,"")||"/",s.toString().replace(/\/$/,"")}catch{return e.replace(/\/chat\/completions$/i,"").replace(/\/completions$/i,"").replace(/\/models$/i,"").replace(/\/+$/,"")}}function mt(){return sa().apiConfig||{}}function As(t){let e=sa();e.apiConfig={...e.apiConfig,...t},hd(e)}function Es(t){let e=[];if(t.useMainApi)return{valid:!0,errors:[]};if(!t.url||!t.url.trim())e.push("API URL \u4E0D\u80FD\u4E3A\u7A7A");else try{new URL(t.url)}catch{e.push("API URL \u683C\u5F0F\u65E0\u6548")}return(!t.model||!t.model.trim())&&e.push("\u6A21\u578B\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"),{valid:e.length===0,errors:e}}function rr(t=""){let e=sa(),s=t||vd()||"";if(s){let o=jn().find(a=>a.name===s);if(o&&o.apiConfig)return{...o.apiConfig,presetName:o.name}}return e.apiConfig||{}}function or(t=""){return t?jn().some(s=>s?.name===t):!1}async function ra(t,e,s={},r=null){let o=rr(t);return await ar(e,{...s,apiConfig:o},r)}function Wn(t,e={}){let s=e.apiConfig||mt();return{messages:t,model:s.model||"gpt-3.5-turbo",max_tokens:s.max_tokens||4096,temperature:s.temperature??.7,top_p:s.top_p??.9,stream:s.stream??!1,...e.extraParams}}function oa(t){let e="";if(t?.choices&&t.choices[0]?.message?.content)e=t.choices[0].message.content;else if(t?.content)e=t.content;else if(t?.text)e=t.text;else if(t?.response)e=t.response;else throw new Error(`\u65E0\u6CD5\u89E3\u6790API\u54CD\u5E94\u683C\u5F0F: ${JSON.stringify(t).slice(0,200)}`);return String(e||"").trim()}async function ar(t,e={},s=null){let r=e.apiConfig||mt(),o=r.useMainApi,a=Es(r);if(!a.valid&&!o)throw new Error(`API\u914D\u7F6E\u65E0\u6548: ${a.errors.join(", ")}`);return o?await Sd(t,e,s):await Td(t,r,e,s)}async function Sd(t,e,s){let r=typeof window.parent<"u"?window.parent:window;if(!r.TavernHelper?.generateRaw)throw new Error("TavernHelper.generateRaw \u4E0D\u53EF\u7528\u3002\u8BF7\u68C0\u67E5SillyTavern\u7248\u672C\u3002");try{let o=await r.TavernHelper.generateRaw({ordered_prompts:t,should_stream:e.apiConfig?.stream??mt().stream??!1,...e.extraParams});if(typeof o!="string")throw new Error("\u4E3BAPI\u8FD4\u56DE\u4E86\u975E\u9884\u671F\u7684\u54CD\u5E94\u7C7B\u578B");return o.trim()}catch(o){throw o.name==="AbortError"?o:new Error(`\u4E3BAPI\u8BF7\u6C42\u5931\u8D25: ${o.message}`)}}async function Td(t,e,s,r){let o=typeof window.parent<"u"?window.parent:window;if(o.TavernHelper?.generateRaw)try{return await _d(t,e,s,r,o)}catch(a){gd.warn("TavernHelper \u81EA\u5B9A\u4E49\u8BF7\u6C42\u5931\u8D25\uFF0C\u56DE\u9000\u5230\u540E\u5907\u94FE\u8DEF:",a)}if(o.SillyTavern?.getRequestHeaders)try{return await Ad(t,e,s,r,o)}catch(a){if(!a?.allowDirectFallback)throw a}return await Ed(t,e,s,r)}async function _d(t,e,s,r,o){if(r?.aborted)throw new DOMException("\u8BF7\u6C42\u5DF2\u53D6\u6D88","AbortError");let a=await o.TavernHelper.generateRaw({ordered_prompts:t,should_stream:e.stream??!1,max_chat_history:0,custom_api:{apiurl:wd(e.url),key:e.apiKey||"",model:e.model||"gpt-3.5-turbo",max_tokens:e.max_tokens||4096,temperature:e.temperature??.7,top_p:e.top_p??.9},...s.extraParams||{}});return typeof a=="string"?a.trim():oa(a)}async function Ad(t,e,s,r,o){let a=String(e.url||"").trim(),n={...Wn(t,{apiConfig:e,...s}),chat_completion_source:"custom",reverse_proxy:a,proxy_password:"",custom_url:a,custom_include_headers:e.apiKey?`Authorization: Bearer ${e.apiKey}`:""},i={...typeof o.SillyTavern?.getRequestHeaders=="function"?o.SillyTavern.getRequestHeaders():{},"Content-Type":"application/json"},l=null;try{l=await fetch("/api/backends/chat-completions/generate",{method:"POST",headers:i,body:JSON.stringify(n),signal:r})}catch(u){throw u?.name==="AbortError"?u:ta(`\u9152\u9986\u540E\u7AEF\u8F6C\u53D1\u8BF7\u6C42\u4E0D\u53EF\u7528\uFF0C\u5DF2\u5C1D\u8BD5\u56DE\u9000\u5230\u6D4F\u89C8\u5668\u76F4\u8FDE\u3002\u539F\u59CB\u9519\u8BEF: ${u.message}`,{allowDirectFallback:!0})}let c=await l.text().catch(()=>"");if(!l.ok){let u=[404,405,501,502].includes(l.status);throw ta(`\u9152\u9986\u540E\u7AEF\u8F6C\u53D1\u8BF7\u6C42\u5931\u8D25 (${l.status}): ${c||"Unknown error"}`,{allowDirectFallback:u})}let d=null;try{d=c?JSON.parse(c):{}}catch{let y=String(c||"").replace(/\s+/g," ").trim().slice(0,120);throw ta(`\u9152\u9986\u540E\u7AEF\u8FD4\u56DE\u4E86\u975EJSON\u5185\u5BB9\u3002\u54CD\u5E94\u7247\u6BB5: ${y||"(\u7A7A\u54CD\u5E94)"}`)}return oa(d)}async function Ed(t,e,s,r){let o=Wn(t,{apiConfig:e,...s}),a=zn(e.url,"chat_completions"),n={"Content-Type":"application/json"};e.apiKey&&(n.Authorization=`Bearer ${e.apiKey}`);let i=await fetch(a,{method:"POST",headers:n,body:JSON.stringify(o),signal:r}),l=await i.text().catch(()=>"");if(!i.ok){let d=l||"Unknown error";throw new Error(`API\u8BF7\u6C42\u5931\u8D25 (${i.status}): ${d}`)}let c=null;try{c=l?JSON.parse(l):{}}catch{let u=String(l||"").replace(/\s+/g," ").trim().slice(0,120);throw new Error(`\u81EA\u5B9A\u4E49API\u8FD4\u56DE\u7684\u4E0D\u662FJSON\uFF0C\u53EF\u80FD\u662FURL\u914D\u7F6E\u9519\u8BEF\u3001\u53EA\u586B\u5199\u4E86\u7AD9\u70B9\u9996\u9875/\u57FA\u7840\u8DEF\u5F84\u3001\u6216\u8BF7\u6C42\u88AB\u91CD\u5B9A\u5411\u3002\u5F53\u524D\u4F1A\u81EA\u52A8\u5C1D\u8BD5\u8865\u5168 chat/completions \u7AEF\u70B9\uFF1B\u82E5\u4ECD\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5API URL\uFF0C\u6216\u6539\u4E3A\u542F\u7528\u201C\u4F7F\u7528SillyTavern\u4E3BAPI\u201D\u3002\u54CD\u5E94\u7247\u6BB5: ${u||"(\u7A7A\u54CD\u5E94)"}`)}return oa(c)}async function Id(t=null){let e=t||mt(),s=Date.now();try{await ar([{role:"user",content:'Hello, this is a connection test. Please respond with "OK".'}],{apiConfig:e});let o=Date.now()-s;return{success:!0,message:`\u8FDE\u63A5\u6210\u529F (\u5EF6\u8FDF: ${o}ms)`,latency:o}}catch(r){return{success:!1,message:`\u8FDE\u63A5\u5931\u8D25: ${r.message}`,latency:Date.now()-s}}}async function aa(t=null){let e=t||mt();return e.useMainApi?await Md():await kd(e)}async function Md(){let t=typeof window.parent<"u"?window.parent:window;try{if(t.SillyTavern?.getContext){let e=t.SillyTavern.getContext();if(e.settings?.api_server)return[e.settings.api_server]}return["gpt-4","gpt-4-turbo","gpt-3.5-turbo","claude-3-opus","claude-3-sonnet"]}catch{return["gpt-4","gpt-3.5-turbo"]}}async function kd(t){if(!t.url||!t.apiKey)return[];try{let e=zn(t.url,"models"),s=await fetch(e,{method:"GET",headers:{Authorization:`Bearer ${t.apiKey}`}});if(!s.ok)return[];let r=await s.json();return r.data&&Array.isArray(r.data)?r.data.map(o=>o.id||o.name).filter(Boolean).sort():[]}catch{return[]}}var gd,Un,fd,md,xd,nr=B(()=>{He();ae();gd=N.createScope("ApiConnection"),Un="settings",fd="api_presets",md="current_preset";xd={IDLE:"idle",CONNECTING:"connecting",SUCCESS:"success",ERROR:"error"}});var Gn={};be(Gn,{createPreset:()=>Kr,createPresetFromCurrentConfig:()=>Dd,deletePreset:()=>lr,duplicatePreset:()=>Od,exportPresets:()=>da,generateUniquePresetName:()=>ya,getActiveConfig:()=>ca,getActivePresetName:()=>Fr,getAllPresets:()=>bt,getPreset:()=>Jt,getPresetNames:()=>Rd,getStarredPresets:()=>la,importPresets:()=>ua,presetExists:()=>ir,renamePreset:()=>Pd,switchToPreset:()=>Xt,togglePresetStar:()=>ia,updatePreset:()=>na,validatePreset:()=>Ld});function $d(){return{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}}}function qn(){return k.get(Cd,$d())}function Le(){return k.get(Fn,[])}function Vt(t){k.set(Fn,t)}function Wr(){return k.get(Hn,"")}function zr(t){k.set(Hn,t||"")}function bt(){return Le()}function Rd(){return Le().map(e=>e.name)}function Jt(t){return!t||typeof t!="string"?null:Le().find(s=>s.name===t)||null}function ir(t){return!t||typeof t!="string"?!1:Le().some(s=>s.name===t)}function Kr(t){let{name:e,description:s,apiConfig:r}=t;if(!e||typeof e!="string"||!e.trim())return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let o=e.trim();if(ir(o))return{success:!1,message:`\u9884\u8BBE "${o}" \u5DF2\u5B58\u5728`};let a={name:o,description:s||"",apiConfig:{url:r?.url||"",apiKey:r?.apiKey||"",model:r?.model||"",useMainApi:r?.useMainApi??!0,stream:r?.stream??!1,max_tokens:r?.max_tokens||4096,temperature:r?.temperature??.7,top_p:r?.top_p??.9},createdAt:Date.now(),updatedAt:Date.now()},n=Le();return n.push(a),Vt(n),{success:!0,message:`\u9884\u8BBE "${o}" \u521B\u5EFA\u6210\u529F`,preset:a}}function na(t,e){if(!t||typeof t!="string")return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=Le(),r=s.findIndex(n=>n.name===t);if(r===-1)return{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`};if(e.name&&e.name!==t)return{success:!1,message:"\u4E0D\u652F\u6301\u4FEE\u6539\u9884\u8BBE\u540D\u79F0\uFF0C\u8BF7\u521B\u5EFA\u65B0\u9884\u8BBE"};let o=s[r],a={...o,...e,name:o.name,updatedAt:Date.now()};return e.apiConfig&&(a.apiConfig={...o.apiConfig,...e.apiConfig}),s[r]=a,Vt(s),{success:!0,message:`\u9884\u8BBE "${t}" \u66F4\u65B0\u6210\u529F`,preset:a}}function lr(t){if(!t||typeof t!="string")return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let e=Le(),s=e.findIndex(r=>r.name===t);return s===-1?{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`}:(e.splice(s,1),Vt(e),Wr()===t&&zr(""),{success:!0,message:`\u9884\u8BBE "${t}" \u5DF2\u5220\u9664`})}function Pd(t,e){if(!t||typeof t!="string")return{success:!1,message:"\u539F\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};if(!e||typeof e!="string"||!e.trim())return{success:!1,message:"\u65B0\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=e.trim();if(!ir(t))return{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`};if(ir(s))return{success:!1,message:`\u9884\u8BBE "${s}" \u5DF2\u5B58\u5728`};let r=Le(),o=r.find(a=>a.name===t);return o&&(o.name=s,o.updatedAt=Date.now(),Vt(r),Wr()===t&&zr(s)),{success:!0,message:`\u9884\u8BBE\u5DF2\u91CD\u547D\u540D\u4E3A "${s}"`}}function Od(t,e){if(!t||typeof t!="string")return{success:!1,message:"\u6E90\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};if(!e||typeof e!="string"||!e.trim())return{success:!1,message:"\u76EE\u6807\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=e.trim(),r=Jt(t);if(!r)return{success:!1,message:`\u6E90\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`};if(ir(s))return{success:!1,message:`\u9884\u8BBE "${s}" \u5DF2\u5B58\u5728`};let o={...JSON.parse(JSON.stringify(r)),name:s,createdAt:Date.now(),updatedAt:Date.now()},a=Le();return a.push(o),Vt(a),{success:!0,message:`\u9884\u8BBE\u5DF2\u590D\u5236\u4E3A "${s}"`,preset:o}}function ia(t){if(!t||typeof t!="string")return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let e=Le(),s=e.find(r=>r.name===t);return s?(s.starred=!s.starred,s.updatedAt=Date.now(),Vt(e),{success:!0,message:s.starred?`\u5DF2\u5C06 "${t}" \u6DFB\u52A0\u5230\u9884\u89C8\u5217\u8868`:`\u5DF2\u5C06 "${t}" \u4ECE\u9884\u89C8\u5217\u8868\u79FB\u9664`,starred:s.starred}):{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`}}function la(){return Le().filter(e=>e.starred===!0)}function Xt(t){if(!t)return zr(""),{success:!0,message:"\u5DF2\u5207\u6362\u5230\u5F53\u524DAPI\u914D\u7F6E"};let e=Jt(t);return e?(zr(t),{success:!0,message:`\u5DF2\u5207\u6362\u5230\u9884\u8BBE "${t}"`,apiConfig:e.apiConfig}):{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`}}function Fr(){return Wr()}function ca(){let t=Wr();if(t){let s=Jt(t);if(s)return{presetName:t,apiConfig:s.apiConfig}}return{presetName:"",apiConfig:qn().apiConfig||{}}}function da(t=null){if(t){let s=Jt(t);if(!s)throw new Error(`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`);return JSON.stringify(s,null,2)}let e=Le();return JSON.stringify(e,null,2)}function ua(t,e={overwrite:!1}){let s;try{s=JSON.parse(t)}catch{return{success:!1,message:"JSON\u89E3\u6790\u5931\u8D25",imported:0}}let r=Array.isArray(s)?s:[s];if(r.length===0)return{success:!1,message:"\u6CA1\u6709\u627E\u5230\u6709\u6548\u7684\u9884\u8BBE\u6570\u636E",imported:0};let o=Le(),a=0;for(let n of r){if(!n.name||typeof n.name!="string"||!n.apiConfig||typeof n.apiConfig!="object")continue;let i=o.findIndex(l=>l.name===n.name);i>=0?e.overwrite&&(n.updatedAt=Date.now(),o[i]=n,a++):(n.createdAt=n.createdAt||Date.now(),n.updatedAt=Date.now(),o.push(n),a++)}return a>0&&Vt(o),{success:!0,message:`\u6210\u529F\u5BFC\u5165 ${a} \u4E2A\u9884\u8BBE`,imported:a}}function Dd(t,e=""){let s=qn();return Kr({name:t,description:e,apiConfig:s.apiConfig})}function Ld(t){let e=[];return(!t.name||typeof t.name!="string"||!t.name.trim())&&e.push("\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"),(!t.apiConfig||typeof t.apiConfig!="object")&&e.push("\u7F3A\u5C11API\u914D\u7F6E"),{valid:e.length===0,errors:e}}function ya(t){(!t||typeof t!="string")&&(t="\u65B0\u9884\u8BBE");let e=Le(),s=new Set(e.map(o=>o.name));if(!s.has(t))return t;let r=1;for(;s.has(`${t} (${r})`);)r++;return`${t} (${r})`}var Cd,Fn,Hn,cr=B(()=>{He();Cd="settings",Fn="api_presets",Hn="current_preset"});function Ct(){return typeof window.parent<"u"&&window.parent!==window&&window.parent.document?window.parent.document:document}function b(t){return typeof t!="string"?"":t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function w(t,e,s=3e3){e||(e=t==="error"?"\u64CD\u4F5C\u5931\u8D25":"\u64CD\u4F5C\u5B8C\u6210");let r=typeof window.parent<"u"&&window.parent!==window?window.parent:window;if(r.toastr){r.toastr[t](e,"YouYou \u5DE5\u5177\u7BB1",{timeOut:s,progressBar:!0});return}Bd(t,e,s),Nd.log(`[${t.toUpperCase()}] ${e}`)}function le(t,e,s={}){e||(e=t==="error"?"\u64CD\u4F5C\u5931\u8D25":"\u64CD\u4F5C\u5B8C\u6210");let{duration:r=3500,sticky:o=!1,noticeId:a=""}=s,n=Ct();if(!n?.body){w(t,e,r);return}let i="yyt-top-notice-container",l="yyt-top-notice-styles",c=n.getElementById(i);if(c||(c=n.createElement("div"),c.id=i,c.style.cssText=`
      position: fixed;
      top: 12px;
      left: 50%;
...
\u70B9\u51FB"\u786E\u5B9A"\u8986\u76D6\u9884\u8BBE\uFF0C\u70B9\u51FB"\u53D6\u6D88"\u4EC5\u4FDD\u5B58\u5F53\u524D\u914D\u7F6E\u5E76\u5207\u6362\u5230\u201C\u5F53\u524D\u914D\u7F6E\u201D`)){As(s),Xt(""),this._setSelectedPresetName(t,""),w("success","API\u914D\u7F6E\u5DF2\u4FDD\u5B58\uFF0C\u5E76\u5DF2\u5207\u6362\u5230\u5F53\u524DAPI\u914D\u7F6E"),this._rerender(t);return}As(s);let a=na(r,{apiConfig:s});a.success?(this._setSelectedPresetName(t,r),w("success",`\u914D\u7F6E\u5DF2\u4FDD\u5B58\u5E76\u8986\u76D6\u9884\u8BBE "${r}"`),Xt(r),P.emit(C.PRESET_UPDATED,{name:r}),this._rerender(t)):w("error",a.message);return}As(s),w("success","API\u914D\u7F6E\u5DF2\u4FDD\u5B58")}),t.find(`#${m}-reset-api-config`).on("click",()=>{confirm("\u786E\u5B9A\u8981\u91CD\u7F6EAPI\u914D\u7F6E\u5417\uFF1F")&&(Xt(""),this._setSelectedPresetName(t,""),As({url:"",apiKey:"",model:"",useMainApi:!0,stream:!1,max_tokens:4096,temperature:.7,top_p:.9}),this._rerender(t),w("info","API\u914D\u7F6E\u5DF2\u91CD\u7F6E"))}),t.find(`#${m}-save-as-preset`).on("click",()=>{this._showSavePresetDialog(t,e)})},_bindFileEvents(t,e){t.find(`#${m}-export-presets`).on("click",()=>{try{let s=da();ht(s,`youyou_toolkit_presets_${Date.now()}.json`),w("success","\u9884\u8BBE\u5DF2\u5BFC\u51FA")}catch(s){w("error",`\u5BFC\u51FA\u5931\u8D25: ${s.message}`)}}),t.find(`#${m}-import-presets`).on("click",()=>{t.find(`#${m}-import-file`).click()}),t.find(`#${m}-import-file`).on("change",async s=>{let r=s.target.files[0];if(r){try{let o=await vt(r),a=ua(o,{overwrite:!0});w(a.success?"success":"error",a.message),a.imported>0&&this._rerender(t)}catch(o){w("error",`\u5BFC\u5165\u5931\u8D25: ${o.message}`)}e(s.target).val("")}})},_showSavePresetDialog(t,e){let r=bt().map(d=>d.name),o=ya("\u65B0\u9884\u8BBE"),a=`
    ...
    `},renderTo(t){let e=this.render({selectedPresetName:this._getSelectedPresetName(t)});t.html(e),this.bindEvents(t,{})}}});var mi={};be(mi,{MESSAGE_MACROS:()=>fi,addTagRule:()=>Cs,createRuleTemplate:()=>di,default:()=>Vd,deleteRulePreset:()=>pi,deleteRuleTemplate:()=>yi,deleteTagRule:()=>eo,escapeRegex:()=>Zt,exportRulesConfig:()=>oo,extractComplexTag:()=>ni,extractCurlyBraceTag:()=>Sa,extractHtmlFormatTag:()=>ii,extractSimpleTag:()=>wa,extractTagContent:()=>es,generateTagSuggestions:()=>Qr,getAllRulePresets:()=>so,getAllRuleTemplates:()=>li,getContentBlacklist:()=>ts,getRuleTemplate:()=>ci,getTagRules:()=>wt,importRulesConfig:()=>ao,isValidTagName:()=>xa,loadRulePreset:()=>ro,saveRulesAsPreset:()=>to,scanTextForTags:()=>Xr,setContentBlacklist:()=>pr,setTagRules:()=>Zr,shouldSkipContent:()=>va,testRegex:()=>gi,updateRuleTemplate:()=>ui,updateTagRule:()=>$s});function Gd(){return{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"},ruleTemplates:[...ha],tagRules:[],contentBlacklist:[],tagRulePresets:{}}}function ze(){return k.get(ai,Gd())}function lt(t){k.set(ai,t)}function Jr(){let t=ze();return Ie=t.ruleTemplates||[...ha],ce=t.tagRules||[],Ne=t.contentBlacklist||[],{ruleTemplates:Ie,tagRules:ce,contentBlacklist:Ne}}function Zt(t){return typeof t!="string"?"":t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function va(t,e){if(!e||e.length===0||!t||typeof t!="string")return!1;let s=t.toLowerCase();return e.some(r=>{let o=r.trim().toLowerCase();return o&&s.includes(o)})}function xa(t){return!t||typeof t!="string"?!1:/^[a-zA-Z][a-zA-Z0-9_-]*$/.test(t)&&!Yd.includes(t.toLowerCase())}function wa(t,e){if(!t||!e)return[];let s=[],r=Zt(e),o=new RegExp(`<${r}>([\\s\\S]*?)<\\/${r}>`,"gi");[...t.matchAll(o)].forEach(l=>{l[1]&&s.push(l[1].trim())});let n=(t.match(new RegExp(`<${r}>`,"gi"))||[]).length,i=(t.match(new RegExp(`<\\/${r}>`,"gi"))||[]).length;return n>i&&xt.warn(`\u53D1\u73B0 ${n-i} \u4E2A\u672A\u95ED\u5408\u7684 <${e}> \u6807\u7B7E`),s}function Sa(t,e){if(!t||!e)return[];let s=[],r=Zt(e),o=new RegExp(`\\{${r}\\|`,"gi"),a;for(;(a=o.exec(t))!==null;){let n=a.index,i=n+a[0].length,l=1,c=i;for(;c<t.length&&l>0;)t[c]==="{"?l++:t[c]==="}"&&l--,c++;if(l===0){let d=t.substring(i,c-1);d.trim()&&s.push(d.trim())}o.lastIndex=n+1}return s}function ni(t,e){if(!t||!e)return[];let s=e.split(",");if(s.length!==2)return xt.error(`\u590D\u6742\u6807\u7B7E\u914D\u7F6E\u683C\u5F0F\u9519\u8BEF\uFF0C\u5E94\u8BE5\u5305\u542B\u4E00\u4E2A\u9017\u53F7: ${e}`),[];let r=s[0].trim(),o=s[1].trim(),a=o.match(/<\/(\w+)>/);if(!a)return xt.error(`\u65E0\u6CD5\u89E3\u6790\u7ED3\u675F\u6807\u7B7E: ${o}`),[];let n=a[1],i=new RegExp(`${Zt(r)}([\\s\\S]*?)<\\/${n}>`,"gi"),l=[];return[...t.matchAll(i)].forEach(d=>{d[1]&&l.push(d[1].trim())}),l}function ii(t,e){if(!t||!e)return[];let s=e.match(/<(\w+)(?:\s[^>]*)?>/);if(!s)return xt.error(`\u65E0\u6CD5\u89E3\u6790HTML\u683C\u5F0F\u6807\u7B7E: ${e}`),[];let r=s[1],o=[],a=new RegExp(`<${r}(?:\\s[^>]*)?>([\\s\\S]*?)<\\/${r}>`,"gi");[...t.matchAll(a)].forEach(c=>{c[1]&&o.push(c[1].trim())});let i=(t.match(new RegExp(`<${r}(?:\\s[^>]*)?>`,"gi"))||[]).length,l=(t.match(new RegExp(`<\\/${r}>`,"gi"))||[]).length;return i>l&&xt.warn(`\u53D1\u73B0 ${i-l} \u4E2A\u672A\u95ED\u5408\u7684 <${r}> \u6807\u7B7E`),o}function es(t,e,s=[]){if(!t)return"";if(!e||e.length===0)return t;let r=e.filter(d=>d.type==="exclude"&&d.enabled),o=e.filter(d=>(d.type==="include"||d.type==="regex_include")&&d.enabled),a=e.filter(d=>d.type==="regex_exclude"&&d.enabled),n=t;for(let d of r)try{let u=new RegExp(`<${Zt(d.value)}(?:\\s[^>]*)?>[\\s\\S]*?<\\/${Zt(d.value)}>`,"gi");n=n.replace(u,"")}catch(u){xt.error("Error applying block exclusion rule:",{rule:d,error:u})}let i=[];if(o.length>0)for(let d of o){let u=[];try{if(d.type==="include")u.push(...wa(n,d.value)),u.push(...Sa(n,d.value));else if(d.type==="regex_include"){let y=new RegExp(d.value,"gi");[...n.matchAll(y)].forEach(g=>{g[1]&&u.push(g[1])})}}catch(y){xt.error("Error applying inclusion rule:",{rule:d,error:y})}u.forEach(y=>i.push(y.trim()))}else i.push(n);let l=[];for(let d of i){for(let u of a)try{let y=new RegExp(u.value,"gi");d=d.replace(y,"")}catch(y){xt.error("Error applying cleanup rule:",{rule:u,error:y})}va(d,s)||l.push(d)}return l.join(`

`).replace(/\n\s*\n\s*\n/g,`

`).replace(/^\s+|\s+$/g,"").trim()}async function Xr(t,e={}){let s=performance.now(),{chunkSize:r=5e4,maxTags:o=100,timeoutMs:a=5e3}=e,n=new Set,i=/<(?:\/|)([a-zA-Z0-9_-]+)(?:[^>]*)>|\{([a-zA-Z0-9_-]+)(?:\||})/g,l=0,c=0;for(let u=0;u<t.length;u+=r){let y=t.slice(u,Math.min(u+r,t.length));if(c++,l+=y.length,performance.now()-s>a){xt.warn(`Tag scanning timed out after ${a}ms`);break}let p;for(;(p=i.exec(y))!==null&&n.size<o;){let g=(p[1]||p[2]).toLowerCase();xa(g)&&n.add(g)}if(n.size>=o)break;c%5===0&&await new Promise(g=>setTimeout(g,0))}let d=performance.now();return{tags:Array.from(n).sort(),stats:{processingTimeMs:Math.round(d-s),processedChars:l,totalChars:t.length,chunkCount:c,tagsFound:n.size}}}function Qr(t,e=25){let s=t.tags.slice(0,e);return{suggestions:s,stats:{totalFound:t.stats.tagsFound,finalCount:s.length}}}function li(){return Ie.length===0&&Jr(),Ie}function ci(t){return Ie.find(e=>e.id===t)}function di(t){let e={id:`rule-${Date.now()}`,name:t.name||"\u65B0\u89C4\u5219",description:t.description||"",type:t.type||"include",value:t.value||"",enabled:t.enabled!==!1,createdAt:new Date().toISOString()};return Ie.push(e),Ta(),{success:!0,template:e,message:"\u89C4\u5219\u6A21\u677F\u521B\u5EFA\u6210\u529F"}}function ui(t,e){let s=Ie.findIndex(r=>r.id===t);return s===-1?{success:!1,message:"\u89C4\u5219\u6A21\u677F\u4E0D\u5B58\u5728"}:(Ie[s]={...Ie[s],...e,updatedAt:new Date().toISOString()},Ta(),{success:!0,template:Ie[s],message:"\u89C4\u5219\u6A21\u677F\u66F4\u65B0\u6210\u529F"})}function yi(t){let e=Ie.findIndex(s=>s.id===t);return e===-1?{success:!1,message:"\u89C4\u5219\u6A21\u677F\u4E0D\u5B58\u5728"}:(Ie.splice(e,1),Ta(),{success:!0,message:"\u89C4\u5219\u6A21\u677F\u5DF2\u5220\u9664"})}function Ta(){let t=ze();t.ruleTemplates=Ie,lt(t)}function wt(){return ce||Jr(),ce}function Zr(t){ce=t||[];let e=ze();e.tagRules=ce,lt(e)}function Cs(t){let e={id:`tag-${Date.now()}`,type:t.type||"include",value:t.value||"",enabled:t.enabled!==!1};ce.push(e);let s=ze();return s.tagRules=ce,lt(s),{success:!0,rule:e,message:"\u89C4\u5219\u6DFB\u52A0\u6210\u529F"}}function $s(t,e){if(t<0||t>=ce.length)return{success:!1,message:"\u89C4\u5219\u7D22\u5F15\u65E0\u6548"};ce[t]={...ce[t],...e};let s=ze();return s.tagRules=ce,lt(s),{success:!0,rule:ce[t],message:"\u89C4\u5219\u66F4\u65B0\u6210\u529F"}}function eo(t){if(t<0||t>=ce.length)return{success:!1,message:"\u89C4\u5219\u7D22\u5F15\u65E0\u6548"};ce.splice(t,1);let e=ze();return e.tagRules=ce,lt(e),{success:!0,message:"\u89C4\u5219\u5DF2\u5220\u9664"}}function ts(){return Ne||Jr(),Ne}function pr(t){Ne=t||[];let e=ze();e.contentBlacklist=Ne,lt(e)}function to(t,e=""){if(!t||!t.trim())return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=ze();s.tagRulePresets||(s.tagRulePresets={});let r=`preset-${Date.now()}`;return s.tagRulePresets[r]={id:r,name:t.trim(),description:e.trim(),rules:JSON.parse(JSON.stringify(ce)),blacklist:JSON.parse(JSON.stringify(Ne)),createdAt:new Date().toISOString()},lt(s),{success:!0,preset:s.tagRulePresets[r],message:"\u9884\u8BBE\u4FDD\u5B58\u6210\u529F"}}function so(){let e=ze().tagRulePresets||{};return Object.values(e)}function ro(t){let e=ze(),r=(e.tagRulePresets||{})[t];return r?(ce=JSON.parse(JSON.stringify(r.rules||[])),Ne=JSON.parse(JSON.stringify(r.blacklist||[])),e.tagRules=ce,e.contentBlacklist=Ne,lt(e),{success:!0,preset:r,message:"\u9884\u8BBE\u52A0\u8F7D\u6210\u529F"}):{success:!1,message:"\u9884\u8BBE\u4E0D\u5B58\u5728"}}function pi(t){let e=ze(),s=e.tagRulePresets||{};return s[t]?(delete s[t],e.tagRulePresets=s,lt(e),{success:!0,message:"\u9884\u8BBE\u5DF2\u5220\u9664"}):{success:!1,message:"\u9884\u8BBE\u4E0D\u5B58\u5728"}}function oo(){return JSON.stringify({tagRules:ce,contentBlacklist:Ne,ruleTemplates:Ie,tagRulePresets:ze().tagRulePresets||{}},null,2)}function ao(t,e={overwrite:!0}){try{let s=JSON.parse(t);if(e.overwrite)ce=s.tagRules||[],Ne=s.contentBlacklist||[],Ie=s.ruleTemplates||ha;else if(s.tagRules&&ce.push(...s.tagRules),s.contentBlacklist){let o=new Set(Ne.map(a=>a.toLowerCase()));s.contentBlacklist.forEach(a=>{o.has(a.toLowerCase())||Ne.push(a)})}let r=ze();return r.tagRules=ce,r.contentBlacklist=Ne,r.ruleTemplates=Ie,s.tagRulePresets&&(r.tagRulePresets={...r.tagRulePresets||{},...s.tagRulePresets}),lt(r),{success:!0,message:"\u914D\u7F6E\u5BFC\u5165\u6210\u529F"}}catch(s){return{success:!1,message:`\u5BFC\u5165\u5931\u8D25: ${s.message}`}}}function gi(t,e,s="g",r=0){try{if(!t||typeof t!="string")return{success:!1,error:"\u6B63\u5219\u8868\u8FBE\u5F0F\u4E0D\u80FD\u4E3A\u7A7A",matches:[]};let o=new RegExp(t,s),a=[];if(s.includes("g")){let n;for(;(n=o.exec(e))!==null;)n.length>1?a.push({fullMatch:n[0],groups:n.slice(1),index:n.index,extracted:n[r]||n[1]||n[0]}):a.push({fullMatch:n[0],groups:[],index:n.index,extracted:n[0]})}else{let n=o.exec(e);n&&a.push({fullMatch:n[0],groups:n.length>1?n.slice(1):[],index:n.index,extracted:n.length>1?n[r]||n[1]:n[0]})}return{success:!0,matches:a,count:a.length,extracted:a.map(n=>n.extracted)}}catch(o){return{success:!1,error:o.message,matches:[]}}}var xt,ai,Yd,ha,Ie,ce,Ne,fi,Vd,no=B(()=>{He();ae();xt=N.createScope("RegexExtractor"),ai="settings";Yd=["font","span","div","p","br","hr","img","a","b","i","u","s","em","strong","small","big","sub","sup","h1","h2","h3","h4","h5","h6","table","tr","td","th","tbody","thead","tfoot","ul","ol","li","form","input","button","select","option","textarea","label","script","style","meta","link","title","head","body","html"],ha=[{id:"exclude-thinking",name:"\u6392\u9664\u601D\u8003\u6807\u7B7E",description:"\u79FB\u9664<thinking>\u6807\u7B7E\u5757",type:"exclude",value:"thinking",enabled:!0},{id:"include-content",name:"\u63D0\u53D6\u5185\u5BB9\u6807\u7B7E",description:"\u63D0\u53D6<content>\u6807\u7B7E\u5185\u5BB9",type:"include",value:"content",enabled:!0},{id:"regex-exclude-cot",name:"\u6392\u9664\u5C0FCoT",description:"\u79FB\u9664HTML\u6CE8\u91CA",type:"regex_exclude",value:"<!--[\\s\\S]*?-->",enabled:!1},{id:"regex-include-details",name:"\u63D0\u53D6details\u6807\u7B7E",description:"\u63D0\u53D6<details>\u6807\u7B7E\u5185\u5BB9",type:"regex_include",value:"<details[^>]*>([\\s\\S]*?)</details>",enabled:!1}],Ie=[],ce=[],Ne=[];fi={lastMessage:{macro:"{{lastMessage}}",description:"\u6700\u540E\u4E00\u6761\u6D88\u606F"},lastCharMessage:{macro:"{{lastCharMessage}}",description:"\u6700\u540E\u4E00\u6761\u89D2\u8272\u6D88\u606F"},lastUserMessage:{macro:"{{lastUserMessage}}",description:"\u6700\u540E\u4E00\u6761\u7528\u6237\u6D88\u606F"},char:{macro:"{{char}}",description:"\u89D2\u8272\u540D\u79F0"},user:{macro:"{{user}}",description:"\u7528\u6237\u540D\u79F0"},input:{macro:"{{input}}",description:"\u5F53\u524D\u8F93\u5165\u6846\u5185\u5BB9"}};Jr();Vd={extractTagContent:es,extractSimpleTag:wa,extractCurlyBraceTag:Sa,extractComplexTag:ni,extractHtmlFormatTag:ii,escapeRegex:Zt,shouldSkipContent:va,isValidTagName:xa,scanTextForTags:Xr,generateTagSuggestions:Qr,getAllRuleTemplates:li,getRuleTemplate:ci,createRuleTemplate:di,updateRuleTemplate:ui,deleteRuleTemplate:yi,getTagRules:wt,setTagRules:Zr,addTagRule:Cs,updateTagRule:$s,deleteTagRule:eo,getContentBlacklist:ts,setContentBlacklist:pr,saveRulesAsPreset:to,getAllRulePresets:so,loadRulePreset:ro,deleteRulePreset:pi,exportRulesConfig:oo,importRulesConfig:ao,testRegex:gi,MESSAGE_MACROS:fi}});var ss,_a=B(()=>{ve();Ae();no();ss={id:"regexExtractPanel",render(t){let e=wt(),s=ts(),r=so();return`
...
`)||"\u65E0")}</div>
      ...
      `).join(""):'<div class="yyt-tool-compact-hint yyt-worldbook-empty">\u672A\u627E\u5230\u5339\u914D\u4E16\u754C\u4E66\u3002</div>');let v=p.length===0?"\u9009\u62E9\u8981\u6CE8\u5165\u7684\u4E16\u754C\u4E66":p.length<=2?p.join("\u3001"):`\u5DF2\u9009 ${p.length} \u9879\uFF1A${p.slice(0,2).join("\u3001")} \u7B49`;l.find(".yyt-worldbook-summary").text(v)}}}var Ks,My,ys=B(()=>{Ae();Lt();Na();cr();Bs();Fa();Ks=`
  .yyt-tool-panel {
    display: flex;
    flex-direction: column;
    gap: 16px;
...
`;My=Nt});var ps,Ha=B(()=>{ys();ps=Nt({id:"summaryToolPanel",toolId:"summaryTool",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u8FDB\u884C\u6458\u8981\u89E3\u6790\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 boo_FM
\u6216 regex:<boo_FM>([\\s\\S]*?)</boo_FM>`,previewDialogId:"summary-extraction-preview",defaultInjectionOrder:1e4,lorebookLogTag:"SummaryToolPanel"})});var gs,qa=B(()=>{ys();gs=Nt({id:"statusBlockPanel",toolId:"statusBlock",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u751F\u6210\u4E3B\u89D2\u72B6\u6001\u680F\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 status_block
\u6216 regex:<status_block>([\\s\\S]*?)</status_block>`,previewDialogId:"status-extraction-preview",defaultInjectionOrder:10001,lorebookLogTag:"StatusBlockPanel"})});var fs,Ga=B(()=>{ys();fs=Nt({id:"youyouReviewPanel",toolId:"youyouReview",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u5728\u672B\u5C3E\u751F\u6210\u5C0F\u5E7D\u70B9\u8BC4\u4E0E\u5267\u60C5\u94A9\u5B50\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 youyou
...
regex:<content>([\\s\\S]*?)</content>`,processorDirections:[{key:"en_to_zh",label:"\u82F1\u6587\u8F6C\u4E2D\u6587",description:"\u6309\u52FE\u9009\u9879\u628A\u82F1\u6587\u6807\u70B9\u66FF\u6362\u4E3A\u4E2D\u6587\u6807\u70B9\u3002"}],processorOptions:[{key:"comma",label:"\u9017\u53F7 ,",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u9017\u53F7\u3002"},{key:"period",label:"\u53E5\u53F7 .",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u53E5\u53F7\u3002"},{key:"exclamation",label:"\u611F\u53F9\u53F7 !",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u611F\u53F9\u53F7\u3002"},{key:"question",label:"\u95EE\u53F7 ?",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u95EE\u53F7\u3002"},{key:"semicolon",label:"\u5206\u53F7 ;",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5206\u53F7\u3002"},{key:"colon",label:"\u5192\u53F7 :",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5192\u53F7\u3002"},{key:"leftParen",label:"\u5DE6\u62EC\u53F7 (",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5DE6\u62EC\u53F7\u3002"},{key:"rightParen",label:"\u53F3\u62EC\u53F7 )",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u53F3\u62EC\u53F7\u3002"}]})});var hs,Xa=B(()=>{ve();Bs();Ae();hs={id:"bypassPanel",_getActivePresetId(t){return t.find(".yyt-bypass-editor-content").data("presetId")||null},render(t){let e=H.getPresetList(),s=H.getDefaultPresetId();return`
    ...
    `},renderTo(t){let e=this.render({});t.html(e),this.bindEvents(t,{})}}});var Al={};be(Al,{SettingsPanel:()=>_t,applyTheme:()=>_l,applyUiPreferences:()=>Qa,default:()=>$y});function Fs({id:t,checked:e=!1,title:s="",hint:r=""}){return`
    <div class="yyt-toggle-row">
      <div class="yyt-toggle-label">
        <span>${s}</span>
  ...
  `}function Sl(){try{if(typeof window.parent<"u"&&window.parent&&window.parent!==window)return window.parent}catch{}return window}function kr(){return Sl()?.document||document}function Tl(t=kr()){return t?.documentElement||document.documentElement}function _l(t,e=kr()){let s=Tl(e),r={...Cy,...wl[t]||wl["dark-blue"]};Object.entries(r).forEach(([o,a])=>{s.style.setProperty(o,a)}),s.setAttribute("data-yyt-theme",t)}function Qa(t={},e=kr()){let s=Tl(e),{theme:r="dark-blue",compactMode:o=!1,animationEnabled:a=!0}=t||{};_l(r,e),s.classList.toggle("yyt-compact-mode",!!o),s.classList.toggle("yyt-no-animation",!a)}var Cy,wl,_t,$y,Po=B(()=>{ve();Ar();ae();Ir();Ae();Cy={"--yyt-accent":"#7bb7ff","--yyt-accent-glow":"rgba(123, 183, 255, 0.4)","--yyt-accent-soft":"rgba(123, 183, 255, 0.15)","--yyt-accent-strong":"#a5d4ff","--yyt-bg-base":"#0b0f15","--yyt-bg-gradient-1":"rgba(123, 183, 255, 0.12)","--yyt-bg-gradient-2":"rgba(155, 123, 255, 0.10)","--yyt-surface":"rgba(255, 255, 255, 0.03)","--yyt-surface-2":"rgba(255, 255, 255, 0.05)","--yyt-surface-3":"rgba(255, 255, 255, 0.075)","--yyt-surface-hover":"rgba(255, 255, 255, 0.08)","--yyt-surface-active":"rgba(255, 255, 255, 0.11)","--yyt-border":"rgba(255, 255, 255, 0.08)","--yyt-border-soft":"rgba(255, 255, 255, 0.05)","--yyt-border-strong":"rgba(255, 255, 255, 0.16)","--yyt-text":"rgba(255, 255, 255, 0.95)","--yyt-text-secondary":"rgba(255, 255, 255, 0.72)","--yyt-text-muted":"rgba(255, 255, 255, 0.5)","--yyt-focus-ring":"0 0 0 3px rgba(123, 183, 255, 0.18)","--yyt-on-accent":"#0b0f15","--yyt-control-bg":"linear-gradient(180deg, #1d2737 0%, #151d2a 100%)","--yyt-control-bg-hover":"linear-gradient(180deg, #243247 0%, #1a2638 100%)","--yyt-control-bg-active":"linear-gradient(180deg, #2a3951 0%, #1d2b3f 100%)","--yyt-control-bg-strong":"linear-gradient(180deg, #243247 0%, #192435 100%)","--yyt-control-bg-focus":"linear-gradient(180deg, #243a57 0%, #1a2a3f 100%)","--yyt-control-border":"rgba(146, 173, 212, 0.24)","--yyt-control-border-hover":"rgba(146, 173, 212, 0.36)","--yyt-control-border-focus":"rgba(123, 183, 255, 0.72)","--yyt-control-shadow":"0 12px 24px rgba(0, 0, 0, 0.24), inset 0 1px 0 rgba(255, 255, 255, 0.04)","--yyt-control-shadow-hover":"0 16px 28px rgba(0, 0, 0, 0.28), inset 0 1px 0 rgba(255, 255, 255, 0.06)","--yyt-control-shadow-focus":"0 18px 30px rgba(8, 14, 24, 0.32), inset 0 1px 0 rgba(255, 255, 255, 0.06)","--yyt-control-shadow-active":"0 10px 20px rgba(0, 0, 0, 0.22), inset 0 1px 0 rgba(255, 255, 255, 0.04)","--yyt-select-surface":"#121a26","--yyt-select-option-bg":"#192334","--yyt-select-option-hover-bg":"#233249","--yyt-select-option-selected-bg":"#2a3f60","--yyt-select-option-border":"rgba(123, 183, 255, 0.22)","--yyt-select-option-selected-border":"rgba(123, 183, 255, 0.4)","--yyt-select-dropdown-shadow":"0 24px 44px rgba(0, 0, 0, 0.52), 0 0 0 1px rgba(8, 12, 18, 0.82)","--yyt-select-arrow-color":"rgba(255, 255, 255, 0.52)"},wl={"dark-blue":{"--yyt-on-accent":"#0b0f15"},"dark-purple":{"--yyt-accent":"#a78bfa","--yyt-accent-glow":"rgba(167, 139, 250, 0.4)","--yyt-accent-soft":"rgba(167, 139, 250, 0.15)","--yyt-accent-strong":"#c4b5fd","--yyt-bg-base":"#0f0b15","--yyt-bg-gradient-1":"rgba(167, 139, 250, 0.12)","--yyt-bg-gradient-2":"rgba(123, 183, 255, 0.10)","--yyt-on-accent":"#120b1f"},"dark-green":{"--yyt-accent":"#4ade80","--yyt-accent-glow":"rgba(74, 222, 128, 0.4)","--yyt-accent-soft":"rgba(74, 222, 128, 0.15)","--yyt-accent-strong":"#86efac","--yyt-bg-base":"#0b150f","--yyt-bg-gradient-1":"rgba(74, 222, 128, 0.12)","--yyt-bg-gradient-2":"rgba(123, 183, 255, 0.10)","--yyt-on-accent":"#0b150f"},light:{"--yyt-accent":"#3b82f6","--yyt-accent-glow":"rgba(59, 130, 246, 0.3)","--yyt-accent-soft":"rgba(59, 130, 246, 0.1)","--yyt-accent-strong":"#93c5fd","--yyt-bg-base":"#f8fafc","--yyt-bg-gradient-1":"rgba(59, 130, 246, 0.08)","--yyt-bg-gradient-2":"rgba(139, 92, 246, 0.06)","--yyt-text":"rgba(15, 23, 42, 0.95)","--yyt-text-secondary":"rgba(15, 23, 42, 0.72)","--yyt-text-muted":"rgba(15, 23, 42, 0.52)","--yyt-surface":"rgba(255, 255, 255, 0.66)","--yyt-surface-2":"rgba(255, 255, 255, 0.86)","--yyt-surface-3":"rgba(255, 255, 255, 0.94)","--yyt-surface-hover":"rgba(255, 255, 255, 0.92)","--yyt-surface-active":"rgba(255, 255, 255, 0.98)","--yyt-border":"rgba(15, 23, 42, 0.08)","--yyt-border-soft":"rgba(15, 23, 42, 0.05)","--yyt-border-strong":"rgba(15, 23, 42, 0.14)","--yyt-focus-ring":"0 0 0 3px rgba(59, 130, 246, 0.14)","--yyt-on-accent":"#0f172a","--yyt-control-bg":"linear-gradient(180deg, rgba(255, 255, 255, 0.98) 0%, rgba(241, 245, 249, 0.98) 100%)","--yyt-control-bg-hover":"linear-gradient(180deg, rgba(255, 255, 255, 1) 0%, rgba(226, 232, 240, 0.98) 100%)","--yyt-control-bg-active":"linear-gradient(180deg, rgba(239, 246, 255, 1) 0%, rgba(219, 234, 254, 0.98) 100%)","--yyt-control-bg-strong":"linear-gradient(180deg, rgba(255, 255, 255, 1) 0%, rgba(241, 245, 249, 0.98) 100%)","--yyt-control-bg-focus":"linear-gradient(180deg, rgba(239, 246, 255, 1) 0%, rgba(219, 234, 254, 0.98) 100%)","--yyt-control-border":"rgba(59, 130, 246, 0.18)","--yyt-control-border-hover":"rgba(59, 130, 246, 0.28)","--yyt-control-border-focus":"rgba(59, 130, 246, 0.58)","--yyt-control-shadow":"0 10px 22px rgba(15, 23, 42, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.75)","--yyt-control-shadow-hover":"0 12px 24px rgba(15, 23, 42, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.85)","--yyt-control-shadow-focus":"0 14px 26px rgba(59, 130, 246, 0.14), inset 0 1px 0 rgba(255, 255, 255, 0.9)","--yyt-control-shadow-active":"0 8px 18px rgba(15, 23, 42, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.85)","--yyt-select-surface":"#ffffff","--yyt-select-option-bg":"#f8fafc","--yyt-select-option-hover-bg":"#eff6ff","--yyt-select-option-selected-bg":"#dbeafe","--yyt-select-option-border":"rgba(59, 130, 246, 0.16)","--yyt-select-option-selected-border":"rgba(59, 130, 246, 0.34)","--yyt-select-dropdown-shadow":"0 18px 32px rgba(15, 23, 42, 0.12), 0 0 0 1px rgba(148, 163, 184, 0.18)","--yyt-select-arrow-color":"rgba(15, 23, 42, 0.45)"}};_t={id:"settingsPanel",render(){let t=Je.getSettings(),e=t.debug?.enableDebugLog===!0,s=t.automation?.enabled===!0,r=this._getAutomationRuntime();return`
    ...
    `},renderTo(t){t.html(this.render({})),this.bindEvents(t,{})}},$y=_t});function Oo(t,e,s){return`${Number.isFinite(t)?t:-1}:${Number.isFinite(e)?e:-1}:${ne(s)||"*"}`}function ne(t){return t==null?"":String(t).trim()}function ue(t){if(t!==void 0)try{return JSON.parse(JSON.stringify(t))}catch{return t}}function Hs(t={}){return{chatId:ne(t.chatId),sourceMessageId:ne(t.sourceMessageId||t.messageId),sourceSwipeId:ne(t.sourceSwipeId||t.effectiveSwipeId),effectiveSwipeId:ne(t.effectiveSwipeId||t.sourceSwipeId),slotBindingKey:ne(t.slotBindingKey),slotRevisionKey:ne(t.slotRevisionKey),slotTransactionId:ne(t.slotTransactionId),traceId:ne(t.traceId),resolvedAt:Number.isFinite(t.resolvedAt)?t.resolvedAt:Date.now()}}function Za(t={}){return{resolvedAt:Number.isFinite(t.resolvedAt)?t.resolvedAt:Date.now(),runSource:ne(t.runSource)||yt.MANUAL,traceId:ne(t.traceId),chatId:ne(t.chatId),sourceMessageId:ne(t.sourceMessageId||t.messageId),sourceSwipeId:ne(t.sourceSwipeId||t.effectiveSwipeId),effectiveSwipeId:ne(t.effectiveSwipeId||t.sourceSwipeId)||"swipe:current",slotBindingKey:ne(t.slotBindingKey),slotRevisionKey:ne(t.slotRevisionKey),slotTransactionId:ne(t.slotTransactionId),assistantContentFingerprint:ne(t.assistantContentFingerprint),assistantBaseFingerprint:ne(t.assistantBaseFingerprint),assistantText:String(t.assistantText||""),assistantBaseText:String(t.assistantBaseText||""),targetMessageIndex:Number.isFinite(t.targetMessageIndex)?t.targetMessageIndex:-1}}function Gs(t){return!t||typeof t!="object"?null:{slotBindingKey:ne(t.slotBindingKey),slotRevisionKey:ne(t.slotRevisionKey),sourceMessageId:ne(t.sourceMessageId),sourceSwipeId:ne(t.sourceSwipeId),tables:Array.isArray(t.tables)?ue(t.tables):[],updatedAt:Number.isFinite(t.updatedAt)?t.updatedAt:0,meta:t.meta&&typeof t.meta=="object"?ue(t.meta):{}}}function Do(t={},e={}){let s=Za(t);return{slotBindingKey:s.slotBindingKey,slotRevisionKey:s.slotRevisionKey,sourceMessageId:s.sourceMessageId,sourceSwipeId:s.sourceSwipeId||s.effectiveSwipeId,tables:Array.isArray(e.tables)?ue(e.tables):[],updatedAt:Number.isFinite(e.updatedAt)?e.updatedAt:Date.now(),meta:e.meta&&typeof e.meta=="object"?ue(e.meta):{}}}function Lo(t){return!t||typeof t!="object"?{lastResolvedTarget:null,lastCommittedTarget:null,updatedAt:0}:{lastResolvedTarget:t.lastResolvedTarget?Hs(t.lastResolvedTarget):null,lastCommittedTarget:t.lastCommittedTarget?Hs(t.lastCommittedTarget):null,updatedAt:Number.isFinite(t.updatedAt)?t.updatedAt:0}}var Cr,qs,yt,$r,vs,El,Bt=B(()=>{Cr="YouYouToolkit_tableState",qs="YouYouToolkit_tableBindings",yt=Object.freeze({MANUAL:"MANUAL_TABLE",AUTO:"AUTO_TABLE"}),$r=Object.freeze({EXACT:"exact",BINDING_FALLBACK:"binding_fallback",TEMPLATE:"template",EMPTY:"empty"}),vs=Object.freeze({INSERT_ROW:"insertRow",UPDATE_ROW:"updateRow",DELETE_ROW:"deleteRow"}),El=Object.freeze({CELL:"cell",ROW:"row",COLUMN:"column"})});function W(t,e,s="",r=Js){return{key:t,title:e,description:s,type:r,required:!1}}function Ut({id:t,name:e,note:s,aiInstructions:r,columns:o}){return{id:t,name:e,note:s,enabled:!0,aiInstructions:{init:r?.init||"",create:r?.create||"",update:r?.update||"",delete:r?.delete||""},columns:o,rows:[]}}function M(t,e=""){return t==null?e:String(t).trim()||e}function Il(t,e=!1){return t==null?e:t===!0}function Oy(t){if(!Array.isArray(t)||t.length!==1)return!1;let e=t[0]&&typeof t[0]=="object"?t[0]:null;if(!e)return!1;let s=M(e.name||e.title,""),r=M(e.note||e.description,""),o=Array.isArray(e.columns)?e.columns:[],a=Array.isArray(e.rows)?e.rows:[];if(s&&!["\u88681","\u8868\u683C 1","\u8868\u683C1"].includes(s)||r||o.length!==1||a.length>1)return!1;let n=o[0]&&typeof o[0]=="object"?o[0]:{},i=M(n.key||n.id,""),l=M(n.title||n.name||n.label,"");if(M(n.description||n.note,"")||i&&i!=="col_1"||l&&!["\u52171","col_1"].includes(l))return!1;if(a.length===0)return!0;let d=a[0]&&typeof a[0]=="object"?a[0]:{},u=M(d.name||d.title||d.label,""),y=d.cells&&typeof d.cells=="object"&&!Array.isArray(d.cells)?d.cells:{},p=Array.isArray(d.values)?d.values:[],g=Object.values(y).some(x=>M(x,""))||p.some(x=>M(x,""));return(!u||u==="\u884C1")&&!g}function Dy(t,{seedDefaultWhenMissing:e=!1}={}){return Oy(t)?ue(No):Array.isArray(t)?ue(t):t&&typeof t=="object"?Ny(t):e?ue(No):[]}function Ly(t=""){let e=[],s=M(t,""),r=/-\s*列\d+\s*[:：]\s*([^\n\-–—]+?)\s*[-–—]\s*([^\n]+)/g,o;for(;o=r.exec(s);)e.push({title:M(o[1],""),description:M(o[2],"")});return e}function Ny(t={}){let e=t&&typeof t=="object"?t:{};return Object.keys(e).filter(r=>r.startsWith("sheet_")&&e[r]&&typeof e[r]=="object").map((r,o)=>({key:r,table:e[r],fallbackOrder:o})).sort((r,o)=>{let a=Number.isFinite(r.table.orderNo)?r.table.orderNo:r.fallbackOrder,n=Number.isFinite(o.table.orderNo)?o.table.orderNo:o.fallbackOrder;return a-n}).map(({key:r,table:o},a)=>{let n=o.sourceData&&typeof o.sourceData=="object"?o.sourceData:{},i=Array.isArray(o.content)?o.content:[],l=Array.isArray(i[0])?i[0]:[],c=Ly(n.note),d=new Set,u=l.slice(1).map((p,g)=>{let x=c[g]||{},v=M(p||x.title,`\u5217${g+1}`);return{key:$l(v||`col_${g+1}`,d),title:v,description:M(x.description,""),type:Js,required:!1}}),y=i.slice(1).map((p,g)=>{let x=Array.isArray(p)?p:[],v={};return u.forEach((_,A)=>{v[_.key]=Rr(x[A+1])}),{name:M(x[0],`\u884C${g+1}`),cells:v}});return{id:M(o.uid||r,`sheet_${a+1}`),name:M(o.name,`\u8868${a+1}`),note:M(n.note,""),enabled:o.enabled!==!1,aiInstructions:{init:M(n.initNode,""),create:M(n.insertNode,""),update:M(n.updateNode,""),delete:M(n.deleteNode,"")},columns:u,rows:y}})}function Rr(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function By(t,e="col"){return M(t,"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")||e}function $l(t,e=new Set){let s=By(t,"col"),r=s,o=2;for(;e.has(r);)r=`${s}_${o}`,o+=1;return e.add(r),r}function Uy(t=[]){let e=[],s=0;return t.forEach(r=>{let o=r&&typeof r=="object"?r:{},a=o.cells&&typeof o.cells=="object"&&!Array.isArray(o.cells)?o.cells:null,n=Array.isArray(o.cells)?o.cells:Array.isArray(o.values)?o.values:null;a&&Object.keys(a).forEach(i=>{e.includes(i)||e.push(i)}),n&&n.length>s&&(s=n.length)}),e.length>0?e.map(r=>({key:r,title:String(r)})):s>0?Array.from({length:s},(r,o)=>({key:`col_${o+1}`,title:`\u5217${o+1}`})):[]}function sn(t,e=Js){let s=M(t,e);return kl.some(r=>r.value===s)?s:e}function jy(t={},e=0,s=new Set){let r=t&&typeof t=="object"?t:{},o=M(r.title||r.name||r.label,`\u5217${e+1}`),a=M(r.key||r.id,""),n=$l(a||o||`col_${e+1}`,s),i=[a,M(r.title,""),M(r.name,""),M(r.label,"")].filter(Boolean);return{key:n,title:o,description:M(r.description||r.note,""),type:sn(r.type),required:r.required===!0,sourceKeys:i}}function zy(t={},e={},s=0){let r=t.cells&&typeof t.cells=="object"&&!Array.isArray(t.cells)?t.cells:null,o=Array.isArray(t.cells)?t.cells:Array.isArray(t.values)?t.values:null;if(r){let a=[...Array.isArray(e.sourceKeys)?e.sourceKeys:[],e.key,e.title].filter(Boolean);for(let n of a)if(r[n]!==void 0)return Rr(r[n])}return o&&o[s]!==void 0?Rr(o[s]):""}function Wy(t={},e=[],s=0){let r=t&&typeof t=="object"?t:{},o={};return e.forEach((a,n)=>{o[a.key]=zy(r,a,n)}),{name:M(r.name||r.title||r.label,`\u884C${s+1}`),cells:o}}function Ky(t={}){let e=t&&typeof t=="object"?t:{};return{init:M(e.init,""),create:M(e.create,""),update:M(e.update,""),delete:M(e.delete,"")}}function Fy(t={},e=""){let s=t&&typeof t=="object"?t:{},r=M(s.presetId,M(e,""));return{enabled:s.enabled===!0,presetId:r}}function Rl(t={},e=0){let s=t&&typeof t=="object"?t:{},r=new Set,a=(Array.isArray(s.columns)&&s.columns.length>0?s.columns:Uy(Array.isArray(s.rows)?s.rows:[])).map((i,l)=>jy(i,l,r)),n=Array.isArray(s.rows)?s.rows.map((i,l)=>Wy(i,a,l)):[];return{id:M(s.id,""),name:M(s.name||s.title,`\u8868${e+1}`),note:M(s.note||s.description,""),enabled:s.enabled!==!1,aiInstructions:Ky(s.aiInstructions),columns:a.map(i=>({key:i.key,title:i.title,description:M(i.description,""),type:sn(i.type),required:i.required===!0})),rows:n}}function Pl(t={}){let e=t&&typeof t=="object"?t:{},s=Array.isArray(e.lastErrorDetails)?e.lastErrorDetails.map(o=>M(o,"")).filter(Boolean):[],r=e.lastValidationSummary&&typeof e.lastValidationSummary=="object"?{errorCount:Number.isFinite(e.lastValidationSummary.errorCount)?e.lastValidationSummary.errorCount:0,warningCount:Number.isFinite(e.lastValidationSummary.warningCount)?e.lastValidationSummary.warningCount:0}:{errorCount:0,warningCount:0};return{lastStatus:M(e.lastStatus,Vs.IDLE),lastRunAt:Number.isFinite(e.lastRunAt)?e.lastRunAt:0,lastDurationMs:Number.isFinite(e.lastDurationMs)?e.lastDurationMs:0,lastError:M(e.lastError,""),lastErrorDetails:s,lastValidationSummary:r,successCount:Number.isFinite(e.successCount)?e.successCount:0,errorCount:Number.isFinite(e.errorCount)?e.errorCount:0,lastSourceMessageId:M(e.lastSourceMessageId,""),lastSlotRevisionKey:M(e.lastSlotRevisionKey,""),lastLoadMode:M(e.lastLoadMode,""),lastMirrorApplied:e.lastMirrorApplied===!0}}function Hy(){return{tables:[]}}function Ol(t=[]){return!Array.isArray(t)||t.length===0?Hy():{tables:t.map((e,s)=>Rl(e,s))}}function qy(t={}){let e=t&&typeof t=="object"?t:{};return(Array.isArray(e.tables)?e.tables:[]).map((r,o)=>Rl(r,o))}function Dl(t="",e={},s={}){let r=sn(e?.type),o=String(t??"").trim(),a=M(s?.label,`${M(s?.tableName,"\u8868\u683C")} / ${M(s?.rowName,"\u884C")} / ${M(e?.title||e?.key,"\u5355\u5143\u683C")}`),n=[],i=[];if(e?.required===!0&&!o&&n.push(`${a} \u4E3A\u5FC5\u586B\uFF0C\u5F53\u524D\u4E3A\u7A7A\u3002`),!o)return{valid:n.length===0,errors:n,warnings:i};if(r==="number"&&!Number.isFinite(Number(o))&&n.push(`${a} \u9700\u8981\u586B\u5199\u6570\u5B57\u3002`),r==="boolean"&&!["true","false","1","0","yes","no"].includes(o.toLowerCase())&&n.push(`${a} \u9700\u8981\u586B\u5199\u5E03\u5C14\u503C\uFF08true / false\uFF09\u3002`),r==="date"&&Number.isNaN(Date.parse(o))&&n.push(`${a} \u9700\u8981\u586B\u5199\u53EF\u89E3\u6790\u7684\u65E5\u671F\u3002`),r==="json")try{JSON.parse(o)}catch(l){n.push(`${a} \u9700\u8981\u586B\u5199\u5408\u6CD5 JSON\uFF1A${l?.message||"\u89E3\u6790\u5931\u8D25"}`)}return{valid:n.length===0,errors:n,warnings:i}}function Gy(t={}){let s=qy(t&&typeof t=="object"?t:{}),r=[];return s.forEach((o,a)=>{let n=M(o?.name,`\u8868${a+1}`),i=Array.isArray(o?.columns)?o.columns:[],l=Array.isArray(o?.rows)?o.rows:[];n||r.push(`\u8868 ${a+1} \u7F3A\u5C11\u540D\u79F0\u3002`),i.length===0&&r.push(`${n} \u81F3\u5C11\u9700\u8981\u4E00\u5217\u3002`);let c=new Set;i.forEach((d,u)=>{let y=M(d?.key,""),p=M(d?.title,`\u5217${u+1}`);if(!y){r.push(`${n} / ${p} \u7F3A\u5C11\u5185\u90E8\u540D\u3002`);return}if(c.has(y)){r.push(`${n} \u4E2D\u5B58\u5728\u91CD\u590D\u5217\u5185\u90E8\u540D\uFF1A${y}`);return}c.add(y)}),l.forEach((d,u)=>{let y=M(d?.name,`\u884C${u+1}`),p=d?.cells&&typeof d.cells=="object"&&!Array.isArray(d.cells)?d.cells:{};i.forEach((g,x)=>{let v=M(g?.key,""),_=M(g?.title||v,`\u5217${x+1}`),A=v?Rr(p[v]):"",S=Dl(A,g,{label:`${n} / ${y} / ${_}`,tableName:n,rowName:y});r.push(...S.errors)})})}),{valid:r.length===0,errors:r,tables:s}}function Ys({severity:t="error",message:e="",tableIndex:s=-1,tableName:r="",columnIndex:o=-1,columnKey:a="",rowIndex:n=-1,rowName:i="",cellKey:l=""}={}){return{severity:t,message:M(e,t==="warning"?"\u5B58\u5728\u8B66\u544A\u3002":"\u5B58\u5728\u9519\u8BEF\u3002"),tableIndex:s,tableName:M(r,""),columnIndex:o,columnKey:M(a,""),rowIndex:n,rowName:M(i,""),cellKey:M(l,"")}}function xs(t={}){let e=Gy(t),s=[];if(!e.valid)return{...e,warnings:[],issues:s,summary:{errorCount:e.errors.length,warningCount:0}};let r=Array.isArray(e.tables)?e.tables:[];r.forEach((n,i)=>{let l=M(n?.name,`\u8868${i+1}`),c=Array.isArray(n?.columns)?n.columns:[],d=Array.isArray(n?.rows)?n.rows:[],u=new Set;l||s.push(Ys({severity:"error",message:`\u8868 ${i+1} \u7F3A\u5C11\u540D\u79F0\u3002`,tableIndex:i,tableName:l})),c.forEach((y,p)=>{let g=M(y?.key,""),x=M(y?.title,`\u5217${p+1}`);g||s.push(Ys({severity:"error",message:`${l} / ${x} \u7F3A\u5C11\u5185\u90E8\u540D\u3002`,tableIndex:i,tableName:l,columnIndex:p,columnKey:g,cellKey:g})),g&&(u.has(g)&&s.push(Ys({severity:"error",message:`${l} \u4E2D\u5B58\u5728\u91CD\u590D\u5217\u5185\u90E8\u540D\uFF1A${g}`,tableIndex:i,tableName:l,columnIndex:p,columnKey:g,cellKey:g})),u.add(g))}),d.forEach((y,p)=>{let g=M(y?.name,`\u884C${p+1}`),x=y?.cells&&typeof y.cells=="object"&&!Array.isArray(y.cells)?y.cells:{};Object.keys(x).forEach(_=>{c.some(A=>M(A?.key,"")===_)||s.push(Ys({severity:"warning",message:`${l} / ${g} \u5305\u542B\u672A\u5B9A\u4E49\u5217 ${_}\uFF0C\u4FDD\u5B58\u540E\u4F1A\u88AB\u5FFD\u7565\u3002`,tableIndex:i,tableName:l,rowIndex:p,rowName:g,cellKey:_}))}),c.forEach((_,A)=>{let S=M(_?.key,""),z=M(_?.title||S,`\u5217${A+1}`),$=S?Rr(x[S]):"",I=Dl($,_,{label:`${l} / ${g} / ${z}`,tableName:l,rowName:g});I.errors.forEach(R=>{s.push(Ys({severity:"error",message:R,tableIndex:i,tableName:l,columnIndex:A,columnKey:S,rowIndex:p,rowName:g,cellKey:S}))}),I.warnings.forEach(R=>{s.push(Ys({severity:"warning",message:R,tableIndex:i,tableName:l,columnIndex:A,columnKey:S,rowIndex:p,rowName:g,cellKey:S}))})})})});let o=s.filter(n=>n.severity!=="warning").map(n=>n.message),a=s.filter(n=>n.severity==="warning").map(n=>n.message);return{valid:o.length===0,errors:o,warnings:a,issues:s,tables:r,summary:{errorCount:o.length,warningCount:a.length}}}function rn(){return[{id:Cl,name:Py,description:"\u5305\u542B\u5168\u5C40\u6570\u636E\u3001\u4E3B\u89D2\u3001\u91CD\u8981\u89D2\u8272\u3001\u6280\u80FD\u3001\u80CC\u5305\u3001\u4EFB\u52A1\u3001\u7EAA\u8981\u548C\u9009\u9879\u8868\u3002",tables:ue(No)}]}function Ll(){return{tables:ue(No),promptTemplate:Ml,apiPreset:"",promptPreset:"",bypass:{enabled:!1,presetId:""},activeTemplate:Cl,autoUpdateEnabled:!1,autoUpdateTrigger:"assistantMessage",runScope:"enabled",fillMode:jt.INCREMENTAL,mirrorToMessage:!1,mirrorTag:"yyt-table-workbench",runtime:Pl()}}function Ze(t={}){let e=Ll(),s=t&&typeof t=="object"?t:{},r=Fy(s.bypass,s.promptPreset);return{tables:Dy(s.tables,{seedDefaultWhenMissing:!Object.prototype.hasOwnProperty.call(s,"tables")}),promptTemplate:M(s.promptTemplate,e.promptTemplate),apiPreset:M(s.apiPreset,""),promptPreset:r.presetId,bypass:r,activeTemplate:M(s.activeTemplate,e.activeTemplate),autoUpdateEnabled:Il(s.autoUpdateEnabled,e.autoUpdateEnabled),autoUpdateTrigger:M(s.autoUpdateTrigger,e.autoUpdateTrigger),runScope:M(s.runScope,e.runScope),fillMode:s.fillMode===jt.FULL?jt.FULL:e.fillMode,mirrorToMessage:Il(s.mirrorToMessage,e.mirrorToMessage),mirrorTag:M(s.mirrorTag,e.mirrorTag),runtime:Pl({...e.runtime,...s.runtime||{}})}}function on(t={}){let e=Ze(t),s=[];return Array.isArray(e.tables)||s.push("\u8868\u5B9A\u4E49\u5FC5\u987B\u662F JSON \u6570\u7EC4\u3002"),e.promptTemplate||s.push("\u586B\u8868 Prompt \u4E0D\u80FD\u4E3A\u7A7A\u3002"),e.mirrorTag||s.push("\u6B63\u6587\u955C\u50CF\u6807\u7B7E\u4E0D\u80FD\u4E3A\u7A7A\u3002"),{valid:s.length===0,errors:s,config:e}}function zt(){let t=en.get(tn,Ll());return Ze(t)}function Ke(t={}){let e=zt(),s=Ze({...e,...t||{},runtime:t?.runtime===void 0?e.runtime:t.runtime}),r=on(s);return r.valid?(en.set(tn,r.config),{success:!0,config:r.config}):{success:!1,error:r.errors.join(`
`),errors:r.errors,config:r.config}}function Pr(t={}){let e=zt(),s=Ze({...e,runtime:{...e.runtime,...t||{}}});return en.set(tn,s),s.runtime}function Yy(t={}){let e=Ze(t);return`${M(e.promptTemplate,Ml)}

${Ry}`.trim()}function Nl(t={}){let e=Ze(t);return{id:"tableWorkbench",name:"\u586B\u8868\u5DE5\u4F5C\u53F0",promptTemplate:Yy(e),bypass:{enabled:e.bypass?.enabled===!0,presetId:e.bypass?.presetId||e.promptPreset||""}}}function Bl({apiPresets:t=[]}={}){let e=[{value:"",label:"\u5F53\u524D API \u914D\u7F6E"},...t.map(s=>({value:String(s?.name||""),label:String(s?.name||"")})).filter(s=>s.value)];return[{name:"tables",type:"tableDefinitions",label:"\u8868\u5B9A\u4E49",description:"\u901A\u8FC7\u7ED3\u6784\u5316\u7F16\u8F91\u5668\u7EF4\u62A4 tables\u3002\u9996\u6B21\u6267\u884C\u6216\u5F53\u524D\u6D88\u606F\u5C1A\u65E0\u7ED1\u5B9A state \u65F6\uFF0C\u4F1A\u4EE5\u7F16\u8BD1\u540E\u7684 tables \u4F5C\u4E3A merge base\u3002",emptyValue:[]},{name:"promptTemplate",type:"textarea",label:"\u586B\u8868 Prompt",rows:12,description:"\u53EF\u4F7F\u7528 {{lastUserMessage}}\u3001{{lastAiMessage}}\u3001{{chatHistory}}\u3001{{toolContentMacro}} \u7B49\u53D8\u91CF\u3002\u7CFB\u7EDF\u4F1A\u81EA\u52A8\u8FFD\u52A0 JSON \u8F93\u51FA\u7EA6\u675F\u3002"},{name:"apiPreset",type:"select",label:"API \u9884\u8BBE",description:"\u4E3A\u7A7A\u65F6\u4F7F\u7528\u5F53\u524D\u5168\u5C40 API \u914D\u7F6E\u3002",options:e},{name:"mirrorToMessage",type:"checkbox",label:"\u955C\u50CF\u5199\u56DE\u6B63\u6587",description:"\u628A\u5F53\u524D tables \u7684 JSON \u9884\u89C8\u955C\u50CF\u5230\u76EE\u6807 assistant \u6D88\u606F\u6B63\u6587\u4E2D\u3002"}]}var en,tn,Vs,jt,Ml,Ry,kl,Js,Bo,Cl,Py,No,Or=B(()=>{He();Bt();en=k.namespace("tableWorkbench"),tn="config",Vs=Object.freeze({IDLE:"idle",RUNNING:"running",SUCCESS:"success",ERROR:"error"}),jt=Object.freeze({INCREMENTAL:"incremental",FULL:"full"}),Ml=`\u8BF7\u6839\u636E\u5F53\u524D\u5BF9\u8BDD\u4E0E\u5F53\u524D\u8868\u683C\u57FA\u5E95\uFF0C\u66F4\u65B0\u7ED3\u6784\u5316 tables \u6570\u636E\u3002
...
- JSON \u7ED3\u6784\u5FC5\u987B\u662F\uFF1A
{
      ...
      ${o.map((n,i)=>{let l=String(n?.key||"").trim();return`
        <td>
          <textarea class="yyt-textarea yyt-code-textarea-small"
                    ...
                    data-column-key="${b(l)}"
                    rows="2"
                    placeholder="${b(n.title||n.key||`\u5217${i+1}`)}">${b(Zy(e,n,i))}</textarea>
        </td>
      `}).join("")}
      <td>
  ...
  `}function Ul(t={},e=0,s={}){let r=Array.isArray(t.columns)?t.columns:[],o=Array.isArray(t.rows)?t.rows:[],a=String(t?.name||"").trim(),n=s.showDeleteTable!==!1,i=an("table",{"table-index":e},{currentIndex:e,size:Number.isInteger(s.totalTables)?s.totalTables:0}),l=n?`
                ...
                <tr class="yyt-table-editor-column" data-table-editor-column="${d}">
                  ...
                  <td>
                    <div class="yyt-table-editor-column-actions">
                      ${an("column",{"table-index":e,"column-index":d},{currentIndex:d,size:r.length})}
      ...
      <div class="yyt-table-editor-section">
        ...
        <div class="yyt-table-editor-grid-wrap">
          <table class="yyt-table-editor-grid">
            ...
            <tbody>
              ${o.length?o.map((c,d)=>ep(t,c,e,d)).join(""):`
                <tr>
  ...
  `}function tp(t={},e={}){let s=jl(t),r=Array.isArray(s?.tables)?s.tables:[],o=e.mode==="focused"?"focused":"full",a=Jy(r.length,Number.parseInt(e.currentTableIndex,10));if(o==="focused"){let n=r[a]||null;return`
  ...
  `}function sp(t={},e={}){let s=String(t.name||"").trim(),r=b(t.label||s),o=t.description?`<div class="yyt-table-form-field-desc">${b(t.description)}</div>`:"",a=jl({tables:Array.isArray(e[s])?e[s]:[]});return`
    <div class="yyt-table-form-field" data-table-form-item="${b(s)}">
      <label>${r}</label>
      ${rp(t,a,{description:o})}
    </div>
  `}function rp(t={},e={},s={}){let r=String(t.name||"").trim(),o=typeof s.description=="string"?s.description:t.description?`<div class="yyt-table-form-field-desc">${b(t.description)}</div>`:"",a=s.mode==="focused"?"focused":"full",n=Number.parseInt(s.currentTableIndex,10);return`
    <div class="yyt-table-editor" data-table-field="${b(r)}" data-field-type="tableDefinitions" data-table-definition-root data-table-editor-mode="${a}" data-current-table-index="${Number.isInteger(n)?n:0}">
      ${tp(e,{mode:a,currentTableIndex:n})}
    </div>
    ${o}
  `}function zl(t=[],e={},s={}){let r=Array.isArray(t)?t:[],o=Array.isArray(s.includeFieldNames)?new Set(s.includeFieldNames.map(i=>String(i||"").trim()).filter(Boolean)):null,a=Array.isArray(s.excludeFieldNames)?new Set(s.excludeFieldNames.map(i=>String(i||"").trim()).filter(Boolean)):null,n=r.filter(i=>{let l=String(i?.name||"").trim();return!l||o&&!o.has(l)||a&&a.has(l)?!1:i.type!=="tableDefinitions"}).map(i=>op(i,e)).join("");return n?`
    <div class="yyt-table-form-grid">
      ${n}
    </div>
  `:""}function op(t={},e={}){let s=String(t.name||"").trim();if(!s)return"";if(t.type==="tableDefinitions")return sp(t,e);let r=e[s],o=b(t.label||s),a=t.description?`<div class="yyt-table-form-field-desc">${b(t.description)}</div>`:"",n=Number.isFinite(t.rows)?t.rows:6;return t.type==="checkbox"?`
      <div class="yyt-table-form-field" data-table-form-item="${b(s)}">
...
\u53EA\u8FD4\u56DE <tableEdit> \u6807\u7B7E\uFF0C\u4E0D\u8981\u9644\u52A0\u5176\u4ED6\u5185\u5BB9\u3002`});function we(t,e=""){return typeof t=="string"&&t.trim()?t.trim():e}function et(t,e){let s=Array.isArray(t)?t.length:0;return s<=0||!Number.isInteger(e)||e<0?0:Math.min(e,s-1)}function Op(t){try{return JSON.stringify(t,null,2)}catch{return String(t??"")}}function Dp(){return Bl({apiPresets:bt()})}function Lr(t,e){return we(t?.aiInstructions?.[e],"")}function Lp(t={}){return{init:Lr(t,"init"),create:Lr(t,"create"),update:Lr(t,"update"),delete:Lr(t,"delete")}}function Np(t){let e=we(t,"idle");return e==="running"?"\u8FD0\u884C\u4E2D":e==="success"?"\u6700\u8FD1\u6210\u529F":e==="error"?"\u6700\u8FD1\u5931\u8D25":"\u672A\u8FD0\u884C"}function Bp(t){return t?new Date(t).toLocaleString():"\u2014"}function Up(t){return Number.isFinite(t)&&t>0?`${(t/1e3).toFixed(t>=1e3?1:2)}s`:"\u2014"}function jp(t,e){return we(t?.id||t?.key,`table_${e}`)}function bc(t){return{columns:Array.isArray(t?.columns)?t.columns.length:0,rows:Array.isArray(t?.rows)?t.rows.length:0}}function Ue(t,e){let s=D(),r=e&&typeof e=="object"?e:zt();if(!s||!j(t))return r;let o={...r,runtime:r.runtime||{}},a=Array.isArray(o.tables)?[...o.tables]:[],n=et(a,o.__activeTableIndex??0);if(a[n]){let A=a[n]||{},S={...A,aiInstructions:Lp(A)},z=t.find("[data-twb-name]");z.length&&(S.name=String(z.val()||"").trim());let $=t.find("[data-twb-note]");$.length&&(S.note=String($.val()||"").trim()),t.find("[data-twb-table-instruction]").each(function(){let I=String(s(this).attr("data-twb-table-instruction")||"").trim();I&&(S.aiInstructions[I]=String(s(this).val()||"").trim())}),t.find("[data-twb-col]").length&&(S.columns=[],t.find("[data-twb-col]").each(function(){let I=s(this);S.columns.push({key:we(I.find("[data-twb-col-key]").val(),""),title:we(I.find("[data-twb-col-title]").val(),""),type:we(I.find("[data-twb-col-type]").val(),"text"),required:I.find("[data-twb-col-req]").is(":checked"),description:we(I.find("[data-twb-col-desc]").val(),"")})})),t.find("[data-twb-row]").length&&(S.rows=[],t.find("[data-twb-row]").each(function(){let I=s(this),R={};(S.columns||[]).forEach(J=>{R[J.key]=we(I.find(`[data-twb-cell="${J.key}"]`).val(),"")}),S.rows.push({name:we(I.find("[data-twb-row-name]").val(),""),cells:R})})),a[n]=S}let i=t.find('[data-twb-field="promptTemplate"]');i.length&&(o.promptTemplate=String(i.val()||""));let l=t.find('[data-twb-field="apiPreset"]');l.length&&(o.apiPreset=String(l.val()||""));let c=t.find('[data-twb-field="fillMode"]');c.length&&(o.fillMode=String(c.val()||""));let d=t.find('[data-twb-field="mirrorToMessage"]');d.length&&(o.mirrorToMessage=d.is(":checked"));let u=t.find('[data-twb-field="autoUpdateEnabled"]');u.length&&(o.autoUpdateEnabled=u.is(":checked"));let y=t.find('[data-twb-field="autoUpdateTrigger"]');y.length&&(o.autoUpdateTrigger=String(y.val()||"assistantMessage"));let p=t.find('[data-twb-field="runScope"]:checked');p.length&&(o.runScope=String(p.val()||"enabled"));let g=t.find('[data-twb-field="promptPreset"]');g.length&&(o.promptPreset=String(g.val()||""));let x=t.find('[data-twb-field="bypassEnabled"]'),v=String(o.promptPreset||"");o.bypass={...o.bypass||{},enabled:x.length?x.is(":checked"):o.bypass?.enabled===!0,presetId:v};let _=t.find('[data-twb-field="activeTemplate"]');return _.length&&(o.activeTemplate=String(_.val()||"")),o.tables=a,o}function Wo(t){let e=we(t,"idle");return`<span class="yyt-tool-runtime-badge yyt-status-${b(e)}">${b(Np(e))}</span>`}function zp(t){return`
    ...
    </header>`}function Wp(t){let e=t?.runtime||{};return`
    ...
    </article>`}function Fp(t){let e=bt(),s=Tr()||[],r=t?.bypass?.enabled===!0,o=we(t?.bypass?.presetId||t?.promptPreset,"");return`
    <article class="yyt-panel-section yyt-twb-card">
      <div class="yyt-twb-card-header">
    ...
    </article>`}function Hp(t){let e=rn();return`
    ...
    </article>`}function qp(t){let e=Array.isArray(t.tables)?t.tables:[],s=we(t.runScope,"enabled");return`
    <article class="yyt-panel-section yyt-twb-card yyt-twb-manual-card">
      ...
      <div class="yyt-twb-table-chip-list">
        ${e.length?e.map((r,o)=>`<label class="yyt-twb-table-chip"><input type="checkbox" data-twb-run-table="${b(jp(r,o))}"><span>${b(we(r?.name,`\u8868\u683C ${o+1}`))}</span></label>`).join(""):'<span class="yyt-twb-muted">\u8FD8\u6CA1\u6709\u53EF\u66F4\u65B0\u7684\u8868\u683C\u3002</span>'}
      </div>
    ...
    </article>`}function Gp(t){let e=Array.isArray(t.tables)?t.tables:[],s=et(e,t.__activeTableIndex??0),r=xs({tables:e});return`
    <section class="yyt-twb-table-overview">
      ...
      ${e.length?`
        <div class="yyt-twb-table-card-list">
          ${e.map((o,a)=>{let n=(r.issues||[]).filter(c=>c.tableIndex===a),i=bc(o);return`
    ...
    </section>`}function Xp(t){let e=Array.isArray(t?.columns)?t.columns:[];return`
    <section class="yyt-panel-section yyt-twb-editor-section">
      <div class="yyt-twb-section-header">
              ...
              <article class="yyt-twb-row-card${n?` row-${n}`:""}" data-twb-row data-twb-ri="${a}">
                <header class="yyt-twb-row-card-header">
                  ...
                  <div class="yyt-twb-row-actions">
                    <span class="yyt-tool-runtime-badge yyt-status-${n==="new"?"success":n==="updated"?"running":"idle"}">${Zp(n)}</span>
    ...
    </section>`}function tg(t,e,s){let o=(xs({tables:Array.isArray(s.tables)?s.tables:[]}).issues||[]).filter(a=>a.tableIndex===e);return`
...
`))}</div>`:'<div class="yyt-twb-muted">\u6682\u65E0\u6821\u9A8C\u95EE\u9898\u3002</div>'}
          ...
          <div>
            <h5>JSON \u9884\u89C8</h5>
            <pre class="yyt-twb-pre">${b(Op(t||{}))}</pre>
          </div>
        </div>
      </details>
    </section>`}function sg(t){let e={tables:Array.isArray(t.tables)?t.tables:[]},r=xs(e)?.summary?.errorCount||0;return`
    <section class="yyt-twb-editor-section yyt-twb-diagnostics">
      <details>
    ...
    </section>`}function rg(t,e,s,r){let a=(Array.isArray(t.tables)?t.tables:[])[e]||null;if(!s||!a)return'<aside class="yyt-twb-editor-drawer"></aside>';let n=bc(a);return`
    ...
    </aside>`}var Pp,Ss,cn=B(()=>{Ae();ys();Wl();Fl();Ir();cr();Bs();Or();fc();Pp=`${Ks} ${Kl()}
...
`;Ss={id:"tableWorkbenchPanel",currentTableIndex:0,editorOpen:!1,lastDiff:null,pendingTemplateApplyId:"",render({config:t}={}){let e=t&&typeof t=="object"?t:zt(),s=Array.isArray(e.tables)?e.tables:[];this.currentTableIndex=et(s,e.__activeTableIndex??this.currentTableIndex);let r=this.currentTableIndex;return`
    ...
    `},bindEvents(t){let e=D();if(!e||!j(t))return;let s=this,r=null,o=!1,a=[],n=t.find("[data-yyt-log-list]"),i=t.find("[data-yyt-log-search]"),l=t.find("[data-yyt-log-autoscroll]"),c=t.find("[data-yyt-log-pause]");function d(p){if(!p.length){n.html('<div class="yyt-logger-empty">\u6682\u65E0\u5339\u914D\u7684\u65E5\u5FD7\u8BB0\u5F55</div>');return}n.html(p.map(g=>`
        <div class="yyt-log-entry ${ng(g.level)}" data-log-id="${g.id}">
          <span class="yyt-log-time">${ig(g.timestamp)}</span>
    ...
    `}}});var Tc={};be(Tc,{ApiPresetPanel:()=>Pt,BypassPanel:()=>hs,EscapeTransformToolPanel:()=>ms,LoggerPanel:()=>Ts,MAIN_TAB_RENDERERS:()=>_n,PanelState:()=>Ms,PunctuationTransformToolPanel:()=>bs,RegexExtractPanel:()=>ss,SCRIPT_ID:()=>m,SUB_TAB_RENDERERS:()=>An,SettingsPanel:()=>_t,StatusBlockPanel:()=>gs,SummaryToolPanel:()=>ps,TableWorkbenchPanel:()=>Ss,ToolManagePanel:()=>ns,UIManager:()=>yr,YouyouReviewPanel:()=>fs,bindDialogEvents:()=>Rt,closeActiveCustomSelectDropdown:()=>je,closeCustomSelectDropdown:()=>dr,createDialogHtml:()=>$t,default:()=>lg,destroyEnhancedCustomSelects:()=>xe,downloadJson:()=>ht,enhanceNativeSelects:()=>ke,escapeHtml:()=>b,fillFormWithConfig:()=>Vr,getAllStyles:()=>Sc,getFormApiConfig:()=>ur,getJQuery:()=>D,getTargetDocument:()=>Ct,initUI:()=>vc,isContainerValid:()=>j,normalizeCustomSelectOptions:()=>Gr,openCustomSelectDropdown:()=>ri,readFileContent:()=>vt,registerComponents:()=>Ko,renderApiPanel:()=>yn,renderBypassPanel:()=>xn,renderCustomSelectControl:()=>Yr,renderEscapeTransformToolPanel:()=>hn,renderLoggerPanel:()=>Tn,renderMainTab:()=>xc,renderPunctuationTransformToolPanel:()=>vn,renderRegexPanel:()=>pn,renderSettingsPanel:()=>wn,renderStatusBlockPanel:()=>mn,renderSubTabComponent:()=>wc,renderSummaryToolPanel:()=>fn,renderTableWorkbenchPanel:()=>Sn,renderToolPanel:()=>gn,renderYouyouReviewPanel:()=>bn,repositionActiveCustomSelectDropdown:()=>fa,resetJQueryCache:()=>Ud,showToast:()=>w,showTopNotice:()=>le,toggleCustomSelectDropdown:()=>qr,uiManager:()=>pe});function Ko(){pe.register(Pt.id,Pt),pe.register(ss.id,ss),pe.register(ns.id,ns),pe.register(ps.id,ps),pe.register(gs.id,gs),pe.register(fs.id,fs),pe.register(ms.id,ms),pe.register(bs.id,bs),pe.register(hs.id,hs),pe.register(_t.id,_t),pe.register(Ss.id,Ss),pe.register(Ts.id,Ts),hc.log("\u7EC4\u4EF6\u6CE8\u518C\u5B8C\u6210")}function vc(t={}){let{autoInjectStyles:e=!0,targetDocument:s,...r}=t;pe.init(r),Ko(),e&&pe.injectStyles(s),hc.log("\u6A21\u5757\u521D\u59CB\u5316\u5B8C\u6210")}function un(){pe.getComponent(Pt.id)||Ko()}function tt(t,e,s={}){un(),pe.render(t,e,s)}function yn(t){tt(Pt.id,t)}function pn(t){tt(ss.id,t)}function gn(t){tt(ns.id,t)}function fn(t){tt(ps.id,t)}function mn(t){tt(gs.id,t)}function bn(t){tt(fs.id,t)}function hn(t){tt(ms.id,t)}function vn(t){tt(bs.id,t)}function xn(t){tt(hs.id,t)}function wn(t){tt(_t.id,t)}function Sn(t){tt(Ss.id,t)}function Tn(t){tt(Ts.id,t)}function xc(t,e){let s=_n[t];if(!s)return!1;un();try{s.render(e)}catch{e.html(`<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>${s.failMessage}</span></div>`)}return!0}function wc(t,e){let s=An[t];if(!s)return null;un();try{s.render(e)}catch{e.html(`<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>${s.failMessage}</span></div>`)}return t}function Sc(){return pe.getAllStyles()}var hc,_n,An,lg,_c=B(()=>{ae();ma();ba();_a();Ra();Ha();qa();Ga();Va();Ja();Xa();Po();cn();dn();Ae();ma();ba();_a();Ra();Ha();qa();Ga();Va();Ja();Xa();Po();cn();dn();hc=N.createScope("UI");_n=Object.freeze({apiPresets:{render:t=>yn(t),failMessage:"API \u9884\u8BBE\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},toolManage:{render:t=>gn(t),failMessage:"\u5DE5\u5177\u7BA1\u7406\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},regexExtract:{render:t=>pn(t),failMessage:"\u6B63\u5219\u63D0\u53D6\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},tableWorkbench:{render:t=>Sn(t),failMessage:"\u586B\u8868\u5DE5\u4F5C\u53F0\u52A0\u8F7D\u5931\u8D25"},bypass:{render:t=>xn(t),failMessage:"Ai\u6307\u4EE4\u9884\u8BBE\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},settings:{render:t=>wn(t),failMessage:"\u8BBE\u7F6E\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},logger:{render:t=>Tn(t),failMessage:"\u65E5\u5FD7\u9762\u677F\u52A0\u8F7D\u5931\u8D25"}}),An=Object.freeze({SummaryToolPanel:{render:t=>fn(t),failMessage:"\u6458\u8981\u5DE5\u5177\u52A0\u8F7D\u5931\u8D25"},StatusBlockPanel:{render:t=>mn(t),failMessage:"\u4E3B\u89D2\u72B6\u6001\u680F\u52A0\u8F7D\u5931\u8D25"},YouyouReviewPanel:{render:t=>bn(t),failMessage:"\u5C0F\u5E7D\u70B9\u8BC4\u52A0\u8F7D\u5931\u8D25"},EscapeTransformToolPanel:{render:t=>hn(t),failMessage:"\u8F6C\u4E49\u5904\u7406\u5DE5\u5177\u52A0\u8F7D\u5931\u8D25"},PunctuationTransformToolPanel:{render:t=>vn(t),failMessage:"\u4E2D\u6587\u6807\u70B9\u66FF\u6362\u5DE5\u5177\u52A0\u8F7D\u5931\u8D25"}});lg={uiManager:pe,ApiPresetPanel:Pt,RegexExtractPanel:ss,ToolManagePanel:ns,SummaryToolPanel:ps,StatusBlockPanel:gs,YouyouReviewPanel:fs,EscapeTransformToolPanel:ms,PunctuationTransformToolPanel:bs,BypassPanel:hs,SettingsPanel:_t,TableWorkbenchPanel:Ss,LoggerPanel:Ts,registerComponents:Ko,initUI:vc,renderApiPanel:yn,renderRegexPanel:pn,renderToolPanel:gn,renderSummaryToolPanel:fn,renderStatusBlockPanel:mn,renderYouyouReviewPanel:bn,renderEscapeTransformToolPanel:hn,renderPunctuationTransformToolPanel:vn,renderBypassPanel:xn,renderSettingsPanel:wn,renderTableWorkbenchPanel:Sn,renderLoggerPanel:Tn,MAIN_TAB_RENDERERS:_n,SUB_TAB_RENDERERS:An,renderMainTab:xc,renderSubTabComponent:wc,getAllStyles:Sc}});var Ec={};be(Ec,{WindowManager:()=>Fo,closeWindow:()=>pg,createWindow:()=>yg,windowManager:()=>Fe});function ug(){if(Fe.stylesInjected)return;Fe.stylesInjected=!0;let t=`
    /* ============================================================
  ...
  `,e=document.createElement("style");e.id=dg+"_styles",e.textContent=t,(document.head||document.documentElement).appendChild(e)}function yg(t){let{id:e,title:s="\u7A97\u53E3",content:r="",width:o=900,height:a=700,modal:n=!1,resizable:i=!0,maximizable:l=!0,startMaximized:c=!1,rememberState:d=!0,onClose:u,onReady:y}=t;ug();let p=window.jQuery||window.parent?.jQuery;if(!p)return cg.error("jQuery not available"),null;if(Fe.isOpen(e))return Fe.bringToFront(e),Fe.getWindow(e);let g=window.innerWidth||1200,x=window.innerHeight||800,v=g<=1100,_=null,A=!1;d&&(_=Fe.getState(e),_&&!v&&(A=!0));let S,z;A&&_.width&&_.height?(S=Math.max(400,Math.min(_.width,g-40)),z=Math.max(300,Math.min(_.height,x-40))):(S=Math.max(400,Math.min(o,g-40)),z=Math.max(300,Math.min(a,x-40)));let $=Math.max(20,Math.min((g-S)/2,g-S-20)),I=Math.max(20,Math.min((x-z)/2,x-z-20)),R=l&&!v,J=`
...
\u6216 regex:<custom_tag>([\\s\\S]*?)</custom_tag>`,previewDialogId:`${f.id}-extraction-preview`,previewTitle:`${f.name||f.id} \u63D0\u53D6\u9884\u89C8`}),o.dynamicToolPanelCache.set(f.id,E)}let O=E();O.renderTo(h),Re(h,{key:f.id,destroy:typeof O?.destroy=="function"?L=>O.destroy(L):null}),Te()}catch(E){p.current=null,_("\u81EA\u5B9A\u4E49\u5DE5\u5177\u9762\u677F\u52A0\u8F7D\u5931\u8D25:",E),h.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u81EA\u5B9A\u4E49\u5DE5\u5177\u9762\u677F\u52A0\u8F7D\u5931\u8D25</span></div>')}}}function Gt(f,h){if(!S())return;let E=r.toolRegistryModule?.getToolConfig(f);if(!E){h.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u5DE5\u5177\u914D\u7F6E\u4E0D\u5B58\u5728</span></div>');return}let O=a.currentSubTab[f]||E.subTabs?.[0]?.id||"config";h.html(`
    ...
    `),qt(f,O)}function Kc(f,h){if(!S())return;let E=r.toolManagerModule?.getTool(f),O=r.presetManagerModule?.getAllPresets()||[],L=r.toolRegistryModule?.getToolApiPreset(f)||"",K=O.map(q=>`<option value="${A(q.name)}" ${q.name===L?"selected":""}>${A(q.name)}</option>`).join("");h.html(`
      <div class="yyt-panel">
        <div class="yyt-panel-section">
          <div class="yyt-section-title">
    ...
    `),ke(h,{namespace:"yytPopupToolConfigSelect",selectors:["#yyt-tool-api-preset"]}),h.find("#yyt-save-tool-preset").on("click",function(){let F=h.find("#yyt-tool-api-preset").val();r.toolRegistryModule?.setToolApiPreset(f,F);let X=s.toastr;X&&X.success("API\u9884\u8BBE\u7ED1\u5B9A\u5DF2\u4FDD\u5B58","YouYou \u5DE5\u5177\u7BB1")})}async function Fc(f,h){if(!S()){h.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u63D0\u793A\u8BCD\u7F16\u8F91\u5668\u6A21\u5757\u672A\u52A0\u8F7D</span></div>');return}let O=r.toolManagerModule?.getTool(f)?.config?.messages||[],L=Uc(O)||Nr,K=new Yo({containerId:`yyt-prompt-editor-${f}`,segments:L,onChange:F=>{let X=Bc(F);v("\u63D0\u793A\u8BCD\u5DF2\u66F4\u65B0:",X.length,"\u6761\u6D88\u606F")}});h.html(`<div id="yyt-prompt-editor-${f}" class="yyt-prompt-editor-container"></div>`),K.init(h.find(`#yyt-prompt-editor-${f}`));let q=Nc();if(q){let F="yyt-prompt-editor-styles",X=s.document||document;if(!X.getElementById(F)){let he=X.createElement("style");he.id=F,he.textContent=q,(X.head||X.documentElement).appendChild(he)}}}function Hc(f,h){S()&&h.html(`
      <div class="yyt-panel">
        <div class="yyt-panel-section">
          <div class="yyt-section-title">
            <i class="fa-solid fa-bookmark"></i>
    ...
    `)}function qc(){return`
      ...
      </div>`}function Gc(f,h,T){let E=g(),O=f.map(L=>`
      <div class="yyt-main-nav-item ${L.id===a.currentMainTab?"active":""}" data-tab="${L.id}">
        <div class="yyt-main-nav-icon">
          <i class="fa-solid ${A(L.icon||"fa-file")}"></i>
        </div>
    ...
    `).join("");return`
      ...
      </div>`}function Vc(f,h){return f.map(T=>`
      <div class="yyt-tab-content ${T.id===h?"active":""}" data-tab="${T.id}">
      </div>
    `).join("")}function Jc(f){return`
