var YouYouToolkit=(()=>{var Mi=Object.defineProperty;var Eh=Object.getOwnPropertyDescriptor;var Ah=Object.getOwnPropertyNames;var Ch=Object.prototype.hasOwnProperty;var D=(t,e)=>()=>(t&&(e=t(t=0)),e);var ae=(t,e)=>{for(var r in e)Mi(t,r,{get:e[r],enumerable:!0})},kh=(t,e,r,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Ah(e))!Ch.call(t,n)&&n!==r&&Mi(t,n,{get:()=>e[n],enumerable:!(s=Eh(e,n))||s.enumerable});return t};var Ih=t=>kh(Mi({},"__esModule",{value:!0}),t);var U,Pi,W,Ze=D(()=>{U={STORAGE_CHANGED:"storage:changed",STORAGE_CLEARED:"storage:cleared",PRESET_CREATED:"preset:created",PRESET_UPDATED:"preset:updated",PRESET_DELETED:"preset:deleted",PRESET_ACTIVATED:"preset:activated",PRESET_IMPORTED:"preset:imported",PRESET_EXPORTED:"preset:exported",API_CONFIG_UPDATED:"api:configUpdated",API_REQUEST_START:"api:requestStart",API_REQUEST_SUCCESS:"api:requestSuccess",API_REQUEST_ERROR:"api:requestError",API_CONNECTION_TESTED:"api:connectionTested",TOOL_REGISTERED:"tool:registered",TOOL_UNREGISTERED:"tool:unregistered",TOOL_UPDATED:"tool:updated",TOOL_RUNTIME_UPDATED:"tool:runtimeUpdated",TOOL_ENABLED:"tool:enabled",TOOL_DISABLED:"tool:disabled",TOOL_EXECUTING:"tool:executing",TOOL_EXECUTED:"tool:executed",TOOL_ERROR:"tool:error",TOOL_EXECUTION_STARTED:"tool:executionStarted",TOOL_EXECUTION_FAILED:"tool:executionFailed",REGEX_RULE_ADDED:"regex:ruleAdded",REGEX_RULE_UPDATED:"regex:ruleUpdated",REGEX_RULE_DELETED:"regex:ruleDeleted",REGEX_RULES_CLEARED:"regex:rulesCleared",REGEX_PRESET_LOADED:"regex:presetLoaded",REGEX_EXTRACTED:"regex:extracted",UI_INITIALIZED:"ui:initialized",UI_RENDER_REQUESTED:"ui:renderRequested",UI_TAB_CHANGED:"ui:tabChanged",UI_SUBTAB_CHANGED:"ui:subTabChanged",UI_POPUP_OPENED:"ui:popupOpened",UI_POPUP_CLOSED:"ui:popupClosed",UI_WINDOW_CREATED:"ui:windowCreated",UI_WINDOW_CLOSED:"ui:windowClosed",APP_INITIALIZING:"app:initializing",APP_INITIALIZED:"app:initialized",APP_ERROR:"app:error",SETTINGS_UPDATED:"settings:updated",TOOL_CONTEXT_INJECTED:"tool:contextInjected",TOOL_CONTEXT_CLEARED:"tool:contextCleared",BYPASS_PRESET_CREATED:"bypass:presetCreated",BYPASS_PRESET_UPDATED:"bypass:presetUpdated",BYPASS_PRESET_DELETED:"bypass:presetDeleted",BYPASS_PRESET_ACTIVATED:"bypass:presetActivated",TOOL_OUTPUT_MODE_CHANGED:"tool:outputModeChanged"},Pi=class{constructor(){this.listeners=new Map,this.onceCallbacks=new Map,this.history=[],this.maxHistorySize=100,this.debugMode=!1}on(e,r,s={}){if(!e||typeof r!="function")return console.warn("[EventBus] \u65E0\u6548\u7684\u4E8B\u4EF6\u6216\u56DE\u8C03"),()=>{};let{priority:n=0}=s;this.listeners.has(e)||this.listeners.set(e,new Set);let o={callback:r,priority:n};return this.listeners.get(e).add(o),this.debugMode&&console.log(`[EventBus] \u8BA2\u9605: ${e}`),()=>this.off(e,r)}off(e,r){let s=this.listeners.get(e);if(s){for(let n of s)if(n.callback===r){s.delete(n);break}this.debugMode&&console.log(`[EventBus] \u53D6\u6D88\u8BA2\u9605: ${e}`)}}emit(e,r){this.debugMode&&console.log(`[EventBus] \u53D1\u5E03: ${e}`,r),this._addToHistory(e,r);let s=this.listeners.get(e);if(!s||s.size===0)return;let n=Array.from(s).sort((o,a)=>a.priority-o.priority);for(let{callback:o}of n)try{o(r)}catch(a){console.error(`[EventBus] \u4E8B\u4EF6\u5904\u7406\u9519\u8BEF (${e}):`,a)}}once(e,r){let s=n=>{this.off(e,s),r(n)};return this.on(e,s)}wait(e,r=0){return new Promise((s,n)=>{let o=null,a=this.once(e,i=>{o&&clearTimeout(o),s(i)});r>0&&(o=setTimeout(()=>{a(),n(new Error(`\u7B49\u5F85\u4E8B\u4EF6\u8D85\u65F6: ${e}`))},r))})}hasListeners(e){let r=this.listeners.get(e);return r&&r.size>0}listenerCount(e){let r=this.listeners.get(e);return r?r.size:0}removeAllListeners(e){e?this.listeners.delete(e):this.listeners.clear()}setDebugMode(e){this.debugMode=e}_addToHistory(e,r){this.history.push({event:e,data:r,timestamp:Date.now()}),this.history.length>this.maxHistorySize&&this.history.shift()}getHistory(e){return e?this.history.filter(r=>r.event===e):[...this.history]}clearHistory(){this.history=[]}},W=new Pi});var Bd={};ae(Bd,{LOG_LEVEL:()=>fe,LoggerService:()=>Ho,default:()=>Rh,logger:()=>E});var fe,$d,Ho,E,Rh,H=D(()=>{Ze();fe=Object.freeze({DEBUG:0,INFO:1,WARN:2,ERROR:3}),$d=Object.freeze({[fe.DEBUG]:"DEBUG",[fe.INFO]:"INFO",[fe.WARN]:"WARN",[fe.ERROR]:"ERROR"}),Ho=class{constructor(){this._entries=[],this._maxSize=2e3,this._nextId=1,this._minLevel=fe.INFO,this._eventKey="logger:entry",this._statsEventKey="logger:statsChanged",this._pendingFlush=!1,this._toastHandler=null}_write(e,r,s,n,o){let a={id:this._nextId++,timestamp:Date.now(),level:e,scope:r,message:s,data:n};if(this._entries.push(a),this._entries.length>this._maxSize&&this._entries.shift(),this._forwardToConsole(a),this._toastHandler&&o)try{this._toastHandler(this.levelToToastType(e),s,o)}catch{}this._pendingFlush||(this._pendingFlush=!0,queueMicrotask(()=>{this._pendingFlush=!1,this._emitEntry(a)}))}_forwardToConsole(e){let r=`[${e.scope}]`;switch(e.level){case fe.DEBUG:console.debug(r,e.message,e.data??"");break;case fe.INFO:console.log(r,e.message,e.data??"");break;case fe.WARN:console.warn(r,e.message,e.data??"");break;case fe.ERROR:console.error(r,e.message,e.data??"");break}}_emitEntry(e){try{W?.emit(this._eventKey,e)}catch{}}debug(e,r,s,n){fe.DEBUG<this._minLevel||this._write(fe.DEBUG,e,r,s,n)}info(e,r,s,n){fe.INFO<this._minLevel||this._write(fe.INFO,e,r,s,n)}log(e,r,s,n){this.info(e,r,s,n)}warn(e,r,s,n){fe.WARN<this._minLevel||this._write(fe.WARN,e,r,s,n)}error(e,r,s,n){fe.ERROR<this._minLevel||this._write(fe.ERROR,e,r,s,n)}createScope(e){return{debug:(r,s,n)=>this.debug(e,r,s,n),info:(r,s,n)=>this.info(e,r,s,n),log:(r,s,n)=>this.log(e,r,s,n),warn:(r,s,n)=>this.warn(e,r,s,n),error:(r,s,n)=>this.error(e,r,s,n)}}setToastHandler(e){this._toastHandler=e}levelToToastType(e){switch(e){case fe.WARN:return"warning";case fe.ERROR:return"error";default:return"info"}}getEntries(e={}){let{level:r,scope:s,search:n,limit:o=500,offset:a=0}=e,i=this._entries;if(r!=null&&(i=i.filter(d=>d.level>=r)),s&&(i=i.filter(d=>d.scope===s)),n){let d=n.toLowerCase();i=i.filter(c=>c.scope.toLowerCase().includes(d)||c.message.toLowerCase().includes(d))}let l=i.length;return i=i.slice(a,a+o),{entries:i,total:l}}getStats(){let e={total:this._entries.length,byLevel:{DEBUG:0,INFO:0,WARN:0,ERROR:0},byScope:{}};for(let r of this._entries){let s=$d[r.level]||"UNKNOWN";e.byLevel[s]=(e.byLevel[s]||0)+1,e.byScope[r.scope]=(e.byScope[r.scope]||0)+1}return e}setLevel(e){this._minLevel=e}getLevel(){return this._minLevel}setMaxSize(e){this._maxSize=Math.max(100,Math.min(1e4,e))}clear(){this._entries=[],this._nextId=1}levelLabel(e){return $d[e]||"UNKNOWN"}},E=new Ho,Rh=E});function Bt(){return typeof window.parent<"u"&&window.parent!==window&&window.parent.document?window.parent.document:document}function ie(t){return typeof t!="string"?"":t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function Go(t,e,r=3e3){e||(e=t==="error"?"\u64CD\u4F5C\u5931\u8D25":"\u64CD\u4F5C\u5B8C\u6210");let s=typeof window.parent<"u"&&window.parent!==window?window.parent:window;if(s.toastr){s.toastr[t](e,"YouYou \u5DE5\u5177\u7BB1",{timeOut:r,progressBar:!0});return}Nh(t,e,r),Ph.log(`[${t.toUpperCase()}] ${e}`)}function $i(t,e,r={}){e||(e=t==="error"?"\u64CD\u4F5C\u5931\u8D25":"\u64CD\u4F5C\u5B8C\u6210");let{duration:s=3500,sticky:n=!1,noticeId:o=""}=r,a=Bt();if(!a?.body){Go(t,e,s);return}let i="yyt-top-notice-container",l="yyt-top-notice-styles",d=a.getElementById(i);if(d||(d=a.createElement("div"),d.id=i,d.style.cssText=`
  ...
  `}function zn(t,e,r={}){if(!te())return()=>{};let n=t.find(`#${e}-overlay`),o=()=>{n.remove(),a?.removeEventListener("keydown",i),r.onClose&&r.onClose()};n.find(`#${e}-close, #${e}-cancel`).on("click",o),n.on("click",function(l){l.target===this&&o()}),n.find(`#${e}-save`).on("click",function(){r.onSave&&r.onSave(o)});let a=n[0]?.ownerDocument||document,i=l=>{l.key==="Escape"&&(l.stopPropagation(),o())};return a.addEventListener("keydown",i),o}function br(t,e,r={}){let{confirmText:s="\u786E\u5B9A",cancelText:n="\u53D6\u6D88",danger:o=!1,width:a="380px"}=r,i=te(),l=Bt();if(!i||!l?.body)return Promise.resolve(!1);let d=`yyt-confirm-${++Zd}`;return new Promise(c=>{let u=!1,p=h=>{u||(u=!0,g.remove(),y?.focus(),c(h))},y=l.activeElement,m=`
      ...
      </div>`,g=i(m).appendTo(l.body);g.find(`#${d}-confirm`).on("click",()=>p(!0)),g.find(`#${d}-cancel, #${d}-close`).on("click",()=>p(!1)),g.on("click",function(h){h.target===this&&p(!1)}),g.on("keydown",h=>{h.key==="Escape"&&(h.stopPropagation(),p(!1)),h.key==="Enter"&&(h.stopPropagation(),p(!0))}),g.find(`#${d}-${o?"cancel":"confirm"}`).trigger("focus")})}function Wh(t,e,r={}){let{defaultValue:s="",placeholder:n="",confirmText:o="\u786E\u5B9A",cancelText:a="\u53D6\u6D88",width:i="380px"}=r,l=te(),d=Bt();if(!l||!d?.body)return Promise.resolve(null);let c=`yyt-prompt-${++Zd}`;return new Promise(u=>{let p=!1,y=S=>{p||(p=!0,h.remove(),m?.focus(),u(S))},m=d.activeElement,g=`
...
${iy}`.trim()}function my(t={},e={}){let r=Ft(t);return{id:"tableWorkbench",name:"\u586B\u8868\u5DE5\u4F5C\u53F0",promptTemplate:hw(r,e),bypass:{enabled:r.bypass?.enabled===!0,presetId:r.bypass?.presetId||r.promptPreset||""}}}var Fl,jl,dr=D(()=>{je();He();yn();Ca();ay();cy();uy();Fl=$.namespace("tableWorkbench"),jl="config"});function Yl(){return ql||(ql=E.createScope("TableIsolation")),ql}var hy,by,ql,Vl,de,qr=D(()=>{je();H();He();hy="tableEngine.isolation",by=Object.freeze({enabled:!1,key:Tt});Vl=class{constructor(){this._cache=null,this._subscribers=new Set}getState(){if(this._cache)return this._cache;let e=$.get(hy,null);return this._cache=this._normalize(e),this._cache}isEnabled(){return this.getState().enabled===!0}getKey(){let e=this.getState();return e.enabled?e.key||Tt:Tt}getConfiguredKey(){return this.getState().key}setEnabled(e){let r=this._normalize({...this.getState(),enabled:!!e});this._commit(r,{reason:"enabled"})}setKey(e){let r=this._normalize({...this.getState(),key:e});this._commit(r,{reason:"key"})}updateState(e={}){let r=this.getState(),s=this._normalize({enabled:e.enabled!==void 0?!!e.enabled:r.enabled,key:e.key!==void 0?e.key:r.key});this._commit(s,{reason:"patch"})}reset(){this._commit({...by},{reason:"reset"})}getScopeKey(e){return co(e,this.getKey())}subscribe(e){return typeof e!="function"?()=>{}:(this._subscribers.add(e),()=>this._subscribers.delete(e))}_normalize(e){return!e||typeof e!="object"?{...by}:{enabled:e.enabled===!0,key:Ae(e.key)}}_commit(e,r={}){let s=this.getState();if(s.enabled===e.enabled&&s.key===e.key)return;this._cache=e;try{$.set(hy,e)}catch(o){Yl().error("isolation \u72B6\u6001\u843D\u76D8\u5931\u8D25",o)}Yl().info("isolation \u72B6\u6001\u53D8\u5316",{prev:s,next:e,reason:r.reason||""});let n={...e,prev:s,reason:r.reason||""};for(let o of this._subscribers)try{o(n)}catch(a){Yl().error("isolation \u8BA2\u9605\u8005\u56DE\u8C03\u5F02\u5E38",a)}}},de=new Vl});var xy={};ae(xy,{AuthorityProvider:()=>Ma,default:()=>xw});var fn,Jl,bw,Yr,Ma,xw,wy=D(()=>{H();mn();fn=E.createScope("AuthorityProvider"),Jl="third-party/youyou-toolkit",bw="YouYou Toolkit",Yr="main",Ma=class{constructor({extensionVersion:e="1.0.149"}={}){this.kind=gn.AUTHORITY,this._client=null,this._extensionVersion=e,this._initialized=!1}async init(){let e=Pa();if(!e)return fn.error("\u672A\u68C0\u6D4B\u5230 window.STAuthority.AuthoritySDK"),!1;try{return this._client=await e.init({extensionId:Jl,displayName:bw,version:this._extensionVersion,installType:"local",declaredPermissions:{sql:{private:!0}}}),this._initialized=!0,fn.info("AuthorityProvider \u521D\u59CB\u5316\u6210\u529F",{extensionId:Jl}),!0}catch(r){return fn.error("AuthorityProvider \u521D\u59CB\u5316\u5931\u8D25",{error:r?.message||r}),this._initialized=!1,!1}}async dispose(){this._client=null,this._initialized=!1}async migrate({migrations:e,database:r=Yr,tableName:s}={}){this._ensureReady();let n={database:r,migrations:e};s&&(n.tableName=s);let o=await this._client.sql.migrate(n);return{applied:o?.applied||[],skipped:o?.skipped||[],tableName:o?.tableName,latestId:o?.latestId}}async query({statement:e,params:r=[],database:s=Yr,page:n=void 0}={}){this._ensureReady();let o={database:s,statement:e,params:r};n&&(o.page=n);let a=await this._client.sql.query(o);return{columns:a.columns||[],rows:a.rows||[],rowCount:a.rowCount??(a.rows?.length||0),page:a.page}}async execute({statement:e,params:r=[],database:s=Yr}={}){this._ensureReady();let n=await this._client.sql.exec({database:s,statement:e,params:r});return{rowsAffected:n.rowsAffected??0,lastInsertRowid:n.lastInsertRowid??null}}async batch({statements:e,database:r=Yr}={}){this._ensureReady();let s=(e||[]).map(o=>({mode:o.mode||(/^\s*SELECT/i.test(o.statement)?"query":"exec"),statement:o.statement,params:o.params||[]}));return{results:(await this._client.sql.batch({database:r,statements:s}))?.results||[]}}async transaction({statements:e,database:r=Yr}={}){this._ensureReady();let s=(e||[]).map(o=>({mode:o.mode||(/^\s*SELECT/i.test(o.statement)?"query":"exec"),statement:o.statement,params:o.params||[]})),n=await this._client.sql.transaction({database:r,statements:s});return{committed:!!n?.committed,results:n?.results||[]}}async paginate({statement:e,params:r=[],database:s=Yr,page:n={}}={}){return this._ensureReady(),this.query({statement:e,params:r,database:s,page:n})}async pageAll({statement:e,params:r=[],database:s=Yr,pageSize:n=200,maxPages:o}={}){this._ensureReady();let a=await this._client.sql.pageAll({database:s,statement:e,params:r},{pageSize:n,maxPages:o});return{columns:a.columns||[],rows:a.rows||[],rowCount:a.rowCount??(a.rows?.length||0)}}async backup(){return fn.warn("backup() \u6682\u672A\u5B9E\u73B0\uFF0CAuthorityProvider \u8D70 Authority \u5185\u7F6E\u5907\u4EFD"),{kind:"authority",timestamp:Date.now()}}async export(){return fn.warn("export() \u6682\u672A\u5B9E\u73B0\uFF0CAuthorityProvider \u8D70 Authority \u5185\u7F6E\u5BFC\u51FA"),{kind:"authority",timestamp:Date.now()}}async import(){fn.warn("import() \u6682\u672A\u5B9E\u73B0\uFF0CAuthorityProvider \u8D70 Authority \u5185\u7F6E\u5BFC\u5165")}describe(){return{kind:this.kind,initialized:this._initialized,extensionId:Jl,database:Yr,hasClient:!!this._client}}_ensureReady(){if(!this._initialized||!this._client)throw new Error("AuthorityProvider \u5C1A\u672A\u521D\u59CB\u5316")}},xw=Ma});var Sy={};ae(Sy,{FallbackProvider:()=>Na,default:()=>Cw});function ww(t){let e=[],r=0,s="";for(let n of t)n==="("?r+=1:n===")"&&(r-=1),n===","&&r===0?(s.trim()&&e.push(s),s=""):s+=n;return s.trim()&&e.push(s),e}function vw(t){let e=t.match(/^\s*CREATE\s+TABLE\s+(?:IF\s+NOT\s+EXISTS\s+)?(\w+)\s*\(([\s\S]+)\)\s*$/i);if(!e)return null;let r=e[1],s=e[2],n=ww(s),o=[],a=[];for(let i of n){let l=i.trim(),d=l.match(/^PRIMARY\s+KEY\s*\(([^)]+)\)$/i);if(d){a=d[1].split(",").map(u=>u.trim());continue}let c=l.match(/^(\w+)\s+(\w+)/);c&&(o.push({name:c[1],type:c[2].toUpperCase(),raw:l}),/PRIMARY\s+KEY/i.test(l)&&!a.length&&(a=[c[1]]))}return{name:r,columns:o,pkCols:a}}function Sw(t){let e=t.match(/^\s*INSERT\s+(?:OR\s+REPLACE\s+)?INTO\s+(\w+)(?:\s*\(([^)]+)\))?\s+VALUES\s*\(([^)]+)\)\s*$/i);if(!e)return null;let r=e[1],s=e[2]?e[2].split(",").map(o=>o.trim()):null,n=(e[3].match(/\?/g)||[]).length;return{name:r,cols:s,paramCount:n}}function Zl(t){let e=t.split(/\s+AND\s+/i),r=[];for(let s of e){let n=s.match(/^\s*(\w+)\s*(=|!=|<>|>=|<=|>|<)\s*\?\s*$/);if(n){let a=n[2]==="<>"?"!=":n[2];r.push({col:n[1],op:a,placeholder:!0});continue}let o=s.match(/^\s*(\w+)\s+IS\s+(NOT\s+)?NULL\s*$/i);if(o){r.push({col:o[1],op:o[2]?"IS NOT NULL":"IS NULL",placeholder:!1});continue}throw new Error(`FallbackProvider \u4E0D\u652F\u6301\u7684 WHERE \u5B50\u53E5: "${s}"`)}return r}function Tw(t){let e=t.match(/^\s*SELECT\s+([\s\S]+?)\s+FROM\s+(\w+)([\s\S]*)$/i);if(!e)return null;let r=e[1].trim(),s=e[2],n=e[3],o=n.match(/\bWHERE\s+([\s\S]+?)(?=\bORDER\s+BY\b|\bLIMIT\b|\bOFFSET\b|$)/i),a=n.match(/\bORDER\s+BY\s+(\w+)\s*(ASC|DESC)?/i),i=n.match(/\bLIMIT\s+(\d+)/i),l=n.match(/\bOFFSET\s+(\d+)/i);return{name:s,cols:r==="*"?null:r.split(",").map(d=>d.trim()),where:o?Zl(o[1].trim()):null,orderBy:a?{col:a[1],dir:(a[2]||"ASC").toUpperCase()}:null,limit:i?parseInt(i[1],10):null,offset:l?parseInt(l[1],10):null}}function _w(t){let e=t.match(/^\s*UPDATE\s+(\w+)\s+SET\s+([\s\S]+?)(?:\s+WHERE\s+([\s\S]+))?\s*$/i);if(!e)return null;let r=e[1],s=e[2],n=e[3],o=s.split(",").map(a=>{let i=a.trim().match(/^(\w+)\s*=\s*\?$/);if(!i)throw new Error(`FallbackProvider \u4E0D\u652F\u6301\u7684 SET \u5B50\u53E5: "${a}"`);return i[1]});return{name:r,setCols:o,where:n?Zl(n.trim()):null}}function Ew(t){let e=t.match(/^\s*DELETE\s+FROM\s+(\w+)(?:\s+WHERE\s+([\s\S]+))?\s*$/i);return e?{name:e[1],where:e[2]?Zl(e[2].trim()):null}:null}function Ql(t,e){return t===e?!0:t==null?e==null:e==null?!1:typeof t=="number"||typeof e=="number"?Number(t)===Number(e):String(t)===String(e)}function yo(t,e){return t===e?0:t==null?-1:e==null?1:typeof t=="number"&&typeof e=="number"?t-e:String(t)<String(e)?-1:1}function Aw(t,e,r){let s=t[e.col];if(e.op==="IS NULL")return s==null;if(e.op==="IS NOT NULL")return s!=null;let n=r.shift();switch(e.op){case"=":return Ql(s,n);case"!=":return!Ql(s,n);case">":return yo(s,n)>0;case"<":return yo(s,n)<0;case">=":return yo(s,n)>=0;case"<=":return yo(s,n)<=0;default:return!1}}function Xl(t,e,r){if(!e||!e.length)return!0;let s=Array.isArray(r)?[...r]:[];for(let n of e)if(!Aw(t,n,s))return!1;return!0}var hn,vy,Na,Cw,Ty=D(()=>{H();je();mn();hn=E.createScope("FallbackProvider"),vy="provider_fallback_v1";Na=class{constructor(){this.kind=gn.FALLBACK,this._tables=new Map,this._migrations=new Set,this._initialized=!1,this._dirty=!1,this._saveTimer=null}async init(){try{let e=Te.get(vy)||{};this._migrations=new Set(Array.isArray(e.migrations)?e.migrations:[]),this._tables=new Map;for(let[r,s]of Object.entries(e.tables||{}))this._tables.set(r,{schema:s.schema||{name:r,columns:[],pkCols:[]},rows:Array.isArray(s.rows)?s.rows:[]});return this._initialized=!0,hn.info("FallbackProvider \u521D\u59CB\u5316\u5B8C\u6210",{tables:this._tables.size,migrations:this._migrations.size}),!0}catch(e){return hn.error("FallbackProvider \u521D\u59CB\u5316\u5931\u8D25",{error:e?.message||e}),this._initialized=!1,!1}}async dispose(){this._flushSave(!0),this._tables.clear(),this._migrations.clear(),this._initialized=!1}async migrate({migrations:e}={}){this._ensureReady();let r=[],s=[];for(let n of e||[]){if(!n?.id||!n?.statement)continue;if(this._migrations.has(n.id)){s.push(n.id);continue}let o=n.statement.trim();if(/^CREATE\s+TABLE/i.test(o)){let a=vw(o);if(!a)throw new Error(`\u65E0\u6CD5\u89E3\u6790 CREATE TABLE: ${o}`);this._tables.has(a.name)||this._tables.set(a.name,{schema:a,rows:[]})}else if(!/^CREATE\s+(UNIQUE\s+)?INDEX/i.test(o))if(/^DROP\s+TABLE/i.test(o)){let a=o.match(/^DROP\s+TABLE\s+(?:IF\s+EXISTS\s+)?(\w+)/i);a&&this._tables.delete(a[1])}else/^ALTER\s+TABLE/i.test(o)?hn.warn("FallbackProvider \u4E0D\u652F\u6301 ALTER TABLE\uFF0C\u8DF3\u8FC7",{id:n.id}):hn.warn("FallbackProvider \u8DF3\u8FC7\u672A\u8BC6\u522B DDL",{id:n.id,statement:o});this._migrations.add(n.id),r.push(n.id)}return this._markDirty(),{applied:r,skipped:s}}async query({statement:e,params:r=[]}={}){this._ensureReady();let s=Tw(e);if(!s)throw new Error(`\u65E0\u6CD5\u89E3\u6790 SELECT: ${e}`);let n=this._tables.get(s.name);if(!n)return{columns:s.cols||[],rows:[],rowCount:0};let o=n.rows.filter(l=>Xl(l,s.where,r));if(s.orderBy){let l=s.orderBy.dir==="DESC"?-1:1;o=[...o].sort((d,c)=>yo(d[s.orderBy.col],c[s.orderBy.col])*l)}s.offset&&(o=o.slice(s.offset)),Number.isFinite(s.limit)&&(o=o.slice(0,s.limit));let a,i=o;return s.cols?(i=o.map(l=>{let d={};for(let c of s.cols)d[c]=l[c]===void 0?null:l[c];return d}),a=s.cols):a=n.schema?.columns?.map(l=>l.name)||(i[0]?Object.keys(i[0]):[]),{columns:a,rows:i,rowCount:i.length}}async execute({statement:e,params:r=[]}={}){this._ensureReady();let s=String(e||"").trim(),n=s.split(/\s+/)[0].toUpperCase(),o;if(n==="INSERT")o=this._doInsert(s,r);else if(n==="UPDATE")o=this._doUpdate(s,r);else if(n==="DELETE")o=this._doDelete(s,r);else throw new Error(`FallbackProvider \u4E0D\u652F\u6301\u7684 execute \u8BED\u53E5: ${e}`);return o}_doInsert(e,r){let s=Sw(e);if(!s)throw new Error(`\u65E0\u6CD5\u89E3\u6790 INSERT: ${e}`);let n=this._tables.get(s.name);if(!n)throw new Error(`\u8868\u4E0D\u5B58\u5728: ${s.name}`);let o=s.cols||(n.schema.columns||[]).map(d=>d.name);if(!o.length)throw new Error(`\u8868 ${s.name} \u65E0\u5217\u5B9A\u4E49`);if(r.length!==o.length)throw new Error(`INSERT \u53C2\u6570\u6570\u91CF\u4E0D\u5339\u914D (\u671F\u671B ${o.length}, \u5B9E\u9645 ${r.length})`);let a={};for(let d=0;d<o.length;d+=1)a[o[d]]=r[d];let i=n.schema?.pkCols||[],l=/^INSERT\s+OR\s+REPLACE/i.test(e);if(i.length){let d=n.rows.findIndex(c=>i.every(u=>Ql(c[u],a[u])));if(d>=0){if(l)return n.rows[d]=a,this._markDirty(),{rowsAffected:1,lastInsertRowid:d+1};throw new Error(`PRIMARY KEY \u51B2\u7A81 (${i.join(",")})`)}}return n.rows.push(a),this._markDirty(),{rowsAffected:1,lastInsertRowid:n.rows.length}}_doUpdate(e,r){let s=_w(e);if(!s)throw new Error(`\u65E0\u6CD5\u89E3\u6790 UPDATE: ${e}`);let n=this._tables.get(s.name);if(!n)return{rowsAffected:0,lastInsertRowid:null};let o=s.setCols.length;if(r.length<o)throw new Error(`UPDATE \u53C2\u6570\u4E0D\u8DB3 (SET \u9700\u8981 ${o}, \u5B9E\u9645 ${r.length})`);let a=r.slice(0,o),i=r.slice(o),l=0;for(let d of n.rows)if(Xl(d,s.where,i)){for(let c=0;c<o;c+=1)d[s.setCols[c]]=a[c];l+=1}return l>0&&this._markDirty(),{rowsAffected:l,lastInsertRowid:null}}_doDelete(e,r){let s=Ew(e);if(!s)throw new Error(`\u65E0\u6CD5\u89E3\u6790 DELETE: ${e}`);let n=this._tables.get(s.name);if(!n)return{rowsAffected:0,lastInsertRowid:null};let o=n.rows.length;n.rows=n.rows.filter(i=>!Xl(i,s.where,r));let a=o-n.rows.length;return a>0&&this._markDirty(),{rowsAffected:a,lastInsertRowid:null}}async batch({statements:e}={}){this._ensureReady();let r=[];for(let s of e||[])if(String(s.statement||"").trim().split(/\s+/)[0].toUpperCase()==="SELECT"){let o=await this.query(s);r.push({kind:"query",...o})}else{let o=await this.execute(s);r.push({kind:"exec",...o})}return{results:r}}async transaction({statements:e}={}){this._ensureReady();let r=this._snapshot();try{let{results:s}=await this.batch({statements:e});return this._flushSave(!0),{committed:!0,results:s}}catch(s){throw this._restore(r),hn.warn("FallbackProvider \u4E8B\u52A1\u56DE\u6EDA",{error:s?.message||s}),s}}async paginate({statement:e,params:r=[],page:s={}}={}){this._ensureReady();let n=Number.isFinite(s?.limit)?s.limit:50,o=Number.isFinite(s?.offset)?s.offset:0,a=`${e} LIMIT ${n} OFFSET ${o}`;return this.query({statement:a,params:r})}async backup(){return this._ensureReady(),this._snapshot()}async export(){return this.backup()}async import(e){this._ensureReady(),this._restore(e||{}),this._markDirty(),this._flushSave(!0)}describe(){return{kind:this.kind,initialized:this._initialized,tables:this._tables.size,migrations:this._migrations.size,tableNames:[...this._tables.keys()]}}_snapshot(){let e={};for(let[r,s]of this._tables)e[r]={schema:s.schema,rows:JSON.parse(JSON.stringify(s.rows))};return{migrations:[...this._migrations],tables:e}}_restore(e){this._migrations=new Set(Array.isArray(e?.migrations)?e.migrations:[]),this._tables=new Map;for(let[r,s]of Object.entries(e?.tables||{}))this._tables.set(r,{schema:s.schema||{name:r,columns:[],pkCols:[]},rows:Array.isArray(s.rows)?s.rows:[]})}_markDirty(){this._dirty=!0,this._saveTimer&&clearTimeout(this._saveTimer),this._saveTimer=setTimeout(()=>this._flushSave(!1),300)}_flushSave(e){if(this._saveTimer&&(clearTimeout(this._saveTimer),this._saveTimer=null),!(!this._dirty&&!e))try{Te.set(vy,this._snapshot()),this._dirty=!1}catch(r){hn.error("FallbackProvider \u6301\u4E45\u5316\u5931\u8D25",{error:r?.message||r})}}_ensureReady(){if(!this._initialized)throw new Error("FallbackProvider \u5C1A\u672A\u521D\u59CB\u5316")}},Cw=Na});var _y={};ae(_y,{PROVIDER_KIND:()=>gn,createProvider:()=>kw,detectAuthoritySdk:()=>Pa,disposeToolDataProvider:()=>Iw,getCurrentProvider:()=>bn,getToolDataProvider:()=>go});function Pa(){if(typeof window>"u")return null;try{let t=window.STAuthority?.AuthoritySDK;if(t)return t}catch{}try{if(window.parent&&window.parent!==window){let t=window.parent.STAuthority?.AuthoritySDK;if(t)return t}}catch{}return null}async function tc({preferAuthority:t=!0,extensionVersion:e="1.0.149"}={}){if(t&&Pa()){let{AuthorityProvider:s}=await Promise.resolve().then(()=>(wy(),xy));return new s({extensionVersion:e})}let{FallbackProvider:r}=await Promise.resolve().then(()=>(Ty(),Sy));return new r}async function go(t={}){return Rs||fo||(fo=(async()=>{let e=await tc({preferAuthority:!0,...t}),r=await e.init();if(!r&&e.kind===gn.AUTHORITY){ec.warn("AuthorityProvider \u521D\u59CB\u5316\u5931\u8D25\uFF0C\u964D\u7EA7\u5230 FallbackProvider");try{await e.dispose()}catch{}e=await tc({preferAuthority:!1}),r=await e.init()}return r?ec.info(`Provider \u521D\u59CB\u5316\u5B8C\u6210: kind=${e.kind}`):ec.error(`Provider \u5168\u90E8\u521D\u59CB\u5316\u5931\u8D25 (kind=${e.kind})`),Rs=e,e})(),fo)}function bn(){return Rs}async function kw(t={}){let e=await tc(t);return await e.init(),e}async function Iw(){if(Rs){try{await Rs.dispose()}catch{}Rs=null}fo=null}var ec,gn,Rs,fo,mn=D(()=>{H();ec=E.createScope("ToolDataProvider"),gn=Object.freeze({AUTHORITY:"authority",FALLBACK:"fallback"}),Rs=null,fo=null});var lc={};ae(lc,{clearChatScopeConfig:()=>By,clearLockEntry:()=>Ny,clearScopeLocks:()=>Ly,clearSheetLocks:()=>Dy,clearSlot:()=>Ry,commitSlotTables:()=>$a,default:()=>Mw,deleteRowsBySheet:()=>ky,deleteSheetsBySlot:()=>Oa,ensureTableDataReady:()=>Ye,getChatScopeConfig:()=>Oy,getCurrentTableDataProvider:()=>Ay,getLocksForSheet:()=>My,getRowsBySheet:()=>ic,getSheetsBySlot:()=>oc,loadSlotTables:()=>Iy,setChatScopeConfig:()=>$y,setLockEntry:()=>Py,upsertSheetMeta:()=>nc,upsertSheetRows:()=>ac});function sc(){return rc||(rc=E.createScope("TableDataService")),rc}async function Ye(){return Ey?bn():mo||(mo=(async()=>{try{let t=await go();if(!t)return sc().error("Provider \u4E0D\u53EF\u7528\uFF0C\u8DF3\u8FC7 migration"),null;let e=await t.migrate({migrations:[...Rw]});return Ey=!0,sc().info("\u8868\u683C\u6570\u636E migration \u5B8C\u6210",{kind:t.kind,applied:e?.applied?.length||0,skipped:e?.skipped?.length||0}),t}catch(t){return sc().error("table-data-service migration \u5931\u8D25",t),null}finally{mo=null}})(),mo)}function Ay(){return bn()}function Cy(){return Date.now()}function Da(t){try{return JSON.stringify(t)}catch{return"{}"}}function La(t,e=null){if(typeof t!="string")return e;try{return JSON.parse(t)}catch{return e}}function Vr(t={}){return{chatId:String(t.chatId??"").trim(),messageId:String(t.messageId??"").trim(),swipeId:String(t.swipeId??"0").trim()||"0",isolationKey:Ae(t.isolationKey)}}function Jr(t){return t&&t.chatId&&t.messageId}async function nc(t,e){let r=await Ye();if(!r)return!1;let s=Vr(t);return!Jr(s)||!e?.uid?!1:(await r.execute({statement:`INSERT INTO table_sheets
      ...
      WHERE chat_id = ? AND message_id = ? AND swipe_id = ? AND isolation_key = ?`,params:[r.chatId,r.messageId,r.swipeId,r.isolationKey]}))?.rowsAffected||0}async function ac(t,e,r){let s=await Ye();if(!s)return!1;let n=Vr(t);if(!Jr(n)||!e||!Array.isArray(r))return!1;if(await s.execute({statement:`DELETE FROM table_rows
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,params:[n.chatId,n.messageId,n.swipeId,n.isolationKey,String(e),i,String(a?.id??""),String(a?.name??""),Da(a?.cells||{})]}));return typeof s.transaction=="function"?await s.transaction({statements:o}):await s.batch({statements:o}),!0}async function ic(t,e){let r=await Ye();if(!r)return[];let s=Vr(t);return!Jr(s)||!e?[]:((await r.query({statement:`SELECT * FROM table_rows
      WHERE chat_id = ? AND message_id = ? AND swipe_id = ? AND isolation_key = ? AND sheet_uid = ?
      ORDER BY row_index ASC`,params:[s.chatId,s.messageId,s.swipeId,s.isolationKey,String(e)]}))?.rows||[]).map(o=>({id:o.row_id||"",name:o.row_name||"",cells:La(o.cells_json,{}),rowIndex:o.row_index}))}async function ky(t,e){let r=await Ye();if(!r)return 0;let s=Vr(t);return!Jr(s)||!e?0:(await r.execute({statement:`DELETE FROM table_rows
      WHERE chat_id = ? AND message_id = ? AND swipe_id = ? AND isolation_key = ? AND sheet_uid = ?`,params:[s.chatId,s.messageId,s.swipeId,s.isolationKey,String(e)]}))?.rowsAffected||0}async function Iy(t){let e=await oc(t);if(e.length===0)return[];let r=[];for(let s of e){let n=await ic(t,s.uid);r.push({id:s.uid,uid:s.uid,name:s.name,columns:s.columns,rows:n,meta:s.meta,orderNo:s.orderNo,updatedAt:s.updatedAt})}return r}async function $a(t,e){let r=await Ye();if(!r)return!1;let s=Vr(t);if(!Jr(s)||!Array.isArray(e))return!1;await Oa(s),await r.execute({statement:`DELETE FROM table_rows
      WHERE chat_id = ? AND message_id = ? AND swipe_id = ? AND isolation_key = ?`,params:[s.chatId,s.messageId,s.swipeId,s.isolationKey]});for(let n=0;n<e.length;n++){let o=e[n],a=String(o?.uid||o?.id||`sheet_${n+1}`);await nc(s,{uid:a,name:o?.name||a,columns:o?.columns||[],meta:o?.meta||{},orderNo:Number.isFinite(o?.orderNo)?o.orderNo:n}),await ac(s,a,Array.isArray(o?.rows)?o.rows:[])}return!0}async function Ry(t){let e=await Ye();if(!e)return!1;let r=Vr(t);return Jr(r)?(await Oa(r),await e.execute({statement:`DELETE FROM table_rows
      WHERE chat_id = ? AND message_id = ? AND swipe_id = ? AND isolation_key = ?`,params:[r.chatId,r.messageId,r.swipeId,r.isolationKey]}),!0):!1}async function My(t,e){let r=await Ye();if(!r)return[];let s=String(t?.chatId??"").trim(),n=Ae(t?.isolationKey);return!s||!e?[]:((await r.query({statement:`SELECT lock_type, target FROM table_locks
      WHERE chat_id = ? AND isolation_key = ? AND sheet_uid = ?`,params:[s,n,String(e)]}))?.rows||[]).map(a=>({lockType:a.lock_type,target:a.target||""}))}async function Py(t,e,r,s=""){let n=await Ye();if(!n)return!1;let o=String(t?.chatId??"").trim(),a=Ae(t?.isolationKey);return!o||!e||!r?!1:(await n.execute({statement:"INSERT INTO table_locks (chat_id, isolation_key, sheet_uid, lock_type, target) VALUES (?, ?, ?, ?, ?)",params:[o,a,String(e),String(r),String(s)]}),!0)}async function Ny(t,e,r,s=""){let n=await Ye();if(!n)return!1;let o=String(t?.chatId??"").trim(),a=Ae(t?.isolationKey);return!o||!e||!r?!1:(await n.execute({statement:`DELETE FROM table_locks
      WHERE chat_id = ? AND isolation_key = ? AND sheet_uid = ? AND lock_type = ? AND target = ?`,params:[o,a,String(e),String(r),String(s)]}),!0)}async function Dy(t,e){let r=await Ye();if(!r)return!1;let s=String(t?.chatId??"").trim(),n=Ae(t?.isolationKey);return!s||!e?!1:(await r.execute({statement:`DELETE FROM table_locks
      WHERE chat_id = ? AND isolation_key = ? AND sheet_uid = ?`,params:[s,n,String(e)]}),!0)}async function Ly(t){let e=await Ye();if(!e)return!1;let r=String(t?.chatId??"").trim(),s=Ae(t?.isolationKey);return r?(await e.execute({statement:"DELETE FROM table_locks WHERE chat_id = ? AND isolation_key = ?",params:[r,s]}),!0):!1}async function Oy(t){let e=await Ye();if(!e)return null;let r=String(t??"").trim();if(!r)return null;let n=(await e.query({statement:"SELECT scoped_config_json FROM table_chat_scope WHERE chat_id = ?",params:[r]}))?.rows?.[0];return n?La(n.scoped_config_json,null):null}async function $y(t,e){let r=await Ye();if(!r)return!1;let s=String(t??"").trim();return s?(await r.execute({statement:"INSERT INTO table_chat_scope (chat_id, scoped_config_json, updated_at) VALUES (?, ?, ?)",params:[s,Da(e||{}),Cy()]}),!0):!1}async function By(t){let e=await Ye();if(!e)return!1;let r=String(t??"").trim();return r?(await e.execute({statement:"DELETE FROM table_chat_scope WHERE chat_id = ?",params:[r]}),!0):!1}var rc,Rw,Ey,mo,Mw,Ba=D(()=>{H();mn();He();Rw=Object.freeze([{id:"table_engine_v1__sheets",statement:`
...
`)||"\u65E0")}</div>
      ...
      ${i}
    `})),zn(t,o,{onSave:l=>l()}),t.find(`#${o}-save`).text("\u5173\u95ED"),t.find(`#${o}-cancel`).remove()}function es(t){return t==null?"":String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var gr,Ic,oS,In=D(()=>{tr();tt();tt();lr();Gn();_n();kc();H();Fr();Ys();gr=E.createScope("ToolConfigPanel"),Ic=`
...
`;oS=ts});var $f={};ae($f,{SummaryToolPanel:()=>Of,default:()=>aS});var Of,aS,Bf=D(()=>{In();Of=ts({id:"summaryToolPanel",toolId:"summaryTool",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u8FDB\u884C\u6458\u8981\u89E3\u6790\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 boo_FM
\u6216 regex:<boo_FM>([\\s\\S]*?)</boo_FM>`,previewDialogId:"summary-extraction-preview",defaultInjectionOrder:1e4,lorebookLogTag:"SummaryToolPanel"}),aS=Of});var Kf={};ae(Kf,{StatusBlockPanel:()=>zf,default:()=>iS});var zf,iS,Uf=D(()=>{In();zf=ts({id:"statusBlockPanel",toolId:"statusBlock",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u751F\u6210\u4E3B\u89D2\u72B6\u6001\u680F\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 status_block
\u6216 regex:<status_block>([\\s\\S]*?)</status_block>`,previewDialogId:"status-extraction-preview",defaultInjectionOrder:10001,lorebookLogTag:"StatusBlockPanel"}),iS=zf});var jf={};ae(jf,{YouyouReviewPanel:()=>Ff,default:()=>lS});var Ff,lS,Wf=D(()=>{In();Ff=ts({id:"youyouReviewPanel",toolId:"youyouReview",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u5728\u672B\u5C3E\u751F\u6210\u5C0F\u5E7D\u70B9\u8BC4\u4E0E\u5267\u60C5\u94A9\u5B50\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 youyou
\u6216 regex:<youyou>([\\s\\S]*?)</youyou>`,previewDialogId:"youyou-review-extraction-preview",previewTitle:"\u5C0F\u5E7D\u70B9\u8BC4\u63D0\u53D6\u9884\u89C8"}),lS=Ff});function Hf(t){return t?t.length!==void 0&&typeof t.get=="function"?t.get(0):t:null}function cS(t){if(!Number.isFinite(t)||t<=0)return"\u4ECE\u672A";let e=Date.now()-t;if(e<6e4)return`${Math.floor(e/1e3)} \u79D2\u524D`;if(e<36e5)return`${Math.floor(e/6e4)} \u5206\u949F\u524D`;if(e<864e5)return`${Math.floor(e/36e5)} \u5C0F\u65F6\u524D`;try{return new Date(t).toLocaleString()}catch{return"\u672A\u77E5"}}function rs(t){return t==null?"":String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function oi(t={}){let{id:e,toolId:r,previewDialogId:s,previewTitle:n="\u6D4B\u8BD5\u63D0\u53D6\u7ED3\u679C",processorDirections:o=[],processorOptions:a=[],heroHint:i=""}=t;return{id:e,toolId:r,renderTo(l){let d=Hf(l);if(!d)return;if(d._yytLocalToolPanelCleanup)try{d._yytLocalToolPanelCleanup()}catch{}let c=()=>this.renderTo(l),u=le(r);if(!u){d.innerHTML='<div class="yyt-empty-state-small">\u5DE5\u5177\u914D\u7F6E\u52A0\u8F7D\u5931\u8D25</div>';return}let p=f("div",{className:"yyt-tool-panel",dataset:{toolId:r}}),y=[];p.appendChild(dS(u,r,c,o,i)),p.appendChild(uS(u));let m=pS(u,r,c);y.push(m),p.appendChild(m.el);let g=yS(u,r,c,l,o,a,s,n);y.push(g),p.appendChild(g.el),d.innerHTML="",d.appendChild(p),d._yytLocalToolPanelCleanup=()=>{for(let h of y)try{h.destroy()}catch{}delete d._yytLocalToolPanelCleanup}},destroy(l){let d=Hf(l);if(d?._yytLocalToolPanelCleanup)try{d._yytLocalToolPanelCleanup()}catch{}},getStyles(){return""}}}function dS(t,e,r,s,n){let o=f("div",{className:"yyt-tool-panel-hero"}),a=f("div",{className:"yyt-tool-panel-hero-row1"});a.appendChild(f("div",{className:"yyt-tool-panel-hero-icon",text:"\u2699"})),a.appendChild(f("div",{className:"yyt-tool-panel-hero-name",text:t.name||e}));let i=f("div",{className:"yyt-tool-panel-hero-actions"});i.appendChild(X({label:"\u25B6 \u7ACB\u5373\u6267\u884C\u4E00\u6B21",size:"small",onClick:async()=>{try{await si(e),Rn.info("\u5DF2\u89E6\u53D1\u624B\u52A8\u6267\u884C",null,{toast:"success"})}catch(g){Rn.error(`\u6267\u884C\u5931\u8D25\uFF1A${g?.message||g}`,null,{toast:!0})}}}).el),i.appendChild(X({label:"\u{1F4BE} \u4FDD\u5B58\u914D\u7F6E",size:"small",variant:"primary",onClick:()=>{Rn.info("\u914D\u7F6E\u5DF2\u4FDD\u5B58",null,{toast:"success"}),r()}}).el),a.appendChild(i),o.appendChild(a),t.description&&o.appendChild(f("div",{className:"yyt-tool-panel-hero-desc",text:t.description})),n&&o.appendChild(f("div",{className:"yyt-tool-panel-hero-desc",text:n}));let l=f("div",{className:"yyt-tool-panel-hero-chips"}),d=t.output?.autoTrigger!==!1;l.appendChild(f("span",{className:"yyt-tool-hero-chip mode",text:`\u672C\u5730\u811A\u672C\uFF08${d?"\u81EA\u52A8":"\u624B\u52A8"}\uFF09`}));let c=t.processor?.direction||s[0]?.key||"",u=s.find(g=>g.key===c)?.label||c;u&&l.appendChild(f("span",{className:"yyt-tool-hero-chip preset",text:`\u65B9\u5411: ${u}`}));let p=t.output?.overwrite!==!1;l.appendChild(f("span",{className:"yyt-tool-hero-chip preset",text:`\u5199\u56DE: ${p?"\u8986\u76D6":"\u8FFD\u52A0"}`}));let y=t.extraction?.regexPresetId||"";if(y){let g=Ee.getPreset(y);g&&l.appendChild(f("span",{className:"yyt-tool-hero-chip preset",text:`\u6B63\u5219: ${g.name}`}))}let m=t.runtime?.lastStatus;if(m){let g=m==="success"?"status-success":m==="failed"?"status-failed":"";l.appendChild(f("span",{className:`yyt-tool-hero-chip ${g}`,text:`\u4E0A\u6B21\u6267\u884C \xB7 ${m}`}))}return o.appendChild(l),o}function uS(t){let e=f("div",{className:"yyt-tool-runtime-row"}),r=t.runtime||{},s=(a,i,l="")=>{let d=f("div",{className:"yyt-tool-runtime-stat"});return d.appendChild(f("span",{className:"yyt-tool-runtime-stat-label",text:a})),d.appendChild(f("span",{className:`yyt-tool-runtime-stat-value ${l}`,text:i})),d},n=r.lastStatus==="success"?"\u2713 \u4E0A\u6B21\u6210\u529F":r.lastStatus==="failed"?"\u2717 \u4E0A\u6B21\u5931\u8D25":"\u5F85\u547D",o=r.lastStatus==="success"?"success":r.lastStatus==="failed"?"error":"muted";return e.appendChild(s("\u72B6\u6001",n,o)),e.appendChild(s("\u6700\u8FD1\u8FD0\u884C",cS(r.lastRunAt),"muted")),e.appendChild(s("\u6210\u529F",String(r.successCount||0),"success")),e.appendChild(s("\u5931\u8D25",String(r.errorCount||0),r.errorCount?"error":"muted")),e}function pS(t,e,r){let s=f("div",{style:{display:"flex",flexDirection:"column"}}),n=Ee.listPresets();return s.appendChild(Rc({label:"\u6B63\u5219\u63D0\u53D6\u9884\u8BBE",hint:"\u51B3\u5B9A\u4ECE AI \u56DE\u590D\u4E2D\u5982\u4F55\u62BD\u53D6\u8981\u672C\u5730\u5904\u7406\u7684\u6587\u672C",control:Re({value:t.extraction?.regexPresetId||"",options:[{value:"",label:"\u2014\u2014 \u65E0\uFF08\u4E0D\u8FDB\u884C\u63D0\u53D6\uFF09 \u2014\u2014"},...n.map(o=>({value:o.id,label:o.name}))],onChange:o=>{let a=le(e)||{},i={...a.extraction||{},regexPresetId:o};if(o){let l=Ee.getPreset(o);Rn.info(`\u5DF2\u7ED1\u5B9A\u6B63\u5219\u9884\u8BBE\uFF1A${l?.name||o}`,null,{toast:"success"})}else Rn.info("\u5DF2\u89E3\u7ED1\u6B63\u5219\u9884\u8BBE\uFF0C\u5DE5\u5177\u5C06\u4E0D\u8FDB\u884C\u5185\u5BB9\u63D0\u53D6",null,{toast:"success"});Ie(e,{...a,extraction:i}),r()}})})),s.appendChild(Rc({label:"\u5199\u56DE\u65B9\u5F0F",hint:"\u5904\u7406\u540E\u7684\u7ED3\u679C\u5982\u4F55\u56DE\u5199\u5230 AI \u6D88\u606F",control:Re({value:t.output?.overwrite!==!1?"replace":"append",options:[{value:"replace",label:"\u8986\u76D6\u539F\u5DE5\u5177\u5757"},{value:"append",label:"\u8FFD\u52A0\u5230\u672B\u5C3E"}],onChange:o=>{let a=le(e)||{};Ie(e,{...a,output:{...a.output||{},overwrite:o==="replace",enabled:!0,mode:"local_transform"}}),r()}})})),s.appendChild(Rc({label:"\u81EA\u52A8\u89E6\u53D1",hint:"\u6536\u5230 AI \u56DE\u590D\u540E\u662F\u5426\u81EA\u52A8\u6267\u884C\u6B64\u811A\u672C",control:Re({value:t.output?.autoTrigger!==!1?"auto":"manual",options:[{value:"auto",label:"\u81EA\u52A8\uFF08\u6536\u5230\u56DE\u590D\u5373\u6267\u884C\uFF09"},{value:"manual",label:"\u624B\u52A8\uFF08\u4EC5\u70B9\u51FB\u6309\u94AE\u6267\u884C\uFF09"}],onChange:o=>{let a=le(e)||{};Ie(e,{...a,output:{...a.output||{},autoTrigger:o==="auto",enabled:!0,mode:"local_transform"}}),r()}})})),Yt({heading:"\u7ED1\u5B9A",icon:"\u{1F517}",content:[s]})}function Rc({label:t,hint:e,control:r}){let s=f("div",{className:"yyt-tool-binding-row"}),n=f("div",{className:"yyt-tool-binding-label"});return n.appendChild(f("span",{className:"yyt-tool-binding-label-text",text:t})),e&&n.appendChild(f("span",{className:"yyt-tool-binding-label-hint",text:e})),s.appendChild(n),Object.assign(r.el.style,{padding:"7px 10px",fontSize:"12px"}),s.appendChild(r.el),s.appendChild(f("div",{className:"yyt-tool-binding-meta"})),s}function yS(t,e,r,s,n,o,a,i){let l=f("div",{style:{display:"flex",flexDirection:"column"}});l.appendChild(f("div",{style:{marginBottom:"10px"}},f("div",{text:"\u6267\u884C\u65B9\u5411",style:{fontSize:"12px",fontWeight:"700",color:"var(--yyt-text)"}}),f("div",{text:"\u51B3\u5B9A\u672C\u5730\u811A\u672C\u8FD0\u884C\u54EA\u4E2A\u53D8\u6362\u8DEF\u5F84\u3002",style:{fontSize:"11px",color:"var(--yyt-text-muted)",lineHeight:"1.6"}})));let d=t.processor?.direction||n[0]?.key||"",c=Re({value:d,options:n.map(g=>({value:g.key,label:g.description?`${g.label} \u2014 ${g.description}`:g.label})),style:{padding:"7px 10px",fontSize:"12px"},onChange:g=>{let h=le(e)||{};Ie(e,{...h,processor:{...h.processor||{},direction:g}}),r()}});if(l.appendChild(c.el),l.appendChild(f("hr",{className:"yyt-zone-divider"})),o.length>0){l.appendChild(f("div",{style:{marginBottom:"10px"}},f("div",{text:"\u5904\u7406\u9879",style:{fontSize:"12px",fontWeight:"700",color:"var(--yyt-text)"}}),f("div",{text:"\u52FE\u9009\u8981\u5305\u542B\u5728\u672C\u6B21\u53D8\u6362\u4E2D\u7684\u9879\u76EE\u3002",style:{fontSize:"11px",color:"var(--yyt-text-muted)",lineHeight:"1.6"}})));let g=f("div",{style:{display:"flex",flexDirection:"column"}}),h=t.processor?.options||{};for(let x of o){let T=wt({label:x.label,hint:x.description||"",checked:h[x.key]===!0,onChange:S=>{let A=le(e)||{};Ie(e,{...A,processor:{...A.processor||{},options:{...A.processor?.options||{},[x.key]:S}}})}});g.appendChild(T.el)}l.appendChild(g),l.appendChild(f("hr",{className:"yyt-zone-divider"}))}l.appendChild(f("div",{style:{marginBottom:"10px"}},f("div",{text:"\u63D0\u53D6\u914D\u7F6E",style:{fontSize:"12px",fontWeight:"700",color:"var(--yyt-text)"}}),f("div",{text:'\u4ECE AI \u56DE\u590D\u4E2D\u62BD\u53D6\u8981\u672C\u5730\u5904\u7406\u7684\u6587\u672C\u3002\u5B8C\u6574\u89C4\u5219\u7531"\u6B63\u5219\u63D0\u53D6\u9884\u8BBE"\u51B3\u5B9A\uFF0C\u8FD9\u91CC\u53EA\u914D\u7F6E\u5DE5\u5177\u53C2\u6570\u3002',style:{fontSize:"11px",color:"var(--yyt-text-muted)",lineHeight:"1.6"}})));let u=f("div",{style:{display:"grid",gridTemplateColumns:"1fr auto",gap:"12px",alignItems:"end"}}),p=f("div",{className:"yyt-form-group",style:{margin:0}});p.appendChild(f("label",{text:"\u6700\u5927\u63D0\u53D6 AI \u6D88\u606F\u6570",style:{fontSize:"12px",fontWeight:"600",color:"var(--yyt-text-secondary, rgba(255,255,255,0.55))"}}));let y=f("input",{className:"yyt-input",attrs:{type:"number",min:"1",max:"50"},style:{padding:"7px 10px",fontSize:"12px"}});y.value=String(Number(t.extraction?.maxMessages)||5),y.addEventListener("change",()=>{let g=le(e)||{};Ie(e,{...g,extraction:{...g.extraction||{},maxMessages:Math.max(1,parseInt(y.value,10)||5)}})}),p.appendChild(y),u.appendChild(p);let m=f("div",{className:"yyt-form-group",style:{margin:0}});return m.appendChild(f("label",{html:"&nbsp;",style:{fontSize:"12px"}})),m.appendChild(X({label:"\u{1F50D} \u6D4B\u8BD5\u63D0\u53D6",onClick:async()=>{try{let g=await ni(e);fS(s,g,a,i)}catch(g){Rn.error(`\u6D4B\u8BD5\u63D0\u53D6\u5931\u8D25\uFF1A${g?.message||g}`,null,{toast:!0})}}}).el),u.appendChild(m),l.appendChild(u),Yt({heading:"\u914D\u7F6E",icon:"\u2699",content:[l]})}function fS(t,e,r,s){if(!te()||!we(t))return;let o=`${us}-${r||"extraction-preview"}`,a=Array.isArray(e?.messageEntries)?e.messageEntries:[],i=a.length>0?`
      <div class="yyt-form-group">
        <label>\u9010\u6761\u6D88\u606F\u9884\u89C8</label>
        <div class="yyt-preview-message-list">
          ${a.map((l,d)=>{let c=d===a.length-1?"\u6700\u65B0\u6D88\u606F":`\u6700\u8FD1\u7684\u7B2C ${a.length-d} \u6761\u6D88\u606F`;return`
...
regex:<content>([\\s\\S]*?)</content>`,processorDirections:[{key:"en_to_zh",label:"\u82F1\u6587\u8F6C\u4E2D\u6587",description:"\u6309\u52FE\u9009\u9879\u628A\u82F1\u6587\u6807\u70B9\u66FF\u6362\u4E3A\u4E2D\u6587\u6807\u70B9\u3002"}],processorOptions:[{key:"comma",label:"\u9017\u53F7 ,",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u9017\u53F7\u3002"},{key:"period",label:"\u53E5\u53F7 .",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u53E5\u53F7\u3002"},{key:"exclamation",label:"\u611F\u53F9\u53F7 !",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u611F\u53F9\u53F7\u3002"},{key:"question",label:"\u95EE\u53F7 ?",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u95EE\u53F7\u3002"},{key:"semicolon",label:"\u5206\u53F7 ;",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5206\u53F7\u3002"},{key:"colon",label:"\u5192\u53F7 :",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5192\u53F7\u3002"},{key:"leftParen",label:"\u5DE6\u62EC\u53F7 (",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5DE6\u62EC\u53F7\u3002"},{key:"rightParen",label:"\u53F3\u62EC\u53F7 )",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u53F3\u62EC\u53F7\u3002"}]}),mS=Vf});var Zf={};ae(Zf,{BypassPanel:()=>Qf,default:()=>hS});var ot,Qf,hS,eg=D(()=>{Ze();_n();tt();H();ot=E.createScope("BypassPanel"),Qf={id:"bypassPanel",_getActivePresetId(t){return t.find(".yyt-bypass-editor-content").data("presetId")||null},render(t){let e=ye.getPresetList(),r=ye.getDefaultPresetId();return`
    ...
    `},renderTo(t){let e=this.render({});t.html(e),this.bindEvents(t,{})}},hS=Qf});var Dc={};ae(Dc,{SettingsPanel:()=>og,applyTheme:()=>ng,applyUiPreferences:()=>Nc,default:()=>xS});function Ao({id:t,checked:e=!1,title:r="",hint:s=""}){return`
  ...
  `}function rg(){try{if(typeof window.parent<"u"&&window.parent&&window.parent!==window)return window.parent}catch{}return window}function Co(){return rg()?.document||document}function sg(t=Co()){return t?.documentElement||document.documentElement}function ng(t,e=Co()){let r=sg(e),s={...bS,...tg[t]||tg["dark-blue"]};Object.entries(s).forEach(([n,o])=>{r.style.setProperty(n,o)}),r.setAttribute("data-yyt-theme",t)}function Nc(t={},e=Co()){let r=sg(e),{theme:s="dark-blue",compactMode:n=!1,animationEnabled:o=!0}=t||{};ng(s,e),r.classList.toggle("yyt-compact-mode",!!n),r.classList.toggle("yyt-no-animation",!o)}var Pc,bS,tg,og,xS,Lc=D(()=>{Ze();vo();H();Ja();tt();Pc=E.createScope("SettingsPanel"),bS={"--yyt-accent":"#7bb7ff","--yyt-accent-glow":"rgba(123, 183, 255, 0.4)","--yyt-accent-soft":"rgba(123, 183, 255, 0.15)","--yyt-accent-strong":"#a5d4ff","--yyt-on-accent":"#0a0d13","--yyt-bg-base":"#0a0d13","--yyt-surface":"#0f1219","--yyt-surface-2":"#151a24","--yyt-surface-3":"#1c2231","--yyt-surface-hover":"#1c2231","--yyt-surface-active":"#232b3e","--yyt-border":"rgba(255, 255, 255, 0.06)","--yyt-border-soft":"rgba(255, 255, 255, 0.04)","--yyt-border-strong":"rgba(255, 255, 255, 0.12)","--yyt-text":"rgba(255, 255, 255, 0.92)","--yyt-text-secondary":"rgba(255, 255, 255, 0.55)","--yyt-text-muted":"rgba(255, 255, 255, 0.35)","--yyt-focus-ring":"0 0 0 2px rgba(123, 183, 255, 1), 0 0 0 4px rgba(123, 183, 255, 0.15)","--yyt-control-bg":"#0f1219","--yyt-control-bg-hover":"#151a24","--yyt-control-bg-active":"#1c2231","--yyt-control-bg-strong":"#151a24","--yyt-control-bg-focus":"#151a24","--yyt-control-border":"rgba(255, 255, 255, 0.08)","--yyt-control-border-hover":"rgba(255, 255, 255, 0.14)","--yyt-control-border-focus":"rgba(123, 183, 255, 0.5)","--yyt-control-shadow":"none","--yyt-control-shadow-hover":"none","--yyt-control-shadow-focus":"none","--yyt-control-shadow-active":"none","--yyt-select-surface":"#151a24","--yyt-select-option-bg":"#1c2231","--yyt-select-option-hover-bg":"#232b3e","--yyt-select-option-selected-bg":"#2a3450","--yyt-select-option-border":"rgba(123, 183, 255, 0.15)","--yyt-select-option-selected-border":"rgba(123, 183, 255, 0.3)","--yyt-select-dropdown-shadow":"0 8px 24px rgba(0, 0, 0, 0.4)","--yyt-select-arrow-color":"rgba(255, 255, 255, 0.4)"},tg={"dark-blue":{"--yyt-on-accent":"#0a0d13"},"dark-purple":{"--yyt-accent":"#a78bfa","--yyt-accent-glow":"rgba(167, 139, 250, 0.4)","--yyt-accent-soft":"rgba(167, 139, 250, 0.15)","--yyt-accent-strong":"#c4b5fd","--yyt-bg-base":"#0d0a14","--yyt-surface":"#12101c","--yyt-surface-2":"#1a1726","--yyt-surface-3":"#221e32","--yyt-surface-hover":"#221e32","--yyt-surface-active":"#2a2540","--yyt-on-accent":"#0d0a14","--yyt-control-bg":"#12101c","--yyt-control-bg-hover":"#1a1726","--yyt-control-bg-active":"#221e32","--yyt-control-bg-strong":"#1a1726","--yyt-control-bg-focus":"#1a1726","--yyt-control-border-focus":"rgba(167, 139, 250, 0.5)","--yyt-select-surface":"#1a1726","--yyt-select-option-bg":"#221e32","--yyt-select-option-hover-bg":"#2a2540","--yyt-select-option-selected-bg":"#332d50","--yyt-select-option-border":"rgba(167, 139, 250, 0.15)","--yyt-select-option-selected-border":"rgba(167, 139, 250, 0.3)","--yyt-focus-ring":"0 0 0 2px rgba(167, 139, 250, 1), 0 0 0 4px rgba(167, 139, 250, 0.15)"},"dark-green":{"--yyt-accent":"#4ade80","--yyt-accent-glow":"rgba(74, 222, 128, 0.4)","--yyt-accent-soft":"rgba(74, 222, 128, 0.15)","--yyt-accent-strong":"#86efac","--yyt-bg-base":"#0a120d","--yyt-surface":"#0f1912","--yyt-surface-2":"#151f1a","--yyt-surface-3":"#1c2824","--yyt-surface-hover":"#1c2824","--yyt-surface-active":"#233530","--yyt-on-accent":"#0a120d","--yyt-control-bg":"#0f1912","--yyt-control-bg-hover":"#151f1a","--yyt-control-bg-active":"#1c2824","--yyt-control-bg-strong":"#151f1a","--yyt-control-bg-focus":"#151f1a","--yyt-control-border-focus":"rgba(74, 222, 128, 0.5)","--yyt-select-surface":"#151f1a","--yyt-select-option-bg":"#1c2824","--yyt-select-option-hover-bg":"#233530","--yyt-select-option-selected-bg":"#2a4038","--yyt-select-option-border":"rgba(74, 222, 128, 0.15)","--yyt-select-option-selected-border":"rgba(74, 222, 128, 0.3)","--yyt-focus-ring":"0 0 0 2px rgba(74, 222, 128, 1), 0 0 0 4px rgba(74, 222, 128, 0.15)"},light:{"--yyt-accent":"#3b82f6","--yyt-accent-glow":"rgba(59, 130, 246, 0.3)","--yyt-accent-soft":"rgba(59, 130, 246, 0.1)","--yyt-accent-strong":"#93c5fd","--yyt-bg-base":"#f5f7fa","--yyt-surface":"#edf0f5","--yyt-surface-2":"#e4e8ef","--yyt-surface-3":"#dbe0e9","--yyt-surface-hover":"#dbe0e9","--yyt-surface-active":"#d1d7e2","--yyt-text":"rgba(15, 23, 42, 0.92)","--yyt-text-secondary":"rgba(15, 23, 42, 0.55)","--yyt-text-muted":"rgba(15, 23, 42, 0.35)","--yyt-border":"rgba(15, 23, 42, 0.08)","--yyt-border-soft":"rgba(15, 23, 42, 0.04)","--yyt-border-strong":"rgba(15, 23, 42, 0.14)","--yyt-focus-ring":"0 0 0 2px rgba(59, 130, 246, 1), 0 0 0 4px rgba(59, 130, 246, 0.12)","--yyt-on-accent":"#ffffff","--yyt-control-bg":"#edf0f5","--yyt-control-bg-hover":"#e4e8ef","--yyt-control-bg-active":"#dbe0e9","--yyt-control-bg-strong":"#e4e8ef","--yyt-control-bg-focus":"#e4e8ef","--yyt-control-border":"rgba(15, 23, 42, 0.1)","--yyt-control-border-hover":"rgba(15, 23, 42, 0.18)","--yyt-control-border-focus":"rgba(59, 130, 246, 0.5)","--yyt-control-shadow":"none","--yyt-control-shadow-hover":"none","--yyt-control-shadow-focus":"none","--yyt-control-shadow-active":"none","--yyt-select-surface":"#e4e8ef","--yyt-select-option-bg":"#edf0f5","--yyt-select-option-hover-bg":"#dbe0e9","--yyt-select-option-selected-bg":"#dbeafe","--yyt-select-option-border":"rgba(59, 130, 246, 0.12)","--yyt-select-option-selected-border":"rgba(59, 130, 246, 0.3)","--yyt-select-dropdown-shadow":"0 8px 24px rgba(15, 23, 42, 0.1)","--yyt-select-arrow-color":"rgba(15, 23, 42, 0.4)"}};og={id:"settingsPanel",render(){let t=jt.getSettings(),e=t.debug?.enableDebugLog===!0,r=this._getAutomationRuntime();return`
    ...
    `},renderTo(t){t.html(this.render({})),this.bindEvents(t,{})}},xS=og});function wS(t={},e=-1){return[t?.sourceId,t?.messageId,t?.message_id,t?.id,t?.mid,t?.mesid,t?.mes_id,t?.chat_index,t?.index,e].map(r=>_e(r))}function vS(t=[],e=""){let r=_e(e);if(!r||!Array.isArray(t))return-1;for(let s=t.length-1;s>=0;s-=1){let n=t[s];if(wS(n,s).includes(r))return s}return-1}function ko(t={},e={}){let r=_e(t?.sourceMessageId||t?.confirmedAssistantMessageId||t?.messageId);if(!r)return null;let s=Ol({resolvedAt:Date.now(),runSource:e.runSource||t?.runSource||st.MANUAL,traceId:t?.traceId||"",chatId:t?.chatId||"",sourceMessageId:r,sourceSwipeId:t?.sourceSwipeId||t?.effectiveSwipeId||"",effectiveSwipeId:t?.effectiveSwipeId||t?.sourceSwipeId||"swipe:current",slotBindingKey:t?.slotBindingKey||"",slotRevisionKey:t?.slotRevisionKey||"",slotTransactionId:t?.slotTransactionId||"",assistantContentFingerprint:t?.assistantContentFingerprint||"",assistantBaseFingerprint:t?.assistantBaseFingerprint||"",assistantText:t?.lastAiMessage||"",assistantBaseText:t?.assistantBaseText||"",targetMessageIndex:vS(t?.chatMessages||t?.chatHistory||[],r)});return!s.slotBindingKey||!s.slotRevisionKey?null:s}async function Oc({runSource:t=st.MANUAL}={}){let e=await bs({runSource:t});return ko(e,{runSource:t})}async function SS({messageId:t,swipeId:e="",runSource:r=st.AUTO}={}){let s=await xs({messageId:t,swipeId:e,runSource:r});return ko(s,{runSource:r})}async function ag(t=null,e={}){let r=t||null;if(typeof e.resolveTarget=="function")return await e.resolveTarget(r);let s=_e(e.runSource||r?.runSource)||st.MANUAL,n=_e(e.messageId||r?.sourceMessageId),o=_e(e.swipeId||r?.sourceSwipeId||r?.effectiveSwipeId);return e.useMessageTarget===!0||s===st.AUTO?n?SS({messageId:n,swipeId:o,runSource:s}):null:Oc({runSource:s})}function ig(t,e){let r=t||null,s=e||null;return!r||!s?{valid:!1,reason:"missing_target_snapshot"}:_e(r.sourceMessageId)!==_e(s.sourceMessageId)?{valid:!1,reason:"source_message_changed"}:_e(r.sourceSwipeId||r.effectiveSwipeId)!==_e(s.sourceSwipeId||s.effectiveSwipeId)?{valid:!1,reason:"source_swipe_changed"}:_e(r.slotRevisionKey)!==_e(s.slotRevisionKey)?{valid:!1,reason:"slot_revision_changed"}:{valid:!0,reason:"ok"}}var ai=D(()=>{ws();He()});function Cr(t,e=""){return t==null?e:String(t).trim()||e}function TS(t){if(!t||t?.is_user===!0||t?.is_system===!0)return!1;let e=String(t?.role||"").trim().toLowerCase();return e==="assistant"||e==="ai"||!e}function _S(t){return!t||typeof t!="object"||Array.isArray(t)?!1:!!(Array.isArray(t.tables)||typeof t.chatId=="string"&&t.chatId.length>0||typeof t.slotBindingKey=="string"&&t.slotBindingKey.length>0)}function lg(t,e){if(!t)return null;let r=t[Cs];if(!r)return null;let s=Ae(e);return _S(r)?s===Tt?r:null:r[s]||null}function Io({loadMode:t=ks.EMPTY,mergeBaseOnly:e=!1,state:r=null,sourceKind:s=Mt.EMPTY,resolvedFromMessageId:n="",resolvedFromRevisionKey:o=""}={}){let a=Sr(r)||null;return{loadMode:t,mergeBaseOnly:e,state:a,sourceKind:s,resolvedFromMessageId:Cr(n,a?.sourceMessageId||""),resolvedFromRevisionKey:Cr(o,a?.slotRevisionKey||"")}}function $c(t,e={}){let r=Sr(t);return r?Sr({...r,meta:{...r.meta||{},...e||{}}}):null}function cg({runtime:t,targetSnapshot:e,currentMessageIndex:r=-1,templateTables:s=[],isolationKey:n}={}){let o=Array.isArray(t?.chat)?t.chat:[],a=Cr(e?.slotRevisionKey,""),i=Cr(e?.slotBindingKey,""),l=Ae(n===void 0?"":n);if(r>=0&&r<o.length){let d=lg(o[r],l),c=Sr(d);if(c&&Cr(c.slotRevisionKey,"")===a)return Io({loadMode:ks.EXACT,mergeBaseOnly:!1,state:$c(c,{sourceKind:Mt.EXACT,isolationKey:l,resolvedFromMessageId:c.sourceMessageId,resolvedFromRevisionKey:c.slotRevisionKey}),sourceKind:Mt.EXACT,resolvedFromMessageId:c.sourceMessageId,resolvedFromRevisionKey:c.slotRevisionKey});if(c&&Cr(c.slotBindingKey,"")===i){let u=$c({...c,slotRevisionKey:a||c.slotRevisionKey,sourceSwipeId:Cr(e?.sourceSwipeId||e?.effectiveSwipeId,c.sourceSwipeId),meta:{...c.meta||{},sourceKind:Mt.BINDING,mergeBaseOnly:!0,fallbackFromBinding:!0,isolationKey:l,fallbackFromRevisionKey:Cr(c.slotRevisionKey,""),requestedRevisionKey:a,resolvedFromMessageId:c.sourceMessageId,resolvedFromRevisionKey:c.slotRevisionKey}});return Io({loadMode:ks.BINDING_FALLBACK,mergeBaseOnly:!0,state:u,sourceKind:Mt.BINDING,resolvedFromMessageId:c.sourceMessageId,resolvedFromRevisionKey:c.slotRevisionKey})}}if(r>0)for(let d=r-1;d>=0;d-=1){let c=o[d];if(!TS(c))continue;let u=lg(c,l),p=Sr(u);if(!p||!Array.isArray(p.tables)||p.tables.length===0)continue;let y=$c({...p,slotBindingKey:i||p.slotBindingKey,slotRevisionKey:a||p.slotRevisionKey,sourceSwipeId:Cr(e?.sourceSwipeId||e?.effectiveSwipeId,p.sourceSwipeId),meta:{...p.meta||{},sourceKind:Mt.HISTORY,mergeBaseOnly:!0,reconstructedFromHistory:!0,isolationKey:l,resolvedFromMessageId:p.sourceMessageId,resolvedFromRevisionKey:p.slotRevisionKey}});return Io({loadMode:ks.HISTORY,mergeBaseOnly:!0,state:y,sourceKind:Mt.HISTORY,resolvedFromMessageId:p.sourceMessageId,resolvedFromRevisionKey:p.slotRevisionKey})}return Array.isArray(s)&&s.length>0?Io({loadMode:ks.TEMPLATE,mergeBaseOnly:!1,state:lo(e,{tables:ce(s),meta:{fromTemplate:!0,isolationKey:l,sourceKind:Mt.TEMPLATE,resolvedFromMessageId:"",resolvedFromRevisionKey:""}}),sourceKind:Mt.TEMPLATE}):Io({loadMode:ks.EMPTY,mergeBaseOnly:!1,state:lo(e,{meta:{isolationKey:l,sourceKind:Mt.EMPTY,resolvedFromMessageId:"",resolvedFromRevisionKey:""}}),sourceKind:Mt.EMPTY})}var dg=D(()=>{He()});function ug(){return Bc||(Bc=E.createScope("TableStateMirror")),Bc}async function ES(t,e,r){try{await Ye(),await $a({chatId:t?.chatId,messageId:t?.sourceMessageId,swipeId:t?.sourceSwipeId||t?.effectiveSwipeId,isolationKey:e},Array.isArray(r)?r:[]),ug().info("slot \u5DF2\u955C\u50CF\u5230 SQL",{chatId:t?.chatId,messageId:t?.sourceMessageId,tableCount:r?.length||0})}catch(s){ug().warn("SQL \u955C\u50CF\u5931\u8D25\uFF08\u4E0D\u5F71\u54CD\u4E3B\u6D41\u7A0B\uFF09",{error:s?.message||String(s)})}}function pg(t){return t==null?"":String(t).trim()}function AS(){try{if(typeof window.parent<"u"&&window.parent&&window.parent!==window)return window.parent}catch{}return window}function Kc(){try{let t=AS(),e=t?.SillyTavern||null,r=e?.getContext?.()||null,s=Array.isArray(r?.chat)?r.chat:[],n=Array.isArray(e?.chat)?e.chat:[],o=s.length?s:n;return{topWindow:t,api:e,context:r,chat:o,contextChat:s,apiChat:n}}catch{return{topWindow:null,api:null,context:null,chat:[],contextChat:[],apiChat:[]}}}function CS(t){if(!t||t?.is_user===!0||t?.is_system===!0)return!1;let e=String(t?.role||"").trim().toLowerCase();return e==="assistant"||e==="ai"||!e}function kS(t=[],e=""){let r=pg(e);if(!Array.isArray(t)||!r)return-1;for(let s=t.length-1;s>=0;s-=1){let n=t[s];if(!CS(n))continue;if([n?.sourceId,n?.message_id,n?.messageId,n?.id,n?.mes_id,n?.mid,n?.mesid,n?.chat_index,n?.index,s].map(a=>pg(a)).includes(r))return s}return-1}function Uc(t){let e=Kc(),r=kS(e.chat,t?.sourceMessageId);return r<0?{runtime:e,messageIndex:r,message:null}:{runtime:e,messageIndex:r,message:e.chat[r]||null}}function ci(t,e,r){let s=n=>{!Array.isArray(n)||e<0||e>=n.length||(n[e]={...n[e]||{},...r})};s(t?.contextChat),s(t?.apiChat)}async function di(t){let e=t?.context||null,r=t?.api||null,s=e?.saveChatDebounced||r?.saveChatDebounced||null,n=e?.saveChat||r?.saveChat||null;typeof s=="function"&&s.call(e||r),typeof n=="function"&&await n.call(e||r)}function ui(t){return!t||typeof t!="object"||Array.isArray(t)?!1:!!(Array.isArray(t.tables)||typeof t.chatId=="string"&&t.chatId.length>0||typeof t.slotBindingKey=="string"&&t.slotBindingKey.length>0)}function Bs(t){return!t||typeof t!="object"||Array.isArray(t)?!1:"lastResolvedTarget"in t||"lastCommittedTarget"in t}function ii(t,e,r,s){if(!t)return null;let n=t[e];if(!n)return null;let o=Ae(r);return typeof s=="function"&&s(n)?o===Tt?n:null:n[o]||null}function zc(t,e,r,s,n){if(!t)return;let o=Ae(r),a=t[e];if(typeof n=="function"&&n(a)){let i={[Tt]:a};i[o]=s,t[e]=i}else a&&typeof a=="object"&&!Array.isArray(a)?t[e]={...a,[o]:s}:t[e]={[o]:s}}function li(t,e,r,s){if(!t)return!1;let n=Ae(r),o=t[e];if(!o)return!1;if(typeof s=="function"&&s(o))return n===Tt?(delete t[e],!0):!1;if(o&&typeof o=="object"&&!Array.isArray(o)){if(o[n]===void 0)return!1;let a={...o};return delete a[n],Object.keys(a).length===0?delete t[e]:t[e]=a,!0}return!1}function yg(t,e={}){let{runtime:r,messageIndex:s}=Uc(t);return cg({runtime:r,targetSnapshot:t,currentMessageIndex:s,templateTables:Array.isArray(e.templateTables)?e.templateTables:[],isolationKey:e.isolationKey===void 0?de.getKey():e.isolationKey})}async function fg(t,e={}){let{runtime:r,messageIndex:s,message:n}=Uc(t);if(!n||s<0)return{success:!1,error:"target_message_not_found"};let o=e.isolationKey===void 0?de.getKey():e.isolationKey,a=ii(n,jr,o,Bs),i={..._a(a),lastResolvedTarget:cn(t),updatedAt:Date.now()};return zc(n,jr,o,i,Bs),ci(r,s,n),await di(r),{success:!0,bindings:i}}async function pi(t,e,r={}){let s=r.skipFreshValidation===!0?t:await ag(t,r),n=r.skipFreshValidation===!0?{valid:!0,reason:"skipped"}:ig(t,s);if(!n.valid)return{success:!1,error:"target_changed_before_commit",validation:n};let o=s||t,{runtime:a,messageIndex:i,message:l}=Uc(o);if(!l||i<0)return{success:!1,error:"target_message_not_found",validation:n};let d=r.isolationKey===void 0?de.getKey():r.isolationKey,c=lo(o),u={...c.meta||{},...e.meta||{},...r.locks?{locks:r.locks}:{},...r.previousSnapshot?{previousSnapshot:r.previousSnapshot}:{},isolationKey:d},p=Sr({...c,...e,meta:u,slotBindingKey:o.slotBindingKey,slotRevisionKey:o.slotRevisionKey,sourceMessageId:o.sourceMessageId,sourceSwipeId:o.sourceSwipeId||o.effectiveSwipeId,updatedAt:Date.now()}),y=ii(l,jr,d,Bs),m={..._a(y),lastResolvedTarget:cn(o),lastCommittedTarget:cn(o),updatedAt:Date.now()};return zc(l,Cs,d,p,ui),zc(l,jr,d,m,Bs),ci(a,i,l),await di(a),ES(o,d,p?.tables||[]).catch(()=>{}),{success:!0,state:p,bindings:m,validation:n,messageIndex:i,sourceMessageId:o.sourceMessageId,slotRevisionKey:o.slotRevisionKey}}function zs(t=null,e={}){let r=Dt.getAssistantMessageSnapshot(t);if(!r?.message)return null;let s=e.isolationKey===void 0?de.getKey():e.isolationKey;return{...r,tableState:Sr(ii(r.message,Cs,s,ui)),tableBindings:_a(ii(r.message,jr,s,Bs))}}async function gg(t,e={}){let r=Kc();if(!Array.isArray(r.chat)||t<0||t>=r.chat.length)return{success:!1,error:"invalid_message_index",messageIndex:t};let s=r.chat[t];if(!s)return{success:!1,error:"message_not_found",messageIndex:t};let n=e.isolationKey===void 0?de.getKey():e.isolationKey,o=li(s,Cs,n,ui),a=e.clearBindings===!1?!1:li(s,jr,n,Bs);return(o||a)&&(ci(r,t,s),await di(r)),{success:!0,cleared:o||a,messageIndex:t,isolationKey:n}}async function mg(t={}){let e=Kc(),r=Number.isFinite(t.fromMessageIndex)?t.fromMessageIndex:0,s=Number.isFinite(t.toMessageIndex)?t.toMessageIndex:(e.chat?.length||0)-1,n=t.isolationKey===void 0?de.getKey():t.isolationKey,o=0;for(let a=r;a<=s;a++){let i=e.chat[a];if(!i)continue;let l=li(i,Cs,n,ui),d=li(i,jr,n,Bs);(l||d)&&(ci(e,a,i),o++)}return o>0&&await di(e),{success:!0,touched:o,from:r,to:s,isolationKey:n}}var Bc,Ro=D(()=>{Ds();He();qr();dg();ai();Ba();H()});function bg(t){let e=new Set;if(!Array.isArray(t))return e;for(let r of t){let s=r?.order;Number.isFinite(s)&&e.add(Math.floor(s))}return e}function Fc(t,e=5e4,r=1,s=99999){for(let n=e;n<=s;n++)if(!t.has(n))return t.add(n),n;for(let n=r;n<e;n++)if(!t.has(n))return t.add(n),n;return hg.warn("\u65E0\u53EF\u7528 order \u69FD\u4F4D"),t.add(e),e}function xg(t,e,r=5e4,s=1,n=99999){let o=n-e+1;for(let a=r;a<=o;a++){let i=!0;for(let l=0;l<e;l++)if(t.has(a+l)){i=!1;break}if(i){for(let l=0;l<e;l++)t.add(a+l);return a}}for(let a=s;a<r&&a<=o;a++){let i=!0;for(let l=0;l<e;l++)if(t.has(a+l)){i=!1;break}if(i){for(let l=0;l<e;l++)t.add(a+l);return a}}hg.warn(`\u65E0\u6CD5\u5206\u914D ${e} \u4E2A\u8FDE\u7EED order \u69FD\u4F4D`);for(let a=0;a<e;a++)t.add(r+a);return r}var hg,wg=D(()=>{H();hg=E.createScope("TableWBOrder")});function jc(t,e="before_character_definition"){let r=String(t||"").trim().toLowerCase();return r==="at_depth_as_system"||r==="system"?"at_depth_as_system":r==="before_char"||r==="before_character"||r==="before_character_definition"||r==="0"?"before_character_definition":r==="after_char"||r==="after_character"||r==="after_character_definition"||r==="1"?"after_character_definition":e}function Mo(t,e){if(!e)return t;let r={...t,position:e.position};return e.position==="at_depth_as_system"?r.depth=e.depth:delete r.depth,r}var ek,tk,vg=D(()=>{ek=Object.freeze(["at_depth_as_system","before_character_definition","after_character_definition"]);tk=Object.freeze({position:"before_character_definition",depth:2,order:5e4})});function Wc(t,e=""){return t==null?e:String(t).trim()||e}function MS(t){return Wc(t,"default_chat").replace(/[\[\]=]/g,"_")}function PS(){let t=globalThis.window||globalThis;return Wc(t?.TavernHelper?.getCurrentChatId?.()||t?.Silvy?.getCurrentChatId?.()||t?.chat_metadata?.chat_id||t?.this_chid||t?.name1,"default_chat")}function NS(){try{if(typeof TavernHelper<"u"&&TavernHelper)return TavernHelper}catch{}return $r()?.TavernHelper||null}function DS(t){return String(t??"").replace(/\|/g,"\uFF5C").replace(/\n/g," ")}function Sg(t){let e=Array.isArray(t.columns)?t.columns:[],r=Array.isArray(t.rows)?t.rows:[];if(r.length===0)return"";let s=e.map(l=>l.key),n=e.map(l=>l.title||l.key),o=`| ${n.join(" | ")} |`,a=`| ${n.map(()=>"---").join(" | ")} |`,i=r.map(l=>{let d=l.cells||{};return`| ${s.map(c=>DS(d[c])).join(" | ")} |`});return`# ${t.name||"\u672A\u547D\u540D\u8868"}

${o}
${a}
${i.join(`
`)}`}function LS(t,e){if(!Array.isArray(t)||t.length===0)return[];let r=new Map;if(Array.isArray(e))for(let s of e){let n=s?.id||s?.key;n&&r.set(n,s)}return t.map(s=>{let n=s?.id?r.get(s.id):null;return{...s,exportConfig:s?.exportConfig||n?.exportConfig||{enabled:!1},enabled:s?.enabled!==!1}})}function yi(t){return`${_g}${IS}${MS(t)}${RS}-`}function OS(t){return`${_g}[${Wc(t,"default_chat")}]-`}function Eg(t,e){if(!t||typeof t!="string")return!1;let r=yi(e);if(t.startsWith(r))return!0;let s=OS(e);return!!t.startsWith(s)}function $S(t,e){let r=yi(t),s=String(e||"").trim();return s?`${r}${s}`:`${r}\u586B\u8868\u6570\u636E`}function Tg(t,e,r){return`${yi(t)}Wrapper-${r}`}function BS(t,e){return t?t.content!==e.content||t.enabled!==e.enabled||t.type!==e.type||t.position!==e.position||t.prevent_recursion!==e.prevent_recursion||t.order!==e.order:!0}async function Po(t,e,r,s,n,o,a){let i=r.find(l=>l.comment===s);return i&&a&&!Eg(i.comment,a)?(Mn.warn(`upsert \u8DF3\u8FC7\uFF1A\u73B0\u6709\u6761\u76EE comment "${s}" \u4E0D\u5C5E\u4E8E\u5F53\u524D chat`,{chatId:a}),{action:"skipped",comment:s,reason:"cross_chat_collision"}):i&&i.uid?BS(i,n)?(await Promise.resolve(t.setLorebookEntries(e,[{uid:i.uid,...n}])),Mn.info(`\u4E16\u754C\u4E66\u6761\u76EE\u5DF2\u66F4\u65B0\uFF1A${s}`),{action:"updated",comment:s}):(o.add(i.order||0),{action:"skipped",comment:s}):typeof t.createLorebookEntries=="function"?(await Promise.resolve(t.createLorebookEntries(e,[{comment:s,keys:[],...n}])),Mn.info(`\u4E16\u754C\u4E66\u6761\u76EE\u5DF2\u521B\u5EFA\uFF1A${s}`),{action:"created",comment:s}):{action:"failed",comment:s,error:"createLorebookEntries \u4E0D\u53EF\u7528"}}async function Ag(t,e){let r=e?.worldbookSync;if(!r?.enabled)return{skipped:!0,reason:"disabled"};let s=String(r.targetBook||"").trim();if(!s)return{skipped:!0,reason:"no_target_book"};let n=NS();if(!n)return{success:!1,error:"TavernHelper \u4E0D\u53EF\u7528"};if(typeof n.getLorebookEntries!="function")return{success:!1,error:"getLorebookEntries \u4E0D\u53EF\u7528"};if(typeof n.setLorebookEntries!="function"&&typeof n.createLorebookEntries!="function")return{success:!1,error:"\u4E16\u754C\u4E66\u5199\u5165 API \u4E0D\u53EF\u7528"};let o=PS(),a=yi(o),i=Array.isArray(e?.tables)?e.tables:[],d=LS(t,i).filter(p=>p&&p.enabled!==!1&&Array.isArray(p.rows)&&p.rows.length>0);if(d.length===0)return{skipped:!0,reason:"empty_tables"};let c=e?.wrapperConfig||{},u=c.enabled!==!1;try{let p=await Promise.resolve(n.getLorebookEntries(s));Array.isArray(p)||(p=[]);let y=bg(p),m=[],g=d.filter(w=>w.exportConfig?.enabled===!0),h=d.filter(w=>w.exportConfig?.enabled!==!0),x="";if(h.length>0&&(x=h.map(w=>Sg(w)).join(`
...
${P}`;m.push(await Po(n,s,p,Tg(o,w,"Start"),Mo({content:j,enabled:!0,type:"constant",order:R,prevent_recursion:!0},{position:_,depth:M}),y,o)),x&&m.push(await Po(n,s,p,`${a}\u5168\u5C40\u6570\u636E`,Mo({content:x,enabled:!0,type:"constant",order:R+1,prevent_recursion:!0},{position:_,depth:M}),y,o)),m.push(await Po(n,s,p,Tg(o,w,"End"),Mo({content:`</${w}>`,enabled:!0,type:"constant",order:R+2,prevent_recursion:!0},{position:_,depth:M}),y,o))}else if(x){let w=Fc(y,5e4,1,99999);m.push(await Po(n,s,p,`${a}\u5168\u5C40\u6570\u636E`,{content:x,enabled:!0,type:"constant",position:"before_character_definition",order:w,prevent_recursion:!0},y,o))}for(let w of g){let P=w.exportConfig||{},B=P.entryName||w.name||"\u672A\u547D\u540D\u8868",z=$S(o,B),R=Sg(w);if(!R)continue;let _=P.entryPlacement||{},M=jc(_.position,"before_character_definition"),j=Fc(y,_.order||5e4,1,99999),q=P.entryType==="keyword"?"keyword":"constant";m.push(await Po(n,s,p,z,Mo({content:R,enabled:!0,type:q,order:j,prevent_recursion:P.preventRecursion!==!1},{position:M,depth:_.depth||2}),y,o))}let T=new Set(m.map(w=>w.comment).filter(Boolean)),S=p.filter(w=>!w.comment||!Eg(w.comment,o)?!1:!T.has(w.comment));if(S.length>0){let w=S.map(P=>P.uid).filter(Boolean);w.length>0&&typeof n.deleteLorebookEntries=="function"&&(await Promise.resolve(n.deleteLorebookEntries(s,w)),Mn.info(`\u5DF2\u6E05\u7406 ${w.length} \u4E2A\u65E7\u4E16\u754C\u4E66\u6761\u76EE [${o}]`))}let A=m.filter(w=>w.action==="created").length,C=m.filter(w=>w.action==="updated").length;return Mn.info(`\u4E16\u754C\u4E66\u540C\u6B65\u5B8C\u6210 [${o}]\uFF1A${A} \u521B\u5EFA, ${C} \u66F4\u65B0, ${S.length} \u6E05\u7406`),{success:!0,results:m,stats:{created:A,updated:C,cleaned:S.length},targetBook:s,chatId:o}}catch(p){return Mn.warn("\u4E16\u754C\u4E66\u540C\u6B65\u5931\u8D25:",p),{success:!1,error:p?.message||"\u4E16\u754C\u4E66\u540C\u6B65\u5931\u8D25"}}}var Mn,_g,IS,RS,Cg=D(()=>{ws();H();wg();vg();Mn=E.createScope("TableWorldbookSync"),_g="YYT-",IS="[YY:chatId=",RS="]"});function fi(t,e=""){return t==null?e:String(t).trim()||e}function KS(t={}){return{tables:Array.isArray(t?.tables)?ce(t.tables):[]}}function US(t={},e={}){let r=fi(e.mirrorTag,"yyt-table-workbench"),s=KS(t);return[`<${r}>`,"[\u586B\u8868\u5DE5\u4F5C\u53F0]","```json",JSON.stringify(s,null,2),"```",`</${r}>`].join(`
`)}async function kg({targetSnapshot:t,nextTables:e,config:r,loadResult:s=null,diff:n=null,fillMode:o="",skipNotify:a=!1}={}){let i=Ft(r),l=await pi(t,{tables:Array.isArray(e)?ce(e):[],meta:{lastLoadMode:fi(s?.loadMode,""),lastFillMode:fi(o),mergeBaseOnly:!1,updatedBy:fi(t?.runSource,"MANUAL_TABLE")}});if(!l?.success)return{success:!1,error:l?.error||"table_state_commit_failed",commitResult:l,mirrorResult:null,warning:""};let d=null,c=null,u="";if(i.mirrorToMessage){let p=US(l.state,{mirrorTag:i.mirrorTag});d=await Dt.injectDetailed(zS,p,{overwrite:!0,extractionSelectors:[i.mirrorTag],sourceMessageId:l.sourceMessageId,sourceSwipeId:t?.sourceSwipeId||t?.effectiveSwipeId,effectiveSwipeId:t?.effectiveSwipeId||t?.sourceSwipeId,slotBindingKey:t?.slotBindingKey,slotRevisionKey:t?.slotRevisionKey,slotTransactionId:t?.slotTransactionId,traceId:t?.traceId,skipNotify:a}),d?.success||(u=d?.error||"\u6B63\u6587\u955C\u50CF\u5199\u56DE\u5931\u8D25")}return i.worldbookSync?.enabled&&(c=await Ag(Array.isArray(e)?e:[],i),c&&!c.success&&!c.skipped&&(u=u?`${u}; ${c.error}`:c.error||"\u4E16\u754C\u4E66\u540C\u6B65\u5931\u8D25")),{success:!0,state:l.state,bindings:l.bindings,diff:n,fillMode:o,commitResult:l,mirrorResult:d,worldbookSyncResult:c,warning:u}}var zS,Ig=D(()=>{Ds();He();Ro();dr();Cg();zS="tableWorkbenchMirror"});function FS(t){return typeof t!="string"||!t?t:t.replace(/[“”「」『』＂]/g,'"')}function Hc(t,e){for(let r=e;r<t.length;r++)if(!/\s/.test(t[r]))return{char:t[r],index:r};return{char:"",index:-1}}function Pg(t){return!!t&&(t==='"'||t==="{"||t==="["||t==="-"||/\d/.test(t)||t==="t"||t==="f"||t==="n")}function jS(t,e,r,s){let n=Hc(t,e+1),o=n.char;if(!o)return r!=="key";if(r==="key")return o===":";if(o==="}"||o==="]")return!0;if(o!==",")return!1;let a=Hc(t,n.index+1).char;return a?s==="object"?a==='"'||a==="}":s==="array"?a==="]"||Pg(a):Pg(a)||a==="}"||a==="]":!0}function WS(t){if(typeof t!="string")return{success:!1,result:t,error:"not a string"};let e="",r=!1,s=!1,n=null,o=[],a=()=>o.length?o[o.length-1]:null,i=()=>{let l=a();l&&(l.expecting="commaOrEnd")};for(let l=0;l<t.length;l++){let d=t[l];if(s){e+=d,s=!1;continue}if(r){if(d==="\\"){e+=d,s=!0;continue}if(d==='"'){let c=a();jS(t,l,n,c?.type||null)?(e+=d,r=!1,n==="key"&&c?.type==="object"?c.expecting="colon":i(),n=null):e+='\\"';continue}e+=d;continue}if(d==='"'){e+=d,r=!0;let c=a();n=c&&c.type==="object"&&(c.expecting==="key"||c.expecting==="keyOrEnd")?"key":"value";continue}if(d==="{"){e+=d,o.push({type:"object",expecting:"keyOrEnd"});continue}if(d==="["){e+=d,o.push({type:"array",expecting:"valueOrEnd"});continue}if(d===":"){e+=d;let c=a();c?.type==="object"&&(c.expecting="value");continue}if(d===","){e+=d;let c=a();c?.type==="object"&&(c.expecting="key"),c?.type==="array"&&(c.expecting="value");continue}if(d==="}"||d==="]"){e+=d,o.pop(),i();continue}e+=d}return{success:!0,result:e,error:null}}function HS(t){if(typeof t!="string"||!t)return t;let e="",r=!1,s=!1;for(let n=0;n<t.length;n++){let o=t[n];if(s){e+=o,s=!1;continue}if(o==="\\"){e+=o,r&&(s=!0);continue}if(o==='"'){e+=o,r=!r;continue}if(r){if(o===`
`){e+="\\n";continue}if(o==="\r"){e+="\\r";continue}if(o==="	"){e+="\\t";continue}if(o==="\0"){e+="\\u0000";continue}}e+=o}return e}function GS(t){if(typeof t!="string"||!t)return t;let e="",r=!1,s=!1;for(let n=0;n<t.length;n++){let o=t[n];if(s){e+=o,s=!1;continue}if(o==="\\"){e+=o,r&&(s=!0);continue}if(o==='"'){e+=o,r=!r;continue}if(!r&&o===","){let a=Hc(t,n+1).char;if(a==="}"||a==="]")continue}e+=o}return e}function qS(t){return typeof t!="string"||!t?t:t.replace(/([{,]\s*)(-?\d+)(\s*:)/g,'$1"$2"$3')}function No(t){if(typeof t!="string")return{success:!1,result:t,layersApplied:[],error:"Input is not a string"};let e=[],r=t,s=FS(r);s!==r&&e.push("normalizeQuotes"),r=s;let n=WS(r);if(!n.success)return{success:!1,result:r,layersApplied:e,error:n.error};n.result!==r&&e.push("escapeUnescapedQuotes"),r=n.result;let o=HS(r);o!==r&&e.push("sanitizeControlChars"),r=o;let a=GS(r);a!==r&&e.push("removeTrailingCommas"),r=a;let i=qS(r);return i!==r&&e.push("fixNumericKeys"),r=i,{success:!0,result:r,layersApplied:e,error:null}}function YS(t,e=","){if(typeof t!="string"||!t)return[];let r=[],s="",n=!1,o=!1,a=0,i=0,l=0;for(let d=0;d<t.length;d++){let c=t[d];if(o){s+=c,o=!1;continue}if(c==="\\"){s+=c,n&&(o=!0);continue}if(c==='"'){s+=c,n=!n;continue}if(!n){if(c==="{")a++;else if(c==="}")a=Math.max(0,a-1);else if(c==="[")i++;else if(c==="]")i=Math.max(0,i-1);else if(c==="(")l++;else if(c===")")l=Math.max(0,l-1);else if(c===e&&a===0&&i===0&&l===0){s.trim()&&r.push(s.trim()),s="";continue}}s+=c}return s.trim()&&r.push(s.trim()),r}function VS(t,e=":"){if(typeof t!="string"||!t)return-1;let r=!1,s=!1,n=0,o=0,a=0;for(let i=0;i<t.length;i++){let l=t[i];if(s){s=!1;continue}if(l==="\\"){r&&(s=!0);continue}if(l==='"'){r=!r;continue}if(!r){if(l==="{")n++;else if(l==="}")n=Math.max(0,n-1);else if(l==="[")o++;else if(l==="]")o=Math.max(0,o-1);else if(l==="(")a++;else if(l===")")a=Math.max(0,a-1);else if(l===e&&n===0&&o===0&&a===0)return i}}return-1}function Gc(t){if(typeof t!="string")return{success:!0,value:t,error:null};let e=t.trim();if(!e)return{success:!1,value:null,error:"Empty value"};let s=`[${e.startsWith("'")&&e.endsWith("'")?`"${e.slice(1,-1).replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\r/g,"\\r").replace(/\n/g,"\\n").replace(/\t/g,"\\t")}"`:e}]`;try{return{success:!0,value:JSON.parse(s)[0],error:null}}catch(n){let o=No(s);if(o.success)try{return{success:!0,value:JSON.parse(o.result)[0],error:null}}catch{}return{success:!1,value:null,error:n?.message||"Failed to parse loose value"}}}function JS(t){let e=typeof t=="string"?t.trim():"";if(!e)return null;if(/^-?\d+$/.test(e))return e;let r=Gc(e);return r.success&&(typeof r.value=="string"||typeof r.value=="number")?String(r.value):e.replace(/^["']|["']$/g,"")}function Ng(t){if(typeof t!="string")return{success:!1,result:null,recoveredKeys:[],error:"not a string"};let e=t.trim();if(!e.startsWith("{")||!e.endsWith("}"))return{success:!1,result:null,recoveredKeys:[],error:"not an object literal"};let r=e.slice(1,-1).trim();if(!r)return{success:!0,result:{},recoveredKeys:[],error:null};let s=YS(r,",").filter(Boolean);if(!s.length)return{success:!1,result:null,recoveredKeys:[],error:"no segments"};let n={},o=0;for(let i of s){let l=VS(i,":");if(l!==-1){let c=JS(i.slice(0,l)),u=Gc(i.slice(l+1));if(!c||!u.success)return{success:!1,result:null,recoveredKeys:Object.keys(n),error:`Failed segment: ${i}`};n[c]=u.value;let p=parseInt(c,10);!isNaN(p)&&String(p)===c&&(o=Math.max(o,p+1));continue}let d=Gc(i);if(!d.success)return{success:!1,result:null,recoveredKeys:Object.keys(n),error:`Failed value: ${i}`};for(;Object.prototype.hasOwnProperty.call(n,String(o));)o++;n[String(o)]=d.value,o++}let a=Object.keys(n).sort((i,l)=>parseInt(i,10)-parseInt(l,10));return a.length?{success:!0,result:n,recoveredKeys:a,error:null}:{success:!1,result:null,recoveredKeys:[],error:"no keys recovered"}}function XS(t){if(typeof t!="string")return"";let e=t.trim();return e=e.replace(/'\s*\+\s*'/g,""),e.startsWith("'")&&e.endsWith("'")&&(e=e.slice(1,-1)),e=e.replace(/\\n/g,`
`),e=e.replace(/\\\\"/g,'\\"'),e=e.replace(/：/g,":"),e}function QS(t){let e=XS(t);if(!e)return[];let r=[];Rg.lastIndex=0;let s;for(;(s=Rg.exec(e))!==null;){let i=s[1];i&&i.trim()&&r.push(i)}if(r.length)return r;let n=i=>/(insertRow|updateRow|deleteRow)\s*\(/.test(i),o=/<!--([\s\S]*?)-->/g,a=[];for(;(s=o.exec(e))!==null;)n(s[1])&&a.push(s[1]);return a}function ZS(t){let e=t.split(/\r?\n/),r=[],s="",n=!1;for(let a of e){let i=a.trim();if(!i||(!n&&i.includes("//")&&!i.includes('"//')&&!i.includes("'//")&&(i=i.split("//")[0].trim()),!i))continue;if(/^(insertRow|updateRow|deleteRow)\s*\(/.test(i)&&!n?(s&&r.push(s),s=i):s+=(s?" ":"")+i,s){let d=(s.match(/\{/g)||[]).length,c=(s.match(/\}/g)||[]).length;n=d>c}}s&&r.push(s);let o=[];for(let a of r){let i=/(?:^|;\s*)((?:insertRow|deleteRow|updateRow)\s*\()/g,l=[],d;for(;(d=i.exec(a))!==null;)l.push(d.index+(d[0].length-d[1].length));if(l.length<=1)o.push(a.replace(/;\s*$/,""));else for(let c=0;c<l.length;c++){let u=l[c],p=c+1<l.length?l[c+1]:a.length,y=a.substring(u,p).replace(/;\s*$/,"").trim();y&&o.push(y)}}return o}function eT(t){try{let e=t;if(e.match(/\)\s*;?\s*\/\/.*$/)&&(e=e.replace(/\/\/.*$/,"").trim()),!e)return null;let r=e.match(/^(insertRow|deleteRow|updateRow)\s*\((.*)\);?$/);if(!r)return null;let s=r[1],n=r[2],o=n.indexOf("{");if(o===-1)return{command:s,args:JSON.parse(`[${n}]`),line:e};let a=n.substring(0,o).trim(),i=n.substring(o),l=JSON.parse(`[${a.replace(/,$/,"")}]`);try{return{command:s,args:[...l,JSON.parse(i)],line:e}}catch{}let d=Ng(i);if(d.success)return{command:s,args:[...l,d.result],line:e};let c=No(i);if(!c.success)return null;try{return{command:s,args:[...l,JSON.parse(c.result)],line:e}}catch{}let u=Ng(c.result);return u.success?{command:s,args:[...l,u.result],line:e}:null}catch{return null}}function tT(t){if(!t)return null;let{command:e,args:r}=t;if(e==="insertRow"){let s=typeof r[0]=="number"?r[0]:0,n=typeof r[1]=="object"&&r[1]!==null?r[1]:{};return{op:e,tableIndex:s,data:n}}if(e==="deleteRow"){let s=typeof r[0]=="number"?r[0]:0,n=typeof r[1]=="number"?r[1]:0;return{op:e,tableIndex:s,rowIndex:n}}if(e==="updateRow"){let s=typeof r[0]=="number"?r[0]:0,n=typeof r[1]=="number"?r[1]:0,o=typeof r[2]=="object"&&r[2]!==null?r[2]:{};return{op:e,tableIndex:s,rowIndex:n,data:o}}return null}function qc(t){let e=QS(t);if(!e.length)return null;let r=[],s=[];for(let n of e){let o=n.replace(/<!--|-->/g,"").trim();if(!o)continue;let a=ZS(o);for(let i of a){let l=eT(i),d=tT(l);d?r.push(d):i&&/^(insertRow|updateRow|deleteRow)/.test(i)&&s.push(i.slice(0,200))}}if(s.length>0)try{console.warn("[TableJsonSanitizer] parseIncrementalEdits: %d \u6761\u6307\u4EE4\u89E3\u6790\u5931\u8D25",s.length,s)}catch{}return r.length?r:null}function Yc(t){Mg.lastIndex=0;let e;for(;(e=Mg.exec(t))!==null;){let m=e[1].trim();if(m)try{return JSON.parse(m)}catch{let h=No(m);if(h.success)try{return JSON.parse(h.result)}catch{}}}let r=t.trim();try{return JSON.parse(r)}catch{}let s=No(r);if(s.success)try{return JSON.parse(s.result)}catch{}let n=r.indexOf("{"),o=r.indexOf("["),a=-1,i="",l="";if(n!==-1&&(o===-1||n<o)?(a=n,i="{",l="}"):o!==-1&&(a=o,i="[",l="]"),a===-1)return null;let d=0,c=-1,u=!1,p=!1;for(let m=a;m<r.length;m++){let g=r[m];if(p){p=!1;continue}if(g==="\\"&&u){p=!0;continue}if(g==='"'){u=!u;continue}if(!u){if(g===i)d++;else if(g===l&&(d--,d===0)){c=m;break}}}if(c===-1)return null;let y=r.substring(a,c+1);try{return JSON.parse(y)}catch{let g=No(y);if(g.success)try{return JSON.parse(g.result)}catch{}}return null}function Dg(t){if(!t||typeof t!="string")return{mode:"empty",edits:null,tables:null};let e=qc(t);if(e)return{mode:"incremental",edits:e,tables:null};let r=Yc(t);if(r){let s=null;if(Array.isArray(r))s=r;else if(r&&Array.isArray(r.tables))s=r.tables;else if(r&&typeof r=="object"){for(let n of Object.values(r))if(Array.isArray(n)){s=n;break}}if(Array.isArray(s))return{mode:"full",edits:null,tables:s}}return{mode:"empty",edits:null,tables:null}}var Rg,Mg,gi=D(()=>{Rg=/<tableEdit>([\s\S]*?)<\/tableEdit>/gi,Mg=/```(?:json)?\s*([\s\S]*?)```/gi});var rT,sT,Lg,Og=D(()=>{gi();rT=/<tableEdit>[\s\S]*?<\/tableEdit>/i,sT=/(insertRow|updateRow|deleteRow)\s*\(/,Lg=Object.freeze({formatId:"dsl",displayName:"<tableEdit> DSL \u589E\u91CF\u534F\u8BAE",detect(t){return!t||typeof t!="string"?!1:rT.test(t)||sT.test(t)},parse(t){let e=qc(t);return!Array.isArray(e)||e.length===0?null:{mode:"incremental",edits:e,tables:null}}})});function Bg(t){if(typeof t!="string")return t;let e=t.trim();return e.startsWith("'")&&e.endsWith("'")||e.startsWith('"')&&e.endsWith('"')?e.slice(1,-1).replace(/''/g,"'").replace(/\\'/g,"'"):e}function Vc(t){let e=String(t||"").match(/(\d+)$/);return e?parseInt(e[1],10):0}function zg(t){let e=String(t||"").match(/row_id\s*=\s*(\d+)/i);return e?parseInt(e[1],10):-1}function nT(t){let e=t.match(/INSERT\s+INTO\s+(\S+)\s*\(([^)]*)\)\s*VALUES\s*\(([^)]*)\)/i);if(!e)return null;let r=e[1],s=e[2],n=e[3],o=s.split(",").map(l=>l.trim()),a=n.split(",").map(l=>Bg(l.trim())),i={};return o.forEach((l,d)=>{l!=="row_id"&&a[d]!==void 0&&(i[l]=a[d])}),{op:"insertRow",tableIndex:Vc(r),data:i}}function oT(t){let e=t.match(/UPDATE\s+(\S+)\s+SET\s+([\s\S]+?)\s+WHERE\s+([\s\S]+?);?$/i);if(!e)return null;let r=e[1],s=e[2],n=e[3],o={},a=s.split(/,(?![^()]*\))/);for(let i of a){let l=i.indexOf("=");if(l<0)continue;let d=i.slice(0,l).trim(),c=Bg(i.slice(l+1).trim());d&&d!=="row_id"&&(o[d]=c)}return{op:"updateRow",tableIndex:Vc(r),rowIndex:zg(n),data:o}}function aT(t){let e=t.match(/DELETE\s+FROM\s+(\S+)\s+WHERE\s+([\s\S]+?);?$/i);return e?{op:"deleteRow",tableIndex:Vc(e[1]),rowIndex:zg(e[2])}:null}function iT(t){let e=[];$g.lastIndex=0;let r;for(;(r=$g.exec(t))!==null;){let s=r[0].trim(),n=null;/^INSERT/i.test(s)?n=nT(s):/^UPDATE/i.test(s)?n=oT(s):/^DELETE/i.test(s)&&(n=aT(s)),n&&e.push(n)}return e}var Do,$g,Kg,Ug=D(()=>{Do=/<sql>([\s\S]*?)<\/sql>/gi,$g=/(INSERT\s+INTO\s+\S+[\s\S]*?;)|(UPDATE\s+\S+\s+SET[\s\S]*?;)|(DELETE\s+FROM\s+\S+[\s\S]*?;)/gi;Kg=Object.freeze({formatId:"sql",displayName:"SQL \u534F\u8BAE\uFF08INSERT/UPDATE/DELETE\uFF09",detect(t){return!t||typeof t!="string"?!1:Do.test(t)?(Do.lastIndex=0,!0):(Do.lastIndex=0,/\b(INSERT\s+INTO|UPDATE\s+\S+\s+SET|DELETE\s+FROM)\b/i.test(t))},parse(t){let e="";Do.lastIndex=0;let r,s=[];for(;(r=Do.exec(t))!==null;)s.push(r[1]);s.length>0?e=s.join(`
`):e=t;let n=iT(e);return!Array.isArray(n)||n.length===0?null:{mode:"incremental",edits:n,tables:null}}})});var Fg,jg=D(()=>{gi();Fg=Object.freeze({formatId:"full-json",displayName:"JSON envelope \u5168\u91CF\u534F\u8BAE",detect(t){return!t||typeof t!="string"?!1:/```json/i.test(t)||/\{[\s\S]*?"tables"\s*:/i.test(t)},parse(t){let e=Yc(t);if(!e)return null;let r=null;if(Array.isArray(e))r=e;else if(e&&Array.isArray(e.tables))r=e.tables;else if(e&&typeof e=="object"){for(let s of Object.values(e))if(Array.isArray(s)){r=s;break}}return!Array.isArray(r)||r.length===0?null:{mode:"full",edits:null,tables:r}}})});function mi(){return Jc||(Jc=E.createScope("AiProtocolAdapter")),Jc}function Wg(t){if(!t||typeof t!="string")return null;for(let e of lT){let r=!1;try{r=e.detect(t)}catch(s){mi().warn(`adapter ${e.formatId} detect \u629B\u9519`,s);continue}if(r)try{let s=e.parse(t);if(s&&(s.mode==="incremental"||s.mode==="full")&&(s.mode==="incremental"&&Array.isArray(s.edits)&&s.edits.length>0||s.mode==="full"&&Array.isArray(s.tables)&&s.tables.length>0))return mi().info("AI \u534F\u8BAE\u9002\u914D\u5668\u547D\u4E2D",{formatId:e.formatId,mode:s.mode,editsCount:s.edits?.length,tablesCount:s.tables?.length}),{...s,rawFormat:e.formatId}}catch(s){mi().warn(`adapter ${e.formatId} parse \u629B\u9519\uFF0C\u5C1D\u8BD5\u4E0B\u4E00\u4E2A`,s)}}return mi().warn("parseAiResponseAuto: \u65E0\u9002\u914D\u5668\u547D\u4E2D",{responseLength:t.length}),null}var Jc,lT,Hg=D(()=>{H();Og();Ug();jg();lT=Object.freeze([Lg,Kg,Fg])});function cT(t,e){let r=new Map;Array.isArray(t)&&t.forEach((o,a)=>{o&&typeof o=="object"&&r.set(o.name||`__row_${a}`,o)});let s=new Map;Array.isArray(e)&&e.forEach((o,a)=>{o&&typeof o=="object"&&s.set(o.name||`__row_${a}`,o)});let n={};for(let[o,a]of s){let i=r.get(o);if(i){n[o]={};let l=new Set([...Object.keys(i.cells||{}),...Object.keys(a.cells||{})]);for(let d of l){let c=String((i.cells&&i.cells[d])??""),u=String((a.cells&&a.cells[d])??"");n[o][d]=c===u?"unchanged":"updated"}n[o].__rowStatus="kept"}else{if(n[o]={},a.cells&&typeof a.cells=="object")for(let l of Object.keys(a.cells))n[o][l]="new";n[o].__rowStatus="new"}}for(let[o]of r)s.has(o)||(n[o]={__rowStatus:"deleted"});return n}function Gg(t,e){let r=Array.isArray(t)?ce(t):[],s=Array.isArray(e)?ce(e):[],n={},o=Math.max(r.length,s.length);for(let a=0;a<o;a++){let i=r[a],l=s[a];!i&&l?(n[a]={},Array.isArray(l.rows)&&l.rows.forEach(d=>{let c=d.name||`__row_${l.rows.indexOf(d)}`;n[a][c]={__rowStatus:"new"}})):i&&!l?(n[a]={},Array.isArray(i.rows)&&i.rows.forEach(d=>{let c=d.name||`__row_${i.rows.indexOf(d)}`;n[a][c]={__rowStatus:"deleted"}})):i&&l&&(n[a]=cT(i.rows,l.rows))}return n}var qg=D(()=>{He()});function dT(){return{mode:"native",async buildRequest(t={},e={}){if(typeof t.buildRequest!="function")throw new Error("table_provider_missing_build_request");return t.buildRequest(e)},async sendRequest(t={},e=null,r={}){if(typeof t.sendRequest!="function")throw new Error("table_provider_missing_send_request");return t.sendRequest(e?.messages||[],r.config||{},r.abortSignal||null)},parseResponse(t={},e=""){if(typeof t.parseResponse!="function")throw new Error("table_provider_missing_parse_response");return t.parseResponse(e)}}}function Yg(){return dT()}var Vg=D(()=>{});function pT(){return Xc||(Xc=E.createScope("TableLock")),Xc}function Ks(t){return t!==null&&typeof t=="object"&&!Array.isArray(t)}function Qg(){let t=Xg.get(Jg,{});return Ks(t)?t:{}}function yT(t){Xg.set(Jg,t)}function Lo(t){let e=Qg();return Ks(e[t])?e[t]:{}}function Qc(t,e){let r=Qg();r[t]=e,yT(r),fT(t,e).catch(()=>{})}async function fT(t,e){try{let{chatKey:r,isolationKey:s}=(()=>{let o=String(t||"").indexOf("::");return o===-1?{chatKey:String(t||""),isolationKey:""}:{chatKey:t.slice(0,o),isolationKey:t.slice(o+2)}})();if(!r)return;let n=await Promise.resolve().then(()=>(Ba(),lc));await n.ensureTableDataReady(),await n.clearScopeLocks({chatId:r,isolationKey:s});for(let[o,a]of Object.entries(e||{})){if(!Ks(a))continue;let i={chatId:r,isolationKey:s};if(Array.isArray(a.rows))for(let l of a.rows)Number.isFinite(l)&&await n.setLockEntry(i,o,"row",String(l));if(Array.isArray(a.cols))for(let l of a.cols)typeof l=="string"&&l&&await n.setLockEntry(i,o,"column",l);if(Array.isArray(a.cells))for(let l of a.cells)typeof l=="string"&&l.includes(":")&&await n.setLockEntry(i,o,"cell",l);a.indexColumn===!0&&await n.setLockEntry(i,o,"index_column","")}}catch(r){pT().warn("lock-service SQL \u955C\u50CF\u5931\u8D25\uFF08\u4E0D\u5F71\u54CD\u4E3B\u6D41\u7A0B\uFF09",{error:r?.message||String(r)})}}function Oo(t){let e=Qp();return Ks(t)&&(Array.isArray(t.rows)&&(e.rows=Array.from(new Set(t.rows.filter(r=>Number.isFinite(r)).map(r=>Math.floor(r)))),e.rows.sort((r,s)=>r-s)),Array.isArray(t.cols)&&(e.cols=Array.from(new Set(t.cols.filter(r=>typeof r=="string"&&r.length>0)))),Array.isArray(t.cells)&&(e.cells=Array.from(new Set(t.cells.filter(r=>typeof r=="string"&&r.includes(":"))))),e.indexColumn=t.indexColumn===!0),e}function $o(t){if(typeof t=="string")return t;if(Ks(t)){if(typeof t.scopeKey=="string"&&t.scopeKey.includes("::"))return t.scopeKey;if(t.chatId!==void 0){let e=t.isolationKey!==void 0?t.isolationKey:de.getKey();return co(t.chatId,e)}}return co("",de.getKey())}function gT(t,e){let r=Lo(t),s={};if(!Array.isArray(e))return s;for(let n=0;n<e.length;n++){let o=e[n];if(!o)continue;let a=o.uid||o.id||"";a&&r[a]&&(s[n]=Oo(r[a]))}return s}function Pn(t,e){let r=$o(t),s=Lo(r);return Oo(s[e])}function Zg(t,e,r,s=!0){if(!e||!Number.isFinite(r))return!1;let n=$o(t),o=Lo(n),a=Oo(o[e]),i=Math.floor(r),l=a.rows.includes(i);if(s&&!l)a.rows.push(i),a.rows.sort((d,c)=>d-c);else if(!s&&l)a.rows=a.rows.filter(d=>d!==i);else return!1;return o[e]=a,Qc(n,o),!0}function em(t,e,r,s=!0){if(!e||!r)return!1;let n=$o(t),o=Lo(n),a=Oo(o[e]),i=a.cols.includes(r);if(s&&!i)a.cols.push(r);else if(!s&&i)a.cols=a.cols.filter(l=>l!==r);else return!1;return o[e]=a,Qc(n,o),!0}function tm(t,e,r,s,n=!0){if(!e||!s||!Number.isFinite(r))return!1;let o=$o(t),a=Lo(o),i=Oo(a[e]),l=Zp(r,-1)==="-1:-1"?`${r}:${s}`:`${r}:${s}`,d=`${Math.floor(r)}:${s}`,c=i.cells.includes(d);if(n&&!c)i.cells.push(d);else if(!n&&c)i.cells=i.cells.filter(u=>u!==d);else return!1;return a[e]=i,Qc(o,a),!0}function rm(t,e=[]){let r=$o(t);return gT(r,e)}function sm(t,e,r,s){if(!Ks(t))return!1;let n=t[e];if(!n)return!1;if(Number.isFinite(r)&&n.rows.includes(r)||typeof s=="string"&&s.length>0&&n.cols.includes(s))return!0;if(Number.isFinite(r)&&typeof s=="string"&&s.length>0){let o=`${r}:${s}`;if(n.cells.includes(o))return!0}return!1}function Zc(t,e,r){if(!Ks(t))return!1;let s=t[e];return s?Number.isFinite(r)&&s.rows.includes(r):!1}var uT,Jg,Xc,Xg,ed=D(()=>{je();H();He();qr();uT="tableLocks",Jg="scopes";Xg=$.namespace(uT)});function mT(){return td||(td=E.createScope("TableAutoSchedule")),td}function om(t,e,r){let s=Ae(e||Tt);return`${String(t||"")}::${s}::${String(r||"")}`}function hT(t,e,r){if(!r)return null;let s=nm.get(om(t,e,r),null);return s&&typeof s=="object"?s:null}function bT(t,e,r,s){if(!r)return;let n=Number.isFinite(s)?s:-1;nm.set(om(t,e,r),{lastMessageIndex:n,lastUpdatedAt:new Date().toISOString()})}function am(t,e,r=[],s){for(let n of r)bT(t,e,n,s)}function im({chatId:t,isolationKey:e,currentMessageIndex:r,scopeTables:s=[]}){let n=new Set,o={};for(let a of s){let i=a?.id||a?.uid||"";if(!i)continue;if(a?.enabled===!1){o[i]="disabled";continue}let l=a?.updateConfig?.updateFrequency;if(!Number.isFinite(l)||l===-1){n.add(i);continue}if(l===0){o[i]="frequency_zero";continue}if(l>=1){let d=hT(t,e,i);if(!d||!Number.isFinite(d.lastMessageIndex)){n.add(i);continue}let c=r-d.lastMessageIndex;c>=l?n.add(i):o[i]=`frequency_not_met (${c}/${l})`}else n.add(i)}return mT().info("buildAutoSchedulePlan",{chatId:t,isolationKey:e,currentMessageIndex:r,shouldUpdateCount:n.size,skipReasonsCount:Object.keys(o).length,shouldUpdateTables:[...n],skipReasons:o}),{shouldUpdate:n,skipReasons:o}}var nm,td,lm=D(()=>{je();H();He();nm=$.namespace("tableAutoSchedule")});function xT(t){let e=Wg(t);return e&&(e.mode==="incremental"||e.mode==="full")?e:Dg(t)}function be(){return E.createScope("TableUpdate")}function vT(t,e){return new Promise(r=>{if(e?.aborted){r(!1);return}let s,n=()=>{clearTimeout(s);try{e?.removeEventListener?.("abort",n)}catch{}r(!1)};s=setTimeout(()=>{try{e?.removeEventListener?.("abort",n)}catch{}r(!0)},t);try{e?.addEventListener?.("abort",n)}catch{}})}function V(t,e=""){return t==null?e:String(t).trim()||e}function cm(t=[],e=8,r="all"){if(!Array.isArray(t)||t.length===0)return"";let s=r==="assistant_only"?t.filter(n=>n?.role==="assistant"):t;return s.slice(Math.max(s.length-e,0)).map(n=>`[${V(n?.role,"unknown")}] ${String(n?.content||"").trim()}`).filter(Boolean).join(`

`)}function dm(t,{extractTags:e=[],useGlobalRules:r=!1,regexPresetId:s=""}={}){if(!t)return t;let n=Array.isArray(e)&&e.length>0,o=typeof s=="string"&&s.trim().length>0;if(!n&&!r&&!o)return t;try{let a=[],i=[];if(o)try{let l=Ee.getPreset(s);if(l){let d=Array.isArray(l.rules)?l.rules.filter(c=>c&&c.enabled!==!1&&c.value):[];a.push(...d),Array.isArray(l.blacklist)&&i.push(...l.blacklist.map(c=>String(c||"").trim()).filter(Boolean))}else be().warn("applyContextExtractionRules: \u627E\u4E0D\u5230\u6B63\u5219\u9884\u8BBE",{regexPresetId:s})}catch(l){be().warn("applyContextExtractionRules: \u52A0\u8F7D\u6B63\u5219\u9884\u8BBE\u5931\u8D25",l)}if(n&&a.push(...e.map(l=>{let d=String(l||"").trim();return d.startsWith("regex:")?{type:"regex_include",value:d.slice(6).trim(),enabled:!0}:{type:"include",value:d,enabled:!0}}).filter(l=>l.value)),r){let l=Js()||[];a=[...a,...l.filter(d=>d?.enabled)],i=[...i,...Xs()||[]]}return a.length===0&&i.length===0?t:xr(t,a,i)||t}catch(a){return be().warn("applyContextExtractionRules \u5931\u8D25\uFF0C\u56DE\u9000\u539F\u59CB\u6587\u672C",a),t}}function ST(t=[],e=-1){return!Number.isFinite(e)||e<0?t:t.map(r=>{let s=Array.isArray(r?.rows)?r.rows:[];return e===0||s.length<=e?r:{...r,rows:s.slice(s.length-e)}})}function TT(t=[]){return!Array.isArray(t)||t.length===0?"":t.map((e,r)=>{let s=e?.aiInstructions&&typeof e.aiInstructions=="object"?e.aiInstructions:{},n=Array.isArray(e?.columns)?e.columns:[],o=[`\u8868 ${r}: ${V(e?.name,`\u8868${r+1}`)}`,`\u8868\u683C\u8BF4\u660E: ${V(e?.note,"\u65E0")}`,`\u521D\u59CB\u5316\u8BF4\u660E: ${V(s.init,"\u65E0")}`,`\u65B0\u589E\u8BF4\u660E: ${V(s.create,"\u65E0")}`,`\u66F4\u65B0\u8BF4\u660E: ${V(s.update,"\u65E0")}`,`\u5220\u9664\u8BF4\u660E: ${V(s.delete,"\u65E0")}`,"\u5B57\u6BB5\uFF08\u8BF7\u7528\u5217\u7D22\u5F15\u4F5C\u4E3A data key\uFF09:"];return n.forEach((a,i)=>{o.push(`- [${i}]: ${V(a?.title||a?.key,"\u672A\u547D\u540D\u5B57\u6BB5")} \u2014 ${V(a?.description,"\u65E0")}`)}),o.join(`
`)}).join(`

`)}function _T(t,e=[]){if(!t||!Array.isArray(e)||e.length===0)return"";let r=e.map((n,o)=>{let a=V(n?.name,`\u8868${o+1}`),i=t.includes(n,o);return`\u8868 ${o}: ${a} - ${i?"\u5141\u8BB8\u7F16\u8F91":"\u53EA\u8BFB\uFF0C\u7981\u6B62\u4FEE\u6539"}`});return e.some((n,o)=>!t.includes(n,o))&&(r.push(""),r.push('\u3010\u91CD\u8981\u7EA6\u675F\u3011\u6807\u8BB0\u4E3A"\u53EA\u8BFB"\u7684\u8868\u683C\uFF0C\u4F60\u5FC5\u987B\u5728\u8F93\u51FA\u4E2D\u539F\u6837\u4FDD\u7559\u5176\u6240\u6709\u884C\u6570\u636E\uFF0C\u4E0D\u5F97\u65B0\u589E\u3001\u4FEE\u6539\u6216\u5220\u9664\u4EFB\u4F55\u884C\u3002'),r.push("\u5168\u91CF\u8F93\u51FA\u65F6\uFF0C\u53EA\u8BFB\u8868\u683C\u7684 rows \u5FC5\u987B\u4E0E\u8F93\u5165\u4E2D\u7684\u5B8C\u5168\u4E00\u81F4\u3002")),r.join(`
`)}function ym(t={},e=0,r=[]){let s=t&&typeof t=="object"?t:{},n=s.cells&&typeof s.cells=="object"&&!Array.isArray(s.cells)?s.cells:{},o={},a=Array.isArray(r)?r.map(l=>V(l?.key,"")).filter(Boolean):[];return new Set([...Object.keys(n),...a]).forEach(l=>{o[l]=V(n[l],"")}),{...s,id:io(s.id||s.rowId,e),name:V(s.name,""),cells:o}}function Fs(t={},e=0){let r=t&&typeof t=="object"?t:{},s=Array.isArray(r.columns)?ce(r.columns):[],n=Array.isArray(r.rows)?r.rows.map((o,a)=>ym(o,a,s)):[];return{...r,id:Jt(r.id||r.key,e),rows:n}}function hr(t=[]){return Array.isArray(t)?t.map((e,r)=>Fs(e,r)):[]}function ET(t=[],e=[],r){let s=hr(t),n=hr(e);if(!r)return n;let o=new Map(n.map((u,p)=>[Jt(u?.id||u?.key,p),u])),a=s.map((u,p)=>({table:u,tableIndex:p,id:Jt(u?.id||u?.key,p)})).filter(({table:u,tableIndex:p})=>r.includes(u,p)),i=new Set,l=new Map;for(let u=0;u<n.length;u++){let p=n[u],y=Jt(p?.id||p?.key,u);o.has(y)&&(l.set(y,p),i.add(y))}let d=0,c=n.filter((u,p)=>{let y=Jt(u?.id||u?.key,p);return!i.has(y)});return s.map((u,p)=>{let y=Jt(u?.id||u?.key,p);if(!r.includes(u,p))return Fs(u,p);let m=l.get(y);if(m)return Fs(m,p);let g=c[d];return g?(d++,Fs({...g,id:u.id||g.id},p)):Fs(u,p)})}function AT(t=[],e=[],r,s={}){if(!Array.isArray(t)||!r)return{edits:[],stats:{total:0,passed:0,droppedByScope:0,droppedByLock:0}};let n=hr(e),o=[],a=0,i=0;for(let l of t){let d=Number.isFinite(l?.tableIndex)?l.tableIndex:-1;if(d<0||d>=n.length){a++;continue}let c=n[d];if(!r.includes(c,d)){a++;continue}if(l.op===dn.INSERT_ROW){o.push(l);continue}let u=Number.isFinite(l?.rowIndex)?l.rowIndex:-1;if(u<0||u>=(Array.isArray(c?.rows)?c.rows.length:0)){a++;continue}if(l.op===dn.DELETE_ROW){if(Zc(s,d,u)){i++;continue}o.push(l);continue}o.push(l)}return{edits:o,stats:{total:t.length,passed:o.length,droppedByScope:a,droppedByLock:i}}}function CT(t=[],e){let r=hr(t);return e?r.map((s,n)=>{let o=Array.isArray(s?.columns)?s.columns:[];return e.includes(s,n)?{...Fs(s,n),scopeEditable:!0,scopeStatus:"editable"}:{...Fs(s,n),scopeEditable:!1,scopeStatus:"readonly",rows:Array.isArray(s?.rows)?s.rows.map((a,i)=>ym(a,i,o)):[]}}):r}function kT(t,e,r){return{target:{sourceMessageId:V(t?.sourceMessageId),sourceSwipeId:V(t?.sourceSwipeId||t?.effectiveSwipeId),slotBindingKey:V(t?.slotBindingKey),slotRevisionKey:V(t?.slotRevisionKey),slotTransactionId:V(t?.slotTransactionId)},loadMode:V(e?.loadMode),mergeBaseOnly:e?.mergeBaseOnly===!0,resolvedFromMessageId:V(e?.resolvedFromMessageId),resolvedFromRevisionKey:V(e?.resolvedFromRevisionKey),sourceKind:V(e?.sourceKind||e?.state?.meta?.sourceKind),scope:typeof r?.toJSON=="function"?r.toJSON():null,tables:CT(e?.state?.tables,r)}}function um(){return IT}function pm(t,e){if(!t||typeof t!="string")return{key:t,source:"fallback"};if(!Array.isArray(e)||e.length===0)return{key:t,source:"fallback"};for(let s of e)if(s?.key===t)return{key:t,source:"direct"};if(/^\d+$/.test(t)){let s=parseInt(t,10);if(s>=0&&s<e.length&&e[s]?.key)return{key:e[s].key,source:"index"}}let r=t.match(/^col(?:_(\d+))?$/i);if(r){let s=r[1]?parseInt(r[1],10)-1:0;if(s>=0&&s<e.length&&e[s]?.key)return{key:e[s].key,source:"col_n"}}return{key:t,source:"fallback"}}function RT(t,e,r,s=null){let n=hr(t||[]),o=r||{},a={direct:0,index:0,col_n:0,fallback:0},i={},l={};if(Array.isArray(e))for(let d of e){let c=Number.isFinite(d?.tableIndex)?d.tableIndex:-1;i[c]=(i[c]||0)+1,l[d?.op||"unknown"]=(l[d?.op||"unknown"]||0)+1}be().info("applyIncrementalEdits \u603B\u89C8",{totalEdits:e?.length||0,tableCount:n.length,editsByTable:i,editsByOp:l});for(let d of e){let c=d.tableIndex;if(c<0||c>=n.length)continue;let u=n[c];if(!u||!Array.isArray(u.rows)||s&&!s.includes(u,c))continue;if(d.op===dn.INSERT_ROW){let y={id:ao("row"),name:"",cells:{}};if(d.data&&typeof d.data=="object"){y.name=V(d.data.name,"");let g=Array.isArray(u.columns)?u.columns:[];for(let[h,x]of Object.entries(d.data)){if(h==="name")continue;let{key:T,source:S}=pm(h,g);y.cells[T]=V(x),a[S]=(a[S]||0)+1}}Object.keys(y.cells).length===0&&!y.name&&be().warn("applyIncrementalEdits: \u63D2\u5165\u7A7A\u884C\uFF08data \u89E3\u6790\u4E3A\u7A7A\uFF09",{tableIndex:c,tableName:u.name,editDataKeys:d.data?Object.keys(d.data):[],editDataPreview:JSON.stringify(d.data||{}).slice(0,200)}),u.rows.push(y);continue}let p=d.rowIndex;if(!(p<0||p>=u.rows.length)){if(d.op===dn.DELETE_ROW){if(Zc(o,c,p))continue;u.rows.splice(p,1);continue}if(d.op===dn.UPDATE_ROW){let y=u.rows[p];if(!y)continue;if(y.id=io(y.id||y.rowId,p),y.cells=y.cells||{},d.data&&typeof d.data=="object"){let m=Array.isArray(u.columns)?u.columns:[];for(let[g,h]of Object.entries(d.data)){if(g==="name")continue;let{key:x,source:T}=pm(g,m);sm(o,c,p,x)||(y.cells[x]=V(h),a[T]=(a[T]||0)+1)}d.data.name!==void 0&&(y.name=V(d.data.name,y.name))}}}}return Object.values(a).some(d=>d>0)&&be().info("\u5217 key \u89E3\u6790\u7EDF\u8BA1",a),hr(n)}async function MT({executionContext:t,targetSnapshot:e,loadResult:r,config:s,assistantSnapshot:n,fillMode:o,runScope:a}={}){let i=Ft(s),l=o==="incremental"||!o&&i.fillMode!=="full",d=my(i,{skipResponseContract:l}),c=kT(e,r,a),u=Array.isArray(n?.tableState?.tables)?hr(n.tableState.tables):[],p=t?.chatHistory||t?.chatMessages||[],{contextDepth:y,contextRoles:m,contextExtractTags:g,contextUseGlobalRules:h,sendLatestRows:x}=i,T=i?.extraction?.regexPresetId||"",S=cm(p,y,m),A=cm(p,y,"all"),C=dm(S,{extractTags:g,useGlobalRules:h,regexPresetId:T}),w=dm(A,{extractTags:g,useGlobalRules:h,regexPresetId:T}),P=await ca({worldbooks:i.worldbooks}),B=ST(c.tables,x),z={...c,tables:B},R={...t,toolName:"\u586B\u8868\u5DE5\u4F5C\u53F0",toolId:"tableWorkbench",lastAiMessage:t?.assistantBaseText||t?.lastAiMessage||"",recentMessagesText:C,rawRecentMessagesText:w,toolWorldbookContent:P,tableGuidance:TT(i.tables),tableScopeGuidance:_T(a,c.tables),injectedContext:n?.injectedContext||Dt.getLatestMessageInjectedContext(e?.sourceMessageId),toolContentMacro:JSON.stringify(z,null,2),extractedContent:JSON.stringify(z,null,2),previousToolOutput:JSON.stringify(u,null,2)},_=await Ls.buildToolMessages(d,R),M=await Ls.buildPromptText(d,R);if(l&&(M+=um(),Array.isArray(_)&&_.length>0)){let q=_[_.length-1];q&&typeof q.content=="string"&&(q.content+=um())}if(!Array.isArray(_)||_.length===0)throw new Error("\u586B\u8868\u8BF7\u6C42\u6D88\u606F\u6784\u5EFA\u5931\u8D25\u3002");let j=i.apiPreset||"";try{let q=Array.isArray(c?.tables)?c.tables:[],ue=q.filter(pe=>pe?.scopeEditable!==!1).map(pe=>V(pe?.updateConfig?.apiPreset,"")).filter(Boolean);ue.length>0&&ue.every(pe=>pe===ue[0])&&(j=ue[0],be().info("L3: \u8868\u7EA7 API \u9884\u8BBE\u751F\u6548",{preset:j,affectedTables:q.filter(pe=>pe?.scopeEditable!==!1).map(pe=>pe?.name||pe?.id)}))}catch(q){be().warn("L3 \u8868\u7EA7 API \u9884\u8BBE\u89E3\u6790\u5931\u8D25\uFF0C\u7528\u5168\u5C40",q)}return{toolConfig:d,context:R,requestPayload:c,promptText:M,messages:_,fillMode:l?"incremental":"full",effectiveApiPreset:j,runScope:typeof a?.toJSON=="function"?a.toJSON():null}}async function PT(t,e={},r=null){let s=Ft(e),n=V(e?._effectiveApiPreset||s.apiPreset,"");if(n){if(!jn(n))throw new Error(`API \u9884\u8BBE\u4E0D\u5B58\u5728: ${n}`);return Fi(n,t,{},r)}return Wn(t,{},r)}function kr({status:t=Ce.IDLE,targetSnapshot:e=null,skipReason:r="",startedAt:s=Date.now(),error:n=""}={}){return{lastAutoRunAt:s,lastAutoStatus:V(t,Ce.IDLE),lastAutoMessageId:V(e?.sourceMessageId,""),lastAutoRevisionKey:V(e?.slotRevisionKey,""),lastAutoSkipReason:V(r,""),...n?{lastError:n,lastErrorDetails:[n]}:{}}}function mr(t={},e=st.MANUAL){let r=t&&typeof t=="object"?t:{};return Object.keys(r).length?gy(r):null}function Us({targetSnapshot:t=null,startedAt:e=Date.now(),status:r="idle",skipReason:s="",warning:n="",writeback:o=null,aborted:a=!1,stale:i=!1,abortReason:l="",error:d=""}={}){return{isAutoRun:!0,status:r,startedAt:e,targetSnapshot:t,sourceMessageId:V(t?.sourceMessageId,""),sourceSwipeId:V(t?.sourceSwipeId||t?.effectiveSwipeId,""),slotRevisionKey:V(t?.slotRevisionKey,""),writebackStatus:o?.success===!0?"success":n?"warning":"",refreshConfirmed:o?.mirrorResult?.refreshConfirmed===!0,warning:V(n,""),skipReason:V(s,""),aborted:a===!0,stale:i===!0,abortReason:V(l,""),error:V(d,"")}}function bi(t=null){if(t?.signal?.aborted)return{aborted:!0,stale:!1,reason:"cancelled_before_host_commit"};if(typeof t?.shouldAbortWriteback=="function")try{return t.shouldAbortWriteback()||!1}catch{return{aborted:!0,stale:!0,reason:"stale_base_changed"}}return!1}async function Bo(t=null,e={}){return gm({configInput:t,runSource:st.MANUAL,clearBeforeUpdate:e?.clearBeforeUpdate===!0,executionContextBuilder:()=>bs({runSource:st.MANUAL}),targetResolver:r=>ko(r,{runSource:st.MANUAL})})}async function fm({messageId:t,swipeId:e="",sourceEvent:r="AUTO_TABLE",configInput:s=null,signal:n=null,shouldAbortWriteback:o=null}={}){return gm({configInput:s,runSource:st.AUTO,autoMeta:{sourceEvent:r,messageId:V(t,""),swipeId:V(e,""),signal:n,shouldAbortWriteback:o},executionContextBuilder:()=>xs({messageId:t,swipeId:e,runSource:st.AUTO}),targetResolver:a=>ko(a,{runSource:st.AUTO})})}async function gm({configInput:t=null,runSource:e=st.MANUAL,executionContextBuilder:r,targetResolver:s,autoMeta:n=null,clearBeforeUpdate:o=!1}={}){let a=Ft(t||Pe()),i=Gl(a),l=Ra({tables:Array.isArray(a.tables)?a.tables:[]}),d=e===st.AUTO,c=Date.now();if(be().info(`\u5F00\u59CB\u586B\u8868 [${e}]`,{isAutoRun:d,fillMode:a.fillMode}),!i.valid||!l.valid){let g=[...i.errors,...l.errors];return be().error("\u914D\u7F6E\u6821\u9A8C\u5931\u8D25",{errors:g}),mr({lastStatus:Ce.ERROR,lastRunAt:c,lastDurationMs:0,lastError:g[0]||"\u586B\u8868\u914D\u7F6E\u65E0\u6548\u3002",lastErrorDetails:g,lastValidationSummary:l.summary||{errorCount:g.length,warningCount:0},errorCount:Number(a?.runtime?.errorCount)||0,...d?kr({status:Ce.ERROR,startedAt:c,skipReason:"invalid_config",error:g[0]||"\u586B\u8868\u914D\u7F6E\u65E0\u6548\u3002"}):{}},e),{success:!1,error:g.join(`
`),errors:g,...d?{meta:Us({startedAt:c,status:Ce.ERROR,skipReason:"invalid_config",error:g[0]||"\u586B\u8868\u914D\u7F6E\u65E0\u6548\u3002"})}:{}}}let u=a.runtime||{},p=Array.isArray(a.tables)?a.tables:[];try{let h=Sn({})?.template?.tables;if(Array.isArray(h)&&h.length>0){let x=a.tableEnabledOverrides&&typeof a.tableEnabledOverrides=="object"?a.tableEnabledOverrides:{};if(p=h.map(S=>{let A=S?.id,C=A&&Object.prototype.hasOwnProperty.call(x,A)?x[A]:void 0,w=C!==void 0?C:S.enabled!==!1;return{...S,enabled:w}}),d){let S=Number.isFinite(targetSnapshot?.targetMessageIndex)?targetSnapshot.targetMessageIndex:-1,A=im({chatId:targetSnapshot?.chatId||"",isolationKey:de.getKey?de.getKey():"",currentMessageIndex:S,scopeTables:p});p=p.map(C=>{let w=C?.id||C?.uid||"";return w&&!A.shouldUpdate.has(w)?{...C,enabled:!1}:C})}let T=p.filter(S=>S.enabled===!1).map(S=>S?.name||S?.id);T.length>0&&be().info("scopeTables: \u7528\u6237\u7981\u7528\u4E86\u90E8\u5206\u8868",{disabledCount:T.length,disabledNames:T})}}catch{}let y=ey(a.scope||a,p);if(be().info("runScope \u5DF2\u89E3\u6790",{mode:y.mode,requestedMode:y.requestedMode,staleScope:y.staleScope,scopeTablesCount:Array.isArray(p)?p.length:0,allowedTableIds:y.allowedTableIds,allTableIds:y.allTableIds,scopeTablesEnabled:Array.isArray(p)?p.map(g=>({id:g?.id,name:g?.name,enabled:g?.enabled})):[]}),y.staleScope&&be().warn("runScope: \u68C0\u6D4B\u5230 stale scope\uFF08activeTableId/selectedTableIds \u4E0D\u5728\u5F53\u524D tables \u8303\u56F4\u5185\uFF09\uFF0C\u5DF2\u81EA\u52A8 fallback \u5230 enabled",{requestedMode:y.requestedMode,requestedActiveTableId:y.activeTableId,requestedSelectedTableIds:y.selectedTableIds}),(y.mode==="current"||y.mode==="selected")&&y.allowedTableIds.length===0){let g=y.mode==="current"?"\u672A\u6307\u5B9A\u5F53\u524D\u8868\u683C\uFF0C\u65E0\u6CD5\u6267\u884C\u3002":"\u672A\u9009\u62E9\u4EFB\u4F55\u8868\u683C\uFF0C\u65E0\u6CD5\u6267\u884C\u3002";return be().warn(g,{mode:y.mode}),mr({lastStatus:Ce.ERROR,lastRunAt:c,lastDurationMs:0,lastError:g,lastErrorDetails:[g]},e),{success:!1,error:g,errors:[g]}}let m=null;mr({lastStatus:Ce.RUNNING,lastError:"",lastErrorDetails:[],lastValidationSummary:l.summary||{errorCount:0,warningCount:0},lastScopeMode:V(y.mode,""),...d?kr({status:Ce.RUNNING,startedAt:c,skipReason:""}):{}},e);try{if(typeof r!="function")throw new Error("table_update_missing_execution_context_builder");if(typeof s!="function")throw new Error("table_update_missing_target_resolver");let g=await r();be().info("\u6267\u884C\u4E0A\u4E0B\u6587\u5DF2\u6784\u5EFA");let h=s(g);if(!h)throw new Error("\u5F53\u524D\u6CA1\u6709\u53EF\u7528\u7684 assistant \u76EE\u6807\u697C\u5C42\u3002");m=h,be().info("\u76EE\u6807\u6D88\u606F\u5DF2\u89E3\u6790",{sourceMessageId:h.sourceMessageId,slotRevisionKey:h.slotRevisionKey}),d&&mr(kr({status:Ce.RUNNING,targetSnapshot:h,startedAt:c,skipReason:""}),e);let x=V(a.autoUpdateTrigger,"assistantMessage");if(d&&(!a.autoUpdateEnabled||x!=="assistantMessage")){let Y=a.autoUpdateEnabled?"auto_trigger_not_assistant_message":"auto_update_disabled";return mr(kr({status:Ce.SKIPPED,targetSnapshot:h,startedAt:c,skipReason:Y}),e),{success:!1,skipped:!0,reason:Y,targetSnapshot:h,meta:Us({targetSnapshot:h,startedAt:c,status:Ce.SKIPPED,skipReason:Y})}}if(d){let Y=bi(n);if(Y)return mr(kr({status:Ce.ABORTED,targetSnapshot:h,startedAt:c,skipReason:Y.reason,error:"\u8BF7\u6C42\u5DF2\u53D6\u6D88"}),e),{success:!1,error:"\u8BF7\u6C42\u5DF2\u53D6\u6D88",targetSnapshot:h,meta:Us({targetSnapshot:h,startedAt:c,status:Ce.ABORTED,skipReason:Y.reason,aborted:Y.aborted===!0,stale:Y.stale===!0,abortReason:Y.reason,error:"\u8BF7\u6C42\u5DF2\u53D6\u6D88"})}}let T=await fg(h);if(!T?.success)throw new Error(T?.error||"\u76EE\u6807\u89E3\u6790\u8BB0\u5F55\u5931\u8D25");if(o&&Number.isFinite(h?.targetMessageIndex)&&h.targetMessageIndex>=0){be().info("clearBeforeUpdate \u542F\u7528\uFF0C\u6E05\u7A7A\u76EE\u6807\u697C\u5C42\u6570\u636E",{targetMessageIndex:h.targetMessageIndex});try{let Y=await gg(h.targetMessageIndex);be().info("clearBeforeUpdate \u5B8C\u6210",Y)}catch(Y){be().error("clearBeforeUpdate \u5931\u8D25",Y)}}let S=zs(h.sourceMessageId),A=Array.isArray(p)&&p.length>0?p:a.tables;be().info("templateTables \u6765\u6E90",{usingActiveTemplate:p!==(Array.isArray(a.tables)?a.tables:[]),tableCount:Array.isArray(A)?A.length:0,firstTableName:A?.[0]?.name||"",firstTableId:A?.[0]?.id||""});let C=yg(h,{templateTables:A}),w=hr(C?.state?.tables||[]),P=Yg(),B=n?.signal||g?.signal||null;be().info("\u72B6\u6001\u5DF2\u52A0\u8F7D",{loadMode:C?.loadMode,sourceKind:C?.sourceKind,tableCount:w.length});let z=await P.buildRequest({buildRequest:MT},{executionContext:g,targetSnapshot:h,loadResult:C,config:a,assistantSnapshot:S,runScope:y});be().info("\u8BF7\u6C42\u5DF2\u6784\u5EFA",{messageCount:z?.messages?.length,fillMode:z?.fillMode});let R="",_=null,M=null;for(let Y=1;Y<=hi;Y++){if(B?.aborted)throw new Error("\u8BF7\u6C42\u5DF2\u53D6\u6D88");try{if(R=await P.sendRequest({sendRequest:PT},z,{config:{...a,_effectiveApiPreset:z?.effectiveApiPreset||""},abortSignal:B}),be().info("API \u54CD\u5E94\u5DF2\u6536\u5230",{attempt:Y,responseLength:R?.length||0}),_=P.parseResponse({parseResponse:xT},R),be().info("\u54CD\u5E94\u5DF2\u89E3\u6790",{attempt:Y,mode:_?.mode,hasEdits:!!_?.edits,hasTables:!!_?.tables,rawFormat:_?.rawFormat}),!(_?.mode==="incremental"&&Array.isArray(_.edits)&&_.edits.length>0||_?.mode==="full"&&_?.tables))throw new Error("AI \u54CD\u5E94\u4E2D\u672A\u627E\u5230\u6709\u6548\u7684 <tableEdit> \u6807\u7B7E\u6216\u8868\u683C JSON");M=null;break}catch(Fe){if(M=Fe,be().warn(`\u586B\u8868 attempt ${Y}/${hi} \u5931\u8D25`,{error:Fe?.message||String(Fe)}),Y<hi&&!await vT(wT,B))throw new Error("\u8BF7\u6C42\u5DF2\u53D6\u6D88\uFF08\u91CD\u8BD5\u7B49\u5F85\u671F\u95F4\uFF09")}}if(M)throw new Error(`\u586B\u8868\u5931\u8D25\uFF08${hi} \u6B21\u91CD\u8BD5\u540E\u4ECD\u5931\u8D25\uFF09: ${M?.message||String(M)}`);let j,q=null,ue=z.fillMode||"full",pe=null;if(_.mode==="incremental"&&_.edits){let Y=rm(C?.state,w),Fe=AT(_.edits,w,y,Y);pe=Fe.stats,j=RT(w,Fe.edits,Y,y),ue="incremental",(pe.droppedByScope>0||pe.droppedByLock>0)&&be().info("scope \u8FC7\u6EE4",pe)}else if(_.mode==="full"&&_.tables){let Y=hr(_.tables);j=ET(w,Y,y),ue="full"}else j=hr(w);if(q=Gg(w,j),be().info("\u5DEE\u5F02\u5DF2\u8BA1\u7B97",{fillMode:ue}),d){let Y=bi(n);if(Y)return mr(kr({status:Ce.ABORTED,targetSnapshot:h,startedAt:c,skipReason:Y.reason,error:"\u5199\u56DE\u524D\u5DF2\u53D6\u6D88"}),e),{success:!1,error:"\u5199\u56DE\u524D\u5DF2\u53D6\u6D88",targetSnapshot:h,meta:Us({targetSnapshot:h,startedAt:c,status:Ce.ABORTED,aborted:Y.aborted===!0,stale:Y.stale===!0,abortReason:Y.reason,error:"\u5199\u56DE\u524D\u5DF2\u53D6\u6D88"})}}let re=await kg({targetSnapshot:h,nextTables:j,config:a,loadResult:C,diff:q,fillMode:ue,skipNotify:d});if(d){let Y=bi(n);if(Y)return mr(kr({status:Ce.ABORTED,targetSnapshot:h,startedAt:c,skipReason:Y.reason,error:"\u8BF7\u6C42\u5DF2\u53D6\u6D88"}),e),{success:!1,error:"\u8BF7\u6C42\u5DF2\u53D6\u6D88",targetSnapshot:h,loadResult:C,request:z,responseText:R,parsed:_,fillMode:ue,diff:q,previousTables:w,nextTables:j,runScope:y,state:re?.state,bindings:re?.bindings,mirrorResult:re?.mirrorResult,warning:re?.warning||"",meta:Us({targetSnapshot:h,startedAt:c,status:Ce.ABORTED,warning:re?.warning||"",writeback:re,aborted:Y.aborted===!0,stale:Y.stale===!0,abortReason:Y.reason,error:"\u8BF7\u6C42\u5DF2\u53D6\u6D88"})}}if(!re?.success)throw new Error(re?.error||"\u7ED3\u6784\u5316\u5199\u56DE\u5931\u8D25");if(d)try{let Y=Number.isFinite(h?.targetMessageIndex)?h.targetMessageIndex:-1,Fe=p.filter(xe=>xe?.enabled!==!1&&(xe?.id||xe?.uid)).map(xe=>xe.id||xe.uid);Fe.length>0&&Y>=0&&am(h?.chatId||"",de.getKey?de.getKey():"",Fe,Y)}catch(Y){be().warn("recordTablesUpdated \u5931\u8D25\uFF08\u4E0D\u5F71\u54CD\u4E3B\u6D41\u7A0B\uFF09",Y)}let Se=Date.now()-c;be().info(`\u586B\u8868\u5B8C\u6210 [${ue}] ${Se}ms`,{success:!0,writebackSuccess:re?.success,mirrorSuccess:re?.mirrorResult?.success});let Ue={lastStatus:Ce.SUCCESS,lastRunAt:Date.now(),lastDurationMs:Se,lastError:"",lastErrorDetails:[],lastValidationSummary:l.summary||{errorCount:0,warningCount:0},successCount:(Number(u.successCount)||0)+1,errorCount:Number(u.errorCount)||0,lastSourceMessageId:V(h.sourceMessageId),lastSlotRevisionKey:V(h.slotRevisionKey),lastLoadMode:V(C.loadMode),lastMirrorApplied:re?.mirrorResult?.success===!0,lastResolvedFromMessageId:V(C?.resolvedFromMessageId),lastResolvedFromRevisionKey:V(C?.resolvedFromRevisionKey),lastSourceKind:V(C?.sourceKind||C?.state?.meta?.sourceKind),lastScopeMode:V(y.mode,""),lastFillMode:ue,...d?kr({status:Ce.SUCCESS,targetSnapshot:h,startedAt:c,skipReason:""}):{}};return mr(Ue,e),{success:!0,targetSnapshot:h,loadResult:C,request:z,responseText:R,parsed:_,fillMode:ue,diff:q,previousTables:w,nextTables:j,runScope:y,scopeStats:pe,state:re.state,bindings:re.bindings,mirrorResult:re.mirrorResult,warning:re.warning||"",...d?{meta:Us({targetSnapshot:h,startedAt:c,status:Ce.SUCCESS,warning:re.warning||"",writeback:re})}:{}}}catch(g){let h=Date.now()-c;be().error(`\u586B\u8868\u5931\u8D25 ${h}ms: ${g?.message||g}`,{stack:g?.stack});let x=d?bi(n):!1,T=g?.name==="AbortError"||g?.message==="\u8BF7\u6C42\u5DF2\u53D6\u6D88"||x?.aborted===!0||x?.stale===!0,S=T?Ce.ABORTED:Ce.ERROR,A={lastStatus:S,lastRunAt:Date.now(),lastDurationMs:h,lastError:g?.message||String(g),lastErrorDetails:[g?.message||String(g)],lastValidationSummary:l.summary||{errorCount:0,warningCount:0},successCount:Number(u.successCount)||0,errorCount:T?Number(u.errorCount)||0:(Number(u.errorCount)||0)+1,lastScopeMode:V(y.mode,""),...d?kr({status:S,targetSnapshot:m,startedAt:c,skipReason:T?x?.reason||"cancelled_before_host_commit":"",error:g?.message||String(g)}):{}};return mr(A,e),{success:!1,error:g?.message||String(g),errors:[g?.message||String(g)],...d?{meta:Us({targetSnapshot:m,startedAt:c,status:S,skipReason:T?x?.reason||"cancelled_before_host_commit":"",aborted:T,stale:x?.stale===!0,abortReason:T?x?.reason||"cancelled_before_host_commit":"",error:g?.message||String(g)})}:{}}}}var hi,wT,IT,xi=D(()=>{ws();Ds();Jo();Qa();H();He();ai();Ro();dr();Ig();gi();Hg();qg();Ca();Vg();ed();yn();da();Qs();Fr();lm();qr();hi=3,wT=5e3;IT=`
...
\u53EA\u8FD4\u56DE <tableEdit> \u6807\u7B7E\uFF0C\u4E0D\u8981\u9644\u52A0\u5176\u4ED6\u5185\u5BB9\u3002`});var bm={};ae(bm,{WindowManager:()=>wi,closeWindow:()=>hm,createWindow:()=>rd,windowManager:()=>yt});function LT(){if(yt.stylesInjected)return;yt.stylesInjected=!0;let t=`
    /* ============================================================
  ...
  `,e=Bt(),r=e.createElement("style");r.id=DT+"_styles",r.textContent=t,(e.head||e.documentElement).appendChild(r)}function rd(t){let{id:e,title:r="\u7A97\u53E3",content:s="",width:n=900,height:o=700,modal:a=!1,resizable:i=!0,maximizable:l=!0,startMaximized:d=!1,rememberState:c=!0,onClose:u,onReady:p}=t;LT();let y=Bt(),m=y.defaultView||window.parent||window,g=window.jQuery||window.parent?.jQuery;if(!g)return NT.error("jQuery not available"),null;if(yt.isOpen(e))return yt.bringToFront(e),yt.getWindow(e);let h=m.innerWidth||1200,x=m.innerHeight||800,T=h<=1100,S=null,A=!1;c&&(S=yt.getState(e),S&&!T&&(A=!0));let C,w;A&&S.width&&S.height?(C=Math.max(400,Math.min(S.width,h-40)),w=Math.max(300,Math.min(S.height,x-40))):(C=Math.max(400,Math.min(n,h-40)),w=Math.max(300,Math.min(o,x-40)));let P=Math.max(20,Math.min((h-C)/2,h-C-20)),B=Math.max(20,Math.min((x-w)/2,x-w-20)),z=l&&!T,R=`
...
`,ad=!1});function a0(t){return ce(t)}function i0(t,e,r){if(!t||typeof t!="object")return;let s=String(e||"").split(".").filter(Boolean);if(s.length===0)return;let n=t;for(let o=0;o<s.length-1;o++){let a=s[o];(n[a]===null||n[a]===void 0||typeof n[a]!="object")&&(n[a]={}),n=n[a]}n[s[s.length-1]]=r}function O(){return dd||(dd=E.createScope("TableWorkbenchView")),dd}async function l0(){try{let t=await go();if(!t)return At.kind=null,At.lastError="Provider \u4E0D\u53EF\u7528",At;if(At.kind=t.kind,typeof t.query=="function"){let e=await t.query({statement:"SELECT COUNT(*) as c FROM table_sheets"}),r=await t.query({statement:"SELECT COUNT(*) as c FROM table_rows"});At.sheetCount=e?.rows?.[0]?.c??0,At.rowCount=r?.rows?.[0]?.c??0}At.lastError=null,At.lastRefreshAt=Date.now(),O().info("Provider stats \u5DF2\u5237\u65B0",{...At})}catch(t){At.lastError=t?.message||String(t),O().warn("Provider stats \u5237\u65B0\u5931\u8D25",t)}return At}function c0(){if(!At.kind){let t=bn();t?.kind&&(At.kind=t.kind)}return At}function ee(t){return String(t??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function _m(t){if(!Number.isFinite(t)||t<=0)return"\u4ECE\u672A";let e=Date.now()-t;if(e<6e4)return`${Math.floor(e/1e3)} \u79D2\u524D`;if(e<36e5)return`${Math.floor(e/6e4)} \u5206\u949F\u524D`;if(e<864e5)return`${Math.floor(e/36e5)} \u5C0F\u65F6\u524D`;try{return new Date(t).toLocaleString()}catch{return"\u672A\u77E5"}}function Am(t){let{config:e,activeTemplate:r,isolationKey:s,tablesPreview:n,templateArchives:o=[],providerStats:a={}}=t,i=e?.runtime||{},l=i.lastStatus==="success"?"\u2713 \u4E0A\u6B21\u6210\u529F":i.lastStatus==="failed"?"\u2717 \u4E0A\u6B21\u5931\u8D25":i.lastStatus==="running"?"\u8FD0\u884C\u4E2D":"\u5F85\u547D",d=i.lastStatus==="success"?"success":i.lastStatus==="failed"?"error":"muted",c=e?.automation?.enabled?"\u81EA\u52A8":"\u624B\u52A8",u=e?.apiPreset||"\u8DDF\u968F\u4E3B API",p=e?.bypassPresetId?"\u5DF2\u7ED1\u5B9A":"\u65E0",y=Array.isArray(o)?o.length:0;return`
  <div class="yyt-tww">
    <!-- Hero -->
  ...
  `}function u0(t){let{config:e}=t,r=e?.fillMode||"incremental",s=Number(e?.contextDepth)||3,n=e?.worldbookSync?.enabled===!0,o=e?.mirrorToMessage===!0;return`
    <div class="yyt-tww-row">
      <div class="yyt-tww-row-label">
...
`});var Pm={};ae(Pm,{TableWorkbenchPanel:()=>Mm,default:()=>x0});function b0(){if(!pd)try{let t=window.parent&&window.parent.document?window.parent.document:document,e=t.head||t.documentElement;if(e.querySelector("#yyt-tww-styles")){pd=!0;return}let r=t.createElement("style");r.id="yyt-tww-styles",r.textContent=Em,e.appendChild(r),pd=!0}catch(t){zo.warn("\u6CE8\u5165\u5DE5\u4F5C\u53F0\u6837\u5F0F\u5931\u8D25",t)}}function Im(t){let e=t?.[0];if(!e)return;let r=e.closest(".yyt-popup-body");if(!r){zo.warn("pinWorkbenchHeight: \u627E\u4E0D\u5230 .yyt-popup-body \u7956\u5148");return}let s=()=>{let o=e.querySelector(".yyt-tww");if(!o)return;let a=r.getBoundingClientRect(),i=e.getBoundingClientRect(),l=a.bottom-i.top-8;l>100?o.style.height=`${l}px`:zo.warn(`pinWorkbenchHeight: \u8BA1\u7B97\u9AD8\u5EA6\u5F02\u5E38 h=${l}, popupBottom=${a.bottom}, tabTop=${i.top}`)};if(s(),requestAnimationFrame(()=>requestAnimationFrame(s)),typeof ResizeObserver>"u"||e.__yytwwROTarget===r&&e.__yytwwRO)return;if(e.__yytwwRO)try{e.__yytwwRO.disconnect()}catch{}let n=new ResizeObserver(()=>s());n.observe(r),e.__yytwwRO=n,e.__yytwwROTarget=r}function Rm(t){let e=t?.[0];if(!e)return;let r=e.querySelector(".yyt-tww-hero"),s=e.querySelector(".yyt-tww-scroll");if(!r||!s)return;let n=()=>{s.scrollTop>0?r.classList.add("yyt-tww-hero--compact"):r.classList.remove("yyt-tww-hero--compact")};n(),s.addEventListener("scroll",n,{passive:!0})}var zo,pd,Mm,x0,Nm=D(()=>{tt();H();km();zo=E.createScope("TableWorkbenchPanel"),pd=!1;Mm={id:"tableWorkbenchPanel",render(){b0();try{let t=Cm();return Am(t)}catch(t){return zo.error("\u6E32\u67D3\u5DE5\u4F5C\u53F0 UI \u5F02\u5E38",t),`<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u5DE5\u4F5C\u53F0\u6E32\u67D3\u5931\u8D25\uFF1A${t?.message||t}</span></div>`}},bindEvents(t){if(!te()||!we(t))return;let r=this,s=()=>{try{t.html(r.render()),ud(t,s),Im(t),Rm(t)}catch(n){zo.error("refresh \u5F02\u5E38",n)}};ud(t,s),Im(t),Rm(t)},renderTo(t){!te()||!we(t)||(t.html(this.render()),this.bindEvents(t))}},x0=Mm});var Lm={};ae(Lm,{LoggerPanel:()=>Dm,default:()=>_0});function S0(t){switch(t){case fe.DEBUG:return"yyt-log-debug";case fe.INFO:return"yyt-log-info";case fe.WARN:return"yyt-log-warn";case fe.ERROR:return"yyt-log-error";default:return""}}function T0(t){let e=new Date(t),r=s=>String(s).padStart(2,"0");return`${r(e.getHours())}:${r(e.getMinutes())}:${r(e.getSeconds())}.${String(e.getMilliseconds()).padStart(3,"0")}`}var w0,v0,Dm,_0,Om=D(()=>{H();Ze();tt();w0="yyt-logger-panel",v0=[{level:null,label:"\u5168\u90E8",icon:"fa-list"},{level:fe.DEBUG,label:"DEBUG",icon:"fa-bug"},{level:fe.INFO,label:"INFO",icon:"fa-circle-info"},{level:fe.WARN,label:"WARN",icon:"fa-triangle-exclamation"},{level:fe.ERROR,label:"ERROR",icon:"fa-circle-exclamation"}];Dm={id:"loggerPanel",render(){let t=E.getStats();return`
    ...
    `},bindEvents(t){let e=te();if(!e||!we(t))return;let r=this,s=null,n=!1,o=[],a=t.find("[data-yyt-log-list]"),i=t.find("[data-yyt-log-search]"),l=t.find("[data-yyt-log-autoscroll]"),d=t.find("[data-yyt-log-pause]");function c(y){if(!y.length){a.html('<div class="yyt-logger-empty">\u6682\u65E0\u5339\u914D\u7684\u65E5\u5FD7\u8BB0\u5F55</div>');return}a.html(y.map(m=>`
        <div class="yyt-log-entry ${S0(m.level)}" data-log-id="${m.id}">
          <span class="yyt-log-time">${T0(m.timestamp)}</span>
...
`;tt();function oh(t,e={}){let{constants:r,topLevelWindow:s,modules:n}=t,{SCRIPT_ID:o,SCRIPT_VERSION:a,MENU_ITEM_ID:i,MENU_CONTAINER_ID:l}=r,d=null,c=!1,u=E.createScope("Bootstrap");E.setToastHandler((A,C,w)=>{if(w.toast&&Go(w.toast===!0?A:w.toast,C,w.duration),w.topNotice){let P=typeof w.topNotice=="object"?w.topNotice:{};$i(A,C,P)}});function p(...A){u.log(A.join(" "))}function y(...A){u.error(A.join(" "))}async function m(){return d||(d=(async()=>{try{n.storageModule=await Promise.resolve().then(()=>(je(),eu)),n.apiConnectionModule=await Promise.resolve().then(()=>(Jo(),ou)),n.presetManagerModule=await Promise.resolve().then(()=>(Gn(),cu)),n.uiModule=await Promise.resolve().then(()=>(Gm(),Hm)),n.regexExtractorModule=await Promise.resolve().then(()=>(Qs(),Tl)),n.toolManagerModule=await Promise.resolve().then(()=>(to(),vp)),n.toolExecutorModule=await Promise.resolve().then(()=>(Ac(),Ec)),n.windowManagerModule=await Promise.resolve().then(()=>(sd(),bm)),n.toolRegistryModule=await Promise.resolve().then(()=>(lr(),Ml)),n.settingsServiceModule=await Promise.resolve().then(()=>(vo(),bf)),n.bypassManagerModule=await Promise.resolve().then(()=>(_n(),hf)),n.variableResolverModule=await Promise.resolve().then(()=>(Ja(),Sf)),n.contextInjectorModule=await Promise.resolve().then(()=>(Ds(),wf)),n.toolPromptServiceModule=await Promise.resolve().then(()=>(Qa(),Ef)),n.toolOutputServiceModule=await Promise.resolve().then(()=>(To(),Cf)),n.toolAutomationServiceModule=await Promise.resolve().then(()=>(Zm(),Qm)),n.toolDataProviderModule=await Promise.resolve().then(()=>(mn(),_y)),n.presetBootstrapModule=await Promise.resolve().then(()=>(nh(),sh));try{n.toolDataProviderModule.getToolDataProvider({extensionVersion:a}).then(A=>{u.log(`Provider \u5C31\u7EEA: ${A.kind}`)}).catch(A=>{u.error(`Provider \u521D\u59CB\u5316\u5F02\u5E38: ${A?.message||A}`)})}catch(A){u.error(`Provider \u542F\u52A8\u5F02\u5E38: ${A?.message||A}`)}return n.toolOutputServiceModule?.toolOutputService&&n.apiConnectionModule&&n.toolOutputServiceModule.toolOutputService.setApiConnection(n.apiConnectionModule),!0}catch(A){return d=null,y("\u6A21\u5757\u52A0\u8F7D\u5931\u8D25\uFF0C\u4F7F\u7528\u5185\u7F6E\u529F\u80FD:",A),y("\u5DF2\u52A0\u8F7D\u6A21\u5757:",Object.keys(n).filter(C=>n[C])),!1}})(),d)}function g(){let A=`${o}-styles`,C=s.document||document;if(C.getElementById(A))return;let w=C.createElement("style");w.id=A,w.textContent=zd,(C.head||C.documentElement).appendChild(w),p("\u6837\u5F0F\u5DF2\u6CE8\u5165")}function h(){let A=s.document||document;if(n.uiModule?.getAllStyles){let C=`${o}-ui-styles`;if(!A.getElementById(C)){let w=A.createElement("style");w.id=C,w.textContent=n.uiModule.getAllStyles(),(A.head||A.documentElement).appendChild(w)}}}async function x(){try{let{applyUiPreferences:A}=await Promise.resolve().then(()=>(Lc(),Dc));if(n.settingsServiceModule?.settingsService){let C=n.settingsServiceModule.settingsService.getUiSettings();if(C&&C.theme){let w=s.document||document;A(C,w),p(`\u4E3B\u9898\u5DF2\u5E94\u7528: ${C.theme}`)}}}catch(A){p("\u4E3B\u9898\u52A0\u8F7D\u5931\u8D25:",A)}}function T(){let A=s.jQuery||window.jQuery;if(!A){y("jQuery \u672A\u627E\u5230\uFF0C\u5EF6\u8FDF\u91CD\u8BD5..."),setTimeout(T,1e3);return}let C=s.document||document,w=A("#extensionsMenu",C);if(!w.length){p("\u9B54\u68D2\u83DC\u5355\u672A\u627E\u5230\uFF0C\u5EF6\u8FDF\u91CD\u8BD5..."),setTimeout(T,2e3);return}if(A(`#${l}`,w).length>0){p("\u83DC\u5355\u9879\u5DF2\u5B58\u5728");return}let B=A(`<div class="extension_container interactable" id="${l}" tabindex="0"></div>`),z=`
      <div class="list-group-item flex-container flexGap5 interactable" id="${i}" title="\u6253\u5F00 YouYou \u5DE5\u5177\u7BB1">
        <div class="fa-fw fa-solid fa-wand-magic-sparkles extensionsMenuExtensionButton"></div>
        <span>YouYou \u5DE5\u5177\u7BB1</span>
      </div>
    `,R=A(z);R.on("click",function(M){M.stopPropagation(),p("\u83DC\u5355\u9879\u88AB\u70B9\u51FB");let j=A("#extensionsMenuButton",C);j.length&&w.is(":visible")&&j.trigger("click"),typeof e.openPopup=="function"&&e.openPopup()}),B.append(R),w.append(B),p("\u83DC\u5355\u9879\u5DF2\u6DFB\u52A0\u5230\u9B54\u68D2\u533A")}async function S(){p(`\u521D\u59CB\u5316\u5F00\u59CB... \u7248\u672C: ${a}`),await g();let A=await m();if(p(A?"\u6240\u6709\u6A21\u5757\u52A0\u8F7D\u6210\u529F":"\u90E8\u5206\u6A21\u5757\u52A0\u8F7D\u5931\u8D25\uFF0C\u4F7F\u7528\u53EF\u7528\u529F\u80FD"),!c&&n.uiModule?.initUI)try{await n.uiModule.initUI({services:n,autoInjectStyles:!1,targetDocument:s.document||document}),c=!0,p("UI \u88C5\u914D\u4E2D\u5FC3\u5DF2\u521D\u59CB\u5316")}catch(w){y("UI \u6A21\u5757\u521D\u59CB\u5316\u5931\u8D25:",w)}if(n.uiModule&&(h(),await x()),n.presetBootstrapModule?.ensurePresetSystem)try{let w=n.presetBootstrapModule.ensurePresetSystem();w?.aborted?p(`\u9884\u8BBE\u7CFB\u7EDF\u8FC1\u79FB\u5931\u8D25\u5DF2 abort\uFF0C\u8001\u5B57\u6BB5\u4FDD\u7559: ${w.error}`):w?.skipped?p(`\u9884\u8BBE\u7CFB\u7EDF\u5DF2\u5C31\u7EEA\uFF08${w.reason}\uFF09`):p(`\u9884\u8BBE\u7CFB\u7EDF\u8FC1\u79FB\u5B8C\u6210\uFF08${w.migratedCount}/${w.total} \u5DE5\u5177\uFF09`)}catch(w){y("\u9884\u8BBE\u7CFB\u7EDF\u521D\u59CB\u5316\u5F02\u5E38:",w)}if(n.toolAutomationServiceModule?.toolAutomationService){let w=n.toolAutomationServiceModule.toolAutomationService.init();p(w?"\u81EA\u52A8\u5316\u751F\u547D\u5468\u671F\u670D\u52A1\u5DF2\u521D\u59CB\u5316":"\u81EA\u52A8\u5316\u751F\u547D\u5468\u671F\u670D\u52A1\u521D\u59CB\u5316\u672A\u5B8C\u6210\uFF0C\u7B49\u5F85\u5BBF\u4E3B\u4E8B\u4EF6\u6E90\u91CD\u8BD5")}let C=s.document||document;C.readyState==="loading"?C.addEventListener("DOMContentLoaded",()=>{setTimeout(T,1e3)}):setTimeout(T,1e3),p("\u521D\u59CB\u5316\u5B8C\u6210")}return{loadModules:m,injectStyles:g,addMenuItem:T,init:S,log:p,logError:y}}Ze();tt();tt();H();var Dn=E.createScope("PromptEditor"),O0="youyou_toolkit_prompt_editor",$0={system:"System Prompt (\u7CFB\u7EDF\u63D0\u793A\u8BCD)",ai:"AI Prompt (AI\u6307\u4EE4\u63D0\u793A\u8BCD)",user:"User Prompt (\u7528\u6237\u63D0\u793A\u8BCD)"},B0={system:"fa-server",ai:"fa-robot",user:"fa-user"},Uo=[{id:"system_1",type:"system",role:"SYSTEM",mainSlot:"",content:"",deletable:!1,expanded:!0},{id:"ai_1",type:"ai",role:"USER",mainSlot:"A",content:"",deletable:!1,expanded:!0,isMain:!0},{id:"user_1",type:"user",role:"USER",mainSlot:"B",content:"",deletable:!1,expanded:!0,isMain2:!0}],Ci=class{constructor(e={}){this.containerId=e.containerId||O0,this.segments=e.segments||[...Uo],this.onChange=e.onChange||null,this.editable=e.editable!==!1,this.showMainSlot=e.showMainSlot!==!1,this.$container=null,this.$=null}init(e){if(this.$=window.jQuery||window.parent?.jQuery,!this.$){Dn.error("jQuery not available");return}this.$container=e,this.render(),this.bindEvents()}setSegments(e){this.segments=e&&Array.isArray(e)?[...e]:[...Uo],this.$container&&(this.render(),this.bindEvents())}getSegments(){return this.segments.map(e=>({...e,content:this.getSegmentContent(e.id)}))}getSegmentContent(e){return this.$container&&this.$container.find(`[data-segment-id="${e}"] .yyt-prompt-textarea`).val()||""}render(){if(!this.$container)return;let e=`
...
\u6216 regex:<custom_tag>([\\s\\S]*?)</custom_tag>`,previewDialogId:`${b.id}-extraction-preview`,previewTitle:`${b.name||b.id} \u63D0\u53D6\u9884\u89C8`}),n.dynamicToolPanelCache.set(b.id,N)}let K=N();K.renderTo(v),q(v,{key:b.id,destroy:typeof K?.destroy=="function"?F=>K.destroy(F):null}),Je()}catch(N){y.current=null,x("\u81EA\u5B9A\u4E49\u5DE5\u5177\u9762\u677F\u52A0\u8F7D\u5931\u8D25:",N),v.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u81EA\u5B9A\u4E49\u5DE5\u5177\u9762\u677F\u52A0\u8F7D\u5931\u8D25</span></div>')}}}function cs(b,v){if(!S())return;let N=s.toolRegistryModule?.getToolConfig(b);if(!N){v.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u5DE5\u5177\u914D\u7F6E\u4E0D\u5B58\u5728</span></div>');return}let K=o.currentSubTab[b]||N.subTabs?.[0]?.id||"config";v.html(`
    ...
    `),ls(b,K)}function ph(b,v){if(!S())return;let N=s.toolManagerModule?.getTool(b),K=s.presetManagerModule?.getAllPresets()||[],F=s.toolRegistryModule?.getToolApiPreset(b)||"",ne=K.map(Q=>`<option value="${T(Q.name)}" ${Q.name===F?"selected":""}>${T(Q.name)}</option>`).join("");v.html(`
      <div class="yyt-panel">
        <div class="yyt-flow-section">
          <div class="yyt-flow-heading">
    ...
    `),zt(v,{namespace:"yytPopupToolConfigSelect",selectors:["#yyt-tool-api-preset"]}),v.find("#yyt-save-tool-preset").on("click",function(){let oe=v.find("#yyt-tool-api-preset").val();s.toolRegistryModule?.setToolApiPreset(b,oe),d.info("API\u9884\u8BBE\u7ED1\u5B9A\u5DF2\u4FDD\u5B58",null,{toast:"success"})})}async function yh(b,v){if(!S()){v.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u63D0\u793A\u8BCD\u7F16\u8F91\u5668\u6A21\u5757\u672A\u52A0\u8F7D</span></div>');return}let K=s.toolManagerModule?.getTool(b)?.config?.messages||[],F=lh(K)||Uo,ne=new Ci({containerId:`yyt-prompt-editor-${b}`,segments:F,onChange:oe=>{let De=ih(oe);h("\u63D0\u793A\u8BCD\u5DF2\u66F4\u65B0:",De.length,"\u6761\u6D88\u606F")}});v.html(`<div id="yyt-prompt-editor-${b}" class="yyt-prompt-editor-container"></div>`),ne.init(v.find(`#yyt-prompt-editor-${b}`));let Q=ah();if(Q){let oe="yyt-prompt-editor-styles",De=r.document||document;if(!De.getElementById(oe)){let me=De.createElement("style");me.id=oe,me.textContent=Q,(De.head||De.documentElement).appendChild(me)}}}function fh(b,v){S()&&v.html(`
      <div class="yyt-panel">
        <div class="yyt-flow-section">
          <div class="yyt-flow-heading">
