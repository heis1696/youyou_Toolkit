var YouYouToolkit=(()=>{var No=Object.defineProperty;var hc=Object.getOwnPropertyDescriptor;var vc=Object.getOwnPropertyNames;var xc=Object.prototype.hasOwnProperty;var W=(t,e)=>()=>(t&&(e=t(t=0)),e);var ue=(t,e)=>{for(var s in e)No(t,s,{get:e[s],enumerable:!0})},wc=(t,e,s,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of vc(e))!xc.call(t,o)&&o!==s&&No(t,o,{get:()=>e[o],enumerable:!(r=hc(e,o))||r.enumerable});return t};var Sc=t=>wc(No({},"__esModule",{value:!0}),t);function na(){let t=C;return t._getStorage(),t._storage}function aa(){return C.get("settings",{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}})}function ia(t){C.set("settings",t)}var vt,C,te,oa,Ls,De=W(()=>{vt=class t{constructor(e="youyou_toolkit"){this.namespaceKey=e,this._storage=null,this._cache=new Map}_getStorage(){if(this._storage)return this._storage;try{let e=typeof window.parent<"u"&&window.parent!==window?window.parent:window;if(e.SillyTavern?.getContext){let s=e.SillyTavern.getContext();if(s?.extensionSettings)return s.extensionSettings[this.namespaceKey]||(s.extensionSettings[this.namespaceKey]={}),this._storage={_target:s.extensionSettings[this.namespaceKey],getItem:r=>{let o=s.extensionSettings[this.namespaceKey][r];return typeof o=="string"?o:o?JSON.stringify(o):null},setItem:(r,o)=>{s.extensionSettings[this.namespaceKey][r]=o,this._saveSettings(s)},removeItem:r=>{delete s.extensionSettings[this.namespaceKey][r],this._saveSettings(s)},_isTavern:!0},this._storage}}catch{console.warn(`[${this.namespaceKey}] SillyTavern\u5B58\u50A8\u4E0D\u53EF\u7528\uFF0C\u4F7F\u7528localStorage`)}return this._storage={getItem:e=>{try{return localStorage.getItem(e)}catch{return null}},setItem:(e,s)=>{try{localStorage.setItem(e,s)}catch(r){console.error(`[${this.namespaceKey}] localStorage\u5199\u5165\u5931\u8D25:`,r)}},removeItem:e=>{try{localStorage.removeItem(e)}catch{}},_isTavern:!1},this._storage}_saveSettings(e){if(typeof e.saveSettings=="function")try{e.saveSettings()}catch{}else if(typeof e.saveSettingsDebounced=="function")try{e.saveSettingsDebounced()}catch{}}get(e,s=null){let r=`${this.namespaceKey}:${e}`;if(this._cache.has(r))return this._cache.get(r);let o=this._getStorage(),n=this._getFullKey(e),a=o.getItem(n);if(a===null)return s;try{let i=JSON.parse(a);return this._cache.set(r,i),i}catch{return a}}set(e,s){let r=this._getStorage(),o=this._getFullKey(e),n=`${this.namespaceKey}:${e}`;this._cache.set(n,s);try{r.setItem(o,JSON.stringify(s))}catch(a){console.error(`[${this.namespaceKey}] \u5B58\u50A8\u5931\u8D25:`,a)}}remove(e){let s=this._getStorage(),r=this._getFullKey(e),o=`${this.namespaceKey}:${e}`;this._cache.delete(o),s.removeItem(r)}has(e){let s=this._getStorage(),r=this._getFullKey(e);return s.getItem(r)!==null}clear(){if(this._getStorage()._isTavern){let s=typeof window.parent<"u"?window.parent:window;if(s.SillyTavern?.getContext){let r=s.SillyTavern.getContext();r?.extensionSettings?.[this.namespaceKey]&&(r.extensionSettings[this.namespaceKey]={},this._saveSettings(r))}}else{let s=`${this.namespaceKey}_`,r=[];for(let o=0;o<localStorage.length;o++){let n=localStorage.key(o);n&&n.startsWith(s)&&r.push(n)}r.forEach(o=>localStorage.removeItem(o))}this._cache.clear()}_getFullKey(e){return this._getStorage()._isTavern?e:`${this.namespaceKey}_${e}`}namespace(e){return new t(`${this.namespaceKey}:${e}`)}getMultiple(e){let s={};return e.forEach(r=>{s[r]=this.get(r)}),s}setMultiple(e){Object.entries(e).forEach(([s,r])=>{this.set(s,r)})}exportAll(){let e=this._getStorage(),s={};if(e._isTavern){let r=typeof window.parent<"u"?window.parent:window;if(r.SillyTavern?.getContext){let n=r.SillyTavern.getContext()?.extensionSettings?.[this.namespaceKey]||{};Object.entries(n).forEach(([a,i])=>{s[a]=typeof i=="string"?JSON.parse(i):i})}}else{let r=`${this.namespaceKey}_`;for(let o=0;o<localStorage.length;o++){let n=localStorage.key(o);if(n&&n.startsWith(r)){let a=n.slice(r.length);try{s[a]=JSON.parse(localStorage.getItem(n))}catch{s[a]=localStorage.getItem(n)}}}}return s}},C=new vt("youyou_toolkit"),te=new vt("youyou_toolkit:tools"),oa=new vt("youyou_toolkit:presets"),Ls=new vt("youyou_toolkit:windows")});var ca={};ue(ca,{DEFAULT_API_PRESETS:()=>_c,DEFAULT_SETTINGS:()=>Tc,STORAGE_KEYS:()=>Bs,StorageService:()=>vt,deepMerge:()=>la,getCurrentPresetName:()=>Mc,getStorage:()=>na,loadApiPresets:()=>Ac,loadSettings:()=>aa,presetStorage:()=>oa,saveApiPresets:()=>Ec,saveSettings:()=>ia,setCurrentPresetName:()=>kc,storage:()=>C,toolStorage:()=>te,windowStorage:()=>Ls});function Ac(){return C.get(Bs.API_PRESETS)||[]}function Ec(t){C.set(Bs.API_PRESETS,t)}function Mc(){return C.get(Bs.CURRENT_PRESET)||""}function kc(t){C.set(Bs.CURRENT_PRESET,t||"")}function la(t,e){let s=o=>o&&typeof o=="object"&&!Array.isArray(o),r={...t};return s(t)&&s(e)&&Object.keys(e).forEach(o=>{s(e[o])?o in t?r[o]=la(t[o],e[o]):Object.assign(r,{[o]:e[o]}):Object.assign(r,{[o]:e[o]})}),r}var Bs,Tc,_c,da=W(()=>{De();De();Bs={SETTINGS:"settings",API_PRESETS:"api_presets",CURRENT_PRESET:"current_preset",TOOLS:"tools",TOOL_PRESETS:"tool_presets",CURRENT_TOOL_PRESET:"current_tool_preset",BYPASS_PRESETS:"bypass_presets",CURRENT_BYPASS_PRESET:"current_bypass_preset",BYPASS_ENABLED:"bypass_enabled"},Tc={apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}},_c=[]});var fa={};ue(fa,{API_STATUS:()=>Dc,fetchAvailableModels:()=>Uo,getApiConfig:()=>it,getEffectiveApiConfig:()=>Ks,hasEffectiveApiPreset:()=>zs,sendApiRequest:()=>Us,sendWithPreset:()=>Ko,testApiConnection:()=>Uc,updateApiConfig:()=>ds,validateApiConfig:()=>us});function Pc(){return{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,stream:!1,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}}}function Bo(){return C.get(ua,Pc())}function Rc(t){C.set(ua,t)}function ya(){return C.get(Ic,[])}function $c(){return C.get(Cc,"")}function Lo(t,e={}){let s=new Error(t);return s.allowDirectFallback=e.allowDirectFallback===!0,s}function pa(t,e="chat_completions"){let s=String(t||"").trim();if(!s)return"";let r=null;try{r=new URL(s)}catch{return s}let o=r.pathname.replace(/\/+$/,""),n=o;return e==="chat_completions"?!/\/chat\/completions$/i.test(o)&&!/\/completions$/i.test(o)&&(n=`${o||""}/chat/completions`):e==="models"&&(/\/chat\/completions$/i.test(o)?n=o.replace(/\/chat\/completions$/i,"/models"):/\/completions$/i.test(o)?n=o.replace(/\/completions$/i,"/models"):/\/models$/i.test(o)||(n=`${o||""}/models`)),r.pathname=n.replace(/\/+/g,"/"),r.toString()}function Oc(t){let e=String(t||"").trim();if(!e)return"";try{let s=new URL(e);return s.pathname=s.pathname.replace(/\/chat\/completions$/i,"").replace(/\/completions$/i,"").replace(/\/models$/i,"").replace(/\/+$/,"")||"/",s.toString().replace(/\/$/,"")}catch{return e.replace(/\/chat\/completions$/i,"").replace(/\/completions$/i,"").replace(/\/models$/i,"").replace(/\/+$/,"")}}function it(){return Bo().apiConfig||{}}function ds(t){let e=Bo();e.apiConfig={...e.apiConfig,...t},Rc(e)}function us(t){let e=[];if(t.useMainApi)return{valid:!0,errors:[]};if(!t.url||!t.url.trim())e.push("API URL \u4E0D\u80FD\u4E3A\u7A7A");else try{new URL(t.url)}catch{e.push("API URL \u683C\u5F0F\u65E0\u6548")}return(!t.model||!t.model.trim())&&e.push("\u6A21\u578B\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"),{valid:e.length===0,errors:e}}function Ks(t=""){let e=Bo(),s=t||$c()||"";if(s){let o=ya().find(n=>n.name===s);if(o&&o.apiConfig)return{...o.apiConfig,presetName:o.name}}return e.apiConfig||{}}function zs(t=""){return t?ya().some(s=>s?.name===t):!1}async function Ko(t,e,s={},r=null){let o=Ks(t);return await Us(e,{...s,apiConfig:o},r)}function ga(t,e={}){let s=e.apiConfig||it();return{messages:t,model:s.model||"gpt-3.5-turbo",max_tokens:s.max_tokens||4096,temperature:s.temperature??.7,top_p:s.top_p??.9,stream:s.stream??!1,...e.extraParams}}function zo(t){let e="";if(t?.choices&&t.choices[0]?.message?.content)e=t.choices[0].message.content;else if(t?.content)e=t.content;else if(t?.text)e=t.text;else if(t?.response)e=t.response;else throw new Error(`\u65E0\u6CD5\u89E3\u6790API\u54CD\u5E94\u683C\u5F0F: ${JSON.stringify(t).slice(0,200)}`);return String(e||"").trim()}async function Us(t,e={},s=null){let r=e.apiConfig||it(),o=r.useMainApi,n=us(r);if(!n.valid&&!o)throw new Error(`API\u914D\u7F6E\u65E0\u6548: ${n.errors.join(", ")}`);return o?await Nc(t,e,s):await Lc(t,r,e,s)}async function Nc(t,e,s){let r=typeof window.parent<"u"?window.parent:window;if(!r.TavernHelper?.generateRaw)throw new Error("TavernHelper.generateRaw \u4E0D\u53EF\u7528\u3002\u8BF7\u68C0\u67E5SillyTavern\u7248\u672C\u3002");try{let o=await r.TavernHelper.generateRaw({ordered_prompts:t,should_stream:e.apiConfig?.stream??it().stream??!1,...e.extraParams});if(typeof o!="string")throw new Error("\u4E3BAPI\u8FD4\u56DE\u4E86\u975E\u9884\u671F\u7684\u54CD\u5E94\u7C7B\u578B");return o.trim()}catch(o){throw o.name==="AbortError"?o:new Error(`\u4E3BAPI\u8BF7\u6C42\u5931\u8D25: ${o.message}`)}}async function Lc(t,e,s,r){let o=typeof window.parent<"u"?window.parent:window;if(o.TavernHelper?.generateRaw)try{return await Bc(t,e,s,r,o)}catch(n){console.warn("[youyou_toolkit] TavernHelper \u81EA\u5B9A\u4E49\u8BF7\u6C42\u5931\u8D25\uFF0C\u56DE\u9000\u5230\u540E\u5907\u94FE\u8DEF:",n)}if(o.SillyTavern?.getRequestHeaders)try{return await Kc(t,e,s,r,o)}catch(n){if(!n?.allowDirectFallback)throw n}return await zc(t,e,s,r)}async function Bc(t,e,s,r,o){if(r?.aborted)throw new DOMException("\u8BF7\u6C42\u5DF2\u53D6\u6D88","AbortError");let n=await o.TavernHelper.generateRaw({ordered_prompts:t,should_stream:e.stream??!1,max_chat_history:0,custom_api:{apiurl:Oc(e.url),key:e.apiKey||"",model:e.model||"gpt-3.5-turbo",max_tokens:e.max_tokens||4096,temperature:e.temperature??.7,top_p:e.top_p??.9},...s.extraParams||{}});return typeof n=="string"?n.trim():zo(n)}async function Kc(t,e,s,r,o){let n=String(e.url||"").trim(),a={...ga(t,{apiConfig:e,...s}),chat_completion_source:"custom",reverse_proxy:n,proxy_password:"",custom_url:n,custom_include_headers:e.apiKey?`Authorization: Bearer ${e.apiKey}`:""},i={...typeof o.SillyTavern?.getRequestHeaders=="function"?o.SillyTavern.getRequestHeaders():{},"Content-Type":"application/json"},l=null;try{l=await fetch("/api/backends/chat-completions/generate",{method:"POST",headers:i,body:JSON.stringify(a),signal:r})}catch(u){throw u?.name==="AbortError"?u:Lo(`\u9152\u9986\u540E\u7AEF\u8F6C\u53D1\u8BF7\u6C42\u4E0D\u53EF\u7528\uFF0C\u5DF2\u5C1D\u8BD5\u56DE\u9000\u5230\u6D4F\u89C8\u5668\u76F4\u8FDE\u3002\u539F\u59CB\u9519\u8BEF: ${u.message}`,{allowDirectFallback:!0})}let c=await l.text().catch(()=>"");if(!l.ok){let u=[404,405,501,502].includes(l.status);throw Lo(`\u9152\u9986\u540E\u7AEF\u8F6C\u53D1\u8BF7\u6C42\u5931\u8D25 (${l.status}): ${c||"Unknown error"}`,{allowDirectFallback:u})}let d=null;try{d=c?JSON.parse(c):{}}catch{let y=String(c||"").replace(/\s+/g," ").trim().slice(0,120);throw Lo(`\u9152\u9986\u540E\u7AEF\u8FD4\u56DE\u4E86\u975EJSON\u5185\u5BB9\u3002\u54CD\u5E94\u7247\u6BB5: ${y||"(\u7A7A\u54CD\u5E94)"}`)}return zo(d)}async function zc(t,e,s,r){let o=ga(t,{apiConfig:e,...s}),n=pa(e.url,"chat_completions"),a={"Content-Type":"application/json"};e.apiKey&&(a.Authorization=`Bearer ${e.apiKey}`);let i=await fetch(n,{method:"POST",headers:a,body:JSON.stringify(o),signal:r}),l=await i.text().catch(()=>"");if(!i.ok){let d=l||"Unknown error";throw new Error(`API\u8BF7\u6C42\u5931\u8D25 (${i.status}): ${d}`)}let c=null;try{c=l?JSON.parse(l):{}}catch{let u=String(l||"").replace(/\s+/g," ").trim().slice(0,120);throw new Error(`\u81EA\u5B9A\u4E49API\u8FD4\u56DE\u7684\u4E0D\u662FJSON\uFF0C\u53EF\u80FD\u662FURL\u914D\u7F6E\u9519\u8BEF\u3001\u53EA\u586B\u5199\u4E86\u7AD9\u70B9\u9996\u9875/\u57FA\u7840\u8DEF\u5F84\u3001\u6216\u8BF7\u6C42\u88AB\u91CD\u5B9A\u5411\u3002\u5F53\u524D\u4F1A\u81EA\u52A8\u5C1D\u8BD5\u8865\u5168 chat/completions \u7AEF\u70B9\uFF1B\u82E5\u4ECD\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5API URL\uFF0C\u6216\u6539\u4E3A\u542F\u7528\u201C\u4F7F\u7528SillyTavern\u4E3BAPI\u201D\u3002\u54CD\u5E94\u7247\u6BB5: ${u||"(\u7A7A\u54CD\u5E94)"}`)}return zo(c)}async function Uc(t=null){let e=t||it(),s=Date.now();try{await Us([{role:"user",content:'Hello, this is a connection test. Please respond with "OK".'}],{apiConfig:e});let o=Date.now()-s;return{success:!0,message:`\u8FDE\u63A5\u6210\u529F (\u5EF6\u8FDF: ${o}ms)`,latency:o}}catch(r){return{success:!1,message:`\u8FDE\u63A5\u5931\u8D25: ${r.message}`,latency:Date.now()-s}}}async function Uo(t=null){let e=t||it();return e.useMainApi?await Wc():await jc(e)}async function Wc(){let t=typeof window.parent<"u"?window.parent:window;try{if(t.SillyTavern?.getContext){let e=t.SillyTavern.getContext();if(e.settings?.api_server)return[e.settings.api_server]}return["gpt-4","gpt-4-turbo","gpt-3.5-turbo","claude-3-opus","claude-3-sonnet"]}catch{return["gpt-4","gpt-3.5-turbo"]}}async function jc(t){if(!t.url||!t.apiKey)return[];try{let e=pa(t.url,"models"),s=await fetch(e,{method:"GET",headers:{Authorization:`Bearer ${t.apiKey}`}});if(!s.ok)return[];let r=await s.json();return r.data&&Array.isArray(r.data)?r.data.map(o=>o.id||o.name).filter(Boolean).sort():[]}catch{return[]}}var ua,Ic,Cc,Dc,Ws=W(()=>{De();ua="settings",Ic="api_presets",Cc="current_preset";Dc={IDLE:"idle",CONNECTING:"connecting",SUCCESS:"success",ERROR:"error"}});var va={};ue(va,{createPreset:()=>Er,createPresetFromCurrentConfig:()=>Vc,deletePreset:()=>Fs,duplicatePreset:()=>Gc,exportPresets:()=>Yo,generateUniquePresetName:()=>Go,getActiveConfig:()=>Ho,getActivePresetName:()=>Mr,getAllPresets:()=>xt,getPreset:()=>Lt,getPresetNames:()=>Yc,getStarredPresets:()=>Fo,importPresets:()=>qo,presetExists:()=>js,renamePreset:()=>qc,switchToPreset:()=>Bt,togglePresetStar:()=>jo,updatePreset:()=>Wo,validatePreset:()=>Jc});function Hc(){return{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}}}function ha(){return C.get(Fc,Hc())}function Ee(){return C.get(ma,[])}function Nt(t){C.set(ma,t)}function Ar(){return C.get(ba,"")}function _r(t){C.set(ba,t||"")}function xt(){return Ee()}function Yc(){return Ee().map(e=>e.name)}function Lt(t){return!t||typeof t!="string"?null:Ee().find(s=>s.name===t)||null}function js(t){return!t||typeof t!="string"?!1:Ee().some(s=>s.name===t)}function Er(t){let{name:e,description:s,apiConfig:r}=t;if(!e||typeof e!="string"||!e.trim())return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let o=e.trim();if(js(o))return{success:!1,message:`\u9884\u8BBE "${o}" \u5DF2\u5B58\u5728`};let n={name:o,description:s||"",apiConfig:{url:r?.url||"",apiKey:r?.apiKey||"",model:r?.model||"",useMainApi:r?.useMainApi??!0,stream:r?.stream??!1,max_tokens:r?.max_tokens||4096,temperature:r?.temperature??.7,top_p:r?.top_p??.9},createdAt:Date.now(),updatedAt:Date.now()},a=Ee();return a.push(n),Nt(a),{success:!0,message:`\u9884\u8BBE "${o}" \u521B\u5EFA\u6210\u529F`,preset:n}}function Wo(t,e){if(!t||typeof t!="string")return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=Ee(),r=s.findIndex(a=>a.name===t);if(r===-1)return{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`};if(e.name&&e.name!==t)return{success:!1,message:"\u4E0D\u652F\u6301\u4FEE\u6539\u9884\u8BBE\u540D\u79F0\uFF0C\u8BF7\u521B\u5EFA\u65B0\u9884\u8BBE"};let o=s[r],n={...o,...e,name:o.name,updatedAt:Date.now()};return e.apiConfig&&(n.apiConfig={...o.apiConfig,...e.apiConfig}),s[r]=n,Nt(s),{success:!0,message:`\u9884\u8BBE "${t}" \u66F4\u65B0\u6210\u529F`,preset:n}}function Fs(t){if(!t||typeof t!="string")return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let e=Ee(),s=e.findIndex(r=>r.name===t);return s===-1?{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`}:(e.splice(s,1),Nt(e),Ar()===t&&_r(""),{success:!0,message:`\u9884\u8BBE "${t}" \u5DF2\u5220\u9664`})}function qc(t,e){if(!t||typeof t!="string")return{success:!1,message:"\u539F\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};if(!e||typeof e!="string"||!e.trim())return{success:!1,message:"\u65B0\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=e.trim();if(!js(t))return{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`};if(js(s))return{success:!1,message:`\u9884\u8BBE "${s}" \u5DF2\u5B58\u5728`};let r=Ee(),o=r.find(n=>n.name===t);return o&&(o.name=s,o.updatedAt=Date.now(),Nt(r),Ar()===t&&_r(s)),{success:!0,message:`\u9884\u8BBE\u5DF2\u91CD\u547D\u540D\u4E3A "${s}"`}}function Gc(t,e){if(!t||typeof t!="string")return{success:!1,message:"\u6E90\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};if(!e||typeof e!="string"||!e.trim())return{success:!1,message:"\u76EE\u6807\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=e.trim(),r=Lt(t);if(!r)return{success:!1,message:`\u6E90\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`};if(js(s))return{success:!1,message:`\u9884\u8BBE "${s}" \u5DF2\u5B58\u5728`};let o={...JSON.parse(JSON.stringify(r)),name:s,createdAt:Date.now(),updatedAt:Date.now()},n=Ee();return n.push(o),Nt(n),{success:!0,message:`\u9884\u8BBE\u5DF2\u590D\u5236\u4E3A "${s}"`,preset:o}}function jo(t){if(!t||typeof t!="string")return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let e=Ee(),s=e.find(r=>r.name===t);return s?(s.starred=!s.starred,s.updatedAt=Date.now(),Nt(e),{success:!0,message:s.starred?`\u5DF2\u5C06 "${t}" \u6DFB\u52A0\u5230\u9884\u89C8\u5217\u8868`:`\u5DF2\u5C06 "${t}" \u4ECE\u9884\u89C8\u5217\u8868\u79FB\u9664`,starred:s.starred}):{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`}}function Fo(){return Ee().filter(e=>e.starred===!0)}function Bt(t){if(!t)return _r(""),{success:!0,message:"\u5DF2\u5207\u6362\u5230\u5F53\u524DAPI\u914D\u7F6E"};let e=Lt(t);return e?(_r(t),{success:!0,message:`\u5DF2\u5207\u6362\u5230\u9884\u8BBE "${t}"`,apiConfig:e.apiConfig}):{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`}}function Mr(){return Ar()}function Ho(){let t=Ar();if(t){let s=Lt(t);if(s)return{presetName:t,apiConfig:s.apiConfig}}return{presetName:"",apiConfig:ha().apiConfig||{}}}function Yo(t=null){if(t){let s=Lt(t);if(!s)throw new Error(`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`);return JSON.stringify(s,null,2)}let e=Ee();return JSON.stringify(e,null,2)}function qo(t,e={overwrite:!1}){let s;try{s=JSON.parse(t)}catch{return{success:!1,message:"JSON\u89E3\u6790\u5931\u8D25",imported:0}}let r=Array.isArray(s)?s:[s];if(r.length===0)return{success:!1,message:"\u6CA1\u6709\u627E\u5230\u6709\u6548\u7684\u9884\u8BBE\u6570\u636E",imported:0};let o=Ee(),n=0;for(let a of r){if(!a.name||typeof a.name!="string"||!a.apiConfig||typeof a.apiConfig!="object")continue;let i=o.findIndex(l=>l.name===a.name);i>=0?e.overwrite&&(a.updatedAt=Date.now(),o[i]=a,n++):(a.createdAt=a.createdAt||Date.now(),a.updatedAt=Date.now(),o.push(a),n++)}return n>0&&Nt(o),{success:!0,message:`\u6210\u529F\u5BFC\u5165 ${n} \u4E2A\u9884\u8BBE`,imported:n}}function Vc(t,e=""){let s=ha();return Er({name:t,description:e,apiConfig:s.apiConfig})}function Jc(t){let e=[];return(!t.name||typeof t.name!="string"||!t.name.trim())&&e.push("\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"),(!t.apiConfig||typeof t.apiConfig!="object")&&e.push("\u7F3A\u5C11API\u914D\u7F6E"),{valid:e.length===0,errors:e}}function Go(t){(!t||typeof t!="string")&&(t="\u65B0\u9884\u8BBE");let e=Ee(),s=new Set(e.map(o=>o.name));if(!s.has(t))return t;let r=1;for(;s.has(`${t} (${r})`);)r++;return`${t} (${r})`}var Fc,ma,ba,Hs=W(()=>{De();Fc="settings",ma="api_presets",ba="current_preset"});var P,Vo,$,ge=W(()=>{P={STORAGE_CHANGED:"storage:changed",STORAGE_CLEARED:"storage:cleared",PRESET_CREATED:"preset:created",PRESET_UPDATED:"preset:updated",PRESET_DELETED:"preset:deleted",PRESET_ACTIVATED:"preset:activated",PRESET_IMPORTED:"preset:imported",PRESET_EXPORTED:"preset:exported",API_CONFIG_UPDATED:"api:configUpdated",API_REQUEST_START:"api:requestStart",API_REQUEST_SUCCESS:"api:requestSuccess",API_REQUEST_ERROR:"api:requestError",API_CONNECTION_TESTED:"api:connectionTested",TOOL_REGISTERED:"tool:registered",TOOL_UNREGISTERED:"tool:unregistered",TOOL_UPDATED:"tool:updated",TOOL_RUNTIME_UPDATED:"tool:runtimeUpdated",TOOL_ENABLED:"tool:enabled",TOOL_DISABLED:"tool:disabled",TOOL_EXECUTING:"tool:executing",TOOL_EXECUTED:"tool:executed",TOOL_ERROR:"tool:error",TOOL_EXECUTION_STARTED:"tool:executionStarted",TOOL_EXECUTION_FAILED:"tool:executionFailed",REGEX_RULE_ADDED:"regex:ruleAdded",REGEX_RULE_UPDATED:"regex:ruleUpdated",REGEX_RULE_DELETED:"regex:ruleDeleted",REGEX_RULES_CLEARED:"regex:rulesCleared",REGEX_PRESET_LOADED:"regex:presetLoaded",REGEX_EXTRACTED:"regex:extracted",UI_INITIALIZED:"ui:initialized",UI_RENDER_REQUESTED:"ui:renderRequested",UI_TAB_CHANGED:"ui:tabChanged",UI_SUBTAB_CHANGED:"ui:subTabChanged",UI_POPUP_OPENED:"ui:popupOpened",UI_POPUP_CLOSED:"ui:popupClosed",UI_WINDOW_CREATED:"ui:windowCreated",UI_WINDOW_CLOSED:"ui:windowClosed",APP_INITIALIZING:"app:initializing",APP_INITIALIZED:"app:initialized",APP_ERROR:"app:error",SETTINGS_UPDATED:"settings:updated",TOOL_CONTEXT_INJECTED:"tool:contextInjected",TOOL_CONTEXT_CLEARED:"tool:contextCleared",BYPASS_PRESET_CREATED:"bypass:presetCreated",BYPASS_PRESET_UPDATED:"bypass:presetUpdated",BYPASS_PRESET_DELETED:"bypass:presetDeleted",BYPASS_PRESET_ACTIVATED:"bypass:presetActivated",TOOL_OUTPUT_MODE_CHANGED:"tool:outputModeChanged"},Vo=class{constructor(){this.listeners=new Map,this.onceCallbacks=new Map,this.history=[],this.maxHistorySize=100,this.debugMode=!1}on(e,s,r={}){if(!e||typeof s!="function")return console.warn("[EventBus] \u65E0\u6548\u7684\u4E8B\u4EF6\u6216\u56DE\u8C03"),()=>{};let{priority:o=0}=r;this.listeners.has(e)||this.listeners.set(e,new Set);let n={callback:s,priority:o};return this.listeners.get(e).add(n),this.debugMode&&console.log(`[EventBus] \u8BA2\u9605: ${e}`),()=>this.off(e,s)}off(e,s){let r=this.listeners.get(e);if(r){for(let o of r)if(o.callback===s){r.delete(o);break}this.debugMode&&console.log(`[EventBus] \u53D6\u6D88\u8BA2\u9605: ${e}`)}}emit(e,s){this.debugMode&&console.log(`[EventBus] \u53D1\u5E03: ${e}`,s),this._addToHistory(e,s);let r=this.listeners.get(e);if(!r||r.size===0)return;let o=Array.from(r).sort((n,a)=>a.priority-n.priority);for(let{callback:n}of o)try{n(s)}catch(a){console.error(`[EventBus] \u4E8B\u4EF6\u5904\u7406\u9519\u8BEF (${e}):`,a)}}once(e,s){let r=o=>{this.off(e,r),s(o)};return this.on(e,r)}wait(e,s=0){return new Promise((r,o)=>{let n=null,a=this.once(e,i=>{n&&clearTimeout(n),r(i)});s>0&&(n=setTimeout(()=>{a(),o(new Error(`\u7B49\u5F85\u4E8B\u4EF6\u8D85\u65F6: ${e}`))},s))})}hasListeners(e){let s=this.listeners.get(e);return s&&s.size>0}listenerCount(e){let s=this.listeners.get(e);return s?s.size:0}removeAllListeners(e){e?this.listeners.delete(e):this.listeners.clear()}setDebugMode(e){this.debugMode=e}_addToHistory(e,s){this.history.push({event:e,data:s,timestamp:Date.now()}),this.history.length>this.maxHistorySize&&this.history.shift()}getHistory(e){return e?this.history.filter(s=>s.event===e):[...this.history]}clearHistory(){this.history=[]}},$=new Vo});function zt(){return typeof window.parent<"u"&&window.parent!==window&&window.parent.document?window.parent.document:document}function x(t){return typeof t!="string"?"":t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function S(t,e,s=3e3){e||(e=t==="error"?"\u64CD\u4F5C\u5931\u8D25":"\u64CD\u4F5C\u5B8C\u6210");let r=typeof window.parent<"u"&&window.parent!==window?window.parent:window;if(r.toastr){r.toastr[t](e,"YouYou \u5DE5\u5177\u7BB1",{timeOut:s,progressBar:!0});return}Xc(t,e,s),console.log(`[YouYou \u5DE5\u5177\u7BB1] [${t.toUpperCase()}] ${e}`)}function me(t,e,s={}){e||(e=t==="error"?"\u64CD\u4F5C\u5931\u8D25":"\u64CD\u4F5C\u5B8C\u6210");let{duration:r=3500,sticky:o=!1,noticeId:n=""}=s,a=zt();if(!a?.body){S(t,e,r);return}let i="yyt-top-notice-container",l="yyt-top-notice-styles",c=a.getElementById(i);if(c||(c=a.createElement("div"),c.id=i,c.style.cssText=`
      position: fixed;
      top: 12px;
      left: 50%;
  ...
  `,i.textContent=e,!r.getElementById("yyt-toast-styles")){let l=r.createElement("style");l.id="yyt-toast-styles",l.textContent=`
    ...
    `,r.head.appendChild(l)}r.body.appendChild(i),setTimeout(()=>{i.style.animation="yyt-toast-out 0.3s ease forwards",setTimeout(()=>{i.remove()},300)},s)}function D(){if(Kt)return Kt;if(typeof window.parent<"u"&&window.parent!==window)try{if(window.parent.jQuery)return Kt=window.parent.jQuery,Kt}catch{}return window.jQuery&&(Kt=window.jQuery),Kt}function Qc(){Kt=null}function B(t){if(!t||t.length===0)return!1;let e=t[0];if(!e||e.nodeType!==1)return!1;let s=e.ownerDocument||document;return e.isConnected?s?.documentElement?.contains?s.documentElement.contains(e):!0:!1}function wt(...t){return t.flat(1/0).flatMap(e=>String(e||"").split(/\s+/)).map(e=>e.trim()).filter(Boolean).join(" ")}function ys(t={}){return Object.entries(t).filter(([,e])=>e!=null&&e!==!1).map(([e,s])=>s===!0?e:`${e}="${x(String(s))}"`).join(" ")}function Ta(t=[],e="",s=""){let r=String(e??""),o=t.find(n=>n.value===r)||t.find(n=>n.disabled!==!0)||null;return o||{value:r,label:s||r||"\u8BF7\u9009\u62E9",disabled:!1}}function Zc(t=""){return String(t||"").split(/\s+/).map(e=>e.trim()).filter(e=>e&&e!=="yyt-select"&&e!=="yyt-native-select-bridge")}function xa(t,e){let s=D();if(!s||!e?.length)return null;let r=e.attr("id")?`#${e.attr("id")}`:e.attr("data-yyt-select-key")?`[data-yyt-select-key="${e.attr("data-yyt-select-key")}"]`:"";if(!r)return null;let n=t.find("[data-yyt-custom-select]").filter((a,i)=>String(s(i).attr("data-yyt-select-target")||"")===r);return n.length?n.first():null}function _a(t){let e=t?.[0];return e?.ownerDocument?e.ownerDocument:typeof window.parent<"u"&&window.parent!==window&&window.parent.document?window.parent.document:document}function ed(t){if(!D()||!B(t))return null;let s=t.find("[data-yyt-custom-select]");return s.length?s:null}function Aa(t,e){if(!D()||!e?.length)return null;let r=e.find("[data-yyt-select-native]").first();if(r.length)return r;let o=String(e.attr("data-yyt-select-target")||"").trim();if(!o)return null;let n=t.find(o).first();return n.length?n:null}function Ea(t=null){return t?.jquery&&t[0]?.ownerDocument?t[0].ownerDocument:t?.ownerDocument?t.ownerDocument:t?.nodeType===9?t:zt()}function Xe(t=null){let e=Ea(t),s=wa.get(e);return s||(s={targetDoc:e,layer:null,activeRoot:null,activeDropdown:null,placeholder:null,cleanup:null},wa.set(e,s)),s}function td(t=null){let e=Ea(t);if(!e?.body)return null;let s=Xe(e);if(s.layer&&s.layer.isConnected)return s.layer;let r=e.getElementById(Sa);return r||(r=e.createElement("div"),r.id=Sa,r.className="yyt-select-portal-layer",e.body.appendChild(r)),s.layer=r,r}function kr(t){if(!D()||!t?.length)return null;let s=t.find("[data-yyt-select-trigger]").first();return s.length?s:t.find(".yyt-select-trigger").first()}function Ma(t){let e=D();if(!e||!t?.length)return null;let s=Xe(t);if(s.activeRoot===t[0]&&s.activeDropdown)return e(s.activeDropdown);let r=t.find("[data-yyt-select-dropdown]").first();return r.length?r:t.find(".yyt-select-dropdown").first()}function sd(t){t&&(t.classList.remove("yyt-floating-open"),t.removeAttribute("data-yyt-floating"),t.removeAttribute("data-yyt-floating-placement"),t.style.position="",t.style.top="",t.style.left="",t.style.right="",t.style.width="",t.style.minWidth="",t.style.maxWidth="",t.style.maxHeight="",t.style.visibility="",t.style.zIndex="")}function ka(t,e=null){if(!t)return!1;let s=Xe(e||t);return s.activeRoot?.contains?.(t)||s.activeDropdown?.contains?.(t)?!0:!!t.closest?.("[data-yyt-custom-select], .yyt-select-portal-layer")}function rd(t){if(!t?.targetDoc||typeof t.cleanup=="function")return;let e=t.targetDoc,s=e.defaultView||window,r=i=>{!t.activeRoot||!t.activeDropdown||ka(i.target,e)||Ie(e)},o=i=>{if(i.key!=="Escape")return;let l=t.activeRoot;Ie(e);let c=D();c&&l&&kr(c(l))?.trigger("focus")},n=()=>{Qo(e)},a=()=>{Qo(e)};e.addEventListener("mousedown",r,!0),e.addEventListener("keydown",o,!0),s.addEventListener("resize",n),e.addEventListener("scroll",a,!0),t.cleanup=()=>{e.removeEventListener("mousedown",r,!0),e.removeEventListener("keydown",o,!0),s.removeEventListener("resize",n),e.removeEventListener("scroll",a,!0)}}function od(t){typeof t?.cleanup=="function"&&t.cleanup(),t&&(t.cleanup=null)}function Xo(t){let e=D();if(!e||!t?.activeRoot||!t?.activeDropdown)return;let s=t.targetDoc;if(!s?.body?.contains?.(t.activeRoot)){Ie(s);return}let r=e(t.activeRoot),o=kr(r),n=t.activeDropdown,a=s?.defaultView||window;if(!o?.length||!n?.isConnected||!r[0]?.isConnected){Ie(s);return}let i=o[0].getBoundingClientRect(),l=a.innerWidth||s.documentElement?.clientWidth||0,c=a.innerHeight||s.documentElement?.clientHeight||0,d=12,u=8,y=Math.max(0,c-i.bottom-d-u),p=Math.max(0,i.top-d-u),f=y<220&&p>y,m=Math.max(120,Math.floor((f?p:y)||0));n.setAttribute("data-yyt-floating","true"),n.setAttribute("data-yyt-floating-placement",f?"top":"bottom"),n.classList.add("yyt-floating-open");let _=Math.ceil(i.width),M=Math.max(_,Math.floor(l-d*2)),w=n.style.width,E=n.style.minWidth,k=n.style.maxWidth,I=n.style.visibility;n.style.width="max-content",n.style.minWidth=`${_}px`,n.style.maxWidth=`${M}px`,n.style.visibility="hidden";let N=Math.ceil(n.scrollWidth||n.getBoundingClientRect().width||_),se=Math.max(_,Math.min(M,N)),q=Math.min(n.scrollHeight||m,m);n.style.width=w,n.style.minWidth=E,n.style.maxWidth=k,n.style.visibility=I;let O=Math.round(i.left);O+se>l-d&&(O=Math.max(d,Math.round(l-d-se))),O=Math.max(d,O);let ee=Math.round(f?i.top-u-q:i.bottom+u);ee=Math.max(d,Math.min(ee,Math.round(c-d-q))),n.style.position="fixed",n.style.top=`${ee}px`,n.style.left=`${O}px`,n.style.right="auto",n.style.width=`${se}px`,n.style.minWidth=`${_}px`,n.style.maxWidth=`${M}px`,n.style.maxHeight=`${Math.floor(m)}px`,n.style.visibility="",n.style.zIndex="10050"}function Ie(t=null){let e=D(),s=Xe(t);if(!e||!s?.activeRoot)return;let r=s.activeRoot,o=s.activeDropdown,n=s.placeholder,a=e(r),i=kr(a);o&&(sd(o),n?.parentNode?n.parentNode.insertBefore(o,n):r?.isConnected?r.appendChild(o):o.remove()),n?.parentNode?.removeChild(n),a.removeClass("yyt-open"),i?.attr("aria-expanded","false"),s.activeRoot=null,s.activeDropdown=null,s.placeholder=null,od(s)}function Qo(t=null){let e=Xe(t);!e?.activeRoot||!e?.activeDropdown||Xo(e)}function Ia(t){if(!D()||!t?.length)return;let s=t.first(),r=kr(s),o=Ma(s);if(!r?.length||!o?.length||r.prop("disabled"))return;let n=Xe(s);if(n.activeRoot===s[0]){Xo(n);return}Ie(s);let a=td(s);if(!a)return;let i=o[0],l=n.targetDoc.createComment("yyt-select-dropdown-placeholder");i.parentNode?.insertBefore(l,i),a.appendChild(i),n.activeRoot=s[0],n.activeDropdown=i,n.placeholder=l,s.addClass("yyt-open"),r.attr("aria-expanded","true"),rd(n),Xo(n)}function nd(t,e){let s=D();if(!s||!e?.length)return null;let r=e.closest("[data-yyt-custom-select]");if(r.length)return r.first();let o=Xe(e);if(o.activeRoot&&o.activeDropdown?.contains?.(e[0])){let n=s(o.activeRoot);return t.has(o.activeRoot).length?n:null}return null}function Ys(t){let e=Xe(t);t?.length&&e.activeRoot&&e.activeRoot!==t[0]||Ie(t)}function Ir(t){let e=Xe(t);if(t?.length&&e.activeRoot===t[0]){Ie(t);return}Ia(t)}function Jo(t,e,s=null){let r=D();if(!r||!e?.length)return;let o=s||Aa(t,e);if(!o?.length)return;let n=Array.isArray(o.data("yytCustomSelectOptions"))?o.data("yytCustomSelectOptions"):[],a=Ta(n,o.val(),e.attr("data-yyt-select-placeholder")||""),i=String(a.value??""),l=String(a.label??""),c=o.is(":disabled");e.find(".yyt-select-value").text(l).attr("data-value",i).data("value",i);let d=Ma(e);(d?.length?d.find("[data-yyt-select-option]"):e.find("[data-yyt-select-option]")).each((p,f)=>{let h=r(f),m=String(h.attr("data-value")||"")===i;h.toggleClass("yyt-selected",m).attr("aria-selected",String(m))});let y=e.find("[data-yyt-select-trigger]").first();y.prop("disabled",c),c&&(Ys(e),e.removeClass("yyt-open"),y.attr("aria-expanded","false"))}function Cr(t=[]){return Array.isArray(t)?t.map(e=>{if(e&&typeof e=="object"&&!Array.isArray(e)){let r=String(e.value??""),o=String(e.label??e.text??e.name??r);return{value:r,label:o,disabled:e.disabled===!0}}let s=String(e??"");return{value:s,label:s,disabled:!1}}):[]}function Pr(t={}){let{selectedValue:e="",options:s=[],placeholder:r="\u8BF7\u9009\u62E9",disabled:o=!1,includeNative:n=!0,nativeTag:a="input",nativeType:i="hidden",rootAttributes:l={},nativeAttributes:c={},triggerAttributes:d={},dropdownAttributes:u={},optionAttributes:y={},optionClass:p="",optionTextClass:f=""}=t,h=Cr(s),m=Ta(h,e,r),_=o===!0||h.length===0,M=ys({...l,class:wt("yyt-custom-select",l.class),"data-yyt-custom-select":l["data-yyt-custom-select"]??"true","data-yyt-select-placeholder":r}),w=ys({type:"button",...d,class:wt("yyt-select-trigger",d.class),"data-yyt-select-trigger":d["data-yyt-select-trigger"]??"true","aria-haspopup":d["aria-haspopup"]??"listbox","aria-expanded":d["aria-expanded"]??"false",disabled:_?!0:d.disabled}),E=ys({...u,class:wt("yyt-select-dropdown",u.class),"data-yyt-select-dropdown":u["data-yyt-select-dropdown"]??"true",role:u.role??"listbox"}),k=n?(()=>{let I={...c,class:wt(c.class),"data-yyt-select-native":c["data-yyt-select-native"]??"true",disabled:_?!0:c.disabled};return a==="select"?`<select ${ys(I)}>${h.map(q=>`
  ...
  `}function ye(t,e="yytCustomSelect"){let s=D();if(!s||!B(t))return;let r=_a(t),o=Xe(r);o.activeRoot&&t.has(o.activeRoot).length&&Ie(r),t.off(`.${e}`),s(r).off(`click.${e}`),s(r).off(`mousedown.${e}`),t.find('[data-yyt-enhanced-select="true"]').remove(),t.find(".yyt-native-select-bridge").each((n,a)=>{let i=s(a),l=i.attr("data-yyt-original-style");l!==void 0&&l?i.attr("style",l):i.removeAttr("style"),i.removeClass("yyt-native-select-bridge").removeAttr("data-yyt-original-style").removeAttr("data-yyt-select-key").removeData("yytCustomSelectOptions")})}function we(t,e={}){let s=D();if(!s||!B(t))return;let{namespace:r="yytCustomSelect",selectors:o=[]}=e,n=Array.isArray(o)?o.filter(Boolean):[o].filter(Boolean);if(n.length===0)return;ye(t,r);let a=n.join(", "),i=_a(t);t.find(a).each((l,c)=>{let d=s(c),u=String(d.attr("id")||"").trim(),y=u||`yyt-select-${Date.now()}-${l}`,p=u?`#${u}`:`[data-yyt-select-key="${y}"]`,f=`${y}-dropdown`,h=Zc(d.attr("class")),m=d.attr("style"),_=d.find("option").map((E,k)=>{let I=s(k);return{value:String(I.attr("value")??I.val()??""),label:I.text(),disabled:I.is(":disabled")}}).get();d.attr("data-yyt-original-style",m??"").attr("data-yyt-select-key",y).addClass("yyt-native-select-bridge").css("display","none").data("yytCustomSelectOptions",_);let M=Pr({includeNative:!1,selectedValue:d.val(),options:_,disabled:d.is(":disabled"),placeholder:_[0]?.label||"\u8BF7\u9009\u62E9",rootAttributes:{class:wt(h),style:m||void 0,"data-yyt-enhanced-select":"true","data-yyt-select-target":p},triggerAttributes:{id:`${y}-trigger`,"aria-controls":f},dropdownAttributes:{id:f}});d.after(M);let w=xa(t,d);Jo(t,w,d)}),t.on(`click.${r}`,"[data-yyt-select-trigger]",l=>{l.preventDefault(),l.stopPropagation();let c=s(l.currentTarget);if(c.prop("disabled"))return;let d=c.closest("[data-yyt-custom-select]");Ir(d)}),t.on(`change.${r}`,a,l=>{let c=s(l.currentTarget),d=c.find("option").map((y,p)=>{let f=s(p);return{value:String(f.attr("value")??f.val()??""),label:f.text(),disabled:f.is(":disabled")}}).get();c.data("yytCustomSelectOptions",d);let u=xa(t,c);Jo(t,u,c)}),s(i).off(`click.${r}`).on(`click.${r}`,l=>{if(ka(l.target,i))return;let c=ed(t);c?.length&&(Ie(i),c.filter(".yyt-open").removeClass("yyt-open").find("[data-yyt-select-trigger]").attr("aria-expanded","false"))}),s(i).off(`mousedown.${r}`,".yyt-select-portal-layer [data-yyt-select-option]").on(`mousedown.${r}`,".yyt-select-portal-layer [data-yyt-select-option]",l=>{l.preventDefault(),l.stopPropagation();let c=s(l.currentTarget);if(c.prop("disabled"))return;let d=nd(t,c);if(!d?.length)return;let u=Aa(t,d);if(!u?.length)return;let y=String(c.attr("data-value")||"");u.val(y).trigger("change"),Jo(t,d,u),Ys(d)})}function qs(t,e=b){if(!D()||!B(t))return{url:"",apiKey:"",model:"",useMainApi:!0,stream:!1,max_tokens:4096,temperature:.7,top_p:.9};let r=t.find(`#${e}-model`).val()?.trim()||"",o=t.find(`#${e}-model-select`);return o.is(":visible")&&(r=o.val()||r),{url:t.find(`#${e}-api-url`).val()?.trim()||"",apiKey:t.find(`#${e}-api-key`).val()||"",model:r,useMainApi:t.find(`#${e}-use-main-api`).is(":checked"),stream:t.find(`#${e}-stream`).is(":checked"),max_tokens:parseInt(t.find(`#${e}-max-tokens`).val())||4096,temperature:parseFloat(t.find(`#${e}-temperature`).val())??.7,top_p:parseFloat(t.find(`#${e}-top-p`).val())??.9}}function Rr(t,e,s=b){if(!D()||!B(t)||!e)return;t.find(`#${s}-api-url`).val(e.url||""),t.find(`#${s}-api-key`).val(e.apiKey||""),t.find(`#${s}-model`).val(e.model||""),t.find(`#${s}-stream`).prop("checked",e.stream===!0),t.find(`#${s}-max-tokens`).val(e.max_tokens||4096),t.find(`#${s}-temperature`).val(e.temperature??.7),t.find(`#${s}-top-p`).val(e.top_p??.9);let o=e.useMainApi??!0;t.find(`#${s}-use-main-api`).prop("checked",o);let a=t.find(`#${s}-custom-api-fields`);o?a.addClass("yyt-disabled").find("input, button, select").prop("disabled",!0):a.removeClass("yyt-disabled").find("input, button, select").prop("disabled",!1),t.find(`#${s}-model`).show(),t.find(`#${s}-model-select`).hide()}function Gs(t){let{id:e,title:s,body:r,width:o="380px",wide:n=!1,dialogClass:a="",bodyClass:i="",footerClass:l=""}=t;return`
...
\u70B9\u51FB"\u786E\u5B9A"\u8986\u76D6\u9884\u8BBE\uFF0C\u70B9\u51FB"\u53D6\u6D88"\u4EC5\u4FDD\u5B58\u5F53\u524D\u914D\u7F6E\u5E76\u5207\u6362\u5230\u201C\u5F53\u524D\u914D\u7F6E\u201D`)){ds(s),Bt(""),this._setSelectedPresetName(t,""),S("success","API\u914D\u7F6E\u5DF2\u4FDD\u5B58\uFF0C\u5E76\u5DF2\u5207\u6362\u5230\u5F53\u524DAPI\u914D\u7F6E"),this._rerender(t);return}ds(s);let n=Wo(r,{apiConfig:s});n.success?(this._setSelectedPresetName(t,r),S("success",`\u914D\u7F6E\u5DF2\u4FDD\u5B58\u5E76\u8986\u76D6\u9884\u8BBE "${r}"`),Bt(r),$.emit(P.PRESET_UPDATED,{name:r}),this._rerender(t)):S("error",n.message);return}ds(s),S("success","API\u914D\u7F6E\u5DF2\u4FDD\u5B58")}),t.find(`#${b}-reset-api-config`).on("click",()=>{confirm("\u786E\u5B9A\u8981\u91CD\u7F6EAPI\u914D\u7F6E\u5417\uFF1F")&&(Bt(""),this._setSelectedPresetName(t,""),ds({url:"",apiKey:"",model:"",useMainApi:!0,stream:!1,max_tokens:4096,temperature:.7,top_p:.9}),this._rerender(t),S("info","API\u914D\u7F6E\u5DF2\u91CD\u7F6E"))}),t.find(`#${b}-save-as-preset`).on("click",()=>{this._showSavePresetDialog(t,e)})},_bindFileEvents(t,e){t.find(`#${b}-export-presets`).on("click",()=>{try{let s=Yo();lt(s,`youyou_toolkit_presets_${Date.now()}.json`),S("success","\u9884\u8BBE\u5DF2\u5BFC\u51FA")}catch(s){S("error",`\u5BFC\u51FA\u5931\u8D25: ${s.message}`)}}),t.find(`#${b}-import-presets`).on("click",()=>{t.find(`#${b}-import-file`).click()}),t.find(`#${b}-import-file`).on("change",async s=>{let r=s.target.files[0];if(r){try{let o=await ct(r),n=qo(o,{overwrite:!0});S(n.success?"success":"error",n.message),n.imported>0&&this._rerender(t)}catch(o){S("error",`\u5BFC\u5165\u5931\u8D25: ${o.message}`)}e(s.target).val("")}})},_showSavePresetDialog(t,e){let r=xt().map(d=>d.name),o=Go("\u65B0\u9884\u8BBE"),n=`
    ...
    `},renderTo(t){let e=this.render({selectedPresetName:this._getSelectedPresetName(t)});t.html(e),this.bindEvents(t,{})}}});var Ua={};ue(Ua,{MESSAGE_MACROS:()=>za,addTagRule:()=>ps,createRuleTemplate:()=>Oa,default:()=>ld,deleteRulePreset:()=>Ba,deleteRuleTemplate:()=>La,deleteTagRule:()=>Lr,escapeRegex:()=>Ut,exportRulesConfig:()=>Ur,extractComplexTag:()=>Pa,extractCurlyBraceTag:()=>an,extractHtmlFormatTag:()=>Ra,extractSimpleTag:()=>nn,extractTagContent:()=>Wt,generateTagSuggestions:()=>Or,getAllRulePresets:()=>Kr,getAllRuleTemplates:()=>$a,getContentBlacklist:()=>jt,getRuleTemplate:()=>Da,getTagRules:()=>dt,importRulesConfig:()=>Wr,isValidTagName:()=>on,loadRulePreset:()=>zr,saveRulesAsPreset:()=>Br,scanTextForTags:()=>Dr,setContentBlacklist:()=>Xs,setTagRules:()=>Nr,shouldSkipContent:()=>rn,testRegex:()=>Ka,updateRuleTemplate:()=>Na,updateTagRule:()=>gs});function ad(){return{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"},ruleTemplates:[...sn],tagRules:[],contentBlacklist:[],tagRulePresets:{}}}function Ce(){return C.get(Ca,ad())}function Qe(t){C.set(Ca,t)}function $r(){let t=Ce();return be=t.ruleTemplates||[...sn],re=t.tagRules||[],Me=t.contentBlacklist||[],{ruleTemplates:be,tagRules:re,contentBlacklist:Me}}function Ut(t){return typeof t!="string"?"":t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function rn(t,e){if(!e||e.length===0||!t||typeof t!="string")return!1;let s=t.toLowerCase();return e.some(r=>{let o=r.trim().toLowerCase();return o&&s.includes(o)})}function on(t){return!t||typeof t!="string"?!1:/^[a-zA-Z][a-zA-Z0-9_-]*$/.test(t)&&!id.includes(t.toLowerCase())}function nn(t,e){if(!t||!e)return[];let s=[],r=Ut(e),o=new RegExp(`<${r}>([\\s\\S]*?)<\\/${r}>`,"gi");[...t.matchAll(o)].forEach(l=>{l[1]&&s.push(l[1].trim())});let a=(t.match(new RegExp(`<${r}>`,"gi"))||[]).length,i=(t.match(new RegExp(`<\\/${r}>`,"gi"))||[]).length;return a>i&&console.warn(`[YouYouToolkit] \u8B66\u544A: \u53D1\u73B0 ${a-i} \u4E2A\u672A\u95ED\u5408\u7684 <${e}> \u6807\u7B7E`),s}function an(t,e){if(!t||!e)return[];let s=[],r=Ut(e),o=new RegExp(`\\{${r}\\|`,"gi"),n;for(;(n=o.exec(t))!==null;){let a=n.index,i=a+n[0].length,l=1,c=i;for(;c<t.length&&l>0;)t[c]==="{"?l++:t[c]==="}"&&l--,c++;if(l===0){let d=t.substring(i,c-1);d.trim()&&s.push(d.trim())}o.lastIndex=a+1}return s}function Pa(t,e){if(!t||!e)return[];let s=e.split(",");if(s.length!==2)return console.error(`[YouYouToolkit] \u590D\u6742\u6807\u7B7E\u914D\u7F6E\u683C\u5F0F\u9519\u8BEF\uFF0C\u5E94\u8BE5\u5305\u542B\u4E00\u4E2A\u9017\u53F7: ${e}`),[];let r=s[0].trim(),o=s[1].trim(),n=o.match(/<\/(\w+)>/);if(!n)return console.error(`[YouYouToolkit] \u65E0\u6CD5\u89E3\u6790\u7ED3\u675F\u6807\u7B7E: ${o}`),[];let a=n[1],i=new RegExp(`${Ut(r)}([\\s\\S]*?)<\\/${a}>`,"gi"),l=[];return[...t.matchAll(i)].forEach(d=>{d[1]&&l.push(d[1].trim())}),l}function Ra(t,e){if(!t||!e)return[];let s=e.match(/<(\w+)(?:\s[^>]*)?>/);if(!s)return console.error(`[YouYouToolkit] \u65E0\u6CD5\u89E3\u6790HTML\u683C\u5F0F\u6807\u7B7E: ${e}`),[];let r=s[1],o=[],n=new RegExp(`<${r}(?:\\s[^>]*)?>([\\s\\S]*?)<\\/${r}>`,"gi");[...t.matchAll(n)].forEach(c=>{c[1]&&o.push(c[1].trim())});let i=(t.match(new RegExp(`<${r}(?:\\s[^>]*)?>`,"gi"))||[]).length,l=(t.match(new RegExp(`<\\/${r}>`,"gi"))||[]).length;return i>l&&console.warn(`[YouYouToolkit] \u8B66\u544A: \u53D1\u73B0 ${i-l} \u4E2A\u672A\u95ED\u5408\u7684 <${r}> \u6807\u7B7E`),o}function Wt(t,e,s=[]){if(!t)return"";if(!e||e.length===0)return t;let r=e.filter(d=>d.type==="exclude"&&d.enabled),o=e.filter(d=>(d.type==="include"||d.type==="regex_include")&&d.enabled),n=e.filter(d=>d.type==="regex_exclude"&&d.enabled),a=t;for(let d of r)try{let u=new RegExp(`<${Ut(d.value)}(?:\\s[^>]*)?>[\\s\\S]*?<\\/${Ut(d.value)}>`,"gi");a=a.replace(u,"")}catch(u){console.error("[YouYouToolkit] Error applying block exclusion rule:",{rule:d,error:u})}let i=[];if(o.length>0)for(let d of o){let u=[];try{if(d.type==="include")u.push(...nn(a,d.value)),u.push(...an(a,d.value));else if(d.type==="regex_include"){let y=new RegExp(d.value,"gi");[...a.matchAll(y)].forEach(f=>{f[1]&&u.push(f[1])})}}catch(y){console.error("[YouYouToolkit] Error applying inclusion rule:",{rule:d,error:y})}u.forEach(y=>i.push(y.trim()))}else i.push(a);let l=[];for(let d of i){for(let u of n)try{let y=new RegExp(u.value,"gi");d=d.replace(y,"")}catch(y){console.error("[YouYouToolkit] Error applying cleanup rule:",{rule:u,error:y})}rn(d,s)||l.push(d)}return l.join(`

`).replace(/\n\s*\n\s*\n/g,`

`).replace(/^\s+|\s+$/g,"").trim()}async function Dr(t,e={}){let s=performance.now(),{chunkSize:r=5e4,maxTags:o=100,timeoutMs:n=5e3}=e,a=new Set,i=/<(?:\/|)([a-zA-Z0-9_-]+)(?:[^>]*)>|\{([a-zA-Z0-9_-]+)(?:\||})/g,l=0,c=0;for(let u=0;u<t.length;u+=r){let y=t.slice(u,Math.min(u+r,t.length));if(c++,l+=y.length,performance.now()-s>n){console.warn(`[YouYouToolkit] Tag scanning timed out after ${n}ms`);break}let p;for(;(p=i.exec(y))!==null&&a.size<o;){let f=(p[1]||p[2]).toLowerCase();on(f)&&a.add(f)}if(a.size>=o)break;c%5===0&&await new Promise(f=>setTimeout(f,0))}let d=performance.now();return{tags:Array.from(a).sort(),stats:{processingTimeMs:Math.round(d-s),processedChars:l,totalChars:t.length,chunkCount:c,tagsFound:a.size}}}function Or(t,e=25){let s=t.tags.slice(0,e);return{suggestions:s,stats:{totalFound:t.stats.tagsFound,finalCount:s.length}}}function $a(){return be.length===0&&$r(),be}function Da(t){return be.find(e=>e.id===t)}function Oa(t){let e={id:`rule-${Date.now()}`,name:t.name||"\u65B0\u89C4\u5219",description:t.description||"",type:t.type||"include",value:t.value||"",enabled:t.enabled!==!1,createdAt:new Date().toISOString()};return be.push(e),ln(),{success:!0,template:e,message:"\u89C4\u5219\u6A21\u677F\u521B\u5EFA\u6210\u529F"}}function Na(t,e){let s=be.findIndex(r=>r.id===t);return s===-1?{success:!1,message:"\u89C4\u5219\u6A21\u677F\u4E0D\u5B58\u5728"}:(be[s]={...be[s],...e,updatedAt:new Date().toISOString()},ln(),{success:!0,template:be[s],message:"\u89C4\u5219\u6A21\u677F\u66F4\u65B0\u6210\u529F"})}function La(t){let e=be.findIndex(s=>s.id===t);return e===-1?{success:!1,message:"\u89C4\u5219\u6A21\u677F\u4E0D\u5B58\u5728"}:(be.splice(e,1),ln(),{success:!0,message:"\u89C4\u5219\u6A21\u677F\u5DF2\u5220\u9664"})}function ln(){let t=Ce();t.ruleTemplates=be,Qe(t)}function dt(){return re||$r(),re}function Nr(t){re=t||[];let e=Ce();e.tagRules=re,Qe(e)}function ps(t){let e={id:`tag-${Date.now()}`,type:t.type||"include",value:t.value||"",enabled:t.enabled!==!1};re.push(e);let s=Ce();return s.tagRules=re,Qe(s),{success:!0,rule:e,message:"\u89C4\u5219\u6DFB\u52A0\u6210\u529F"}}function gs(t,e){if(t<0||t>=re.length)return{success:!1,message:"\u89C4\u5219\u7D22\u5F15\u65E0\u6548"};re[t]={...re[t],...e};let s=Ce();return s.tagRules=re,Qe(s),{success:!0,rule:re[t],message:"\u89C4\u5219\u66F4\u65B0\u6210\u529F"}}function Lr(t){if(t<0||t>=re.length)return{success:!1,message:"\u89C4\u5219\u7D22\u5F15\u65E0\u6548"};re.splice(t,1);let e=Ce();return e.tagRules=re,Qe(e),{success:!0,message:"\u89C4\u5219\u5DF2\u5220\u9664"}}function jt(){return Me||$r(),Me}function Xs(t){Me=t||[];let e=Ce();e.contentBlacklist=Me,Qe(e)}function Br(t,e=""){if(!t||!t.trim())return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=Ce();s.tagRulePresets||(s.tagRulePresets={});let r=`preset-${Date.now()}`;return s.tagRulePresets[r]={id:r,name:t.trim(),description:e.trim(),rules:JSON.parse(JSON.stringify(re)),blacklist:JSON.parse(JSON.stringify(Me)),createdAt:new Date().toISOString()},Qe(s),{success:!0,preset:s.tagRulePresets[r],message:"\u9884\u8BBE\u4FDD\u5B58\u6210\u529F"}}function Kr(){let e=Ce().tagRulePresets||{};return Object.values(e)}function zr(t){let e=Ce(),r=(e.tagRulePresets||{})[t];return r?(re=JSON.parse(JSON.stringify(r.rules||[])),Me=JSON.parse(JSON.stringify(r.blacklist||[])),e.tagRules=re,e.contentBlacklist=Me,Qe(e),{success:!0,preset:r,message:"\u9884\u8BBE\u52A0\u8F7D\u6210\u529F"}):{success:!1,message:"\u9884\u8BBE\u4E0D\u5B58\u5728"}}function Ba(t){let e=Ce(),s=e.tagRulePresets||{};return s[t]?(delete s[t],e.tagRulePresets=s,Qe(e),{success:!0,message:"\u9884\u8BBE\u5DF2\u5220\u9664"}):{success:!1,message:"\u9884\u8BBE\u4E0D\u5B58\u5728"}}function Ur(){return JSON.stringify({tagRules:re,contentBlacklist:Me,ruleTemplates:be,tagRulePresets:Ce().tagRulePresets||{}},null,2)}function Wr(t,e={overwrite:!0}){try{let s=JSON.parse(t);if(e.overwrite)re=s.tagRules||[],Me=s.contentBlacklist||[],be=s.ruleTemplates||sn;else if(s.tagRules&&re.push(...s.tagRules),s.contentBlacklist){let o=new Set(Me.map(n=>n.toLowerCase()));s.contentBlacklist.forEach(n=>{o.has(n.toLowerCase())||Me.push(n)})}let r=Ce();return r.tagRules=re,r.contentBlacklist=Me,r.ruleTemplates=be,s.tagRulePresets&&(r.tagRulePresets={...r.tagRulePresets||{},...s.tagRulePresets}),Qe(r),{success:!0,message:"\u914D\u7F6E\u5BFC\u5165\u6210\u529F"}}catch(s){return{success:!1,message:`\u5BFC\u5165\u5931\u8D25: ${s.message}`}}}function Ka(t,e,s="g",r=0){try{if(!t||typeof t!="string")return{success:!1,error:"\u6B63\u5219\u8868\u8FBE\u5F0F\u4E0D\u80FD\u4E3A\u7A7A",matches:[]};let o=new RegExp(t,s),n=[];if(s.includes("g")){let a;for(;(a=o.exec(e))!==null;)a.length>1?n.push({fullMatch:a[0],groups:a.slice(1),index:a.index,extracted:a[r]||a[1]||a[0]}):n.push({fullMatch:a[0],groups:[],index:a.index,extracted:a[0]})}else{let a=o.exec(e);a&&n.push({fullMatch:a[0],groups:a.length>1?a.slice(1):[],index:a.index,extracted:a.length>1?a[r]||a[1]:a[0]})}return{success:!0,matches:n,count:n.length,extracted:n.map(a=>a.extracted)}}catch(o){return{success:!1,error:o.message,matches:[]}}}var Ca,id,sn,be,re,Me,za,ld,jr=W(()=>{De();Ca="settings";id=["font","span","div","p","br","hr","img","a","b","i","u","s","em","strong","small","big","sub","sup","h1","h2","h3","h4","h5","h6","table","tr","td","th","tbody","thead","tfoot","ul","ol","li","form","input","button","select","option","textarea","label","script","style","meta","link","title","head","body","html"],sn=[{id:"exclude-thinking",name:"\u6392\u9664\u601D\u8003\u6807\u7B7E",description:"\u79FB\u9664<thinking>\u6807\u7B7E\u5757",type:"exclude",value:"thinking",enabled:!0},{id:"include-content",name:"\u63D0\u53D6\u5185\u5BB9\u6807\u7B7E",description:"\u63D0\u53D6<content>\u6807\u7B7E\u5185\u5BB9",type:"include",value:"content",enabled:!0},{id:"regex-exclude-cot",name:"\u6392\u9664\u5C0FCoT",description:"\u79FB\u9664HTML\u6CE8\u91CA",type:"regex_exclude",value:"<!--[\\s\\S]*?-->",enabled:!1},{id:"regex-include-details",name:"\u63D0\u53D6details\u6807\u7B7E",description:"\u63D0\u53D6<details>\u6807\u7B7E\u5185\u5BB9",type:"regex_include",value:"<details[^>]*>([\\s\\S]*?)</details>",enabled:!1}],be=[],re=[],Me=[];za={lastMessage:{macro:"{{lastMessage}}",description:"\u6700\u540E\u4E00\u6761\u6D88\u606F"},lastCharMessage:{macro:"{{lastCharMessage}}",description:"\u6700\u540E\u4E00\u6761\u89D2\u8272\u6D88\u606F"},lastUserMessage:{macro:"{{lastUserMessage}}",description:"\u6700\u540E\u4E00\u6761\u7528\u6237\u6D88\u606F"},char:{macro:"{{char}}",description:"\u89D2\u8272\u540D\u79F0"},user:{macro:"{{user}}",description:"\u7528\u6237\u540D\u79F0"},input:{macro:"{{input}}",description:"\u5F53\u524D\u8F93\u5165\u6846\u5185\u5BB9"}};$r();ld={extractTagContent:Wt,extractSimpleTag:nn,extractCurlyBraceTag:an,extractComplexTag:Pa,extractHtmlFormatTag:Ra,escapeRegex:Ut,shouldSkipContent:rn,isValidTagName:on,scanTextForTags:Dr,generateTagSuggestions:Or,getAllRuleTemplates:$a,getRuleTemplate:Da,createRuleTemplate:Oa,updateRuleTemplate:Na,deleteRuleTemplate:La,getTagRules:dt,setTagRules:Nr,addTagRule:ps,updateTagRule:gs,deleteTagRule:Lr,getContentBlacklist:jt,setContentBlacklist:Xs,saveRulesAsPreset:Br,getAllRulePresets:Kr,loadRulePreset:zr,deleteRulePreset:Ba,exportRulesConfig:Ur,importRulesConfig:Wr,testRegex:Ka,MESSAGE_MACROS:za}});var Ft,cn=W(()=>{ge();Se();jr();Ft={id:"regexExtractPanel",render(t){let e=dt(),s=jt(),r=Kr();return`
...
\u2022 \u63D0\u53D6\u82B1\u62EC\u53F7\u5185\u5BB9: \u7C7B\u578B=\u5305\u542B, \u503C=story
    ...
    `},renderTo(t){let e=this.render({});t.html(e),this.bindEvents(t,{})}}});var Va={};ue(Va,{createDefaultToolDefinition:()=>Ht,default:()=>yd,deleteTool:()=>Yr,deleteToolPreset:()=>Ya,exportTools:()=>Vr,getAllTools:()=>Tt,getCurrentToolPreset:()=>qa,getTool:()=>fs,getToolPresets:()=>qr,importTools:()=>Jr,normalizeToolDefinitionToRuntimeConfig:()=>Zs,resetTools:()=>Xr,saveTool:()=>Hr,saveToolPreset:()=>Ha,setCurrentToolPreset:()=>Ga,setToolEnabled:()=>Gr});function cd(t={}){return!t||typeof t!="object"?{}:Object.fromEntries(Object.entries(t).map(([e,s])=>[e,Ht({...s||{},id:e})]))}function Qs(t){return Array.isArray(t)?t.map(e=>String(e||"").trim()).filter(Boolean):[]}function dn(t,e){let s=parseInt(t,10);return Number.isFinite(s)&&s>0?s:e}function Wa(t,e){let s=parseInt(t,10);return Number.isFinite(s)&&s>=0?s:e}function ja(t={}){return{enabled:t?.enabled===!0,settleMs:Wa(t?.settleMs,1200),cooldownMs:Wa(t?.cooldownMs,5e3)}}function Fa(t={}){return{enabled:t?.enabled===!0,selected:Qs(t?.selected)}}function dd(t=[]){let e=Array.isArray(t)?t.map(s=>({role:String(s?.role||"user").trim().toUpperCase(),content:String(s?.content||"").trim()})).filter(s=>s.content):[];return e.length===0?"":e.length===1?e[0].content:e.map(s=>`\u3010${s.role||"USER"}\u3011
${s.content}`).join(`

`)}function ud(t,e={}){let s=typeof e?.promptTemplate=="string"?e.promptTemplate.trim():"";if(s)return s;let r=dd(e?.config?.messages||[]);return r||`\u8BF7\u57FA\u4E8E\u6700\u8FD1\u7684 AI \u56DE\u590D\u4E3A\u5DE5\u5177\u201C${e?.name||t}\u201D\u751F\u6210\u7ED3\u6784\u5316\u8F93\u51FA\u3002`}function Ht(t={}){let e=new Date().toISOString(),s=t?.config||{};return{...Ne,...t,id:t?.id||Ne.id,icon:t?.icon||Ne.icon,order:Number.isFinite(t?.order)?t.order:Ne.order,promptTemplate:typeof t?.promptTemplate=="string"?t.promptTemplate:Ne.promptTemplate,extractTags:Qs(t?.extractTags),config:{execution:{...Ne.config.execution,...s.execution||{},timeout:dn(s?.execution?.timeout,Ne.config.execution.timeout),retries:Math.max(0,parseInt(s?.execution?.retries,10)||Ne.config.execution.retries)},api:{...Ne.config.api,...s.api||{}},messages:Array.isArray(s?.messages)?s.messages:[],context:{...Ne.config.context,...s.context||{},depth:dn(s?.context?.depth,Ne.config.context.depth),includeTags:Qs(s?.context?.includeTags),excludeTags:Qs(s?.context?.excludeTags)},automation:ja(s?.automation),worldbooks:Fa(s?.worldbooks)},enabled:t?.enabled!==!1,metadata:{...Ne.metadata,...t?.metadata||{},createdAt:t?.metadata?.createdAt||e,updatedAt:t?.metadata?.updatedAt||e}}}function Zs(t,e={},s={}){let r=Ht({...e,id:t||e?.id||""}),o=Qs(r?.extractTags?.length?r.extractTags:r?.config?.context?.includeTags),n=String(e?.output?.apiPreset||r?.config?.api?.preset||"").trim(),a=ud(t,r),i=typeof e?.output?.mode=="string"&&e.output.mode.trim()?e.output.mode.trim():s.defaultOutputMode||"follow_ai";return{id:r.id||t,name:r.name||t,icon:r.icon||"fa-screwdriver-wrench",description:r.description||"",enabled:r.enabled!==!1,order:Number.isFinite(r.order)?r.order:100,bypass:{enabled:r?.config?.api?.useBypass===!0&&!!r?.config?.api?.bypassPreset,presetId:r?.config?.api?.bypassPreset||""},output:{mode:i,apiPreset:n,overwrite:!0,enabled:!0},automation:ja(r?.config?.automation),worldbooks:Fa(r?.config?.worldbooks),extraction:{enabled:!0,maxMessages:dn(r?.config?.context?.depth,5),selectors:o},promptTemplate:a,runtime:{lastRunAt:0,lastStatus:"idle",lastError:"",lastDurationMs:0,successCount:0,errorCount:0},apiPreset:n,extractTags:o,isCustom:!0,category:r.category||"utility",metadata:{...r.metadata||{}}}}function Tt(){let t=te.get(ae.TOOLS),e=cd(t);return t&&JSON.stringify(t)!==JSON.stringify(e)&&te.set(ae.TOOLS,e),{...Fr,...e}}function fs(t){return Tt()[t]||null}function Hr(t,e){if(!t||!e)return!1;let s=te.get(ae.TOOLS)||{},r=!s[t]&&!Fr[t],o=Ht({...s[t]||{},...e,id:t,metadata:{...s[t]?.metadata||{},...e.metadata||{},createdAt:s[t]?.metadata?.createdAt||e?.metadata?.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString()}});return s[t]=o,te.set(ae.TOOLS,s),$.emit(r?P.TOOL_REGISTERED:P.TOOL_UPDATED,{toolId:t,tool:o}),!0}function Yr(t){let e=te.get(ae.TOOLS)||{};return!e[t]&&!Fr[t]||Fr[t]?!1:(delete e[t],te.set(ae.TOOLS,e),$.emit(P.TOOL_UNREGISTERED,{toolId:t}),!0)}function qr(){return te.get(ae.PRESETS)||{}}function Ha(t,e){if(!t||!e)return!1;let s=qr(),r=!s[t];return s[t]={...e,name:t,updatedAt:new Date().toISOString()},te.set(ae.PRESETS,s),$.emit(r?P.PRESET_CREATED:P.PRESET_UPDATED,{type:"tool",presetName:t,preset:s[t]}),!0}function Ya(t){let e=qr();return e[t]?(delete e[t],te.set(ae.PRESETS,e),$.emit(P.PRESET_DELETED,{type:"tool",presetName:t}),!0):!1}function qa(){return te.get(ae.CURRENT_PRESET)||""}function Ga(t){return te.set(ae.CURRENT_PRESET,t||""),$.emit(P.PRESET_ACTIVATED,{type:"tool",presetName:t}),!0}function Gr(t,e){let s=fs(t);if(!s)return!1;let r=te.get(ae.TOOLS)||{};return r[t]=Ht({...s,id:t,enabled:e,metadata:{...s?.metadata||{},createdAt:s?.metadata?.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString()}}),te.set(ae.TOOLS,r),$.emit(e?P.TOOL_ENABLED:P.TOOL_DISABLED,{toolId:t,enabled:e}),!0}function Vr(){let t=te.get(ae.TOOLS)||{},e=te.get(ae.PRESETS)||{};return JSON.stringify({version:"1.0.0",exportedAt:new Date().toISOString(),tools:t,presets:e},null,2)}function Jr(t,e=!1){try{let s=typeof e=="object"?!!e?.overwrite:!!e,r=JSON.parse(t);if(!r||typeof r!="object")return{success:!1,toolsImported:0,presetsImported:0,message:"\u65E0\u6548\u7684JSON\u683C\u5F0F"};let o=s?{}:te.get(ae.TOOLS)||{},n=s?{}:te.get(ae.PRESETS)||{},a=0,i=0;if(r.tools&&typeof r.tools=="object"){for(let[l,c]of Object.entries(r.tools))!c||typeof c!="object"||(o[l]=Ht({...c,id:l}),a+=1);te.set(ae.TOOLS,o)}if(r.presets&&typeof r.presets=="object"){for(let[l,c]of Object.entries(r.presets))!c||typeof c!="object"||(n[l]={...c,name:l,updatedAt:new Date().toISOString()},i+=1);te.set(ae.PRESETS,n)}return{success:!0,toolsImported:a,presetsImported:i,message:`\u6210\u529F\u5BFC\u5165 ${a} \u4E2A\u5DE5\u5177\u548C ${i} \u4E2A\u9884\u8BBE`}}catch(s){return{success:!1,toolsImported:0,presetsImported:0,message:`\u5BFC\u5165\u5931\u8D25: ${s.message}`}}}function Xr(){te.remove(ae.TOOLS),te.remove(ae.PRESETS),te.remove(ae.CURRENT_PRESET)}var Ne,Fr,ae,yd,Qr=W(()=>{De();ge();Ne={id:"",name:"",description:"",icon:"fa-screwdriver-wrench",order:100,category:"utility",promptTemplate:"",extractTags:[],config:{execution:{timeout:6e4,retries:3},api:{preset:"",useBypass:!1,bypassPreset:""},messages:[],context:{depth:3,includeTags:[],excludeTags:[]},automation:{enabled:!1,settleMs:1200,cooldownMs:5e3},worldbooks:{enabled:!1,selected:[]}},enabled:!0,metadata:{createdAt:null,updatedAt:null,author:"",version:"1.0.0"}},Fr={},ae={TOOLS:"tools",PRESETS:"tool_presets",CURRENT_PRESET:"current_tool_preset"};yd={getAllTools:Tt,getTool:fs,saveTool:Hr,deleteTool:Yr,setToolEnabled:Gr,exportTools:Vr,importTools:Jr,resetTools:Xr,getToolPresets:qr,saveToolPreset:Ha,deleteToolPreset:Ya,getCurrentToolPreset:qa,setCurrentToolPreset:Ga,createDefaultToolDefinition:Ht,normalizeToolDefinitionToRuntimeConfig:Zs}});var gi={};ue(gi,{TOOL_CATEGORIES:()=>Ja,TOOL_REGISTRY:()=>ms,appendToolRuntimeHistory:()=>li,clearToolApiPreset:()=>ni,default:()=>xd,ensureToolRuntimeConfig:()=>Zr,getAllDefaultToolConfigs:()=>di,getAllToolApiBindings:()=>ai,getAllToolFullConfigs:()=>sr,getEnabledTools:()=>ui,getToolApiPreset:()=>fn,getToolBaseConfig:()=>bs,getToolConfig:()=>tr,getToolFullConfig:()=>Z,getToolList:()=>ti,getToolSubTabs:()=>si,getToolWindowState:()=>pi,hasTool:()=>gn,onPresetDeleted:()=>ii,patchToolRuntime:()=>_t,registerTool:()=>Za,resetToolConfig:()=>ci,resetToolRegistry:()=>ri,saveToolConfig:()=>Be,saveToolWindowState:()=>yi,setToolApiPreset:()=>oi,setToolApiPresetConfig:()=>bd,setToolBypassConfig:()=>hd,setToolOutputMode:()=>md,setToolPromptTemplate:()=>vd,unregisterTool:()=>ei,updateToolRuntime:()=>mn});function qt(t={}){let e=Array.isArray(t?.recentWritebackHistory)?t.recentWritebackHistory.filter(Boolean):[];return{lastRunAt:Number.isFinite(t?.lastRunAt)?t.lastRunAt:0,lastStatus:typeof t?.lastStatus=="string"?t.lastStatus:"idle",lastError:typeof t?.lastError=="string"?t.lastError:"",lastDurationMs:Number.isFinite(t?.lastDurationMs)?t.lastDurationMs:0,successCount:Number.isFinite(t?.successCount)?t.successCount:0,errorCount:Number.isFinite(t?.errorCount)?t.errorCount:0,lastMessageKey:typeof t?.lastMessageKey=="string"?t.lastMessageKey:"",lastExecutionKey:typeof t?.lastExecutionKey=="string"?t.lastExecutionKey:"",lastExecutionPath:typeof t?.lastExecutionPath=="string"?t.lastExecutionPath:"",lastWritebackStatus:typeof t?.lastWritebackStatus=="string"?t.lastWritebackStatus:"",lastFailureStage:typeof t?.lastFailureStage=="string"?t.lastFailureStage:"",lastSlotBindingKey:typeof t?.lastSlotBindingKey=="string"?t.lastSlotBindingKey:"",lastSlotRevisionKey:typeof t?.lastSlotRevisionKey=="string"?t.lastSlotRevisionKey:"",lastSlotTransactionId:typeof t?.lastSlotTransactionId=="string"?t.lastSlotTransactionId:"",lastSourceMessageId:typeof t?.lastSourceMessageId=="string"?t.lastSourceMessageId:"",lastSourceSwipeId:typeof t?.lastSourceSwipeId=="string"?t.lastSourceSwipeId:"",lastContentCommitted:t?.lastContentCommitted===!0,lastHostCommitApplied:t?.lastHostCommitApplied===!0,lastRefreshRequested:t?.lastRefreshRequested===!0,lastRefreshConfirmed:t?.lastRefreshConfirmed===!0,lastPreferredCommitMethod:typeof t?.lastPreferredCommitMethod=="string"?t.lastPreferredCommitMethod:"",lastAppliedCommitMethod:typeof t?.lastAppliedCommitMethod=="string"?t.lastAppliedCommitMethod:"",lastRefreshMethodCount:Number.isFinite(t?.lastRefreshMethodCount)?t.lastRefreshMethodCount:0,lastRefreshMethods:Array.isArray(t?.lastRefreshMethods)?t.lastRefreshMethods.filter(Boolean):[],lastRefreshConfirmChecks:Number.isFinite(t?.lastRefreshConfirmChecks)?t.lastRefreshConfirmChecks:0,lastRefreshConfirmedBy:typeof t?.lastRefreshConfirmedBy=="string"?t.lastRefreshConfirmedBy:"",lastTraceId:typeof t?.lastTraceId=="string"?t.lastTraceId:"",lastAutoRunAt:Number.isFinite(t?.lastAutoRunAt)?t.lastAutoRunAt:0,lastAutoStatus:typeof t?.lastAutoStatus=="string"?t.lastAutoStatus:"idle",lastAutoMessageId:typeof t?.lastAutoMessageId=="string"?t.lastAutoMessageId:"",lastAutoSwipeId:typeof t?.lastAutoSwipeId=="string"?t.lastAutoSwipeId:"",lastAutoRevisionKey:typeof t?.lastAutoRevisionKey=="string"?t.lastAutoRevisionKey:"",lastAutoWritebackStatus:typeof t?.lastAutoWritebackStatus=="string"?t.lastAutoWritebackStatus:"",lastAutoRefreshConfirmed:t?.lastAutoRefreshConfirmed===!0,lastAutoSkipReason:typeof t?.lastAutoSkipReason=="string"?t.lastAutoSkipReason:"",recentWritebackHistory:e}}function pd(t,e=10){let s=Number.isFinite(e)?Math.max(1,Math.min(50,Math.floor(e))):10;return Array.isArray(t)?t.length<=s?t:t.slice(t.length-s):[]}function Xa(){let t=Tt()||{};return Object.entries(t).filter(([e])=>!er[e]).map(([e,s])=>[e,s||{}])}function un(t={}){return t?.toolKind==="script"?"script":t?.toolKind==="ai"?"ai":t?.output?.mode==="local_transform"||t?.processor?.type?"script":"ai"}function Qa(){let t=Array.isArray(ms.tools?.subTabs)?ms.tools.subTabs.map((s,r)=>({...s,order:Number.isFinite(s?.order)?s.order:r,toolKind:un(s),toolGroupLabel:un(s)==="script"?"\u811A\u672C\u5DE5\u5177":"AI \u5DE5\u5177"})):[],e=Xa().map(([s,r],o)=>{let n=Zs(s,r),a=un(n);return{id:s,name:n.name||s,icon:n.icon||"fa-screwdriver-wrench",component:"GenericToolConfigPanel",order:Number.isFinite(n.order)?n.order:100+o,isCustom:!0,description:n.description||"",toolKind:a,toolGroupLabel:a==="script"?"\u811A\u672C\u5DE5\u5177":"AI \u5DE5\u5177"}});return[...t,...e].sort((s,r)=>(s.order??0)-(r.order??0))}function gd(t,e={}){let s=Zs(t,e,{defaultOutputMode:"follow_ai"});return{...s,runtime:qt(s.runtime)}}function pn(t){let e=er[t];if(e)return{...e,output:{...e.output||{}},bypass:{...e.bypass||{}},worldbooks:{...e.worldbooks||{},selected:Array.isArray(e?.worldbooks?.selected)?[...e.worldbooks.selected]:[]},extraction:{...e.extraction||{}},processor:{...e.processor||{},options:{...e?.processor?.options||{}}},runtime:qt(e.runtime),extractTags:Array.isArray(e.extractTags)?[...e.extractTags]:[]};let r=(Tt()||{})[t]||null;return r?gd(t,r):tr(t)}function bs(t){let e=pn(t);return e?{...e,output:{...e.output||{}},automation:{...e.automation||{}},bypass:{...e.bypass||{}},worldbooks:{...e.worldbooks||{},selected:Array.isArray(e?.worldbooks?.selected)?[...e.worldbooks.selected]:[]},extraction:{...e.extraction||{},selectors:Array.isArray(e?.extraction?.selectors)?[...e.extraction.selectors]:[]},processor:{...e.processor||{},options:{...e?.processor?.options||{}}},runtime:{...e.runtime||{}},extractTags:Array.isArray(e.extractTags)?[...e.extractTags]:[]}:null}function fd(t,e={},s=""){if(!t)return null;let r={...t,...e,id:t.id||e.id};r.output={...t.output||{},...e.output||{}},r.automation={enabled:t?.automation?.enabled===!0||e?.automation?.enabled===!0,settleMs:Number.isFinite(e?.automation?.settleMs)?e.automation.settleMs:Number.isFinite(t?.automation?.settleMs)?t.automation.settleMs:1200,cooldownMs:Number.isFinite(e?.automation?.cooldownMs)?e.automation.cooldownMs:Number.isFinite(t?.automation?.cooldownMs)?t.automation.cooldownMs:5e3},r.bypass={...t.bypass||{},...e.bypass||{}},r.worldbooks={...t.worldbooks||{},...e.worldbooks||{},selected:Array.isArray(e?.worldbooks?.selected)?[...e.worldbooks.selected]:Array.isArray(t?.worldbooks?.selected)?[...t.worldbooks.selected]:[]},r.runtime=qt({...t.runtime||{},...e.runtime||{}}),r.extraction={...t.extraction||{},...e.extraction||{}},r.processor={...t.processor||{},...e.processor||{},options:{...t?.processor?.options||{},...e?.processor?.options||{}}};let o=e?.output?.apiPreset||e?.apiPreset||r.output?.apiPreset||r.apiPreset||s||"";return r.output={...r.output||{},apiPreset:o},r.apiPreset=o,(!Array.isArray(r.extraction.selectors)||r.extraction.selectors.length===0)&&Array.isArray(r.extractTags)&&r.extractTags.length>0&&(r.extraction.selectors=[...r.extractTags]),(!Array.isArray(r.extractTags)||r.extractTags.length===0)&&(r.extractTags=Array.isArray(r.extraction.selectors)?[...r.extraction.selectors]:[]),t.isCustom?r.enabled=t.enabled!==!1:typeof e.enabled=="boolean"?r.enabled=e.enabled:r.enabled=t.enabled!==!1,r}function Za(t,e){if(!t||typeof t!="string")return console.error("[ToolRegistry] \u5DE5\u5177ID\u65E0\u6548"),!1;if(!e||typeof e!="object")return console.error("[ToolRegistry] \u5DE5\u5177\u914D\u7F6E\u65E0\u6548"),!1;let s=["name","icon","component"];for(let r of s)if(!e[r])return console.error(`[ToolRegistry] \u5DE5\u5177\u7F3A\u5C11\u5FC5\u9700\u5B57\u6BB5: ${r}`),!1;return Ze[t]={id:t,...e,order:e.order??Object.keys(Ze).length},console.log(`[ToolRegistry] \u5DE5\u5177\u5DF2\u6CE8\u518C: ${t}`),!0}function ei(t){return Ze[t]?(delete Ze[t],console.log(`[ToolRegistry] \u5DE5\u5177\u5DF2\u6CE8\u9500: ${t}`),!0):(console.warn(`[ToolRegistry] \u5DE5\u5177\u4E0D\u5B58\u5728: ${t}`),!1)}function ti(t=!0){let e=Object.values(Ze).map(s=>s.id==="tools"?{...s,subTabs:Qa()}:s);return t?e.sort((s,r)=>(s.order??0)-(r.order??0)):e}function tr(t){return t==="tools"&&Ze[t]?{...Ze[t],subTabs:Qa()}:Ze[t]||null}function gn(t){return!!Ze[t]}function si(t){let e=tr(t);return!e||!e.hasSubTabs?[]:e.subTabs||[]}function ri(){Ze={...ms},console.log("[ToolRegistry] \u5DE5\u5177\u6CE8\u518C\u8868\u5DF2\u91CD\u7F6E")}function oi(t,e){if(!gn(t))return console.warn(`[ToolRegistry] \u5DE5\u5177\u4E0D\u5B58\u5728: ${t}`),!1;let s=C.get(Le)||{};return s[t]=e||"",C.set(Le,s),console.log(`[ToolRegistry] \u5DE5\u5177 "${t}" \u7ED1\u5B9A\u5230\u9884\u8BBE "${e||"\u5F53\u524D\u914D\u7F6E"}"`),!0}function fn(t){return(C.get(Le)||{})[t]||""}function ni(t){let e=C.get(Le)||{};delete e[t],C.set(Le,e),console.log(`[ToolRegistry] \u5DE5\u5177 "${t}" \u7684API\u9884\u8BBE\u7ED1\u5B9A\u5DF2\u6E05\u9664`)}function ai(){return C.get(Le)||{}}function ii(t){let e=C.get(Le)||{},s=!1;for(let r in e)e[r]===t&&(e[r]="",s=!0,console.log(`[ToolRegistry] \u5DE5\u5177 "${r}" \u7684API\u9884\u8BBE\u7ED1\u5B9A\u5DF2\u6E05\u9664\uFF08\u9884\u8BBE\u88AB\u5220\u9664\uFF09`));s&&C.set(Le,e)}function Z(t){let e=pn(t);if(!e)return tr(t);let r=(C.get(Yt)||{})[t]||{},o=fn(t);return fd({...e,id:t},r,o)}function Zr(t){if(!t)return!1;let e=pn(t);if(!e)return!1;let s=C.get(Yt)||{};if(s[t])return!0;let r={promptTemplate:e.promptTemplate||"",enabled:e.enabled!==!1,extractTags:Array.isArray(e.extractTags)?[...e.extractTags]:[],apiPreset:e.apiPreset||"",output:{...e.output||{}},automation:{...e.automation||{}},bypass:{...e.bypass||{}},worldbooks:{...e.worldbooks||{},selected:Array.isArray(e?.worldbooks?.selected)?[...e.worldbooks.selected]:[]},extraction:{...e.extraction||{},selectors:Array.isArray(e?.extraction?.selectors)?[...e.extraction.selectors]:[]},processor:{...e.processor||{},options:{...e?.processor?.options||{}}},runtime:{...e.runtime||{}}};s[t]=r,C.set(Yt,s);let o=C.get(Le)||{};return o[t]=r.output?.apiPreset||r.apiPreset||"",C.set(Le,o),$.emit(P.TOOL_UPDATED,{toolId:t,config:r}),!0}function Be(t,e,s={}){if(!t||!Z(t))return console.warn("[ToolRegistry] \u5DE5\u5177\u4E0D\u5B58\u5728:",t),!1;let{emitEvent:r=!0}=s,o=C.get(Yt)||{},n=C.get(Le)||{},a=e?.output?.apiPreset??e?.apiPreset??"",i=["promptTemplate","enabled","extractTags","apiPreset","output","automation","bypass","worldbooks","extraction","processor","runtime"];return o[t]={},i.forEach(l=>{if(e[l]!==void 0){if(l==="output"&&e.output){o[t][l]={...e.output,apiPreset:a};return}if(l==="apiPreset"){o[t][l]=a;return}o[t][l]=e[l]}}),o[t].apiPreset===void 0&&(o[t].apiPreset=a),!o[t].output&&e.output!==void 0&&(o[t].output={...e.output||{},apiPreset:a}),C.set(Yt,o),n[t]=a,C.set(Le,n),r&&$.emit(P.TOOL_UPDATED,{toolId:t,config:o[t]}),console.log(`[ToolRegistry] \u5DE5\u5177\u914D\u7F6E\u5DF2\u4FDD\u5B58: ${t}`),!0}function md(t,e){let s=Z(t);return s?Be(t,{...s,output:{...s.output,mode:e}}):!1}function bd(t,e){let s=Z(t);return s?Be(t,{...s,apiPreset:e,output:{...s.output,apiPreset:e}}):!1}function hd(t,e){let s=Z(t);return s?Be(t,{...s,bypass:{...s.bypass,...e}}):!1}function vd(t,e){let s=Z(t);return s?Be(t,{...s,promptTemplate:e}):!1}function _t(t,e,s={}){let r=Z(t);if(!r)return!1;let{touchLastRunAt:o=!1,emitEvent:n=!1,emitRuntimeEvent:a=!0}=s,i=qt({...r.runtime||{},...e||{}});o&&(i.lastRunAt=Date.now());let l=Be(t,{...r,runtime:i},{emitEvent:n});return l&&a&&$.emit(P.TOOL_RUNTIME_UPDATED,{toolId:t,runtime:i,previousRuntime:qt(r.runtime||{})}),l}function li(t,e,s={},r={}){let o=Z(t);if(!o)return!1;let{limit:n=10,emitEvent:a=!1,emitRuntimeEvent:i=!0}=r,l=qt(o.runtime||{}),c=qt(o.runtime||{}),d="recentWritebackHistory",u={id:s?.id||`hist_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,at:s?.at||Date.now(),...s};l[d]=pd([...Array.isArray(l[d])?l[d]:[],u],n),u?.traceId&&(l.lastTraceId=u.traceId);let y=Be(t,{...o,runtime:l},{emitEvent:a});return y&&i&&$.emit(P.TOOL_RUNTIME_UPDATED,{toolId:t,runtime:l,previousRuntime:c,historyType:e,historyEntry:u}),y}function mn(t,e,s={}){let{touchLastRunAt:r=!0,emitEvent:o=!1,emitRuntimeEvent:n=!0}=s;return _t(t,e,{touchLastRunAt:r,emitEvent:o,emitRuntimeEvent:n})}function ci(t){if(!t||!er[t])return console.warn("[ToolRegistry] \u5DE5\u5177\u4E0D\u5B58\u5728:",t),!1;let e=C.get(Yt)||{};return delete e[t],C.set(Yt,e),$.emit(P.TOOL_UPDATED,{toolId:t,config:null}),console.log(`[ToolRegistry] \u5DE5\u5177\u914D\u7F6E\u5DF2\u91CD\u7F6E: ${t}`),!0}function di(){return{...er}}function sr(){let t=new Set([...Object.keys(er),...Xa().map(([e])=>e)]);return Array.from(t).map(e=>Z(e)).filter(Boolean)}function ui(){return sr().filter(t=>t&&t.enabled)}function yi(t,e){let s=C.get(yn)||{};s[t]={...e,updatedAt:Date.now()},C.set(yn,s)}function pi(t){return(C.get(yn)||{})[t]||null}var Yt,Le,yn,er,ms,Ja,Ze,xd,At=W(()=>{De();ge();Qr();Yt="tool_configs",Le="tool_api_bindings",yn="tool_window_states";er={summaryTool:{id:"summaryTool",name:"\u6458\u8981\u5DE5\u5177",icon:"fa-file-lines",description:"\u751F\u6210\u5267\u60C5\u6458\u8981\u5757",enabled:!0,order:3,bypass:{enabled:!1,presetId:""},output:{mode:"follow_ai",apiPreset:"",overwrite:!0,enabled:!0},automation:{enabled:!1,settleMs:1200,cooldownMs:5e3},worldbooks:{enabled:!1,selected:[]},extraction:{enabled:!0,maxMessages:5,selectors:["boo_FM"]},promptTemplate:`\u8BF7\u6839\u636E\u4EE5\u4E0BAI\u56DE\u590D\u751F\u6210\u6458\u8981\u5757\uFF1A
...
<gouzi>\u8FD9\u91CC\u5199\u5267\u60C5\u94A9\u5B50</gouzi>
    ...
    `;this._removeDialog(t),t.append(n);let a=t.find("#yyt-tool-dialog-overlay"),i=a.find("#yyt-tool-name"),l=a.find("#yyt-tool-category"),c=a.find("#yyt-tool-desc"),d=a.find("#yyt-tool-timeout"),u=a.find("#yyt-tool-retries");we(a,{namespace:"yytToolManageDialogSelect",selectors:["#yyt-tool-category"]});let y=()=>{ye(a,"yytToolManageDialogSelect"),a.remove()};a.find("#yyt-tool-dialog-close, #yyt-tool-dialog-cancel").on("click",y),a.on("click",function(p){p.target===this&&y()}),a.find("#yyt-tool-dialog-save").on("click",()=>{let p=i.val().trim(),f=l.val(),h=c.val().trim(),m=parseInt(d.val())||6e4,_=parseInt(u.val())||3;if(!p){S("warning","\u8BF7\u8F93\u5165\u5DE5\u5177\u540D\u79F0");return}let M=s||`tool_${Date.now()}`;if(!Hr(M,{name:p,category:f,description:h,promptTemplate:r?.promptTemplate||"",extractTags:Array.isArray(r?.extractTags)?r.extractTags:[],config:{execution:{timeout:m,retries:_},api:r?.config?.api||{preset:"",useBypass:!1,bypassPreset:""},messages:Array.isArray(r?.config?.messages)?r.config.messages:[],context:{depth:r?.config?.context?.depth||3,includeTags:Array.isArray(r?.config?.context?.includeTags)?r.config.context.includeTags:[],excludeTags:Array.isArray(r?.config?.context?.excludeTags)?r.config.context.excludeTags:[]},worldbooks:{enabled:r?.config?.worldbooks?.enabled===!0,selected:Array.isArray(r?.config?.worldbooks?.selected)?r.config.worldbooks.selected:[]}},enabled:r?.enabled!==!1})){S("error",o?"\u5DE5\u5177\u66F4\u65B0\u5931\u8D25":"\u5DE5\u5177\u521B\u5EFA\u5931\u8D25");return}Zr(M),y(),this.renderTo(t),S("success",o?"\u5DE5\u5177\u5DF2\u66F4\u65B0":"\u5DE5\u5177\u5DF2\u521B\u5EFA"),o||this._openToolConfig(M)})},destroy(t){!D()||!B(t)||(this._removeDialog(t),t.off(".yytToolManage"))},getStyles(){return`
      /* \u5DE5\u5177\u7BA1\u7406\u9762\u677F\u6837\u5F0F */
      .yyt-tool-manager {
        display: flex;
        flex-direction: column;
                ...
                <div class="yyt-worldbook-dropdown" id="${b}-tool-worldbook-dropdown">
                  ...
                  ${this.worldbookLoadState!=="ready"?`
                    <details class="yyt-worldbook-diagnostics">
                      ...
                      <pre class="yyt-preview-box yyt-preview-pre">${x(JSON.stringify(Ti()||{state:this.worldbookLoadState||"idle",message:"\u5C1A\u672A\u751F\u6210\u8BCA\u65AD\u4FE1\u606F"},null,2))}</pre>
                    </details>
                  `:""}
                </div>
              </div>
...
`)||"\u65E0")}</div>
      ...
      `).join(""):'<div class="yyt-tool-compact-hint yyt-worldbook-empty">\u672A\u627E\u5230\u5339\u914D\u4E16\u754C\u4E66\u3002</div>');let m=p.length===0?"\u9009\u62E9\u8981\u6CE8\u5165\u7684\u4E16\u754C\u4E66":p.length<=2?p.join("\u3001"):`\u5DF2\u9009 ${p.length} \u9879\uFF1A${p.slice(0,2).join("\u3001")} \u7B49`;l.find(".yyt-worldbook-summary").text(m)}}}var As,Du,es=W(()=>{Se();At();Sn();Hs();ar();Cn();As=`
  .yyt-tool-panel {
    display: flex;
    flex-direction: column;
    gap: 16px;
...
`;Du=Et});var ts,Pn=W(()=>{es();ts=Et({id:"summaryToolPanel",toolId:"summaryTool",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u8FDB\u884C\u6458\u8981\u89E3\u6790\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 boo_FM
\u6216 regex:<boo_FM>([\\s\\S]*?)</boo_FM>`,previewDialogId:"summary-extraction-preview",defaultInjectionOrder:1e4,lorebookLogTag:"SummaryToolPanel"})});var ss,Rn=W(()=>{es();ss=Et({id:"statusBlockPanel",toolId:"statusBlock",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u751F\u6210\u4E3B\u89D2\u72B6\u6001\u680F\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 status_block
\u6216 regex:<status_block>([\\s\\S]*?)</status_block>`,previewDialogId:"status-extraction-preview",defaultInjectionOrder:10001,lorebookLogTag:"StatusBlockPanel"})});var rs,$n=W(()=>{es();rs=Et({id:"youyouReviewPanel",toolId:"youyouReview",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u5728\u672B\u5C3E\u751F\u6210\u5C0F\u5E7D\u70B9\u8BC4\u4E0E\u5267\u60C5\u94A9\u5B50\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 youyou
\u6216 regex:<youyou>([\\s\\S]*?)</youyou>`,previewDialogId:"youyou-review-extraction-preview",previewTitle:"\u5C0F\u5E7D\u70B9\u8BC4\u63D0\u53D6\u9884\u89C8"})});function Hi(t=[],e={}){return t.map(s=>({...s,checked:e?.[s.key]===!0}))}function fo(t){let{id:e,toolId:s,previewDialogId:r,previewTitle:o="\u6D4B\u8BD5\u63D0\u53D6\u7ED3\u679C",processorDirections:n=[],processorOptions:a=[],heroHint:i="",extractionPlaceholder:l=""}=t;return{id:e,toolId:s,renderSessionId:0,_beginRenderSession(c){return this.renderSessionId=(this.renderSessionId||0)+1,B(c)&&c.data("yytRenderSessionId",this.renderSessionId),this.renderSessionId},_isRenderSessionActive(c,d){return B(c)&&c.data("yytRenderSessionId")===d},_renderIfSessionActive(c,d){return this._isRenderSessionActive(c,d)?(this.renderTo(c),!0):!1},render(){let c=Z(this.toolId);if(!c)return'<div class="yyt-error">\u5DE5\u5177\u914D\u7F6E\u52A0\u8F7D\u5931\u8D25</div>';let d=c.processor||{},u=c.extraction||{},y=c.runtime?.lastStatus||"idle",p=c.runtime?.lastRunAt?new Date(c.runtime.lastRunAt).toLocaleString():"\u672A\u8FD0\u884C",f=c.runtime?.lastError||"",h=Array.isArray(u.selectors)?u.selectors.join(`
`):"",m=c.output?.overwrite!==!1,_=Hi(n,{[d.direction||n[0]?.key||""]:!0}),M=Hi(a,d.options||{});return`
        <div class="yyt-tool-panel" data-tool-id="${this.toolId}">
          <div class="yyt-tool-panel-hero">
            <div class="yyt-tool-panel-hero-copy">
...
`});var os,On=W(()=>{Dn();os=fo({id:"escapeTransformToolPanel",toolId:"escapeTransformTool",previewDialogId:"escape-transform-extraction-preview",previewTitle:"\u8F6C\u4E49\u5904\u7406\u63D0\u53D6\u9884\u89C8",heroHint:"\u4ECE\u6700\u8FD1 AI \u6D88\u606F\u63D0\u53D6\u6587\u672C\u540E\uFF0C\u5728\u672C\u5730\u6267\u884C\u8F6C\u4E49\u6216\u53BB\u8F6C\u4E49\uFF0C\u518D\u6309\u6240\u9009\u65B9\u5F0F\u5199\u56DE\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\u6216\u6B63\u5219\uFF0C\u4F8B\u5982\uFF1A
content
regex:<content>([\\s\\S]*?)</content>`,processorDirections:[{key:"escape",label:"\u8F6C\u4E49",description:"\u628A\u539F\u59CB\u5B57\u7B26\u8F6C\u6362\u6210\u8F6C\u4E49\u5E8F\u5217\u3002"},{key:"unescape",label:"\u53BB\u8F6C\u4E49",description:"\u628A\u8F6C\u4E49\u5E8F\u5217\u8FD8\u539F\u6210\u539F\u59CB\u5B57\u7B26\u3002"}],processorOptions:[{key:"doubleQuote",label:"\u53CC\u5F15\u53F7",description:'\u5904\u7406 " \u4E0E \\"\u3002'},{key:"singleQuote",label:"\u5355\u5F15\u53F7",description:"\u5904\u7406 ' \u4E0E \\'\u3002"},{key:"newline",label:"\u6362\u884C\u7B26",description:"\u5904\u7406\u6362\u884C\u4E0E \\n\u3002"}]})});var ns,Nn=W(()=>{Dn();ns=fo({id:"punctuationTransformToolPanel",toolId:"punctuationTransformTool",previewDialogId:"punctuation-transform-extraction-preview",previewTitle:"\u4E2D\u6587\u6807\u70B9\u66FF\u6362\u63D0\u53D6\u9884\u89C8",heroHint:"\u4ECE\u6700\u8FD1 AI \u6D88\u606F\u63D0\u53D6\u6587\u672C\u540E\uFF0C\u5728\u672C\u5730\u628A\u82F1\u6587\u6807\u70B9\u66FF\u6362\u6210\u4E2D\u6587\u6807\u70B9\uFF0C\u518D\u6309\u6240\u9009\u65B9\u5F0F\u5199\u56DE\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\u6216\u6B63\u5219\uFF0C\u4F8B\u5982\uFF1A
content
regex:<content>([\\s\\S]*?)</content>`,processorDirections:[{key:"en_to_zh",label:"\u82F1\u6587\u8F6C\u4E2D\u6587",description:"\u6309\u52FE\u9009\u9879\u628A\u82F1\u6587\u6807\u70B9\u66FF\u6362\u4E3A\u4E2D\u6587\u6807\u70B9\u3002"}],processorOptions:[{key:"comma",label:"\u9017\u53F7 ,",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u9017\u53F7\u3002"},{key:"period",label:"\u53E5\u53F7 .",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u53E5\u53F7\u3002"},{key:"exclamation",label:"\u611F\u53F9\u53F7 !",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u611F\u53F9\u53F7\u3002"},{key:"question",label:"\u95EE\u53F7 ?",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u95EE\u53F7\u3002"},{key:"semicolon",label:"\u5206\u53F7 ;",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5206\u53F7\u3002"},{key:"colon",label:"\u5192\u53F7 :",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5192\u53F7\u3002"},{key:"leftParen",label:"\u5DE6\u62EC\u53F7 (",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5DE6\u62EC\u53F7\u3002"},{key:"rightParen",label:"\u53F3\u62EC\u53F7 )",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u53F3\u62EC\u53F7\u3002"}]})});var as,Ln=W(()=>{ge();ar();Se();as={id:"bypassPanel",_getActivePresetId(t){return t.find(".yyt-bypass-editor-content").data("presetId")||null},render(t){let e=j.getPresetList(),s=j.getDefaultPresetId();return`
    ...
    `},renderTo(t){let e=this.render({});t.html(e),this.bindEvents(t,{})}}});var Ji={};ue(Ji,{SettingsPanel:()=>pt,applyTheme:()=>Vi,applyUiPreferences:()=>Bn,default:()=>Lu});function Es({id:t,checked:e=!1,title:s="",hint:r=""}){return`
    <div class="yyt-toggle-row">
      <div class="yyt-toggle-label">
        <span>${s}</span>
  ...
  `}function qi(){try{if(typeof window.parent<"u"&&window.parent&&window.parent!==window)return window.parent}catch{}return window}function yr(){return qi()?.document||document}function Gi(t=yr()){return t?.documentElement||document.documentElement}function Vi(t,e=yr()){let s=Gi(e),r={...Nu,...Yi[t]||Yi["dark-blue"]};Object.entries(r).forEach(([o,n])=>{s.style.setProperty(o,n)}),s.setAttribute("data-yyt-theme",t)}function Bn(t={},e=yr()){let s=Gi(e),{theme:r="dark-blue",compactMode:o=!1,animationEnabled:n=!0}=t||{};Vi(r,e),s.classList.toggle("yyt-compact-mode",!!o),s.classList.toggle("yyt-no-animation",!n)}var Nu,Yi,pt,Lu,mo=W(()=>{ge();lr();dr();Se();Nu={"--yyt-accent":"#7bb7ff","--yyt-accent-glow":"rgba(123, 183, 255, 0.4)","--yyt-accent-soft":"rgba(123, 183, 255, 0.15)","--yyt-accent-strong":"#a5d4ff","--yyt-bg-base":"#0b0f15","--yyt-bg-gradient-1":"rgba(123, 183, 255, 0.12)","--yyt-bg-gradient-2":"rgba(155, 123, 255, 0.10)","--yyt-surface":"rgba(255, 255, 255, 0.03)","--yyt-surface-2":"rgba(255, 255, 255, 0.05)","--yyt-surface-3":"rgba(255, 255, 255, 0.075)","--yyt-surface-hover":"rgba(255, 255, 255, 0.08)","--yyt-surface-active":"rgba(255, 255, 255, 0.11)","--yyt-border":"rgba(255, 255, 255, 0.08)","--yyt-border-soft":"rgba(255, 255, 255, 0.05)","--yyt-border-strong":"rgba(255, 255, 255, 0.16)","--yyt-text":"rgba(255, 255, 255, 0.95)","--yyt-text-secondary":"rgba(255, 255, 255, 0.72)","--yyt-text-muted":"rgba(255, 255, 255, 0.5)","--yyt-focus-ring":"0 0 0 3px rgba(123, 183, 255, 0.18)","--yyt-on-accent":"#0b0f15","--yyt-control-bg":"linear-gradient(180deg, #1d2737 0%, #151d2a 100%)","--yyt-control-bg-hover":"linear-gradient(180deg, #243247 0%, #1a2638 100%)","--yyt-control-bg-active":"linear-gradient(180deg, #2a3951 0%, #1d2b3f 100%)","--yyt-control-bg-strong":"linear-gradient(180deg, #243247 0%, #192435 100%)","--yyt-control-bg-focus":"linear-gradient(180deg, #243a57 0%, #1a2a3f 100%)","--yyt-control-border":"rgba(146, 173, 212, 0.24)","--yyt-control-border-hover":"rgba(146, 173, 212, 0.36)","--yyt-control-border-focus":"rgba(123, 183, 255, 0.72)","--yyt-control-shadow":"0 12px 24px rgba(0, 0, 0, 0.24), inset 0 1px 0 rgba(255, 255, 255, 0.04)","--yyt-control-shadow-hover":"0 16px 28px rgba(0, 0, 0, 0.28), inset 0 1px 0 rgba(255, 255, 255, 0.06)","--yyt-control-shadow-focus":"0 18px 30px rgba(8, 14, 24, 0.32), inset 0 1px 0 rgba(255, 255, 255, 0.06)","--yyt-control-shadow-active":"0 10px 20px rgba(0, 0, 0, 0.22), inset 0 1px 0 rgba(255, 255, 255, 0.04)","--yyt-select-surface":"#121a26","--yyt-select-option-bg":"#192334","--yyt-select-option-hover-bg":"#233249","--yyt-select-option-selected-bg":"#2a3f60","--yyt-select-option-border":"rgba(123, 183, 255, 0.22)","--yyt-select-option-selected-border":"rgba(123, 183, 255, 0.4)","--yyt-select-dropdown-shadow":"0 24px 44px rgba(0, 0, 0, 0.52), 0 0 0 1px rgba(8, 12, 18, 0.82)","--yyt-select-arrow-color":"rgba(255, 255, 255, 0.52)"},Yi={"dark-blue":{"--yyt-on-accent":"#0b0f15"},"dark-purple":{"--yyt-accent":"#a78bfa","--yyt-accent-glow":"rgba(167, 139, 250, 0.4)","--yyt-accent-soft":"rgba(167, 139, 250, 0.15)","--yyt-accent-strong":"#c4b5fd","--yyt-bg-base":"#0f0b15","--yyt-bg-gradient-1":"rgba(167, 139, 250, 0.12)","--yyt-bg-gradient-2":"rgba(123, 183, 255, 0.10)","--yyt-on-accent":"#120b1f"},"dark-green":{"--yyt-accent":"#4ade80","--yyt-accent-glow":"rgba(74, 222, 128, 0.4)","--yyt-accent-soft":"rgba(74, 222, 128, 0.15)","--yyt-accent-strong":"#86efac","--yyt-bg-base":"#0b150f","--yyt-bg-gradient-1":"rgba(74, 222, 128, 0.12)","--yyt-bg-gradient-2":"rgba(123, 183, 255, 0.10)","--yyt-on-accent":"#0b150f"},light:{"--yyt-accent":"#3b82f6","--yyt-accent-glow":"rgba(59, 130, 246, 0.3)","--yyt-accent-soft":"rgba(59, 130, 246, 0.1)","--yyt-accent-strong":"#93c5fd","--yyt-bg-base":"#f8fafc","--yyt-bg-gradient-1":"rgba(59, 130, 246, 0.08)","--yyt-bg-gradient-2":"rgba(139, 92, 246, 0.06)","--yyt-text":"rgba(15, 23, 42, 0.95)","--yyt-text-secondary":"rgba(15, 23, 42, 0.72)","--yyt-text-muted":"rgba(15, 23, 42, 0.52)","--yyt-surface":"rgba(255, 255, 255, 0.66)","--yyt-surface-2":"rgba(255, 255, 255, 0.86)","--yyt-surface-3":"rgba(255, 255, 255, 0.94)","--yyt-surface-hover":"rgba(255, 255, 255, 0.92)","--yyt-surface-active":"rgba(255, 255, 255, 0.98)","--yyt-border":"rgba(15, 23, 42, 0.08)","--yyt-border-soft":"rgba(15, 23, 42, 0.05)","--yyt-border-strong":"rgba(15, 23, 42, 0.14)","--yyt-focus-ring":"0 0 0 3px rgba(59, 130, 246, 0.14)","--yyt-on-accent":"#0f172a","--yyt-control-bg":"linear-gradient(180deg, rgba(255, 255, 255, 0.98) 0%, rgba(241, 245, 249, 0.98) 100%)","--yyt-control-bg-hover":"linear-gradient(180deg, rgba(255, 255, 255, 1) 0%, rgba(226, 232, 240, 0.98) 100%)","--yyt-control-bg-active":"linear-gradient(180deg, rgba(239, 246, 255, 1) 0%, rgba(219, 234, 254, 0.98) 100%)","--yyt-control-bg-strong":"linear-gradient(180deg, rgba(255, 255, 255, 1) 0%, rgba(241, 245, 249, 0.98) 100%)","--yyt-control-bg-focus":"linear-gradient(180deg, rgba(239, 246, 255, 1) 0%, rgba(219, 234, 254, 0.98) 100%)","--yyt-control-border":"rgba(59, 130, 246, 0.18)","--yyt-control-border-hover":"rgba(59, 130, 246, 0.28)","--yyt-control-border-focus":"rgba(59, 130, 246, 0.58)","--yyt-control-shadow":"0 10px 22px rgba(15, 23, 42, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.75)","--yyt-control-shadow-hover":"0 12px 24px rgba(15, 23, 42, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.85)","--yyt-control-shadow-focus":"0 14px 26px rgba(59, 130, 246, 0.14), inset 0 1px 0 rgba(255, 255, 255, 0.9)","--yyt-control-shadow-active":"0 8px 18px rgba(15, 23, 42, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.85)","--yyt-select-surface":"#ffffff","--yyt-select-option-bg":"#f8fafc","--yyt-select-option-hover-bg":"#eff6ff","--yyt-select-option-selected-bg":"#dbeafe","--yyt-select-option-border":"rgba(59, 130, 246, 0.16)","--yyt-select-option-selected-border":"rgba(59, 130, 246, 0.34)","--yyt-select-dropdown-shadow":"0 18px 32px rgba(15, 23, 42, 0.12), 0 0 0 1px rgba(148, 163, 184, 0.18)","--yyt-select-arrow-color":"rgba(15, 23, 42, 0.45)"}};pt={id:"settingsPanel",render(){let t=Ke.getSettings(),e=t.debug?.enableDebugLog===!0,s=t.automation?.enabled===!0,r=this._getAutomationRuntime();return`
    ...
    `},renderTo(t){t.html(this.render({})),this.bindEvents(t,{})}},Lu=pt});function ne(t){return t==null?"":String(t).trim()}function Te(t){if(t!==void 0)try{return JSON.parse(JSON.stringify(t))}catch{return t}}function Ms(t={}){return{chatId:ne(t.chatId),sourceMessageId:ne(t.sourceMessageId||t.messageId),sourceSwipeId:ne(t.sourceSwipeId||t.effectiveSwipeId),effectiveSwipeId:ne(t.effectiveSwipeId||t.sourceSwipeId),slotBindingKey:ne(t.slotBindingKey),slotRevisionKey:ne(t.slotRevisionKey),slotTransactionId:ne(t.slotTransactionId),traceId:ne(t.traceId),resolvedAt:Number.isFinite(t.resolvedAt)?t.resolvedAt:Date.now()}}function Kn(t={}){return{resolvedAt:Number.isFinite(t.resolvedAt)?t.resolvedAt:Date.now(),runSource:ne(t.runSource)||st.MANUAL,traceId:ne(t.traceId),chatId:ne(t.chatId),sourceMessageId:ne(t.sourceMessageId||t.messageId),sourceSwipeId:ne(t.sourceSwipeId||t.effectiveSwipeId),effectiveSwipeId:ne(t.effectiveSwipeId||t.sourceSwipeId)||"swipe:current",slotBindingKey:ne(t.slotBindingKey),slotRevisionKey:ne(t.slotRevisionKey),slotTransactionId:ne(t.slotTransactionId),assistantContentFingerprint:ne(t.assistantContentFingerprint),assistantBaseFingerprint:ne(t.assistantBaseFingerprint),assistantText:String(t.assistantText||""),assistantBaseText:String(t.assistantBaseText||""),targetMessageIndex:Number.isFinite(t.targetMessageIndex)?t.targetMessageIndex:-1}}function gr(t){return!t||typeof t!="object"?null:{slotBindingKey:ne(t.slotBindingKey),slotRevisionKey:ne(t.slotRevisionKey),sourceMessageId:ne(t.sourceMessageId),sourceSwipeId:ne(t.sourceSwipeId),tables:Array.isArray(t.tables)?Te(t.tables):[],updatedAt:Number.isFinite(t.updatedAt)?t.updatedAt:0,meta:t.meta&&typeof t.meta=="object"?Te(t.meta):{}}}function ho(t={},e={}){let s=Kn(t);return{slotBindingKey:s.slotBindingKey,slotRevisionKey:s.slotRevisionKey,sourceMessageId:s.sourceMessageId,sourceSwipeId:s.sourceSwipeId||s.effectiveSwipeId,tables:Array.isArray(e.tables)?Te(e.tables):[],updatedAt:Number.isFinite(e.updatedAt)?e.updatedAt:Date.now(),meta:e.meta&&typeof e.meta=="object"?Te(e.meta):{}}}function vo(t){return!t||typeof t!="object"?{lastResolvedTarget:null,lastCommittedTarget:null,updatedAt:0}:{lastResolvedTarget:t.lastResolvedTarget?Ms(t.lastResolvedTarget):null,lastCommittedTarget:t.lastCommittedTarget?Ms(t.lastCommittedTarget):null,updatedAt:Number.isFinite(t.updatedAt)?t.updatedAt:0}}var bo,ks,st,pr,Is=W(()=>{bo="YouYouToolkit_tableState",ks="YouYouToolkit_tableBindings",st=Object.freeze({MANUAL:"MANUAL_TABLE",AUTO:"AUTO_TABLE"}),pr=Object.freeze({EXACT:"exact",BINDING_FALLBACK:"binding_fallback",TEMPLATE:"template",EMPTY:"empty"})});function z(t,e=""){return t==null?e:String(t).trim()||e}function Ku(t,e=!1){return t==null?e:t===!0}function zu(t){return Array.isArray(t)?Te(t):[]}function xo(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function Uu(t,e="col"){return z(t,"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")||e}function el(t,e=new Set){let s=Uu(t,"col"),r=s,o=2;for(;e.has(r);)r=`${s}_${o}`,o+=1;return e.add(r),r}function Wu(t=[]){let e=[],s=0;return t.forEach(r=>{let o=r&&typeof r=="object"?r:{},n=o.cells&&typeof o.cells=="object"&&!Array.isArray(o.cells)?o.cells:null,a=Array.isArray(o.cells)?o.cells:Array.isArray(o.values)?o.values:null;n&&Object.keys(n).forEach(i=>{e.includes(i)||e.push(i)}),a&&a.length>s&&(s=a.length)}),e.length>0?e.map(r=>({key:r,title:String(r)})):s>0?Array.from({length:s},(r,o)=>({key:`col_${o+1}`,title:`\u5217${o+1}`})):[]}function Wn(t,e=Rs){let s=z(t,e);return Qi.some(r=>r.value===s)?s:e}function ju(t={},e=0,s=new Set){let r=t&&typeof t=="object"?t:{},o=z(r.title||r.name||r.label,`\u5217${e+1}`),n=z(r.key||r.id,""),a=el(n||o||`col_${e+1}`,s),i=[n,z(r.title,""),z(r.name,""),z(r.label,"")].filter(Boolean);return{key:a,title:o,description:z(r.description||r.note,""),type:Wn(r.type),required:r.required===!0,sourceKeys:i}}function Fu(t={},e={},s=0){let r=t.cells&&typeof t.cells=="object"&&!Array.isArray(t.cells)?t.cells:null,o=Array.isArray(t.cells)?t.cells:Array.isArray(t.values)?t.values:null;if(r){let n=[...Array.isArray(e.sourceKeys)?e.sourceKeys:[],e.key,e.title].filter(Boolean);for(let a of n)if(r[a]!==void 0)return xo(r[a])}return o&&o[s]!==void 0?xo(o[s]):""}function Hu(t={},e=[],s=0){let r=t&&typeof t=="object"?t:{},o={};return e.forEach((n,a)=>{o[n.key]=Fu(r,n,a)}),{name:z(r.name||r.title||r.label,`\u884C${s+1}`),cells:o}}function tl(t={},e=0){let s=t&&typeof t=="object"?t:{},r=new Set,n=(Array.isArray(s.columns)&&s.columns.length>0?s.columns:Wu(Array.isArray(s.rows)?s.rows:[])).map((i,l)=>ju(i,l,r)),a=Array.isArray(s.rows)?s.rows.map((i,l)=>Hu(i,n,l)):[];return{name:z(s.name||s.title,`\u8868${e+1}`),note:z(s.note||s.description,""),columns:n.map(i=>({key:i.key,title:i.title,description:z(i.description,""),type:Wn(i.type),required:i.required===!0})),rows:a}}function sl(t={}){let e=t&&typeof t=="object"?t:{},s=Array.isArray(e.lastErrorDetails)?e.lastErrorDetails.map(o=>z(o,"")).filter(Boolean):[],r=e.lastValidationSummary&&typeof e.lastValidationSummary=="object"?{errorCount:Number.isFinite(e.lastValidationSummary.errorCount)?e.lastValidationSummary.errorCount:0,warningCount:Number.isFinite(e.lastValidationSummary.warningCount)?e.lastValidationSummary.warningCount:0}:{errorCount:0,warningCount:0};return{lastStatus:z(e.lastStatus,Ps.IDLE),lastRunAt:Number.isFinite(e.lastRunAt)?e.lastRunAt:0,lastDurationMs:Number.isFinite(e.lastDurationMs)?e.lastDurationMs:0,lastError:z(e.lastError,""),lastErrorDetails:s,lastValidationSummary:r,successCount:Number.isFinite(e.successCount)?e.successCount:0,errorCount:Number.isFinite(e.errorCount)?e.errorCount:0,lastSourceMessageId:z(e.lastSourceMessageId,""),lastSlotRevisionKey:z(e.lastSlotRevisionKey,""),lastLoadMode:z(e.lastLoadMode,""),lastMirrorApplied:e.lastMirrorApplied===!0}}function jn(t=1,e=[]){let s=new Set((Array.isArray(e)?e:[]).map(o=>z(o?.key,"")).filter(Boolean));return{key:el(`col_${t}`,s),title:`\u5217${t}`,description:"",type:Rs,required:!1}}function Yu(t=[],e=1){let s={};return(Array.isArray(t)?t:[]).forEach(r=>{let o=z(r?.key,"");o&&(s[o]="")}),{name:`\u884C${e}`,cells:s}}function rl(t=1){let e=jn(1);return{name:`\u8868${t}`,note:"",columns:[e],rows:[Yu([e],1)]}}function qu(){return{tables:[]}}function ol(t=[]){return!Array.isArray(t)||t.length===0?qu():{tables:t.map((e,s)=>tl(e,s))}}function Gu(t={}){let e=t&&typeof t=="object"?t:{};return(Array.isArray(e.tables)?e.tables:[]).map((r,o)=>tl(r,o))}function nl(t="",e={},s={}){let r=Wn(e?.type),o=String(t??"").trim(),n=z(s?.label,`${z(s?.tableName,"\u8868\u683C")} / ${z(s?.rowName,"\u884C")} / ${z(e?.title||e?.key,"\u5355\u5143\u683C")}`),a=[],i=[];if(e?.required===!0&&!o&&a.push(`${n} \u4E3A\u5FC5\u586B\uFF0C\u5F53\u524D\u4E3A\u7A7A\u3002`),!o)return{valid:a.length===0,errors:a,warnings:i};if(r==="number"&&!Number.isFinite(Number(o))&&a.push(`${n} \u9700\u8981\u586B\u5199\u6570\u5B57\u3002`),r==="boolean"&&!["true","false","1","0","yes","no"].includes(o.toLowerCase())&&a.push(`${n} \u9700\u8981\u586B\u5199\u5E03\u5C14\u503C\uFF08true / false\uFF09\u3002`),r==="date"&&Number.isNaN(Date.parse(o))&&a.push(`${n} \u9700\u8981\u586B\u5199\u53EF\u89E3\u6790\u7684\u65E5\u671F\u3002`),r==="json")try{JSON.parse(o)}catch(l){a.push(`${n} \u9700\u8981\u586B\u5199\u5408\u6CD5 JSON\uFF1A${l?.message||"\u89E3\u6790\u5931\u8D25"}`)}return{valid:a.length===0,errors:a,warnings:i}}function Vu(t={}){let s=Gu(t&&typeof t=="object"?t:{}),r=[];return s.forEach((o,n)=>{let a=z(o?.name,`\u8868${n+1}`),i=Array.isArray(o?.columns)?o.columns:[],l=Array.isArray(o?.rows)?o.rows:[];a||r.push(`\u8868 ${n+1} \u7F3A\u5C11\u540D\u79F0\u3002`),i.length===0&&r.push(`${a} \u81F3\u5C11\u9700\u8981\u4E00\u5217\u3002`);let c=new Set;i.forEach((d,u)=>{let y=z(d?.key,""),p=z(d?.title,`\u5217${u+1}`);if(!y){r.push(`${a} / ${p} \u7F3A\u5C11\u5185\u90E8\u540D\u3002`);return}if(c.has(y)){r.push(`${a} \u4E2D\u5B58\u5728\u91CD\u590D\u5217\u5185\u90E8\u540D\uFF1A${y}`);return}c.add(y)}),l.forEach((d,u)=>{let y=z(d?.name,`\u884C${u+1}`),p=d?.cells&&typeof d.cells=="object"&&!Array.isArray(d.cells)?d.cells:{};i.forEach((f,h)=>{let m=z(f?.key,""),_=z(f?.title||m,`\u5217${h+1}`),M=m?xo(p[m]):"",w=nl(M,f,{label:`${a} / ${y} / ${_}`,tableName:a,rowName:y});r.push(...w.errors)})})}),{valid:r.length===0,errors:r,tables:s}}function Cs({severity:t="error",message:e="",tableIndex:s=-1,tableName:r="",columnIndex:o=-1,columnKey:n="",rowIndex:a=-1,rowName:i="",cellKey:l=""}={}){return{severity:t,message:z(e,t==="warning"?"\u5B58\u5728\u8B66\u544A\u3002":"\u5B58\u5728\u9519\u8BEF\u3002"),tableIndex:s,tableName:z(r,""),columnIndex:o,columnKey:z(n,""),rowIndex:a,rowName:z(i,""),cellKey:z(l,"")}}function gt(t={}){let e=Vu(t),s=[];if(!e.valid)return{...e,warnings:[],issues:s,summary:{errorCount:e.errors.length,warningCount:0}};let r=Array.isArray(e.tables)?e.tables:[];r.forEach((a,i)=>{let l=z(a?.name,`\u8868${i+1}`),c=Array.isArray(a?.columns)?a.columns:[],d=Array.isArray(a?.rows)?a.rows:[],u=new Set;l||s.push(Cs({severity:"error",message:`\u8868 ${i+1} \u7F3A\u5C11\u540D\u79F0\u3002`,tableIndex:i,tableName:l})),c.forEach((y,p)=>{let f=z(y?.key,""),h=z(y?.title,`\u5217${p+1}`);f||s.push(Cs({severity:"error",message:`${l} / ${h} \u7F3A\u5C11\u5185\u90E8\u540D\u3002`,tableIndex:i,tableName:l,columnIndex:p,columnKey:f,cellKey:f})),f&&(u.has(f)&&s.push(Cs({severity:"error",message:`${l} \u4E2D\u5B58\u5728\u91CD\u590D\u5217\u5185\u90E8\u540D\uFF1A${f}`,tableIndex:i,tableName:l,columnIndex:p,columnKey:f,cellKey:f})),u.add(f))}),d.forEach((y,p)=>{let f=z(y?.name,`\u884C${p+1}`),h=y?.cells&&typeof y.cells=="object"&&!Array.isArray(y.cells)?y.cells:{};Object.keys(h).forEach(_=>{c.some(M=>z(M?.key,"")===_)||s.push(Cs({severity:"warning",message:`${l} / ${f} \u5305\u542B\u672A\u5B9A\u4E49\u5217 ${_}\uFF0C\u4FDD\u5B58\u540E\u4F1A\u88AB\u5FFD\u7565\u3002`,tableIndex:i,tableName:l,rowIndex:p,rowName:f,cellKey:_}))}),c.forEach((_,M)=>{let w=z(_?.key,""),E=z(_?.title||w,`\u5217${M+1}`),k=w?xo(h[w]):"",I=nl(k,_,{label:`${l} / ${f} / ${E}`,tableName:l,rowName:f});I.errors.forEach(N=>{s.push(Cs({severity:"error",message:N,tableIndex:i,tableName:l,columnIndex:M,columnKey:w,rowIndex:p,rowName:f,cellKey:w}))}),I.warnings.forEach(N=>{s.push(Cs({severity:"warning",message:N,tableIndex:i,tableName:l,columnIndex:M,columnKey:w,rowIndex:p,rowName:f,cellKey:w}))})})})});let o=s.filter(a=>a.severity!=="warning").map(a=>a.message),n=s.filter(a=>a.severity==="warning").map(a=>a.message);return{valid:o.length===0,errors:o,warnings:n,issues:s,tables:r,summary:{errorCount:o.length,warningCount:n.length}}}function al(){return{tables:[],promptTemplate:Xi,apiPreset:"",mirrorToMessage:!1,mirrorTag:"yyt-table-workbench",runtime:sl()}}function je(t={}){let e=al(),s=t&&typeof t=="object"?t:{};return{tables:zu(s.tables),promptTemplate:z(s.promptTemplate,e.promptTemplate),apiPreset:z(s.apiPreset,""),mirrorToMessage:Ku(s.mirrorToMessage,e.mirrorToMessage),mirrorTag:z(s.mirrorTag,e.mirrorTag),runtime:sl({...e.runtime,...s.runtime||{}})}}function Fn(t={}){let e=je(t),s=[];return Array.isArray(e.tables)||s.push("\u8868\u5B9A\u4E49\u5FC5\u987B\u662F JSON \u6570\u7EC4\u3002"),e.promptTemplate||s.push("\u586B\u8868 Prompt \u4E0D\u80FD\u4E3A\u7A7A\u3002"),e.mirrorTag||s.push("\u6B63\u6587\u955C\u50CF\u6807\u7B7E\u4E0D\u80FD\u4E3A\u7A7A\u3002"),{valid:s.length===0,errors:s,config:e}}function Fe(){let t=zn.get(Un,al());return je(t)}function il(t={}){let e=Fe(),s=je({...e,...t||{},runtime:t?.runtime===void 0?e.runtime:t.runtime}),r=Fn(s);return r.valid?(zn.set(Un,r.config),{success:!0,config:r.config}):{success:!1,error:r.errors.join(`
`),errors:r.errors,config:r.config}}function fr(t={}){let e=Fe(),s=je({...e,runtime:{...e.runtime,...t||{}}});return zn.set(Un,s),s.runtime}function Ju(t={}){let e=je(t);return`${z(e.promptTemplate,Xi)}

${Bu}`.trim()}function ll(t={}){return{id:"tableWorkbench",name:"\u586B\u8868\u5DE5\u4F5C\u53F0",promptTemplate:Ju(t),bypass:{enabled:!1}}}function cl({apiPresets:t=[]}={}){let e=[{value:"",label:"\u5F53\u524D API \u914D\u7F6E"},...t.map(s=>({value:String(s?.name||""),label:String(s?.name||"")})).filter(s=>s.value)];return[{name:"tables",type:"tableDefinitions",label:"\u8868\u5B9A\u4E49",description:"\u901A\u8FC7\u7ED3\u6784\u5316\u7F16\u8F91\u5668\u7EF4\u62A4 tables\u3002\u9996\u6B21\u6267\u884C\u6216\u5F53\u524D\u6D88\u606F\u5C1A\u65E0\u7ED1\u5B9A state \u65F6\uFF0C\u4F1A\u4EE5\u7F16\u8BD1\u540E\u7684 tables \u4F5C\u4E3A merge base\u3002",emptyValue:[]},{name:"promptTemplate",type:"textarea",label:"\u586B\u8868 Prompt",rows:12,description:"\u53EF\u4F7F\u7528 {{lastUserMessage}}\u3001{{lastAiMessage}}\u3001{{chatHistory}}\u3001{{toolContentMacro}} \u7B49\u53D8\u91CF\u3002\u7CFB\u7EDF\u4F1A\u81EA\u52A8\u8FFD\u52A0 JSON \u8F93\u51FA\u7EA6\u675F\u3002"},{name:"apiPreset",type:"select",label:"API \u9884\u8BBE",description:"\u4E3A\u7A7A\u65F6\u4F7F\u7528\u5F53\u524D\u5168\u5C40 API \u914D\u7F6E\u3002",options:e},{name:"mirrorToMessage",type:"checkbox",label:"\u955C\u50CF\u5199\u56DE\u6B63\u6587",description:"\u628A\u5F53\u524D tables \u7684 JSON \u9884\u89C8\u955C\u50CF\u5230\u76EE\u6807 assistant \u6D88\u606F\u6B63\u6587\u4E2D\u3002"}]}var zn,Un,Ps,Xi,Bu,Qi,Rs,Zi,mr=W(()=>{De();Is();zn=C.namespace("tableWorkbench"),Un="config",Ps=Object.freeze({IDLE:"idle",RUNNING:"running",SUCCESS:"success",ERROR:"error"}),Xi=`\u8BF7\u6839\u636E\u5F53\u524D\u5BF9\u8BDD\u4E0E\u5F53\u524D\u8868\u683C\u57FA\u5E95\uFF0C\u66F4\u65B0\u7ED3\u6784\u5316 tables \u6570\u636E\u3002
...
{
  "tables": []
}`,Qi=Object.freeze([{value:"text",label:"\u6587\u672C"},{value:"number",label:"\u6570\u5B57"},{value:"boolean",label:"\u5E03\u5C14"},{value:"date",label:"\u65E5\u671F"},{value:"json",label:"JSON"}]),Rs="text",Zi=Object.freeze(Qi.map(t=>Object.freeze({...t})))});function Mt(t=[],e=-1,s=-1){if(!Array.isArray(t))return[];if(!Number.isInteger(e)||!Number.isInteger(s)||e<0||s<0||e>=t.length||s>=t.length||e===s)return[...t];let r=[...t],[o]=r.splice(e,1);return r.splice(s,0,o),r}function br(t,e={},s={}){let r=Number.isInteger(s.size)?s.size:0,o=Number.isInteger(s.currentIndex)?s.currentIndex:-1,n=o<=0,a=o<0||o>=r-1,i=Object.entries(e).filter(([,l])=>Number.isInteger(l)).map(([l,c])=>`data-${l}="${c}"`).join(" ");return`
  ...
  `}function is(t,e=null){let s=D();if(!s||!t?.length)return e;t.find("[data-table-validation-summary]").remove(),t.find(".yyt-table-cell-error").removeClass("yyt-table-cell-error"),t.find(".yyt-has-error").removeClass("yyt-has-error");let r=e||gt($s(t)),o=Array.isArray(r?.issues)?r.issues:[],n=new Set(o.filter(l=>l?.severity!=="warning").map(l=>ty(l))),a=new Set(o.filter(l=>l?.severity!=="warning").map(l=>`${l?.tableIndex??-1}:${l?.columnIndex??-1}`)),i=new Set(o.filter(l=>l?.severity!=="warning").map(l=>`${l?.tableIndex??-1}`));return o.length>0&&t.prepend(sy(r)),t.find("[data-table-editor-table]").each((l,c)=>{let d=s(c);i.has(`${l}`)&&d.addClass("yyt-has-error"),d.find("[data-table-editor-column]").each((u,y)=>{let p=s(y);a.has(`${l}:${u}`)&&(p.addClass("yyt-has-error"),p.find("[data-table-editor-column-title], [data-table-editor-column-key], [data-table-editor-column-type], [data-table-editor-column-description]").addClass("yyt-table-cell-error"))}),d.find("[data-table-editor-row]").each((u,y)=>{let p=s(y),f=!1;p.find("[data-table-editor-cell]").each((h,m)=>{let _=String(d.find(`[data-table-editor-column="${h}"] [data-table-editor-column-key]`).val()||"").trim(),M=[l,u,h,_].join(":");n.has(M)&&(f=!0,s(m).addClass("yyt-table-cell-error"))}),f&&p.addClass("yyt-has-error")})}),r}function ry(t={},e={},s=0,r=0){let o=Array.isArray(t.columns)?t.columns:[],n=br("row",{"table-index":s,"row-index":r},{currentIndex:r,size:o.length>=0&&Array.isArray(t.rows)?t.rows.length:0});return`
      ...
      ${o.map((a,i)=>{let l=String(a?.key||"").trim();return`
        <td>
          <textarea class="yyt-textarea yyt-code-textarea-small"
                    ...
                    data-column-key="${x(l)}"
                    rows="2"
                    placeholder="${x(a.title||a.key||`\u5217${i+1}`)}">${x(ey(e,a,i))}</textarea>
        </td>
      `}).join("")}
      <td>
  ...
  `}function ul(t={},e=0,s={}){let r=Array.isArray(t.columns)?t.columns:[],o=Array.isArray(t.rows)?t.rows:[],n=String(t?.name||"").trim(),a=s.showDeleteTable!==!1,i=br("table",{"table-index":e},{currentIndex:e,size:Number.isInteger(s.totalTables)?s.totalTables:0}),l=a?`
  ...
  `}function gl(t={},e={}){let s=Hn(t),r=Array.isArray(s?.tables)?s.tables:[],o=e.mode==="focused"?"focused":"full",n=pl(r.length,Number.parseInt(e.currentTableIndex,10));if(o==="focused"){let a=r[n]||null;return`
      <div class="yyt-table-editor-shell">
        ${a?ul(a,n,{totalTables:r.length}):`
    ...
    <div class="yyt-table-editor-shell">
      ...
      <div class="yyt-table-editor-stack">
        ${r.length?r.map((a,i)=>ul(a,i,{totalTables:r.length})).join(""):`
          <div class="yyt-table-editor-empty">\u8FD8\u6CA1\u6709\u8868\uFF0C\u5148\u65B0\u5EFA\u4E00\u5F20\u3002</div>
        `}
      </div>
    </div>
  `}function oy(t={},e={}){let s=String(t.name||"").trim(),r=x(t.label||s),o=t.description?`<div class="yyt-table-form-field-desc">${x(t.description)}</div>`:"",n=Hn({tables:Array.isArray(e[s])?e[s]:[]});return`
    <div class="yyt-table-form-field" data-table-form-item="${x(s)}">
      <label>${r}</label>
      ${Yn(t,n,{description:o})}
    </div>
  `}function Yn(t={},e={},s={}){let r=String(t.name||"").trim(),o=typeof s.description=="string"?s.description:t.description?`<div class="yyt-table-form-field-desc">${x(t.description)}</div>`:"",n=s.mode==="focused"?"focused":"full",a=Number.parseInt(s.currentTableIndex,10);return`
    <div class="yyt-table-editor" data-table-field="${x(r)}" data-field-type="tableDefinitions" data-table-definition-root data-table-editor-mode="${n}" data-current-table-index="${Number.isInteger(a)?a:0}">
      ${gl(e,{mode:n,currentTableIndex:a})}
    </div>
    ${o}
  ...
  `:""}function ny(t={},e={}){let s=String(t.name||"").trim();if(!s)return"";if(t.type==="tableDefinitions")return oy(t,e);let r=e[s],o=x(t.label||s),n=t.description?`<div class="yyt-table-form-field-desc">${x(t.description)}</div>`:"",a=Number.isFinite(t.rows)?t.rows:6;return t.type==="checkbox"?`
      <div class="yyt-table-form-field" data-table-form-item="${x(s)}">
    ...
    <div class="yyt-table-form-field" data-table-form-item="${x(s)}">
      ...
      <textarea class="yyt-textarea yyt-code-textarea ${t.type==="json"?"":"yyt-code-textarea-small"}"
                ...
                rows="${a}">${x(Qu(t,r))}</textarea>
      ${n}
    </div>
  `}function $s(t){let e=D();return!e||!t?.length?{tables:[]}:{tables:t.find("[data-table-editor-table]").map((r,o)=>{let n=e(o),a=n.find("[data-table-editor-column]").map((l,c)=>{let d=e(c);return{title:String(d.find("[data-table-editor-column-title]").val()||""),key:String(d.find("[data-table-editor-column-key]").val()||""),description:String(d.find("[data-table-editor-column-description]").val()||""),type:String(d.find("[data-table-editor-column-type]").val()||Rs),required:d.find("[data-table-editor-column-required]").is(":checked")}}).get(),i=n.find("[data-table-editor-row]").map((l,c)=>{let d=e(c);return{name:String(d.find("[data-table-editor-row-name]").val()||""),cells:d.find("[data-table-editor-cell]").map((u,y)=>String(e(y).val()||"")).get()}}).get();return{name:String(n.find("[data-table-editor-table-name]").val()||""),note:String(n.find("[data-table-editor-table-note]").val()||""),columns:a,rows:i}}).get()}}function ay(t=[],e=1){return{name:`\u884C${e}`,cells:Array.from({length:Array.isArray(t)?t.length:0},()=>"")}}function rt(t,e={},s={}){let r=String(t.attr("data-table-editor-mode")||"").trim()==="focused"?"focused":"full",o=Number.parseInt(t.attr("data-current-table-index")||"0",10),n=Hn(s),a=pl(Array.isArray(n.tables)?n.tables.length:0,o);t.attr("data-current-table-index",String(a)),t.html(gl(n,{mode:r,currentTableIndex:a}))}function ml(t,e=[],s={}){let r=D();if(!r||!B(t))return;let o=Array.isArray(e)?e:[],n=c=>{let d=String(c.attr("data-table-field")||"").trim();return o.find(u=>String(u?.name||"").trim()===d)||{name:d}},a=()=>{typeof s.onChange=="function"&&s.onChange()},i=(c={})=>{typeof s.onTableMutation=="function"&&s.onTableMutation(c)};t.off(".yytTableForm"),t.on("click.yytTableForm","[data-table-definition-root] [data-table-editor-action]",c=>{c.preventDefault();let d=r(c.currentTarget),u=String(d.attr("data-table-editor-action")||"").trim(),y=d.closest("[data-table-definition-root]");if(!y.length)return;let p=n(y),f=$s(y),h=Array.isArray(f.tables)?f.tables:[],m=Number.parseInt(d.attr("data-table-index")||"",10),_=Number.parseInt(d.attr("data-column-index")||"",10),M=Number.parseInt(d.attr("data-row-index")||"",10);if(u==="add-table"){let w=[...h,rl(h.length+1)];rt(y,p,{tables:w}),i({action:"add-table",tableIndex:w.length-1,draft:{tables:w}}),a();return}if(u==="delete-table"&&Number.isInteger(m)&&m>=0&&m<h.length){h.splice(m,1),rt(y,p,{tables:h}),i({action:"delete-table",tableIndex:m,draft:{tables:h}}),a();return}if(u==="move-table-up"&&Number.isInteger(m)){let w=Mt(h,m,m-1);rt(y,p,{tables:w}),i({action:"move-table-up",tableIndex:m,nextTableIndex:Math.max(0,m-1),draft:{tables:w}}),a();return}if(u==="move-table-down"&&Number.isInteger(m)){let w=Mt(h,m,m+1);rt(y,p,{tables:w}),i({action:"move-table-down",tableIndex:m,nextTableIndex:Math.min(w.length-1,m+1),draft:{tables:w}}),a();return}if(u==="add-column"&&Number.isInteger(m)&&m>=0&&m<h.length){let w=h[m]||{},E=Array.isArray(w.columns)?w.columns:[],k=jn(E.length+1,E);w.columns=[...E,k],w.rows=(Array.isArray(w.rows)?w.rows:[]).map((I,N)=>({name:String(I?.name||`\u884C${N+1}`),cells:[...Array.isArray(I?.cells)?I.cells:[],""]}))}if(u==="delete-column"&&Number.isInteger(m)&&m>=0&&m<h.length){let w=h[m]||{},E=Array.isArray(w.columns)?w.columns:[];Number.isInteger(_)&&_>=0&&_<E.length&&(w.columns=E.filter((k,I)=>I!==_),w.rows=(Array.isArray(w.rows)?w.rows:[]).map((k,I)=>{let N=Array.isArray(k?.cells)?[...k.cells]:[];return N.splice(_,1),{name:String(k?.name||`\u884C${I+1}`),cells:N}}))}if(u==="move-column-up"&&Number.isInteger(m)&&Number.isInteger(_)&&m>=0&&m<h.length){let w=h[m]||{},E=Array.isArray(w.columns)?w.columns:[];w.columns=Mt(E,_,_-1),w.rows=(Array.isArray(w.rows)?w.rows:[]).map((k,I)=>({name:String(k?.name||`\u884C${I+1}`),cells:Mt(Array.isArray(k?.cells)?k.cells:[],_,_-1)})),rt(y,p,{tables:h}),a();return}if(u==="move-column-down"&&Number.isInteger(m)&&Number.isInteger(_)&&m>=0&&m<h.length){let w=h[m]||{},E=Array.isArray(w.columns)?w.columns:[];w.columns=Mt(E,_,_+1),w.rows=(Array.isArray(w.rows)?w.rows:[]).map((k,I)=>({name:String(k?.name||`\u884C${I+1}`),cells:Mt(Array.isArray(k?.cells)?k.cells:[],_,_+1)})),rt(y,p,{tables:h}),a();return}if(u==="add-row"&&Number.isInteger(m)&&m>=0&&m<h.length){let w=h[m]||{},E=Array.isArray(w.columns)?w.columns:[],k=Array.isArray(w.rows)?w.rows:[];w.rows=[...k,ay(E,k.length+1)]}if(u==="delete-row"&&Number.isInteger(m)&&m>=0&&m<h.length){let w=h[m]||{},E=Array.isArray(w.rows)?w.rows:[];Number.isInteger(M)&&M>=0&&M<E.length&&(w.rows=E.filter((k,I)=>I!==M))}if(u==="move-row-up"&&Number.isInteger(m)&&Number.isInteger(M)&&m>=0&&m<h.length){let w=h[m]||{};w.rows=Mt(Array.isArray(w.rows)?w.rows:[],M,M-1),rt(y,p,{tables:h}),a();return}if(u==="move-row-down"&&Number.isInteger(m)&&Number.isInteger(M)&&m>=0&&m<h.length){let w=h[m]||{};w.rows=Mt(Array.isArray(w.rows)?w.rows:[],M,M+1),rt(y,p,{tables:h}),a();return}rt(y,p,{tables:h}),is(y),a()}),t.on("input.yytTableForm","[data-table-definition-root] input, [data-table-definition-root] textarea",c=>{let d=r(c.currentTarget).closest("[data-table-definition-root]");d.length&&is(d),a()}),t.on("click.yytTableForm","[data-table-select-trigger]",c=>{c.preventDefault(),c.stopPropagation();let d=r(c.currentTarget),u=d.closest("[data-table-custom-select]"),y=u.hasClass("yyt-open");t.find("[data-table-custom-select].yyt-open").not(u).removeClass("yyt-open").find("[data-table-select-trigger]").attr("aria-expanded","false"),u.toggleClass("yyt-open",!y),d.attr("aria-expanded",String(!y))}),t.on("click.yytTableForm","[data-table-select-option]",c=>{c.preventDefault(),c.stopPropagation();let d=r(c.currentTarget),u=d.closest("[data-table-custom-select]"),y=String(d.attr("data-value")||""),p=d.find(".yyt-option-text").text();u.find(".yyt-table-select-native").val(y).trigger("change"),u.find(".yyt-select-value").text(p).attr("data-value",y).data("value",y),u.find("[data-table-select-option]").removeClass("yyt-selected").attr("aria-selected","false"),d.addClass("yyt-selected").attr("aria-selected","true"),u.removeClass("yyt-open"),u.find("[data-table-select-trigger]").attr("aria-expanded","false"),a()}),t.on("change.yytTableForm",'[data-table-field][data-field-type="select"]',()=>{a()}),t.on("blur.yytTableForm","[data-table-definition-root] [data-table-editor-cell], [data-table-definition-root] [data-table-editor-column-key], [data-table-definition-root] [data-table-editor-column-title], [data-table-definition-root] [data-table-editor-column-type], [data-table-definition-root] [data-table-editor-column-required]",c=>{let d=r(c.currentTarget).closest("[data-table-definition-root]");d.length&&is(d)}),t.on("change.yytTableForm","[data-table-definition-root] [data-table-editor-column-key], [data-table-definition-root] [data-table-editor-column-title]",c=>{let d=r(c.currentTarget).closest("[data-table-definition-root]");if(!d.length)return;let u=n(d);rt(d,u,$s(d)),a()});let l=zt();r(l).off("click.yytTableFormSelect").on("click.yytTableFormSelect",c=>{r(c.target).closest(t).length||t.find("[data-table-custom-select].yyt-open").removeClass("yyt-open").find("[data-table-select-trigger]").attr("aria-expanded","false")})}function bl(t){let e=D();!e||!B(t)||(t.off(".yytTableForm"),e(zt()).off("click.yytTableFormSelect"))}function qn(t,e=[]){let s=Array.isArray(e)?e:[],r={},o=[];return s.forEach(n=>{let a=String(n?.name||"").trim();if(!a)return;let i=t.find(`[data-table-field="${a}"]`);if(!i.length)return;if(n.type==="tableDefinitions"){let c=gt($s(i));if(is(i,c),!c.valid){c.errors.forEach(d=>{o.push(`${n.label||a}\uFF1A${d}`)});return}r[a]=dl(c.tables);return}if(n.type==="checkbox"){r[a]=i.is(":checked");return}let l=String(i.val()||"");if(n.type==="json"){let c=l.trim();if(!c){r[a]=dl(n.emptyValue);return}try{r[a]=JSON.parse(c)}catch(d){o.push(`${n.label||a} \u4E0D\u662F\u5408\u6CD5 JSON\uFF1A${d?.message||String(d)}`)}return}r[a]=l}),{values:r,errors:o}}var yl,hl=W(()=>{Se();mr();yl=`
...
`});function iy(t={},e=-1){return[t?.sourceId,t?.messageId,t?.message_id,t?.id,t?.mid,t?.mesid,t?.mes_id,t?.chat_index,t?.index,e].map(s=>X(s))}function ly(t=[],e=""){let s=X(e);if(!s||!Array.isArray(t))return-1;for(let r=t.length-1;r>=0;r-=1){let o=t[r];if(iy(o,r).includes(s))return r}return-1}function wo(t={},e={}){let s=X(t?.sourceMessageId||t?.confirmedAssistantMessageId||t?.messageId);if(!s)return null;let r=Kn({resolvedAt:Date.now(),runSource:e.runSource||t?.runSource||st.MANUAL,traceId:t?.traceId||"",chatId:t?.chatId||"",sourceMessageId:s,sourceSwipeId:t?.sourceSwipeId||t?.effectiveSwipeId||"",effectiveSwipeId:t?.effectiveSwipeId||t?.sourceSwipeId||"swipe:current",slotBindingKey:t?.slotBindingKey||"",slotRevisionKey:t?.slotRevisionKey||"",slotTransactionId:t?.slotTransactionId||"",assistantContentFingerprint:t?.assistantContentFingerprint||"",assistantBaseFingerprint:t?.assistantBaseFingerprint||"",assistantText:t?.lastAiMessage||"",assistantBaseText:t?.assistantBaseText||"",targetMessageIndex:ly(t?.chatMessages||t?.chatHistory||[],s)});return!r.slotBindingKey||!r.slotRevisionKey?null:r}async function Gn({runSource:t=st.MANUAL}={}){let e=await Vt({runSource:t});return wo(e,{runSource:t})}async function cy({messageId:t,swipeId:e="",runSource:s=st.AUTO}={}){let r=await rr({messageId:t,swipeId:e,runSource:s});return wo(r,{runSource:s})}async function vl(t=null,e={}){let s=t||null;if(typeof e.resolveTarget=="function")return await e.resolveTarget(s);let r=X(e.runSource||s?.runSource)||st.MANUAL,o=X(e.messageId||s?.sourceMessageId),n=X(e.swipeId||s?.sourceSwipeId||s?.effectiveSwipeId);return e.useMessageTarget===!0||r===st.AUTO?o?cy({messageId:o,swipeId:n,runSource:r}):null:Gn({runSource:r})}function xl(t,e){let s=t||null,r=e||null;return!s||!r?{valid:!1,reason:"missing_target_snapshot"}:X(s.sourceMessageId)!==X(r.sourceMessageId)?{valid:!1,reason:"source_message_changed"}:X(s.sourceSwipeId||s.effectiveSwipeId)!==X(r.sourceSwipeId||r.effectiveSwipeId)?{valid:!1,reason:"source_swipe_changed"}:X(s.slotRevisionKey)!==X(r.slotRevisionKey)?{valid:!1,reason:"slot_revision_changed"}:{valid:!0,reason:"ok"}}var So=W(()=>{vs();Is()});function ot(t){return t==null?"":String(t).trim()}function dy(){try{if(typeof window.parent<"u"&&window.parent&&window.parent!==window)return window.parent}catch{}return window}function uy(){try{let t=dy(),e=t?.SillyTavern||null,s=e?.getContext?.()||null,r=Array.isArray(s?.chat)?s.chat:[],o=Array.isArray(e?.chat)?e.chat:[],n=r.length?r:o;return{topWindow:t,api:e,context:s,chat:n,contextChat:r,apiChat:o}}catch{return{topWindow:null,api:null,context:null,chat:[],contextChat:[],apiChat:[]}}}function yy(t){if(!t||t?.is_user===!0||t?.is_system===!0)return!1;let e=String(t?.role||"").trim().toLowerCase();return e==="assistant"||e==="ai"||!e}function py(t=[],e=""){let s=ot(e);if(!Array.isArray(t)||!s)return-1;for(let r=t.length-1;r>=0;r-=1){let o=t[r];if(!yy(o))continue;if([o?.sourceId,o?.message_id,o?.messageId,o?.id,o?.mes_id,o?.mid,o?.mesid,o?.chat_index,o?.index,r].map(a=>ot(a)).includes(s))return r}return-1}function Vn(t){let e=uy(),s=py(e.chat,t?.sourceMessageId);return s<0?{runtime:e,messageIndex:s,message:null}:{runtime:e,messageIndex:s,message:e.chat[s]||null}}function wl(t,e,s){let r=o=>{!Array.isArray(o)||e<0||e>=o.length||(o[e]={...o[e]||{},...s})};r(t?.contextChat),r(t?.apiChat)}async function Sl(t){let e=t?.context||null,s=t?.api||null,r=e?.saveChatDebounced||s?.saveChatDebounced||null,o=e?.saveChat||s?.saveChat||null;typeof r=="function"&&r.call(e||s),typeof o=="function"&&await o.call(e||s)}function gy(t){let{message:e}=Vn(t);return gr(e?.[bo])}function To(t,e={}){let s=gy(t);return s&&ot(s.slotRevisionKey)===ot(t?.slotRevisionKey)?{loadMode:pr.EXACT,mergeBaseOnly:!1,state:s}:s&&ot(s.slotBindingKey)===ot(t?.slotBindingKey)?{loadMode:pr.BINDING_FALLBACK,mergeBaseOnly:!0,state:gr({...s,slotRevisionKey:ot(t?.slotRevisionKey)||s.slotRevisionKey,sourceSwipeId:ot(t?.sourceSwipeId||t?.effectiveSwipeId)||s.sourceSwipeId,meta:{...s.meta||{},mergeBaseOnly:!0,fallbackFromBinding:!0,fallbackFromRevisionKey:ot(s.slotRevisionKey),requestedRevisionKey:ot(t?.slotRevisionKey)}})}:Array.isArray(e.templateTables)?{loadMode:pr.TEMPLATE,mergeBaseOnly:!1,state:ho(t,{tables:Te(e.templateTables),meta:{fromTemplate:!0}})}:{loadMode:pr.EMPTY,mergeBaseOnly:!1,state:ho(t)}}async function Tl(t){let{runtime:e,messageIndex:s,message:r}=Vn(t);if(!r||s<0)return{success:!1,error:"target_message_not_found"};let o={...vo(r[ks]),lastResolvedTarget:Ms(t),updatedAt:Date.now()};return r[ks]=o,wl(e,s,r),await Sl(e),{success:!0,bindings:o}}async function _l(t,e,s={}){let r=s.skipFreshValidation===!0?t:await vl(t,s),o=s.skipFreshValidation===!0?{valid:!0,reason:"skipped"}:xl(t,r);if(!o.valid)return{success:!1,error:"target_changed_before_commit",validation:o};let n=r||t,{runtime:a,messageIndex:i,message:l}=Vn(n);if(!l||i<0)return{success:!1,error:"target_message_not_found",validation:o};let c=gr({...ho(n),...e,slotBindingKey:n.slotBindingKey,slotRevisionKey:n.slotRevisionKey,sourceMessageId:n.sourceMessageId,sourceSwipeId:n.sourceSwipeId||n.effectiveSwipeId,updatedAt:Date.now()}),d={...vo(l[ks]),lastResolvedTarget:Ms(n),lastCommittedTarget:Ms(n),updatedAt:Date.now()};return l[bo]=c,l[ks]=d,wl(a,i,l),await Sl(a),{success:!0,state:c,bindings:d,validation:o,messageIndex:i,sourceMessageId:n.sourceMessageId,slotRevisionKey:n.slotRevisionKey}}function _o(t=null){let e=Pe.getAssistantMessageSnapshot(t);return e?.message?{...e,tableState:gr(e.message[bo]),tableBindings:vo(e.message[ks])}:null}var Ao=W(()=>{Jt();Is();So()});function Jn(t,e=""){return t==null?e:String(t).trim()||e}function my(t={}){return{tables:Array.isArray(t?.tables)?Te(t.tables):[]}}function by(t={},e={}){let s=Jn(e.mirrorTag,"yyt-table-workbench"),r=my(t);return[`<${s}>`,"[\u586B\u8868\u5DE5\u4F5C\u53F0]","```json",JSON.stringify(r,null,2),"```",`</${s}>`].join(`
`)}async function Al({targetSnapshot:t,nextTables:e,config:s,loadResult:r=null}={}){let o=je(s),n=await _l(t,{tables:Array.isArray(e)?Te(e):[],meta:{lastLoadMode:Jn(r?.loadMode,""),mergeBaseOnly:!1,updatedBy:Jn(t?.runSource,"MANUAL_TABLE")}});if(!n?.success)return{success:!1,error:n?.error||"table_state_commit_failed",commitResult:n,mirrorResult:null,warning:""};let a=null,i="";if(o.mirrorToMessage){let l=by(n.state,{mirrorTag:o.mirrorTag});a=await Pe.injectDetailed(fy,l,{overwrite:!0,extractionSelectors:[o.mirrorTag],sourceMessageId:n.sourceMessageId,sourceSwipeId:t?.sourceSwipeId||t?.effectiveSwipeId,effectiveSwipeId:t?.effectiveSwipeId||t?.sourceSwipeId,slotBindingKey:t?.slotBindingKey,slotRevisionKey:t?.slotRevisionKey,slotTransactionId:t?.slotTransactionId,traceId:t?.traceId}),a?.success||(i=a?.error||"\u6B63\u6587\u955C\u50CF\u5199\u56DE\u5931\u8D25")}return{success:!0,state:n.state,bindings:n.bindings,commitResult:n,mirrorResult:a,warning:i}}var fy,El=W(()=>{Jt();Is();Ao();mr();fy="tableWorkbenchMirror"});function He(t,e=""){return t==null?e:String(t).trim()||e}function Ml(t=[],e=8){return!Array.isArray(t)||t.length===0?"":t.slice(Math.max(t.length-e,0)).map(s=>`[${He(s?.role,"unknown")}] ${String(s?.content||"").trim()}`).filter(Boolean).join(`

`)}function hy(t,e){return{target:{sourceMessageId:He(t?.sourceMessageId),sourceSwipeId:He(t?.sourceSwipeId||t?.effectiveSwipeId),slotBindingKey:He(t?.slotBindingKey),slotRevisionKey:He(t?.slotRevisionKey),slotTransactionId:He(t?.slotTransactionId)},loadMode:He(e?.loadMode),mergeBaseOnly:e?.mergeBaseOnly===!0,tables:Array.isArray(e?.state?.tables)?Te(e.state.tables):[]}}function vy(t=""){let e=String(t||"").trim();if(!e)return[];let s=[],r=c=>{let d=String(c||"").trim();d&&(s.includes(d)||s.push(d))};(e.match(/```(?:json)?\s*([\s\S]*?)```/gi)||[]).forEach(c=>{let d=c.replace(/^```(?:json)?\s*/i,"").replace(/```$/i,"").trim();r(d)}),r(e);let n=e.indexOf("{"),a=e.lastIndexOf("}");n>=0&&a>n&&r(e.slice(n,a+1));let i=e.indexOf("["),l=e.lastIndexOf("]");return i>=0&&l>i&&r(e.slice(i,l+1)),s}function xy(t){if(Array.isArray(t))return t;if(t&&typeof t=="object"){if(Array.isArray(t.tables))return t.tables;if(t.data&&typeof t.data=="object"&&Array.isArray(t.data.tables))return t.data.tables}return null}function wy(t=""){let e=vy(t),s=[];for(let r of e)try{let o=JSON.parse(r),n=xy(o);if(!Array.isArray(n)){s.push("JSON \u4E2D\u7F3A\u5C11 tables \u6570\u7EC4\u3002");continue}return{tables:Te(n),parsed:o}}catch(o){s.push(o?.message||String(o))}throw new Error(s[0]||"\u65E0\u6CD5\u4ECE\u6A21\u578B\u54CD\u5E94\u4E2D\u89E3\u6790 tables JSON\u3002")}async function Sy({executionContext:t,targetSnapshot:e,loadResult:s,config:r,assistantSnapshot:o}={}){let n=je(r),a=ll(n),i=hy(e,s),l=Array.isArray(o?.tableState?.tables)?Te(o.tableState.tables):[],c={...t,toolName:"\u586B\u8868\u5DE5\u4F5C\u53F0",toolId:"tableWorkbench",lastAiMessage:t?.assistantBaseText||t?.lastAiMessage||"",recentMessagesText:Ml(t?.chatHistory||t?.chatMessages||[]),rawRecentMessagesText:Ml(t?.chatHistory||t?.chatMessages||[],20),injectedContext:o?.injectedContext||Pe.getLatestMessageInjectedContext(e?.sourceMessageId),toolContentMacro:JSON.stringify(i,null,2),extractedContent:JSON.stringify(i,null,2),previousToolOutput:JSON.stringify(l,null,2)},d=await Xt.buildToolMessages(a,c),u=await Xt.buildPromptText(a,c);if(!Array.isArray(d)||d.length===0)throw new Error("\u586B\u8868\u8BF7\u6C42\u6D88\u606F\u6784\u5EFA\u5931\u8D25\u3002");return{toolConfig:a,context:c,requestPayload:i,promptText:u,messages:d}}async function Ty(t,e={},s=null){let r=je(e),o=He(r.apiPreset,"");if(o){if(!zs(o))throw new Error(`API \u9884\u8BBE\u4E0D\u5B58\u5728: ${o}`);return Ko(o,t,{},s)}return Us(t,{},s)}async function kl(t=null){let e=je(t||Fe()),s=Fn(e),r=gt({tables:Array.isArray(e.tables)?e.tables:[]});if(!s.valid||!r.valid){let a=[...s.errors,...r.errors];return fr({lastStatus:Ps.ERROR,lastRunAt:Date.now(),lastDurationMs:0,lastError:a[0]||"\u586B\u8868\u914D\u7F6E\u65E0\u6548\u3002",lastErrorDetails:a,lastValidationSummary:r.summary||{errorCount:a.length,warningCount:0},errorCount:Number(e?.runtime?.errorCount)||0}),{success:!1,error:a.join(`
`),errors:a}}let o=e.runtime||{},n=Date.now();fr({lastStatus:Ps.RUNNING,lastError:"",lastErrorDetails:[],lastValidationSummary:r.summary||{errorCount:0,warningCount:0}});try{let a=await Vt({runSource:st.MANUAL}),i=wo(a,{runSource:st.MANUAL});if(!i)throw new Error("\u5F53\u524D\u6CA1\u6709\u53EF\u7528\u7684 assistant \u76EE\u6807\u697C\u5C42\u3002");let l=await Tl(i);if(!l?.success)throw new Error(l?.error||"\u76EE\u6807\u89E3\u6790\u8BB0\u5F55\u5931\u8D25");let c=_o(i.sourceMessageId),d=To(i,{templateTables:e.tables}),u=await Sy({executionContext:a,targetSnapshot:i,loadResult:d,config:e,assistantSnapshot:c}),y=await Ty(u.messages,e),p=wy(y),f=await Al({targetSnapshot:i,nextTables:p.tables,config:e,loadResult:d});if(!f?.success)throw new Error(f?.error||"\u7ED3\u6784\u5316\u5199\u56DE\u5931\u8D25");let h=Date.now()-n;return fr({lastStatus:Ps.SUCCESS,lastRunAt:Date.now(),lastDurationMs:h,lastError:"",lastErrorDetails:[],lastValidationSummary:r.summary||{errorCount:0,warningCount:0},successCount:(Number(o.successCount)||0)+1,errorCount:Number(o.errorCount)||0,lastSourceMessageId:He(i.sourceMessageId),lastSlotRevisionKey:He(i.slotRevisionKey),lastLoadMode:He(d.loadMode),lastMirrorApplied:f?.mirrorResult?.success===!0}),{success:!0,targetSnapshot:i,loadResult:d,request:u,responseText:y,parsed:p,state:f.state,bindings:f.bindings,mirrorResult:f.mirrorResult,warning:f.warning||""}}catch(a){let i=Date.now()-n;return fr({lastStatus:Ps.ERROR,lastRunAt:Date.now(),lastDurationMs:i,lastError:a?.message||String(a),lastErrorDetails:[a?.message||String(a)],lastValidationSummary:r.summary||{errorCount:0,warningCount:0},successCount:Number(o.successCount)||0,errorCount:(Number(o.errorCount)||0)+1}),{success:!1,error:a?.message||String(a),errors:[a?.message||String(a)]}}}var Il=W(()=>{vs();Jt();Ws();io();Is();So();Ao();mr();El()});function hr(){return cl({apiPresets:xt()})}function Eo(t,e=""){return typeof t=="string"&&t.trim()?t.trim():e}function Rl(t){return Number.isFinite(t)&&t>0?new Date(t).toLocaleString():"\u672A\u8BB0\u5F55"}function Mo(t){try{return JSON.stringify(t,null,2)}catch{return String(t??"")}}function Ye(t=[],e=0){let s=Array.isArray(t)?t.length:0;return s<=0||!Number.isInteger(e)||e<0?0:Math.min(e,s-1)}function Ay(t=[],e=-1,s=-1){if(!Array.isArray(t))return[];if(!Number.isInteger(e)||!Number.isInteger(s)||e<0||s<0||e>=t.length||s>=t.length||e===s)return[...t];let r=[...t],[o]=r.splice(e,1);return r.splice(s,0,o),r}function Ey(t=[]){return(Array.isArray(t)?t:[]).find(e=>e?.type==="tableDefinitions")||{name:"tables",label:"\u8868\u5B9A\u4E49",description:""}}function Xn(t,e={}){let s=D(),r=e&&typeof e=="object"?e:Fe();if(!s||!B(t))return r;let o={...r,runtime:r.runtime||{}},n=t.find("[data-table-definition-root]");if(n.length){let c=$s(n);o.tables=Array.isArray(c?.tables)?c.tables:[]}let a=t.find('[data-table-field="promptTemplate"]');a.length&&(o.promptTemplate=String(a.val()||""));let i=t.find('[data-table-field="apiPreset"]');i.length&&(o.apiPreset=String(i.val()||""));let l=t.find('[data-table-field="mirrorToMessage"]');return l.length&&(o.mirrorToMessage=l.is(":checked")),o}function $l(t={}){let e=Number(t?.summary?.errorCount)||0,s=Number(t?.summary?.warningCount)||0,r=Array.isArray(t?.issues)?t.issues:[],o=e>0?`\u5F53\u524D\u8868\u683C\u6709 ${e} \u4E2A\u9519\u8BEF${s>0?`\uFF0C\u53E6\u6709 ${s} \u4E2A\u63D0\u793A`:""}`:s>0?`\u5F53\u524D\u8868\u683C\u6709 ${s} \u4E2A\u63D0\u793A`:"\u5F53\u524D\u6570\u636E\u8D28\u91CF\u6B63\u5E38",n=r.slice(0,5).map(l=>`<li>${x(l?.message||"")}</li>`).join(""),a=r.length>5?`<li>\u8FD8\u6709 ${r.length-5} \u6761\uFF0C\u8BF7\u5148\u4FEE\u6B63\u4E0A\u9762\u8FD9\u4E9B\u3002</li>`:"";return`
  ...
  `}function Qn(t){if(!D()||!B(t))return;let s=hr(),{values:r,errors:o}=qn(t,s),n=t.find("[data-table-workbench-compiled-preview]");if(n.length){if(o.length>0){n.text(o.join(`
`));return}n.text(Mo(r.tables||[]))}}function My(){return`
  ...
  `}function ky(t=[],e=0){let s=Ye(t,e);return`
    <div>
  ...
  `}function Iy(t={},e=[],s=0){let r=Ey(e),o={tables:Array.isArray(t?.tables)?t.tables:[]},n=gt(o),a=Array.isArray(n?.tables)?n.tables:[],i=Ye(a,s),l=a[i]||null,c=Eo(l?.name,a.length?`\u8868\u683C ${i+1}`:"\u672A\u9009\u62E9");return Yn(r,o,{mode:"focused",currentTableIndex:i,description:""})}function Cy(t={}){let e=t.runtime||{},s=Eo(e.lastStatus,"idle"),r=e.lastRunAt?Rl(e.lastRunAt):"\u672A\u8FD0\u884C",o=Number.isFinite(e.lastDurationMs)&&e.lastDurationMs>0?`${e.lastDurationMs} ms`:"\u672A\u8BB0\u5F55",n=e.lastValidationSummary||{},a=`${Number(n.errorCount)||0} \u4E2A\u9519\u8BEF / ${Number(n.warningCount)||0} \u4E2A\u63D0\u793A`,i=Eo(e.lastLoadMode,"\u672A\u8BB0\u5F55"),l=e.lastMirrorApplied===!0?"\u5DF2\u5199\u56DE\u6B63\u6587":"\u672A\u5199\u56DE\u6B63\u6587",c=Eo(e.lastError,"");return`
    <div class="yyt-tool-runtime-card">
  ...
  `}function Py(t,e,s={}){let r=s.meta?`<div class="yyt-table-workbench-secondary-summary-meta">${s.meta}</div>`:"";return`
  ...
  `}function Ry(t={}){let e={tables:Array.isArray(t?.tables)?t.tables:[]},s=gt(e),r=ze.getVariableHelp(),o=Number(s?.summary?.errorCount)||0,n=Number(s?.summary?.warningCount)||0;return`
  ...
  `}function $y(t={},e=0){let s=hr(),r=Array.isArray(t?.tables)?t.tables:[],o=Ye(r,e);return`
  ...
  `:'<div class="yyt-table-workbench-empty-state"><div class="yyt-table-workbench-muted">\u6682\u65E0\u53EF\u663E\u793A\u5185\u5BB9\u3002</div></div>'}async function Dy(t){if(!D()||!B(t))return;let s=Fe(),r=t.find("[data-table-workbench-target]"),o=t.find("[data-table-workbench-load]"),n=t.find("[data-table-workbench-load-preview]");try{let a=await Gn();if(!B(t))return;if(!a){r.html('<div class="yyt-table-workbench-muted">\u5F53\u524D\u6CA1\u6709\u53EF\u7528\u7684 assistant \u76EE\u6807\u3002</div>'),o.html('<div class="yyt-table-workbench-muted">\u5C1A\u672A\u89E3\u6790\u5230\u53EF\u6267\u884C\u76EE\u6807\uFF0C\u56E0\u6B64\u4E0D\u4F1A\u52A0\u8F7D bound state\u3002</div>'),n.text(Mo(s.tables||[]));return}let i=_o(a.sourceMessageId),l=To(a,{templateTables:s.tables}),c=gt({tables:Array.isArray(l.state?.tables)?l.state.tables:[]}),d=i?.tableBindings||{},u=[{label:"sourceMessageId",value:a.sourceMessageId||"\u672A\u89E3\u6790"},{label:"sourceSwipeId",value:a.sourceSwipeId||a.effectiveSwipeId||"\u672A\u89E3\u6790"},{label:"slotBindingKey",value:a.slotBindingKey||"\u672A\u89E3\u6790"},{label:"slotRevisionKey",value:a.slotRevisionKey||"\u672A\u89E3\u6790"},{label:"slotTransactionId",value:a.slotTransactionId||"\u672A\u89E3\u6790"},{label:"lastResolvedTarget",value:d?.lastResolvedTarget?.slotRevisionKey||"\u672A\u8BB0\u5F55"},{label:"lastCommittedTarget",value:d?.lastCommittedTarget?.slotRevisionKey||"\u672A\u8BB0\u5F55"}],y=[{label:"loadMode",value:l.loadMode||"empty"},{label:"mergeBaseOnly",value:l.mergeBaseOnly===!0?"true":"false"},{label:"tables \u6570\u91CF",value:String(Array.isArray(l.state?.tables)?l.state.tables.length:0)},{label:"state updatedAt",value:Rl(l.state?.updatedAt)},{label:"\u6570\u636E\u8D28\u91CF",value:c.valid?c.summary?.warningCount>0?`0 \u4E2A\u9519\u8BEF / ${c.summary.warningCount} \u4E2A\u63D0\u793A`:"\u6B63\u5E38":`${c.summary?.errorCount||0} \u4E2A\u9519\u8BEF / ${c.summary?.warningCount||0} \u4E2A\u63D0\u793A`}];r.html(Cl(u)),o.html(`${Cl(y)}${$l(c)}`),n.text(Mo(l.state?.tables||[]))}catch(a){if(!B(t))return;r.html(`<div class="yyt-table-workbench-muted">${x(a?.message||"\u76EE\u6807\u8BCA\u65AD\u5931\u8D25")}</div>`),o.html('<div class="yyt-table-workbench-muted">\u65E0\u6CD5\u751F\u6210\u52A0\u8F7D\u8BCA\u65AD\u3002</div>'),n.text("\u65E0\u6CD5\u8BFB\u53D6\u8F7D\u5165\u5185\u5BB9\u3002")}}function Pl(t,{silent:e=!1}={}){let s=hr(),{values:r,errors:o}=qn(t,s);if(Qn(t),o.length>0)return me("warning",o.join(`
`),{duration:4e3,noticeId:"yyt-table-workbench-form-error"}),{success:!1,errors:o};let n=il(r);return n.success?(e||S("success","\u586B\u8868\u5DE5\u4F5C\u53F0\u914D\u7F6E\u5DF2\u4FDD\u5B58"),n):(S("error",n.error||"\u4FDD\u5B58\u5931\u8D25"),n)}var _y,ls,Zn=W(()=>{Se();es();hl();dr();Hs();mr();So();Ao();Il();_y=`${As}
${yl}
...
`;ls={id:"tableWorkbenchPanel",currentTableIndex:0,render({config:t}={}){let e=t&&typeof t=="object"?t:Fe();return this.currentTableIndex=Ye(e.tables,this.currentTableIndex),$y(e,this.currentTableIndex)},bindEvents(t){let e=D();if(!e||!B(t))return;let s=this;t.off(".yytTableWorkbench"),t.on("click.yytTableWorkbench",'[data-table-workbench-action="add-table"]',()=>{let r=t.find('[data-table-definition-root] [data-table-editor-action="add-table"]').first();r.length&&r.trigger("click")}),t.on("click.yytTableWorkbench",'[data-table-workbench-select-table] [data-table-editor-action^="move-table-"]',r=>{r.preventDefault(),r.stopPropagation();let o=e(r.currentTarget),n=String(o.attr("data-table-editor-action")||""),a=Number.parseInt(o.attr("data-table-index")||"-1",10),i=Xn(t,Fe()),l=Array.isArray(i.tables)?i.tables:[];if(!Number.isInteger(a)||a<0||a>=l.length)return;let c=n==="move-table-up"?a-1:a+1;i.tables=Ay(l,a,c),s.currentTableIndex=Ye(i.tables,c),s.renderTo(t,{config:i})}),t.on("click.yytTableWorkbench","[data-table-workbench-select-table]",r=>{if(e(r.target).closest("[data-table-editor-action]").length)return;let o=Number.parseInt(e(r.currentTarget).attr("data-table-workbench-select-table")||"0",10),n=Xn(t,Fe());s.currentTableIndex=Ye(n.tables,o),s.renderTo(t,{config:n})}),t.on("keydown.yytTableWorkbench","[data-table-workbench-select-table]",r=>{r.key!=="Enter"&&r.key!==" "||e(r.target).closest("[data-table-editor-action]").length||(r.preventDefault(),e(r.currentTarget).trigger("click"))}),t.on("click.yytTableWorkbench",'[data-table-workbench-action="save"]',()=>{let r=Pl(t,{silent:!1});r?.success&&(s.currentTableIndex=Ye(r.config?.tables,s.currentTableIndex),s.renderTo(t,{config:r.config}))}),t.on("click.yytTableWorkbench",'[data-table-workbench-action="refresh"]',()=>{s.renderTo(t)}),t.on("click.yytTableWorkbench",'[data-table-workbench-action="run"]',async()=>{if(Pl(t,{silent:!0}).success)try{let o=await kl();o?.success?o.warning?me("warning",`\u586B\u8868\u5DF2\u5B8C\u6210\uFF0C\u4F46\u6B63\u6587\u955C\u50CF\u5931\u8D25\uFF1A${o.warning}`,{duration:4200,noticeId:"yyt-table-workbench-run-result"}):me("success","\u624B\u52A8\u586B\u8868\u5B8C\u6210",{duration:2800,noticeId:"yyt-table-workbench-run-result"}):me("warning",o?.error||"\u624B\u52A8\u586B\u8868\u5931\u8D25",{duration:4e3,noticeId:"yyt-table-workbench-run-result"})}catch(o){S("error",o?.message||"\u624B\u52A8\u586B\u8868\u5931\u8D25")}finally{s.renderTo(t)}})},destroy(t){!D()||!B(t)||(bl(t),t.off(".yytTableWorkbench"))},getStyles(){return _y},renderTo(t,{config:e}={}){if(!D()||!B(t))return;let r=e&&typeof e=="object"?e:Fe();this.currentTableIndex=Ye(r.tables,this.currentTableIndex),t.html(this.render({config:r})),ml(t,hr(),{onChange:()=>{Qn(t);let n=t.find("[data-table-definition-root]");n.length&&is(n)},onTableMutation:({action:n,tableIndex:a,nextTableIndex:i,draft:l})=>{let c=Xn(t,r);if(c.tables=Array.isArray(l?.tables)?l.tables:c.tables,n==="add-table"){this.currentTableIndex=Ye(c.tables,a),this.renderTo(t,{config:c});return}if(n==="move-table-up"||n==="move-table-down"){this.currentTableIndex=Ye(c.tables,i),this.renderTo(t,{config:c});return}n==="delete-table"&&(this.currentTableIndex=Ye(c.tables,a),this.renderTo(t,{config:c}))}}),this.bindEvents(t,{}),Qn(t);let o=t.find("[data-table-definition-root]");o.length&&is(o),Dy(t)}}});var ql={};ue(ql,{ApiPresetPanel:()=>St,BypassPanel:()=>as,EscapeTransformToolPanel:()=>os,PunctuationTransformToolPanel:()=>ns,RegexExtractPanel:()=>Ft,SCRIPT_ID:()=>b,SettingsPanel:()=>pt,StatusBlockPanel:()=>ss,SummaryToolPanel:()=>ts,TableWorkbenchPanel:()=>ls,ToolManagePanel:()=>Gt,UIManager:()=>Js,YouyouReviewPanel:()=>rs,bindDialogEvents:()=>Vs,closeActiveCustomSelectDropdown:()=>Ie,closeCustomSelectDropdown:()=>Ys,createDialogHtml:()=>Gs,default:()=>Ny,destroyEnhancedCustomSelects:()=>ye,downloadJson:()=>lt,enhanceNativeSelects:()=>we,escapeHtml:()=>x,fillFormWithConfig:()=>Rr,getAllStyles:()=>Yl,getFormApiConfig:()=>qs,getJQuery:()=>D,getTargetDocument:()=>zt,initUI:()=>Dl,isContainerValid:()=>B,normalizeCustomSelectOptions:()=>Cr,openCustomSelectDropdown:()=>Ia,readFileContent:()=>ct,registerComponents:()=>ko,renderApiPanel:()=>Ol,renderBypassPanel:()=>jl,renderCustomSelectControl:()=>Pr,renderEscapeTransformToolPanel:()=>Ul,renderPunctuationTransformToolPanel:()=>Wl,renderRegexPanel:()=>Nl,renderSettingsPanel:()=>Fl,renderStatusBlockPanel:()=>Kl,renderSummaryToolPanel:()=>Bl,renderTableWorkbenchPanel:()=>Hl,renderToolPanel:()=>Ll,renderYouyouReviewPanel:()=>zl,repositionActiveCustomSelectDropdown:()=>Qo,resetJQueryCache:()=>Qc,showToast:()=>S,showTopNotice:()=>me,toggleCustomSelectDropdown:()=>Ir,uiManager:()=>de});function ko(){de.register(St.id,St),de.register(Ft.id,Ft),de.register(Gt.id,Gt),de.register(ts.id,ts),de.register(ss.id,ss),de.register(rs.id,rs),de.register(os.id,os),de.register(ns.id,ns),de.register(as.id,as),de.register(pt.id,pt),de.register(ls.id,ls),console.log("[UI] \u7EC4\u4EF6\u6CE8\u518C\u5B8C\u6210")}function Dl(t={}){let{autoInjectStyles:e=!0,targetDocument:s,...r}=t;de.init(r),ko(),e&&de.injectStyles(s),console.log("[UI] \u6A21\u5757\u521D\u59CB\u5316\u5B8C\u6210")}function Oy(){de.getComponent(St.id)||ko()}function qe(t,e,s={}){Oy(),de.render(t,e,s)}function Ol(t){qe(St.id,t)}function Nl(t){qe(Ft.id,t)}function Ll(t){qe(Gt.id,t)}function Bl(t){qe(ts.id,t)}function Kl(t){qe(ss.id,t)}function zl(t){qe(rs.id,t)}function Ul(t){qe(os.id,t)}function Wl(t){qe(ns.id,t)}function jl(t){qe(as.id,t)}function Fl(t){qe(pt.id,t)}function Hl(t){qe(ls.id,t)}function Yl(){return de.getAllStyles()}var Ny,Gl=W(()=>{Zo();tn();cn();bn();Pn();Rn();$n();On();Nn();Ln();mo();Zn();Se();Zo();tn();cn();bn();Pn();Rn();$n();On();Nn();Ln();mo();Zn();Ny={uiManager:de,ApiPresetPanel:St,RegexExtractPanel:Ft,ToolManagePanel:Gt,SummaryToolPanel:ts,StatusBlockPanel:ss,YouyouReviewPanel:rs,EscapeTransformToolPanel:os,PunctuationTransformToolPanel:ns,BypassPanel:as,SettingsPanel:pt,TableWorkbenchPanel:ls,registerComponents:ko,initUI:Dl,renderApiPanel:Ol,renderRegexPanel:Nl,renderToolPanel:Ll,renderSummaryToolPanel:Bl,renderStatusBlockPanel:Kl,renderYouyouReviewPanel:zl,renderEscapeTransformToolPanel:Ul,renderPunctuationTransformToolPanel:Wl,renderBypassPanel:jl,renderSettingsPanel:Fl,renderTableWorkbenchPanel:Hl,getAllStyles:Yl}});var Jl={};ue(Jl,{WindowManager:()=>Io,closeWindow:()=>zy,createWindow:()=>Ky,windowManager:()=>Re});function By(){if(Re.stylesInjected)return;Re.stylesInjected=!0;let t=`
    /* ============================================================
  ...
  `,e=document.createElement("style");e.id=Ly+"_styles",e.textContent=t,(document.head||document.documentElement).appendChild(e)}function Ky(t){let{id:e,title:s="\u7A97\u53E3",content:r="",width:o=900,height:n=700,modal:a=!1,resizable:i=!0,maximizable:l=!0,startMaximized:c=!1,rememberState:d=!0,onClose:u,onReady:y}=t;By();let p=window.jQuery||window.parent?.jQuery;if(!p)return console.error("[WindowManager] jQuery not available"),null;if(Re.isOpen(e))return Re.bringToFront(e),Re.getWindow(e);let f=window.innerWidth||1200,h=window.innerHeight||800,m=f<=1100,_=null,M=!1;d&&(_=Re.getState(e),_&&!m&&(M=!0));let w,E;M&&_.width&&_.height?(w=Math.max(400,Math.min(_.width,f-40)),E=Math.max(300,Math.min(_.height,h-40))):(w=Math.max(400,Math.min(o,f-40)),E=Math.max(300,Math.min(n,h-40)));let k=Math.max(20,Math.min((f-w)/2,f-w-20)),I=Math.max(20,Math.min((h-E)/2,h-E-20)),N=l&&!m,se=`
...
\u6216 regex:<custom_tag>([\\s\\S]*?)</custom_tag>`,previewDialogId:`${g.id}-extraction-preview`,previewTitle:`${g.name||g.id} \u63D0\u53D6\u9884\u89C8`}),o.dynamicToolPanelCache.set(g.id,A)}let R=A();R.renderTo(v),ee(v,{key:g.id,destroy:typeof R?.destroy=="function"?L=>R.destroy(L):null}),ce()}catch(A){y.current=null,console.error(`[${a}] \u81EA\u5B9A\u4E49\u5DE5\u5177\u9762\u677F\u52A0\u8F7D\u5931\u8D25:`,A),v.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u81EA\u5B9A\u4E49\u5DE5\u5177\u9762\u677F\u52A0\u8F7D\u5931\u8D25</span></div>')}}}function Ns(g,v){if(!m())return;let A=r.toolRegistryModule?.getToolConfig(g);if(!A){v.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u5DE5\u5177\u914D\u7F6E\u4E0D\u5B58\u5728</span></div>');return}let R=n.currentSubTab[g]||A.subTabs?.[0]?.id||"config";v.html(`
    ...
    `),we(v,{namespace:"yytPopupToolConfigSelect",selectors:["#yyt-tool-api-preset"]}),v.find("#yyt-save-tool-preset").on("click",function(){let K=v.find("#yyt-tool-api-preset").val();r.toolRegistryModule?.setToolApiPreset(g,K);let J=s.toastr;J&&J.success("API\u9884\u8BBE\u7ED1\u5B9A\u5DF2\u4FDD\u5B58","YouYou \u5DE5\u5177\u7BB1")})}async function Tr(g,v){if(!m()){v.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u63D0\u793A\u8BCD\u7F16\u8F91\u5668\u6A21\u5757\u672A\u52A0\u8F7D</span></div>');return}let R=r.toolManagerModule?.getTool(g)?.config?.messages||[],L=cc(R)||vr,U=new $o({containerId:`yyt-prompt-editor-${g}`,segments:L,onChange:K=>{let J=lc(K);p("\u63D0\u793A\u8BCD\u5DF2\u66F4\u65B0:",J.length,"\u6761\u6D88\u606F")}});v.html(`<div id="yyt-prompt-editor-${g}" class="yyt-prompt-editor-container"></div>`),U.init(v.find(`#yyt-prompt-editor-${g}`));let H=ic();if(H){let K="yyt-prompt-editor-styles",J=s.document||document;if(!J.getElementById(K)){let fe=J.createElement("style");fe.id=K,fe.textContent=H,(J.head||J.documentElement).appendChild(fe)}}}function Dt(g,v){m()&&v.html(`
      <div class="yyt-panel">
        <div class="yyt-panel-section">
          <div class="yyt-section-title">
            <i class="fa-solid fa-bookmark"></i>
