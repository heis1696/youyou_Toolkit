var YouYouToolkit=(()=>{var Go=Object.defineProperty;var Yc=Object.getOwnPropertyDescriptor;var Vc=Object.getOwnPropertyNames;var Jc=Object.prototype.hasOwnProperty;var z=(t,e)=>()=>(t&&(e=t(t=0)),e);var pe=(t,e)=>{for(var s in e)Go(t,s,{get:e[s],enumerable:!0})},Xc=(t,e,s,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let o of Vc(e))!Jc.call(t,o)&&o!==s&&Go(t,o,{get:()=>e[o],enumerable:!(r=Yc(e,o))||r.enumerable});return t};var Qc=t=>Xc(Go({},"__esModule",{value:!0}),t);var I,Yo,P,fe=z(()=>{I={STORAGE_CHANGED:"storage:changed",STORAGE_CLEARED:"storage:cleared",PRESET_CREATED:"preset:created",PRESET_UPDATED:"preset:updated",PRESET_DELETED:"preset:deleted",PRESET_ACTIVATED:"preset:activated",PRESET_IMPORTED:"preset:imported",PRESET_EXPORTED:"preset:exported",API_CONFIG_UPDATED:"api:configUpdated",API_REQUEST_START:"api:requestStart",API_REQUEST_SUCCESS:"api:requestSuccess",API_REQUEST_ERROR:"api:requestError",API_CONNECTION_TESTED:"api:connectionTested",TOOL_REGISTERED:"tool:registered",TOOL_UNREGISTERED:"tool:unregistered",TOOL_UPDATED:"tool:updated",TOOL_RUNTIME_UPDATED:"tool:runtimeUpdated",TOOL_ENABLED:"tool:enabled",TOOL_DISABLED:"tool:disabled",TOOL_EXECUTING:"tool:executing",TOOL_EXECUTED:"tool:executed",TOOL_ERROR:"tool:error",TOOL_EXECUTION_STARTED:"tool:executionStarted",TOOL_EXECUTION_FAILED:"tool:executionFailed",REGEX_RULE_ADDED:"regex:ruleAdded",REGEX_RULE_UPDATED:"regex:ruleUpdated",REGEX_RULE_DELETED:"regex:ruleDeleted",REGEX_RULES_CLEARED:"regex:rulesCleared",REGEX_PRESET_LOADED:"regex:presetLoaded",REGEX_EXTRACTED:"regex:extracted",UI_INITIALIZED:"ui:initialized",UI_RENDER_REQUESTED:"ui:renderRequested",UI_TAB_CHANGED:"ui:tabChanged",UI_SUBTAB_CHANGED:"ui:subTabChanged",UI_POPUP_OPENED:"ui:popupOpened",UI_POPUP_CLOSED:"ui:popupClosed",UI_WINDOW_CREATED:"ui:windowCreated",UI_WINDOW_CLOSED:"ui:windowClosed",APP_INITIALIZING:"app:initializing",APP_INITIALIZED:"app:initialized",APP_ERROR:"app:error",SETTINGS_UPDATED:"settings:updated",TOOL_CONTEXT_INJECTED:"tool:contextInjected",TOOL_CONTEXT_CLEARED:"tool:contextCleared",BYPASS_PRESET_CREATED:"bypass:presetCreated",BYPASS_PRESET_UPDATED:"bypass:presetUpdated",BYPASS_PRESET_DELETED:"bypass:presetDeleted",BYPASS_PRESET_ACTIVATED:"bypass:presetActivated",TOOL_OUTPUT_MODE_CHANGED:"tool:outputModeChanged"},Yo=class{constructor(){this.listeners=new Map,this.onceCallbacks=new Map,this.history=[],this.maxHistorySize=100,this.debugMode=!1}on(e,s,r={}){if(!e||typeof s!="function")return console.warn("[EventBus] \u65E0\u6548\u7684\u4E8B\u4EF6\u6216\u56DE\u8C03"),()=>{};let{priority:o=0}=r;this.listeners.has(e)||this.listeners.set(e,new Set);let a={callback:s,priority:o};return this.listeners.get(e).add(a),this.debugMode&&console.log(`[EventBus] \u8BA2\u9605: ${e}`),()=>this.off(e,s)}off(e,s){let r=this.listeners.get(e);if(r){for(let o of r)if(o.callback===s){r.delete(o);break}this.debugMode&&console.log(`[EventBus] \u53D6\u6D88\u8BA2\u9605: ${e}`)}}emit(e,s){this.debugMode&&console.log(`[EventBus] \u53D1\u5E03: ${e}`,s),this._addToHistory(e,s);let r=this.listeners.get(e);if(!r||r.size===0)return;let o=Array.from(r).sort((a,n)=>n.priority-a.priority);for(let{callback:a}of o)try{a(s)}catch(n){console.error(`[EventBus] \u4E8B\u4EF6\u5904\u7406\u9519\u8BEF (${e}):`,n)}}once(e,s){let r=o=>{this.off(e,r),s(o)};return this.on(e,r)}wait(e,s=0){return new Promise((r,o)=>{let a=null,n=this.once(e,i=>{a&&clearTimeout(a),r(i)});s>0&&(a=setTimeout(()=>{n(),o(new Error(`\u7B49\u5F85\u4E8B\u4EF6\u8D85\u65F6: ${e}`))},s))})}hasListeners(e){let s=this.listeners.get(e);return s&&s.size>0}listenerCount(e){let s=this.listeners.get(e);return s?s.size:0}removeAllListeners(e){e?this.listeners.delete(e):this.listeners.clear()}setDebugMode(e){this.debugMode=e}_addToHistory(e,s){this.history.push({event:e,data:s,timestamp:Date.now()}),this.history.length>this.maxHistorySize&&this.history.shift()}getHistory(e){return e?this.history.filter(s=>s.event===e):[...this.history]}clearHistory(){this.history=[]}},P=new Yo});var Pn={};pe(Pn,{LOG_LEVEL:()=>G,LoggerService:()=>$r,default:()=>Zc,logger:()=>B});var G,Rn,$r,B,Zc,re=z(()=>{fe();G=Object.freeze({DEBUG:0,INFO:1,WARN:2,ERROR:3}),Rn=Object.freeze({[G.DEBUG]:"DEBUG",[G.INFO]:"INFO",[G.WARN]:"WARN",[G.ERROR]:"ERROR"}),$r=class{constructor(){this._entries=[],this._maxSize=2e3,this._nextId=1,this._minLevel=G.INFO,this._eventKey="logger:entry",this._statsEventKey="logger:statsChanged",this._pendingFlush=!1}_write(e,s,r,o){let a={id:this._nextId++,timestamp:Date.now(),level:e,scope:s,message:r,data:o};this._entries.push(a),this._entries.length>this._maxSize&&this._entries.shift(),this._forwardToConsole(a),this._pendingFlush||(this._pendingFlush=!0,queueMicrotask(()=>{this._pendingFlush=!1,this._emitEntry(a)}))}_forwardToConsole(e){let s=`[${e.scope}]`;switch(e.level){case G.DEBUG:console.debug(s,e.message,e.data??"");break;case G.INFO:console.log(s,e.message,e.data??"");break;case G.WARN:console.warn(s,e.message,e.data??"");break;case G.ERROR:console.error(s,e.message,e.data??"");break}}_emitEntry(e){try{P?.emit(this._eventKey,e)}catch{}}debug(e,s,r){G.DEBUG<this._minLevel||this._write(G.DEBUG,e,s,r)}info(e,s,r){G.INFO<this._minLevel||this._write(G.INFO,e,s,r)}log(e,s,r){this.info(e,s,r)}warn(e,s,r){G.WARN<this._minLevel||this._write(G.WARN,e,s,r)}error(e,s,r){G.ERROR<this._minLevel||this._write(G.ERROR,e,s,r)}createScope(e){return{debug:(s,r)=>this.debug(e,s,r),info:(s,r)=>this.info(e,s,r),log:(s,r)=>this.log(e,s,r),warn:(s,r)=>this.warn(e,s,r),error:(s,r)=>this.error(e,s,r)}}getEntries(e={}){let{level:s,scope:r,search:o,limit:a=500,offset:n=0}=e,i=this._entries;if(s!=null&&(i=i.filter(c=>c.level>=s)),r&&(i=i.filter(c=>c.scope===r)),o){let c=o.toLowerCase();i=i.filter(d=>d.scope.toLowerCase().includes(c)||d.message.toLowerCase().includes(c))}let l=i.length;return i=i.slice(n,n+a),{entries:i,total:l}}getStats(){let e={total:this._entries.length,byLevel:{DEBUG:0,INFO:0,WARN:0,ERROR:0},byScope:{}};for(let s of this._entries){let r=Rn[s.level]||"UNKNOWN";e.byLevel[r]=(e.byLevel[r]||0)+1,e.byScope[s.scope]=(e.byScope[s.scope]||0)+1}return e}setLevel(e){this._minLevel=e}getLevel(){return this._minLevel}setMaxSize(e){this._maxSize=Math.max(100,Math.min(1e4,e))}clear(){this._entries=[],this._nextId=1}levelLabel(e){return Rn[e]||"UNKNOWN"}},B=new $r,Zc=B});function Dn(){let t=C;return t._getStorage(),t._storage}function On(){return C.get("settings",{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}})}function Ln(t){C.set("settings",t)}var Vo,Et,C,te,$n,Vs,ze=z(()=>{re();Vo=B.createScope("StorageService"),Et=class t{constructor(e="youyou_toolkit"){this.namespaceKey=e,this._storage=null,this._cache=new Map}_getStorage(){if(this._storage)return this._storage;try{let e=typeof window.parent<"u"&&window.parent!==window?window.parent:window;if(e.SillyTavern?.getContext){let s=e.SillyTavern.getContext();if(s?.extensionSettings)return s.extensionSettings[this.namespaceKey]||(s.extensionSettings[this.namespaceKey]={}),this._storage={_target:s.extensionSettings[this.namespaceKey],getItem:r=>{let o=s.extensionSettings[this.namespaceKey][r];return typeof o=="string"?o:o?JSON.stringify(o):null},setItem:(r,o)=>{s.extensionSettings[this.namespaceKey][r]=o,this._saveSettings(s)},removeItem:r=>{delete s.extensionSettings[this.namespaceKey][r],this._saveSettings(s)},_isTavern:!0},this._storage}}catch{Vo.warn("SillyTavern\u5B58\u50A8\u4E0D\u53EF\u7528\uFF0C\u4F7F\u7528localStorage")}return this._storage={getItem:e=>{try{return localStorage.getItem(e)}catch{return null}},setItem:(e,s)=>{try{localStorage.setItem(e,s)}catch(r){Vo.error("localStorage\u5199\u5165\u5931\u8D25:",r)}},removeItem:e=>{try{localStorage.removeItem(e)}catch{}},_isTavern:!1},this._storage}_saveSettings(e){if(typeof e.saveSettings=="function")try{e.saveSettings()}catch{}else if(typeof e.saveSettingsDebounced=="function")try{e.saveSettingsDebounced()}catch{}}get(e,s=null){let r=`${this.namespaceKey}:${e}`;if(this._cache.has(r))return this._cache.get(r);let o=this._getStorage(),a=this._getFullKey(e),n=o.getItem(a);if(n===null)return s;try{let i=JSON.parse(n);return this._cache.set(r,i),i}catch{return n}}set(e,s){let r=this._getStorage(),o=this._getFullKey(e),a=`${this.namespaceKey}:${e}`;this._cache.set(a,s);try{r.setItem(o,JSON.stringify(s))}catch(n){Vo.error("\u5B58\u50A8\u5931\u8D25:",n)}}remove(e){let s=this._getStorage(),r=this._getFullKey(e),o=`${this.namespaceKey}:${e}`;this._cache.delete(o),s.removeItem(r)}has(e){let s=this._getStorage(),r=this._getFullKey(e);return s.getItem(r)!==null}clear(){if(this._getStorage()._isTavern){let s=typeof window.parent<"u"?window.parent:window;if(s.SillyTavern?.getContext){let r=s.SillyTavern.getContext();r?.extensionSettings?.[this.namespaceKey]&&(r.extensionSettings[this.namespaceKey]={},this._saveSettings(r))}}else{let s=`${this.namespaceKey}_`,r=[];for(let o=0;o<localStorage.length;o++){let a=localStorage.key(o);a&&a.startsWith(s)&&r.push(a)}r.forEach(o=>localStorage.removeItem(o))}this._cache.clear()}_getFullKey(e){return this._getStorage()._isTavern?e:`${this.namespaceKey}_${e}`}namespace(e){return new t(`${this.namespaceKey}:${e}`)}getMultiple(e){let s={};return e.forEach(r=>{s[r]=this.get(r)}),s}setMultiple(e){Object.entries(e).forEach(([s,r])=>{this.set(s,r)})}exportAll(){let e=this._getStorage(),s={};if(e._isTavern){let r=typeof window.parent<"u"?window.parent:window;if(r.SillyTavern?.getContext){let a=r.SillyTavern.getContext()?.extensionSettings?.[this.namespaceKey]||{};Object.entries(a).forEach(([n,i])=>{s[n]=typeof i=="string"?JSON.parse(i):i})}}else{let r=`${this.namespaceKey}_`;for(let o=0;o<localStorage.length;o++){let a=localStorage.key(o);if(a&&a.startsWith(r)){let n=a.slice(r.length);try{s[n]=JSON.parse(localStorage.getItem(a))}catch{s[n]=localStorage.getItem(a)}}}}return s}},C=new Et("youyou_toolkit"),te=new Et("youyou_toolkit:tools"),$n=new Et("youyou_toolkit:presets"),Vs=new Et("youyou_toolkit:windows")});var Bn={};pe(Bn,{DEFAULT_API_PRESETS:()=>td,DEFAULT_SETTINGS:()=>ed,STORAGE_KEYS:()=>Js,StorageService:()=>Et,deepMerge:()=>Nn,getCurrentPresetName:()=>od,getStorage:()=>Dn,loadApiPresets:()=>sd,loadSettings:()=>On,presetStorage:()=>$n,saveApiPresets:()=>rd,saveSettings:()=>Ln,setCurrentPresetName:()=>ad,storage:()=>C,toolStorage:()=>te,windowStorage:()=>Vs});function sd(){return C.get(Js.API_PRESETS)||[]}function rd(t){C.set(Js.API_PRESETS,t)}function od(){return C.get(Js.CURRENT_PRESET)||""}function ad(t){C.set(Js.CURRENT_PRESET,t||"")}function Nn(t,e){let s=o=>o&&typeof o=="object"&&!Array.isArray(o),r={...t};return s(t)&&s(e)&&Object.keys(e).forEach(o=>{s(e[o])?o in t?r[o]=Nn(t[o],e[o]):Object.assign(r,{[o]:e[o]}):Object.assign(r,{[o]:e[o]})}),r}var Js,ed,td,Un=z(()=>{ze();ze();Js={SETTINGS:"settings",API_PRESETS:"api_presets",CURRENT_PRESET:"current_preset",TOOLS:"tools",TOOL_PRESETS:"tool_presets",CURRENT_TOOL_PRESET:"current_tool_preset",BYPASS_PRESETS:"bypass_presets",CURRENT_BYPASS_PRESET:"current_bypass_preset",BYPASS_ENABLED:"bypass_enabled"},ed={apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}},td=[]});var Fn={};pe(Fn,{API_STATUS:()=>yd,fetchAvailableModels:()=>ea,getApiConfig:()=>gt,getEffectiveApiConfig:()=>Xs,hasEffectiveApiPreset:()=>Qs,sendApiRequest:()=>Zs,sendWithPreset:()=>Qo,testApiConnection:()=>vd,updateApiConfig:()=>vs,validateApiConfig:()=>xs});function cd(){return{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,stream:!1,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}}}function Xo(){return C.get(zn,cd())}function dd(t){C.set(zn,t)}function Kn(){return C.get(id,[])}function ud(){return C.get(ld,"")}function Jo(t,e={}){let s=new Error(t);return s.allowDirectFallback=e.allowDirectFallback===!0,s}function Wn(t,e="chat_completions"){let s=String(t||"").trim();if(!s)return"";let r=null;try{r=new URL(s)}catch{return s}let o=r.pathname.replace(/\/+$/,""),a=o;return e==="chat_completions"?!/\/chat\/completions$/i.test(o)&&!/\/completions$/i.test(o)&&(a=`${o||""}/chat/completions`):e==="models"&&(/\/chat\/completions$/i.test(o)?a=o.replace(/\/chat\/completions$/i,"/models"):/\/completions$/i.test(o)?a=o.replace(/\/completions$/i,"/models"):/\/models$/i.test(o)||(a=`${o||""}/models`)),r.pathname=a.replace(/\/+/g,"/"),r.toString()}function pd(t){let e=String(t||"").trim();if(!e)return"";try{let s=new URL(e);return s.pathname=s.pathname.replace(/\/chat\/completions$/i,"").replace(/\/completions$/i,"").replace(/\/models$/i,"").replace(/\/+$/,"")||"/",s.toString().replace(/\/$/,"")}catch{return e.replace(/\/chat\/completions$/i,"").replace(/\/completions$/i,"").replace(/\/models$/i,"").replace(/\/+$/,"")}}function gt(){return Xo().apiConfig||{}}function vs(t){let e=Xo();e.apiConfig={...e.apiConfig,...t},dd(e)}function xs(t){let e=[];if(t.useMainApi)return{valid:!0,errors:[]};if(!t.url||!t.url.trim())e.push("API URL \u4E0D\u80FD\u4E3A\u7A7A");else try{new URL(t.url)}catch{e.push("API URL \u683C\u5F0F\u65E0\u6548")}return(!t.model||!t.model.trim())&&e.push("\u6A21\u578B\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"),{valid:e.length===0,errors:e}}function Xs(t=""){let e=Xo(),s=t||ud()||"";if(s){let o=Kn().find(a=>a.name===s);if(o&&o.apiConfig)return{...o.apiConfig,presetName:o.name}}return e.apiConfig||{}}function Qs(t=""){return t?Kn().some(s=>s?.name===t):!1}async function Qo(t,e,s={},r=null){let o=Xs(t);return await Zs(e,{...s,apiConfig:o},r)}function jn(t,e={}){let s=e.apiConfig||gt();return{messages:t,model:s.model||"gpt-3.5-turbo",max_tokens:s.max_tokens||4096,temperature:s.temperature??.7,top_p:s.top_p??.9,stream:s.stream??!1,...e.extraParams}}function Zo(t){let e="";if(t?.choices&&t.choices[0]?.message?.content)e=t.choices[0].message.content;else if(t?.content)e=t.content;else if(t?.text)e=t.text;else if(t?.response)e=t.response;else throw new Error(`\u65E0\u6CD5\u89E3\u6790API\u54CD\u5E94\u683C\u5F0F: ${JSON.stringify(t).slice(0,200)}`);return String(e||"").trim()}async function Zs(t,e={},s=null){let r=e.apiConfig||gt(),o=r.useMainApi,a=xs(r);if(!a.valid&&!o)throw new Error(`API\u914D\u7F6E\u65E0\u6548: ${a.errors.join(", ")}`);return o?await gd(t,e,s):await fd(t,r,e,s)}async function gd(t,e,s){let r=typeof window.parent<"u"?window.parent:window;if(!r.TavernHelper?.generateRaw)throw new Error("TavernHelper.generateRaw \u4E0D\u53EF\u7528\u3002\u8BF7\u68C0\u67E5SillyTavern\u7248\u672C\u3002");try{let o=await r.TavernHelper.generateRaw({ordered_prompts:t,should_stream:e.apiConfig?.stream??gt().stream??!1,...e.extraParams});if(typeof o!="string")throw new Error("\u4E3BAPI\u8FD4\u56DE\u4E86\u975E\u9884\u671F\u7684\u54CD\u5E94\u7C7B\u578B");return o.trim()}catch(o){throw o.name==="AbortError"?o:new Error(`\u4E3BAPI\u8BF7\u6C42\u5931\u8D25: ${o.message}`)}}async function fd(t,e,s,r){let o=typeof window.parent<"u"?window.parent:window;if(o.TavernHelper?.generateRaw)try{return await md(t,e,s,r,o)}catch(a){nd.warn("TavernHelper \u81EA\u5B9A\u4E49\u8BF7\u6C42\u5931\u8D25\uFF0C\u56DE\u9000\u5230\u540E\u5907\u94FE\u8DEF:",a)}if(o.SillyTavern?.getRequestHeaders)try{return await bd(t,e,s,r,o)}catch(a){if(!a?.allowDirectFallback)throw a}return await hd(t,e,s,r)}async function md(t,e,s,r,o){if(r?.aborted)throw new DOMException("\u8BF7\u6C42\u5DF2\u53D6\u6D88","AbortError");let a=await o.TavernHelper.generateRaw({ordered_prompts:t,should_stream:e.stream??!1,max_chat_history:0,custom_api:{apiurl:pd(e.url),key:e.apiKey||"",model:e.model||"gpt-3.5-turbo",max_tokens:e.max_tokens||4096,temperature:e.temperature??.7,top_p:e.top_p??.9},...s.extraParams||{}});return typeof a=="string"?a.trim():Zo(a)}async function bd(t,e,s,r,o){let a=String(e.url||"").trim(),n={...jn(t,{apiConfig:e,...s}),chat_completion_source:"custom",reverse_proxy:a,proxy_password:"",custom_url:a,custom_include_headers:e.apiKey?`Authorization: Bearer ${e.apiKey}`:""},i={...typeof o.SillyTavern?.getRequestHeaders=="function"?o.SillyTavern.getRequestHeaders():{},"Content-Type":"application/json"},l=null;try{l=await fetch("/api/backends/chat-completions/generate",{method:"POST",headers:i,body:JSON.stringify(n),signal:r})}catch(u){throw u?.name==="AbortError"?u:Jo(`\u9152\u9986\u540E\u7AEF\u8F6C\u53D1\u8BF7\u6C42\u4E0D\u53EF\u7528\uFF0C\u5DF2\u5C1D\u8BD5\u56DE\u9000\u5230\u6D4F\u89C8\u5668\u76F4\u8FDE\u3002\u539F\u59CB\u9519\u8BEF: ${u.message}`,{allowDirectFallback:!0})}let c=await l.text().catch(()=>"");if(!l.ok){let u=[404,405,501,502].includes(l.status);throw Jo(`\u9152\u9986\u540E\u7AEF\u8F6C\u53D1\u8BF7\u6C42\u5931\u8D25 (${l.status}): ${c||"Unknown error"}`,{allowDirectFallback:u})}let d=null;try{d=c?JSON.parse(c):{}}catch{let y=String(c||"").replace(/\s+/g," ").trim().slice(0,120);throw Jo(`\u9152\u9986\u540E\u7AEF\u8FD4\u56DE\u4E86\u975EJSON\u5185\u5BB9\u3002\u54CD\u5E94\u7247\u6BB5: ${y||"(\u7A7A\u54CD\u5E94)"}`)}return Zo(d)}async function hd(t,e,s,r){let o=jn(t,{apiConfig:e,...s}),a=Wn(e.url,"chat_completions"),n={"Content-Type":"application/json"};e.apiKey&&(n.Authorization=`Bearer ${e.apiKey}`);let i=await fetch(a,{method:"POST",headers:n,body:JSON.stringify(o),signal:r}),l=await i.text().catch(()=>"");if(!i.ok){let d=l||"Unknown error";throw new Error(`API\u8BF7\u6C42\u5931\u8D25 (${i.status}): ${d}`)}let c=null;try{c=l?JSON.parse(l):{}}catch{let u=String(l||"").replace(/\s+/g," ").trim().slice(0,120);throw new Error(`\u81EA\u5B9A\u4E49API\u8FD4\u56DE\u7684\u4E0D\u662FJSON\uFF0C\u53EF\u80FD\u662FURL\u914D\u7F6E\u9519\u8BEF\u3001\u53EA\u586B\u5199\u4E86\u7AD9\u70B9\u9996\u9875/\u57FA\u7840\u8DEF\u5F84\u3001\u6216\u8BF7\u6C42\u88AB\u91CD\u5B9A\u5411\u3002\u5F53\u524D\u4F1A\u81EA\u52A8\u5C1D\u8BD5\u8865\u5168 chat/completions \u7AEF\u70B9\uFF1B\u82E5\u4ECD\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5API URL\uFF0C\u6216\u6539\u4E3A\u542F\u7528\u201C\u4F7F\u7528SillyTavern\u4E3BAPI\u201D\u3002\u54CD\u5E94\u7247\u6BB5: ${u||"(\u7A7A\u54CD\u5E94)"}`)}return Zo(c)}async function vd(t=null){let e=t||gt(),s=Date.now();try{await Zs([{role:"user",content:'Hello, this is a connection test. Please respond with "OK".'}],{apiConfig:e});let o=Date.now()-s;return{success:!0,message:`\u8FDE\u63A5\u6210\u529F (\u5EF6\u8FDF: ${o}ms)`,latency:o}}catch(r){return{success:!1,message:`\u8FDE\u63A5\u5931\u8D25: ${r.message}`,latency:Date.now()-s}}}async function ea(t=null){let e=t||gt();return e.useMainApi?await xd():await wd(e)}async function xd(){let t=typeof window.parent<"u"?window.parent:window;try{if(t.SillyTavern?.getContext){let e=t.SillyTavern.getContext();if(e.settings?.api_server)return[e.settings.api_server]}return["gpt-4","gpt-4-turbo","gpt-3.5-turbo","claude-3-opus","claude-3-sonnet"]}catch{return["gpt-4","gpt-3.5-turbo"]}}async function wd(t){if(!t.url||!t.apiKey)return[];try{let e=Wn(t.url,"models"),s=await fetch(e,{method:"GET",headers:{Authorization:`Bearer ${t.apiKey}`}});if(!s.ok)return[];let r=await s.json();return r.data&&Array.isArray(r.data)?r.data.map(o=>o.id||o.name).filter(Boolean).sort():[]}catch{return[]}}var nd,zn,id,ld,yd,er=z(()=>{ze();re();nd=B.createScope("ApiConnection"),zn="settings",id="api_presets",ld="current_preset";yd={IDLE:"idle",CONNECTING:"connecting",SUCCESS:"success",ERROR:"error"}});var Yn={};pe(Yn,{createPreset:()=>Lr,createPresetFromCurrentConfig:()=>Md,deletePreset:()=>sr,duplicatePreset:()=>Ed,exportPresets:()=>aa,generateUniquePresetName:()=>ia,getActiveConfig:()=>oa,getActivePresetName:()=>Nr,getAllPresets:()=>Mt,getPreset:()=>Ht,getPresetNames:()=>_d,getStarredPresets:()=>ra,importPresets:()=>na,presetExists:()=>tr,renamePreset:()=>Ad,switchToPreset:()=>qt,togglePresetStar:()=>sa,updatePreset:()=>ta,validatePreset:()=>kd});function Td(){return{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"}}}function Gn(){return C.get(Sd,Td())}function $e(){return C.get(Hn,[])}function Ft(t){C.set(Hn,t)}function Or(){return C.get(qn,"")}function Dr(t){C.set(qn,t||"")}function Mt(){return $e()}function _d(){return $e().map(e=>e.name)}function Ht(t){return!t||typeof t!="string"?null:$e().find(s=>s.name===t)||null}function tr(t){return!t||typeof t!="string"?!1:$e().some(s=>s.name===t)}function Lr(t){let{name:e,description:s,apiConfig:r}=t;if(!e||typeof e!="string"||!e.trim())return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let o=e.trim();if(tr(o))return{success:!1,message:`\u9884\u8BBE "${o}" \u5DF2\u5B58\u5728`};let a={name:o,description:s||"",apiConfig:{url:r?.url||"",apiKey:r?.apiKey||"",model:r?.model||"",useMainApi:r?.useMainApi??!0,stream:r?.stream??!1,max_tokens:r?.max_tokens||4096,temperature:r?.temperature??.7,top_p:r?.top_p??.9},createdAt:Date.now(),updatedAt:Date.now()},n=$e();return n.push(a),Ft(n),{success:!0,message:`\u9884\u8BBE "${o}" \u521B\u5EFA\u6210\u529F`,preset:a}}function ta(t,e){if(!t||typeof t!="string")return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=$e(),r=s.findIndex(n=>n.name===t);if(r===-1)return{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`};if(e.name&&e.name!==t)return{success:!1,message:"\u4E0D\u652F\u6301\u4FEE\u6539\u9884\u8BBE\u540D\u79F0\uFF0C\u8BF7\u521B\u5EFA\u65B0\u9884\u8BBE"};let o=s[r],a={...o,...e,name:o.name,updatedAt:Date.now()};return e.apiConfig&&(a.apiConfig={...o.apiConfig,...e.apiConfig}),s[r]=a,Ft(s),{success:!0,message:`\u9884\u8BBE "${t}" \u66F4\u65B0\u6210\u529F`,preset:a}}function sr(t){if(!t||typeof t!="string")return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let e=$e(),s=e.findIndex(r=>r.name===t);return s===-1?{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`}:(e.splice(s,1),Ft(e),Or()===t&&Dr(""),{success:!0,message:`\u9884\u8BBE "${t}" \u5DF2\u5220\u9664`})}function Ad(t,e){if(!t||typeof t!="string")return{success:!1,message:"\u539F\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};if(!e||typeof e!="string"||!e.trim())return{success:!1,message:"\u65B0\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=e.trim();if(!tr(t))return{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`};if(tr(s))return{success:!1,message:`\u9884\u8BBE "${s}" \u5DF2\u5B58\u5728`};let r=$e(),o=r.find(a=>a.name===t);return o&&(o.name=s,o.updatedAt=Date.now(),Ft(r),Or()===t&&Dr(s)),{success:!0,message:`\u9884\u8BBE\u5DF2\u91CD\u547D\u540D\u4E3A "${s}"`}}function Ed(t,e){if(!t||typeof t!="string")return{success:!1,message:"\u6E90\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};if(!e||typeof e!="string"||!e.trim())return{success:!1,message:"\u76EE\u6807\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=e.trim(),r=Ht(t);if(!r)return{success:!1,message:`\u6E90\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`};if(tr(s))return{success:!1,message:`\u9884\u8BBE "${s}" \u5DF2\u5B58\u5728`};let o={...JSON.parse(JSON.stringify(r)),name:s,createdAt:Date.now(),updatedAt:Date.now()},a=$e();return a.push(o),Ft(a),{success:!0,message:`\u9884\u8BBE\u5DF2\u590D\u5236\u4E3A "${s}"`,preset:o}}function sa(t){if(!t||typeof t!="string")return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let e=$e(),s=e.find(r=>r.name===t);return s?(s.starred=!s.starred,s.updatedAt=Date.now(),Ft(e),{success:!0,message:s.starred?`\u5DF2\u5C06 "${t}" \u6DFB\u52A0\u5230\u9884\u89C8\u5217\u8868`:`\u5DF2\u5C06 "${t}" \u4ECE\u9884\u89C8\u5217\u8868\u79FB\u9664`,starred:s.starred}):{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`}}function ra(){return $e().filter(e=>e.starred===!0)}function qt(t){if(!t)return Dr(""),{success:!0,message:"\u5DF2\u5207\u6362\u5230\u5F53\u524DAPI\u914D\u7F6E"};let e=Ht(t);return e?(Dr(t),{success:!0,message:`\u5DF2\u5207\u6362\u5230\u9884\u8BBE "${t}"`,apiConfig:e.apiConfig}):{success:!1,message:`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`}}function Nr(){return Or()}function oa(){let t=Or();if(t){let s=Ht(t);if(s)return{presetName:t,apiConfig:s.apiConfig}}return{presetName:"",apiConfig:Gn().apiConfig||{}}}function aa(t=null){if(t){let s=Ht(t);if(!s)throw new Error(`\u9884\u8BBE "${t}" \u4E0D\u5B58\u5728`);return JSON.stringify(s,null,2)}let e=$e();return JSON.stringify(e,null,2)}function na(t,e={overwrite:!1}){let s;try{s=JSON.parse(t)}catch{return{success:!1,message:"JSON\u89E3\u6790\u5931\u8D25",imported:0}}let r=Array.isArray(s)?s:[s];if(r.length===0)return{success:!1,message:"\u6CA1\u6709\u627E\u5230\u6709\u6548\u7684\u9884\u8BBE\u6570\u636E",imported:0};let o=$e(),a=0;for(let n of r){if(!n.name||typeof n.name!="string"||!n.apiConfig||typeof n.apiConfig!="object")continue;let i=o.findIndex(l=>l.name===n.name);i>=0?e.overwrite&&(n.updatedAt=Date.now(),o[i]=n,a++):(n.createdAt=n.createdAt||Date.now(),n.updatedAt=Date.now(),o.push(n),a++)}return a>0&&Ft(o),{success:!0,message:`\u6210\u529F\u5BFC\u5165 ${a} \u4E2A\u9884\u8BBE`,imported:a}}function Md(t,e=""){let s=Gn();return Lr({name:t,description:e,apiConfig:s.apiConfig})}function kd(t){let e=[];return(!t.name||typeof t.name!="string"||!t.name.trim())&&e.push("\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"),(!t.apiConfig||typeof t.apiConfig!="object")&&e.push("\u7F3A\u5C11API\u914D\u7F6E"),{valid:e.length===0,errors:e}}function ia(t){(!t||typeof t!="string")&&(t="\u65B0\u9884\u8BBE");let e=$e(),s=new Set(e.map(o=>o.name));if(!s.has(t))return t;let r=1;for(;s.has(`${t} (${r})`);)r++;return`${t} (${r})`}var Sd,Hn,qn,rr=z(()=>{ze();Sd="settings",Hn="api_presets",qn="current_preset"});function Yt(){return typeof window.parent<"u"&&window.parent!==window&&window.parent.document?window.parent.document:document}function v(t){return typeof t!="string"?"":t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function S(t,e,s=3e3){e||(e=t==="error"?"\u64CD\u4F5C\u5931\u8D25":"\u64CD\u4F5C\u5B8C\u6210");let r=typeof window.parent<"u"&&window.parent!==window?window.parent:window;if(r.toastr){r.toastr[t](e,"YouYou \u5DE5\u5177\u7BB1",{timeOut:s,progressBar:!0});return}Id(t,e,s),Cd.log(`[${t.toUpperCase()}] ${e}`)}function we(t,e,s={}){e||(e=t==="error"?"\u64CD\u4F5C\u5931\u8D25":"\u64CD\u4F5C\u5B8C\u6210");let{duration:r=3500,sticky:o=!1,noticeId:a=""}=s,n=Yt();if(!n?.body){S(t,e,r);return}let i="yyt-top-notice-container",l="yyt-top-notice-styles",c=n.getElementById(i);if(c||(c=n.createElement("div"),c.id=i,c.style.cssText=`
      position: fixed;
      top: 12px;
      left: 50%;
  ...
  `,i.textContent=e,!r.getElementById("yyt-toast-styles")){let l=r.createElement("style");l.id="yyt-toast-styles",l.textContent=`
    ...
    `,r.head.appendChild(l)}r.body.appendChild(i),setTimeout(()=>{i.style.animation="yyt-toast-out 0.3s ease forwards",setTimeout(()=>{i.remove()},300)},s)}function $(){if(Gt)return Gt;if(typeof window.parent<"u"&&window.parent!==window)try{if(window.parent.jQuery)return Gt=window.parent.jQuery,Gt}catch{}return window.jQuery&&(Gt=window.jQuery),Gt}function Rd(){Gt=null}function N(t){if(!t||t.length===0)return!1;let e=t[0];if(!e||e.nodeType!==1)return!1;let s=e.ownerDocument||document;return e.isConnected?s?.documentElement?.contains?s.documentElement.contains(e):!0:!1}function kt(...t){return t.flat(1/0).flatMap(e=>String(e||"").split(/\s+/)).map(e=>e.trim()).filter(Boolean).join(" ")}function ws(t={}){return Object.entries(t).filter(([,e])=>e!=null&&e!==!1).map(([e,s])=>s===!0?e:`${e}="${v(String(s))}"`).join(" ")}function Qn(t=[],e="",s=""){let r=String(e??""),o=t.find(a=>a.value===r)||t.find(a=>a.disabled!==!0)||null;return o||{value:r,label:s||r||"\u8BF7\u9009\u62E9",disabled:!1}}function Pd(t=""){return String(t||"").split(/\s+/).map(e=>e.trim()).filter(e=>e&&e!=="yyt-select"&&e!=="yyt-native-select-bridge")}function Vn(t,e){let s=$();if(!s||!e?.length)return null;let r=e.attr("id")?`#${e.attr("id")}`:e.attr("data-yyt-select-key")?`[data-yyt-select-key="${e.attr("data-yyt-select-key")}"]`:"";if(!r)return null;let a=t.find("[data-yyt-custom-select]").filter((n,i)=>String(s(i).attr("data-yyt-select-target")||"")===r);return a.length?a.first():null}function Zn(t){let e=t?.[0];return e?.ownerDocument?e.ownerDocument:typeof window.parent<"u"&&window.parent!==window&&window.parent.document?window.parent.document:document}function $d(t){if(!$()||!N(t))return null;let s=t.find("[data-yyt-custom-select]");return s.length?s:null}function ei(t,e){if(!$()||!e?.length)return null;let r=e.find("[data-yyt-select-native]").first();if(r.length)return r;let o=String(e.attr("data-yyt-select-target")||"").trim();if(!o)return null;let a=t.find(o).first();return a.length?a:null}function ti(t=null){return t?.jquery&&t[0]?.ownerDocument?t[0].ownerDocument:t?.ownerDocument?t.ownerDocument:t?.nodeType===9?t:Yt()}function ot(t=null){let e=ti(t),s=Jn.get(e);return s||(s={targetDoc:e,layer:null,activeRoot:null,activeDropdown:null,placeholder:null,cleanup:null},Jn.set(e,s)),s}function Dd(t=null){let e=ti(t);if(!e?.body)return null;let s=ot(e);if(s.layer&&s.layer.isConnected)return s.layer;let r=e.getElementById(Xn);return r||(r=e.createElement("div"),r.id=Xn,r.className="yyt-select-portal-layer",e.body.appendChild(r)),s.layer=r,r}function Br(t){if(!$()||!t?.length)return null;let s=t.find("[data-yyt-select-trigger]").first();return s.length?s:t.find(".yyt-select-trigger").first()}function si(t){let e=$();if(!e||!t?.length)return null;let s=ot(t);if(s.activeRoot===t[0]&&s.activeDropdown)return e(s.activeDropdown);let r=t.find("[data-yyt-select-dropdown]").first();return r.length?r:t.find(".yyt-select-dropdown").first()}function Od(t){t&&(t.classList.remove("yyt-floating-open"),t.removeAttribute("data-yyt-floating"),t.removeAttribute("data-yyt-floating-placement"),t.style.position="",t.style.top="",t.style.left="",t.style.right="",t.style.width="",t.style.minWidth="",t.style.maxWidth="",t.style.maxHeight="",t.style.visibility="",t.style.zIndex="")}function ri(t,e=null){if(!t)return!1;let s=ot(e||t);return s.activeRoot?.contains?.(t)||s.activeDropdown?.contains?.(t)?!0:!!t.closest?.("[data-yyt-custom-select], .yyt-select-portal-layer")}function Ld(t){if(!t?.targetDoc||typeof t.cleanup=="function")return;let e=t.targetDoc,s=e.defaultView||window,r=i=>{!t.activeRoot||!t.activeDropdown||ri(i.target,e)||Le(e)},o=i=>{if(i.key!=="Escape")return;let l=t.activeRoot;Le(e);let c=$();c&&l&&Br(c(l))?.trigger("focus")},a=()=>{da(e)},n=()=>{da(e)};e.addEventListener("mousedown",r,!0),e.addEventListener("keydown",o,!0),s.addEventListener("resize",a),e.addEventListener("scroll",n,!0),t.cleanup=()=>{e.removeEventListener("mousedown",r,!0),e.removeEventListener("keydown",o,!0),s.removeEventListener("resize",a),e.removeEventListener("scroll",n,!0)}}function Nd(t){typeof t?.cleanup=="function"&&t.cleanup(),t&&(t.cleanup=null)}function ca(t){let e=$();if(!e||!t?.activeRoot||!t?.activeDropdown)return;let s=t.targetDoc;if(!s?.body?.contains?.(t.activeRoot)){Le(s);return}let r=e(t.activeRoot),o=Br(r),a=t.activeDropdown,n=s?.defaultView||window;if(!o?.length||!a?.isConnected||!r[0]?.isConnected){Le(s);return}let i=o[0].getBoundingClientRect(),l=n.innerWidth||s.documentElement?.clientWidth||0,c=n.innerHeight||s.documentElement?.clientHeight||0,d=12,u=8,y=Math.max(0,c-i.bottom-d-u),p=Math.max(0,i.top-d-u),g=y<220&&p>y,b=Math.max(120,Math.floor((g?p:y)||0));a.setAttribute("data-yyt-floating","true"),a.setAttribute("data-yyt-floating-placement",g?"top":"bottom"),a.classList.add("yyt-floating-open");let T=Math.ceil(i.width),A=Math.max(T,Math.floor(l-d*2)),w=a.style.width,L=a.style.minWidth,M=a.style.maxWidth,k=a.style.visibility;a.style.width="max-content",a.style.minWidth=`${T}px`,a.style.maxWidth=`${A}px`,a.style.visibility="hidden";let R=Math.ceil(a.scrollWidth||a.getBoundingClientRect().width||T),ee=Math.max(T,Math.min(A,R)),Y=Math.min(a.scrollHeight||b,b);a.style.width=w,a.style.minWidth=L,a.style.maxWidth=M,a.style.visibility=k;let U=Math.round(i.left);U+ee>l-d&&(U=Math.max(d,Math.round(l-d-ee))),U=Math.max(d,U);let J=Math.round(g?i.top-u-Y:i.bottom+u);J=Math.max(d,Math.min(J,Math.round(c-d-Y))),a.style.position="fixed",a.style.top=`${J}px`,a.style.left=`${U}px`,a.style.right="auto",a.style.width=`${ee}px`,a.style.minWidth=`${T}px`,a.style.maxWidth=`${A}px`,a.style.maxHeight=`${Math.floor(b)}px`,a.style.visibility="",a.style.zIndex="10050"}function Le(t=null){let e=$(),s=ot(t);if(!e||!s?.activeRoot)return;let r=s.activeRoot,o=s.activeDropdown,a=s.placeholder,n=e(r),i=Br(n);o&&(Od(o),a?.parentNode?a.parentNode.insertBefore(o,a):r?.isConnected?r.appendChild(o):o.remove()),a?.parentNode?.removeChild(a),n.removeClass("yyt-open"),i?.attr("aria-expanded","false"),s.activeRoot=null,s.activeDropdown=null,s.placeholder=null,Nd(s)}function da(t=null){let e=ot(t);!e?.activeRoot||!e?.activeDropdown||ca(e)}function oi(t){if(!$()||!t?.length)return;let s=t.first(),r=Br(s),o=si(s);if(!r?.length||!o?.length||r.prop("disabled"))return;let a=ot(s);if(a.activeRoot===s[0]){ca(a);return}Le(s);let n=Dd(s);if(!n)return;let i=o[0],l=a.targetDoc.createComment("yyt-select-dropdown-placeholder");i.parentNode?.insertBefore(l,i),n.appendChild(i),a.activeRoot=s[0],a.activeDropdown=i,a.placeholder=l,s.addClass("yyt-open"),r.attr("aria-expanded","true"),Ld(a),ca(a)}function Bd(t,e){let s=$();if(!s||!e?.length)return null;let r=e.closest("[data-yyt-custom-select]");if(r.length)return r.first();let o=ot(e);if(o.activeRoot&&o.activeDropdown?.contains?.(e[0])){let a=s(o.activeRoot);return t.has(o.activeRoot).length?a:null}return null}function or(t){let e=ot(t);t?.length&&e.activeRoot&&e.activeRoot!==t[0]||Le(t)}function Ur(t){let e=ot(t);if(t?.length&&e.activeRoot===t[0]){Le(t);return}oi(t)}function la(t,e,s=null){let r=$();if(!r||!e?.length)return;let o=s||ei(t,e);if(!o?.length)return;let a=Array.isArray(o.data("yytCustomSelectOptions"))?o.data("yytCustomSelectOptions"):[],n=Qn(a,o.val(),e.attr("data-yyt-select-placeholder")||""),i=String(n.value??""),l=String(n.label??""),c=o.is(":disabled");e.find(".yyt-select-value").text(l).attr("data-value",i).data("value",i);let d=si(e);(d?.length?d.find("[data-yyt-select-option]"):e.find("[data-yyt-select-option]")).each((p,g)=>{let x=r(g),b=String(x.attr("data-value")||"")===i;x.toggleClass("yyt-selected",b).attr("aria-selected",String(b))});let y=e.find("[data-yyt-select-trigger]").first();y.prop("disabled",c),c&&(or(e),e.removeClass("yyt-open"),y.attr("aria-expanded","false"))}function zr(t=[]){return Array.isArray(t)?t.map(e=>{if(e&&typeof e=="object"&&!Array.isArray(e)){let r=String(e.value??""),o=String(e.label??e.text??e.name??r);return{value:r,label:o,disabled:e.disabled===!0}}let s=String(e??"");return{value:s,label:s,disabled:!1}}):[]}function Kr(t={}){let{selectedValue:e="",options:s=[],placeholder:r="\u8BF7\u9009\u62E9",disabled:o=!1,includeNative:a=!0,nativeTag:n="input",nativeType:i="hidden",rootAttributes:l={},nativeAttributes:c={},triggerAttributes:d={},dropdownAttributes:u={},optionAttributes:y={},optionClass:p="",optionTextClass:g=""}=t,x=zr(s),b=Qn(x,e,r),T=o===!0||x.length===0,A=ws({...l,class:kt("yyt-custom-select",l.class),"data-yyt-custom-select":l["data-yyt-custom-select"]??"true","data-yyt-select-placeholder":r}),w=ws({type:"button",...d,class:kt("yyt-select-trigger",d.class),"data-yyt-select-trigger":d["data-yyt-select-trigger"]??"true","aria-haspopup":d["aria-haspopup"]??"listbox","aria-expanded":d["aria-expanded"]??"false",disabled:T?!0:d.disabled}),L=ws({...u,class:kt("yyt-select-dropdown",u.class),"data-yyt-select-dropdown":u["data-yyt-select-dropdown"]??"true",role:u.role??"listbox"}),M=a?(()=>{let k={...c,class:kt(c.class),"data-yyt-select-native":c["data-yyt-select-native"]??"true",disabled:T?!0:c.disabled};return n==="select"?`<select ${ws(k)}>${x.map(Y=>`
            <option value="${v(Y.value)}" ${Y.value===String(b.value??"")?"selected":""} ${Y.disabled?"disabled":""}>${v(Y.label)}</option>
...
\u70B9\u51FB"\u786E\u5B9A"\u8986\u76D6\u9884\u8BBE\uFF0C\u70B9\u51FB"\u53D6\u6D88"\u4EC5\u4FDD\u5B58\u5F53\u524D\u914D\u7F6E\u5E76\u5207\u6362\u5230\u201C\u5F53\u524D\u914D\u7F6E\u201D`)){vs(s),qt(""),this._setSelectedPresetName(t,""),S("success","API\u914D\u7F6E\u5DF2\u4FDD\u5B58\uFF0C\u5E76\u5DF2\u5207\u6362\u5230\u5F53\u524DAPI\u914D\u7F6E"),this._rerender(t);return}vs(s);let a=ta(r,{apiConfig:s});a.success?(this._setSelectedPresetName(t,r),S("success",`\u914D\u7F6E\u5DF2\u4FDD\u5B58\u5E76\u8986\u76D6\u9884\u8BBE "${r}"`),qt(r),P.emit(I.PRESET_UPDATED,{name:r}),this._rerender(t)):S("error",a.message);return}vs(s),S("success","API\u914D\u7F6E\u5DF2\u4FDD\u5B58")}),t.find(`#${m}-reset-api-config`).on("click",()=>{confirm("\u786E\u5B9A\u8981\u91CD\u7F6EAPI\u914D\u7F6E\u5417\uFF1F")&&(qt(""),this._setSelectedPresetName(t,""),vs({url:"",apiKey:"",model:"",useMainApi:!0,stream:!1,max_tokens:4096,temperature:.7,top_p:.9}),this._rerender(t),S("info","API\u914D\u7F6E\u5DF2\u91CD\u7F6E"))}),t.find(`#${m}-save-as-preset`).on("click",()=>{this._showSavePresetDialog(t,e)})},_bindFileEvents(t,e){t.find(`#${m}-export-presets`).on("click",()=>{try{let s=aa();ft(s,`youyou_toolkit_presets_${Date.now()}.json`),S("success","\u9884\u8BBE\u5DF2\u5BFC\u51FA")}catch(s){S("error",`\u5BFC\u51FA\u5931\u8D25: ${s.message}`)}}),t.find(`#${m}-import-presets`).on("click",()=>{t.find(`#${m}-import-file`).click()}),t.find(`#${m}-import-file`).on("change",async s=>{let r=s.target.files[0];if(r){try{let o=await mt(r),a=na(o,{overwrite:!0});S(a.success?"success":"error",a.message),a.imported>0&&this._rerender(t)}catch(o){S("error",`\u5BFC\u5165\u5931\u8D25: ${o.message}`)}e(s.target).val("")}})},_showSavePresetDialog(t,e){let r=Mt().map(d=>d.name),o=ia("\u65B0\u9884\u8BBE"),a=`
    ...
    `},renderTo(t){let e=this.render({selectedPresetName:this._getSelectedPresetName(t)});t.html(e),this.bindEvents(t,{})}}});var bi={};pe(bi,{MESSAGE_MACROS:()=>mi,addTagRule:()=>_s,createRuleTemplate:()=>ui,default:()=>Kd,deleteRulePreset:()=>gi,deleteRuleTemplate:()=>pi,deleteTagRule:()=>Gr,escapeRegex:()=>Vt,exportRulesConfig:()=>Xr,extractComplexTag:()=>ii,extractCurlyBraceTag:()=>ba,extractHtmlFormatTag:()=>li,extractSimpleTag:()=>ma,extractTagContent:()=>Jt,generateTagSuggestions:()=>Hr,getAllRulePresets:()=>Vr,getAllRuleTemplates:()=>ci,getContentBlacklist:()=>Xt,getRuleTemplate:()=>di,getTagRules:()=>ht,importRulesConfig:()=>Qr,isValidTagName:()=>fa,loadRulePreset:()=>Jr,saveRulesAsPreset:()=>Yr,scanTextForTags:()=>Fr,setContentBlacklist:()=>ir,setTagRules:()=>qr,shouldSkipContent:()=>ga,testRegex:()=>fi,updateRuleTemplate:()=>yi,updateTagRule:()=>As});function Ud(){return{apiConfig:{url:"",apiKey:"",model:"",useMainApi:!0,max_tokens:4096,temperature:.7,top_p:.9},currentPreset:"",uiSettings:{theme:"dark",lastTab:"api"},ruleTemplates:[...pa],tagRules:[],contentBlacklist:[],tagRulePresets:{}}}function Ne(){return C.get(ni,Ud())}function at(t){C.set(ni,t)}function jr(){let t=Ne();return Te=t.ruleTemplates||[...pa],ae=t.tagRules||[],De=t.contentBlacklist||[],{ruleTemplates:Te,tagRules:ae,contentBlacklist:De}}function Vt(t){return typeof t!="string"?"":t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function ga(t,e){if(!e||e.length===0||!t||typeof t!="string")return!1;let s=t.toLowerCase();return e.some(r=>{let o=r.trim().toLowerCase();return o&&s.includes(o)})}function fa(t){return!t||typeof t!="string"?!1:/^[a-zA-Z][a-zA-Z0-9_-]*$/.test(t)&&!zd.includes(t.toLowerCase())}function ma(t,e){if(!t||!e)return[];let s=[],r=Vt(e),o=new RegExp(`<${r}>([\\s\\S]*?)<\\/${r}>`,"gi");[...t.matchAll(o)].forEach(l=>{l[1]&&s.push(l[1].trim())});let n=(t.match(new RegExp(`<${r}>`,"gi"))||[]).length,i=(t.match(new RegExp(`<\\/${r}>`,"gi"))||[]).length;return n>i&&bt.warn(`\u53D1\u73B0 ${n-i} \u4E2A\u672A\u95ED\u5408\u7684 <${e}> \u6807\u7B7E`),s}function ba(t,e){if(!t||!e)return[];let s=[],r=Vt(e),o=new RegExp(`\\{${r}\\|`,"gi"),a;for(;(a=o.exec(t))!==null;){let n=a.index,i=n+a[0].length,l=1,c=i;for(;c<t.length&&l>0;)t[c]==="{"?l++:t[c]==="}"&&l--,c++;if(l===0){let d=t.substring(i,c-1);d.trim()&&s.push(d.trim())}o.lastIndex=n+1}return s}function ii(t,e){if(!t||!e)return[];let s=e.split(",");if(s.length!==2)return bt.error(`\u590D\u6742\u6807\u7B7E\u914D\u7F6E\u683C\u5F0F\u9519\u8BEF\uFF0C\u5E94\u8BE5\u5305\u542B\u4E00\u4E2A\u9017\u53F7: ${e}`),[];let r=s[0].trim(),o=s[1].trim(),a=o.match(/<\/(\w+)>/);if(!a)return bt.error(`\u65E0\u6CD5\u89E3\u6790\u7ED3\u675F\u6807\u7B7E: ${o}`),[];let n=a[1],i=new RegExp(`${Vt(r)}([\\s\\S]*?)<\\/${n}>`,"gi"),l=[];return[...t.matchAll(i)].forEach(d=>{d[1]&&l.push(d[1].trim())}),l}function li(t,e){if(!t||!e)return[];let s=e.match(/<(\w+)(?:\s[^>]*)?>/);if(!s)return bt.error(`\u65E0\u6CD5\u89E3\u6790HTML\u683C\u5F0F\u6807\u7B7E: ${e}`),[];let r=s[1],o=[],a=new RegExp(`<${r}(?:\\s[^>]*)?>([\\s\\S]*?)<\\/${r}>`,"gi");[...t.matchAll(a)].forEach(c=>{c[1]&&o.push(c[1].trim())});let i=(t.match(new RegExp(`<${r}(?:\\s[^>]*)?>`,"gi"))||[]).length,l=(t.match(new RegExp(`<\\/${r}>`,"gi"))||[]).length;return i>l&&bt.warn(`\u53D1\u73B0 ${i-l} \u4E2A\u672A\u95ED\u5408\u7684 <${r}> \u6807\u7B7E`),o}function Jt(t,e,s=[]){if(!t)return"";if(!e||e.length===0)return t;let r=e.filter(d=>d.type==="exclude"&&d.enabled),o=e.filter(d=>(d.type==="include"||d.type==="regex_include")&&d.enabled),a=e.filter(d=>d.type==="regex_exclude"&&d.enabled),n=t;for(let d of r)try{let u=new RegExp(`<${Vt(d.value)}(?:\\s[^>]*)?>[\\s\\S]*?<\\/${Vt(d.value)}>`,"gi");n=n.replace(u,"")}catch(u){bt.error("Error applying block exclusion rule:",{rule:d,error:u})}let i=[];if(o.length>0)for(let d of o){let u=[];try{if(d.type==="include")u.push(...ma(n,d.value)),u.push(...ba(n,d.value));else if(d.type==="regex_include"){let y=new RegExp(d.value,"gi");[...n.matchAll(y)].forEach(g=>{g[1]&&u.push(g[1])})}}catch(y){bt.error("Error applying inclusion rule:",{rule:d,error:y})}u.forEach(y=>i.push(y.trim()))}else i.push(n);let l=[];for(let d of i){for(let u of a)try{let y=new RegExp(u.value,"gi");d=d.replace(y,"")}catch(y){bt.error("Error applying cleanup rule:",{rule:u,error:y})}ga(d,s)||l.push(d)}return l.join(`

`).replace(/\n\s*\n\s*\n/g,`

`).replace(/^\s+|\s+$/g,"").trim()}async function Fr(t,e={}){let s=performance.now(),{chunkSize:r=5e4,maxTags:o=100,timeoutMs:a=5e3}=e,n=new Set,i=/<(?:\/|)([a-zA-Z0-9_-]+)(?:[^>]*)>|\{([a-zA-Z0-9_-]+)(?:\||})/g,l=0,c=0;for(let u=0;u<t.length;u+=r){let y=t.slice(u,Math.min(u+r,t.length));if(c++,l+=y.length,performance.now()-s>a){bt.warn(`Tag scanning timed out after ${a}ms`);break}let p;for(;(p=i.exec(y))!==null&&n.size<o;){let g=(p[1]||p[2]).toLowerCase();fa(g)&&n.add(g)}if(n.size>=o)break;c%5===0&&await new Promise(g=>setTimeout(g,0))}let d=performance.now();return{tags:Array.from(n).sort(),stats:{processingTimeMs:Math.round(d-s),processedChars:l,totalChars:t.length,chunkCount:c,tagsFound:n.size}}}function Hr(t,e=25){let s=t.tags.slice(0,e);return{suggestions:s,stats:{totalFound:t.stats.tagsFound,finalCount:s.length}}}function ci(){return Te.length===0&&jr(),Te}function di(t){return Te.find(e=>e.id===t)}function ui(t){let e={id:`rule-${Date.now()}`,name:t.name||"\u65B0\u89C4\u5219",description:t.description||"",type:t.type||"include",value:t.value||"",enabled:t.enabled!==!1,createdAt:new Date().toISOString()};return Te.push(e),ha(),{success:!0,template:e,message:"\u89C4\u5219\u6A21\u677F\u521B\u5EFA\u6210\u529F"}}function yi(t,e){let s=Te.findIndex(r=>r.id===t);return s===-1?{success:!1,message:"\u89C4\u5219\u6A21\u677F\u4E0D\u5B58\u5728"}:(Te[s]={...Te[s],...e,updatedAt:new Date().toISOString()},ha(),{success:!0,template:Te[s],message:"\u89C4\u5219\u6A21\u677F\u66F4\u65B0\u6210\u529F"})}function pi(t){let e=Te.findIndex(s=>s.id===t);return e===-1?{success:!1,message:"\u89C4\u5219\u6A21\u677F\u4E0D\u5B58\u5728"}:(Te.splice(e,1),ha(),{success:!0,message:"\u89C4\u5219\u6A21\u677F\u5DF2\u5220\u9664"})}function ha(){let t=Ne();t.ruleTemplates=Te,at(t)}function ht(){return ae||jr(),ae}function qr(t){ae=t||[];let e=Ne();e.tagRules=ae,at(e)}function _s(t){let e={id:`tag-${Date.now()}`,type:t.type||"include",value:t.value||"",enabled:t.enabled!==!1};ae.push(e);let s=Ne();return s.tagRules=ae,at(s),{success:!0,rule:e,message:"\u89C4\u5219\u6DFB\u52A0\u6210\u529F"}}function As(t,e){if(t<0||t>=ae.length)return{success:!1,message:"\u89C4\u5219\u7D22\u5F15\u65E0\u6548"};ae[t]={...ae[t],...e};let s=Ne();return s.tagRules=ae,at(s),{success:!0,rule:ae[t],message:"\u89C4\u5219\u66F4\u65B0\u6210\u529F"}}function Gr(t){if(t<0||t>=ae.length)return{success:!1,message:"\u89C4\u5219\u7D22\u5F15\u65E0\u6548"};ae.splice(t,1);let e=Ne();return e.tagRules=ae,at(e),{success:!0,message:"\u89C4\u5219\u5DF2\u5220\u9664"}}function Xt(){return De||jr(),De}function ir(t){De=t||[];let e=Ne();e.contentBlacklist=De,at(e)}function Yr(t,e=""){if(!t||!t.trim())return{success:!1,message:"\u9884\u8BBE\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"};let s=Ne();s.tagRulePresets||(s.tagRulePresets={});let r=`preset-${Date.now()}`;return s.tagRulePresets[r]={id:r,name:t.trim(),description:e.trim(),rules:JSON.parse(JSON.stringify(ae)),blacklist:JSON.parse(JSON.stringify(De)),createdAt:new Date().toISOString()},at(s),{success:!0,preset:s.tagRulePresets[r],message:"\u9884\u8BBE\u4FDD\u5B58\u6210\u529F"}}function Vr(){let e=Ne().tagRulePresets||{};return Object.values(e)}function Jr(t){let e=Ne(),r=(e.tagRulePresets||{})[t];return r?(ae=JSON.parse(JSON.stringify(r.rules||[])),De=JSON.parse(JSON.stringify(r.blacklist||[])),e.tagRules=ae,e.contentBlacklist=De,at(e),{success:!0,preset:r,message:"\u9884\u8BBE\u52A0\u8F7D\u6210\u529F"}):{success:!1,message:"\u9884\u8BBE\u4E0D\u5B58\u5728"}}function gi(t){let e=Ne(),s=e.tagRulePresets||{};return s[t]?(delete s[t],e.tagRulePresets=s,at(e),{success:!0,message:"\u9884\u8BBE\u5DF2\u5220\u9664"}):{success:!1,message:"\u9884\u8BBE\u4E0D\u5B58\u5728"}}function Xr(){return JSON.stringify({tagRules:ae,contentBlacklist:De,ruleTemplates:Te,tagRulePresets:Ne().tagRulePresets||{}},null,2)}function Qr(t,e={overwrite:!0}){try{let s=JSON.parse(t);if(e.overwrite)ae=s.tagRules||[],De=s.contentBlacklist||[],Te=s.ruleTemplates||pa;else if(s.tagRules&&ae.push(...s.tagRules),s.contentBlacklist){let o=new Set(De.map(a=>a.toLowerCase()));s.contentBlacklist.forEach(a=>{o.has(a.toLowerCase())||De.push(a)})}let r=Ne();return r.tagRules=ae,r.contentBlacklist=De,r.ruleTemplates=Te,s.tagRulePresets&&(r.tagRulePresets={...r.tagRulePresets||{},...s.tagRulePresets}),at(r),{success:!0,message:"\u914D\u7F6E\u5BFC\u5165\u6210\u529F"}}catch(s){return{success:!1,message:`\u5BFC\u5165\u5931\u8D25: ${s.message}`}}}function fi(t,e,s="g",r=0){try{if(!t||typeof t!="string")return{success:!1,error:"\u6B63\u5219\u8868\u8FBE\u5F0F\u4E0D\u80FD\u4E3A\u7A7A",matches:[]};let o=new RegExp(t,s),a=[];if(s.includes("g")){let n;for(;(n=o.exec(e))!==null;)n.length>1?a.push({fullMatch:n[0],groups:n.slice(1),index:n.index,extracted:n[r]||n[1]||n[0]}):a.push({fullMatch:n[0],groups:[],index:n.index,extracted:n[0]})}else{let n=o.exec(e);n&&a.push({fullMatch:n[0],groups:n.length>1?n.slice(1):[],index:n.index,extracted:n.length>1?n[r]||n[1]:n[0]})}return{success:!0,matches:a,count:a.length,extracted:a.map(n=>n.extracted)}}catch(o){return{success:!1,error:o.message,matches:[]}}}var bt,ni,zd,pa,Te,ae,De,mi,Kd,Zr=z(()=>{ze();re();bt=B.createScope("RegexExtractor"),ni="settings";zd=["font","span","div","p","br","hr","img","a","b","i","u","s","em","strong","small","big","sub","sup","h1","h2","h3","h4","h5","h6","table","tr","td","th","tbody","thead","tfoot","ul","ol","li","form","input","button","select","option","textarea","label","script","style","meta","link","title","head","body","html"],pa=[{id:"exclude-thinking",name:"\u6392\u9664\u601D\u8003\u6807\u7B7E",description:"\u79FB\u9664<thinking>\u6807\u7B7E\u5757",type:"exclude",value:"thinking",enabled:!0},{id:"include-content",name:"\u63D0\u53D6\u5185\u5BB9\u6807\u7B7E",description:"\u63D0\u53D6<content>\u6807\u7B7E\u5185\u5BB9",type:"include",value:"content",enabled:!0},{id:"regex-exclude-cot",name:"\u6392\u9664\u5C0FCoT",description:"\u79FB\u9664HTML\u6CE8\u91CA",type:"regex_exclude",value:"<!--[\\s\\S]*?-->",enabled:!1},{id:"regex-include-details",name:"\u63D0\u53D6details\u6807\u7B7E",description:"\u63D0\u53D6<details>\u6807\u7B7E\u5185\u5BB9",type:"regex_include",value:"<details[^>]*>([\\s\\S]*?)</details>",enabled:!1}],Te=[],ae=[],De=[];mi={lastMessage:{macro:"{{lastMessage}}",description:"\u6700\u540E\u4E00\u6761\u6D88\u606F"},lastCharMessage:{macro:"{{lastCharMessage}}",description:"\u6700\u540E\u4E00\u6761\u89D2\u8272\u6D88\u606F"},lastUserMessage:{macro:"{{lastUserMessage}}",description:"\u6700\u540E\u4E00\u6761\u7528\u6237\u6D88\u606F"},char:{macro:"{{char}}",description:"\u89D2\u8272\u540D\u79F0"},user:{macro:"{{user}}",description:"\u7528\u6237\u540D\u79F0"},input:{macro:"{{input}}",description:"\u5F53\u524D\u8F93\u5165\u6846\u5185\u5BB9"}};jr();Kd={extractTagContent:Jt,extractSimpleTag:ma,extractCurlyBraceTag:ba,extractComplexTag:ii,extractHtmlFormatTag:li,escapeRegex:Vt,shouldSkipContent:ga,isValidTagName:fa,scanTextForTags:Fr,generateTagSuggestions:Hr,getAllRuleTemplates:ci,getRuleTemplate:di,createRuleTemplate:ui,updateRuleTemplate:yi,deleteRuleTemplate:pi,getTagRules:ht,setTagRules:qr,addTagRule:_s,updateTagRule:As,deleteTagRule:Gr,getContentBlacklist:Xt,setContentBlacklist:ir,saveRulesAsPreset:Yr,getAllRulePresets:Vr,loadRulePreset:Jr,deleteRulePreset:gi,exportRulesConfig:Xr,importRulesConfig:Qr,testRegex:fi,MESSAGE_MACROS:mi}});var Qt,va=z(()=>{fe();Se();Zr();Qt={id:"regexExtractPanel",render(t){let e=ht(),s=Xt(),r=Vr();return`
...
\u2022 \u63D0\u53D6\u82B1\u62EC\u53F7\u5185\u5BB9: \u7C7B\u578B=\u5305\u542B, \u503C=story
    ...
    `},renderTo(t){let e=this.render({});t.html(e),this.bindEvents(t,{})}}});var Ai={};pe(Ai,{createDefaultToolDefinition:()=>Zt,default:()=>Hd,deleteTool:()=>so,deleteToolPreset:()=>Si,exportTools:()=>ao,getAllTools:()=>Pt,getCurrentToolPreset:()=>Ti,getTool:()=>Es,getToolPresets:()=>ro,importTools:()=>no,normalizeToolDefinitionToRuntimeConfig:()=>cr,resetTools:()=>io,saveTool:()=>to,saveToolPreset:()=>wi,setCurrentToolPreset:()=>_i,setToolEnabled:()=>oo});function Wd(t={}){return!t||typeof t!="object"?{}:Object.fromEntries(Object.entries(t).map(([e,s])=>[e,Zt({...s||{},id:e})]))}function lr(t){return Array.isArray(t)?t.map(e=>String(e||"").trim()).filter(Boolean):[]}function xa(t,e){let s=parseInt(t,10);return Number.isFinite(s)&&s>0?s:e}function hi(t,e){let s=parseInt(t,10);return Number.isFinite(s)&&s>=0?s:e}function vi(t={}){return{enabled:t?.enabled===!0,settleMs:hi(t?.settleMs,1200),cooldownMs:hi(t?.cooldownMs,5e3)}}function xi(t={}){return{enabled:t?.enabled===!0,selected:lr(t?.selected)}}function jd(t=[]){let e=Array.isArray(t)?t.map(s=>({role:String(s?.role||"user").trim().toUpperCase(),content:String(s?.content||"").trim()})).filter(s=>s.content):[];return e.length===0?"":e.length===1?e[0].content:e.map(s=>`\u3010${s.role||"USER"}\u3011
${s.content}`).join(`

`)}function Fd(t,e={}){let s=typeof e?.promptTemplate=="string"?e.promptTemplate.trim():"";if(s)return s;let r=jd(e?.config?.messages||[]);return r||`\u8BF7\u57FA\u4E8E\u6700\u8FD1\u7684 AI \u56DE\u590D\u4E3A\u5DE5\u5177\u201C${e?.name||t}\u201D\u751F\u6210\u7ED3\u6784\u5316\u8F93\u51FA\u3002`}function Zt(t={}){let e=new Date().toISOString(),s=t?.config||{};return{...We,...t,id:t?.id||We.id,icon:t?.icon||We.icon,order:Number.isFinite(t?.order)?t.order:We.order,promptTemplate:typeof t?.promptTemplate=="string"?t.promptTemplate:We.promptTemplate,extractTags:lr(t?.extractTags),config:{execution:{...We.config.execution,...s.execution||{},timeout:xa(s?.execution?.timeout,We.config.execution.timeout),retries:Math.max(0,parseInt(s?.execution?.retries,10)||We.config.execution.retries)},api:{...We.config.api,...s.api||{}},messages:Array.isArray(s?.messages)?s.messages:[],context:{...We.config.context,...s.context||{},depth:xa(s?.context?.depth,We.config.context.depth),includeTags:lr(s?.context?.includeTags),excludeTags:lr(s?.context?.excludeTags)},automation:vi(s?.automation),worldbooks:xi(s?.worldbooks)},enabled:t?.enabled!==!1,metadata:{...We.metadata,...t?.metadata||{},createdAt:t?.metadata?.createdAt||e,updatedAt:t?.metadata?.updatedAt||e}}}function cr(t,e={},s={}){let r=Zt({...e,id:t||e?.id||""}),o=lr(r?.extractTags?.length?r.extractTags:r?.config?.context?.includeTags),a=String(e?.output?.apiPreset||r?.config?.api?.preset||"").trim(),n=Fd(t,r),i=typeof e?.output?.mode=="string"&&e.output.mode.trim()?e.output.mode.trim():s.defaultOutputMode||"follow_ai";return{id:r.id||t,name:r.name||t,icon:r.icon||"fa-screwdriver-wrench",description:r.description||"",enabled:r.enabled!==!1,order:Number.isFinite(r.order)?r.order:100,bypass:{enabled:r?.config?.api?.useBypass===!0&&!!r?.config?.api?.bypassPreset,presetId:r?.config?.api?.bypassPreset||""},output:{mode:i,apiPreset:a,overwrite:!0,enabled:!0},automation:vi(r?.config?.automation),worldbooks:xi(r?.config?.worldbooks),extraction:{enabled:!0,maxMessages:xa(r?.config?.context?.depth,5),selectors:o},promptTemplate:n,runtime:{lastRunAt:0,lastStatus:"idle",lastError:"",lastDurationMs:0,successCount:0,errorCount:0},apiPreset:a,extractTags:o,isCustom:!0,category:r.category||"utility",metadata:{...r.metadata||{}}}}function Pt(){let t=te.get(le.TOOLS),e=Wd(t);return t&&JSON.stringify(t)!==JSON.stringify(e)&&te.set(le.TOOLS,e),{...eo,...e}}function Es(t){return Pt()[t]||null}function to(t,e){if(!t||!e)return!1;let s=te.get(le.TOOLS)||{},r=!s[t]&&!eo[t],o=Zt({...s[t]||{},...e,id:t,metadata:{...s[t]?.metadata||{},...e.metadata||{},createdAt:s[t]?.metadata?.createdAt||e?.metadata?.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString()}});return s[t]=o,te.set(le.TOOLS,s),P.emit(r?I.TOOL_REGISTERED:I.TOOL_UPDATED,{toolId:t,tool:o}),!0}function so(t){let e=te.get(le.TOOLS)||{};return!e[t]&&!eo[t]||eo[t]?!1:(delete e[t],te.set(le.TOOLS,e),P.emit(I.TOOL_UNREGISTERED,{toolId:t}),!0)}function ro(){return te.get(le.PRESETS)||{}}function wi(t,e){if(!t||!e)return!1;let s=ro(),r=!s[t];return s[t]={...e,name:t,updatedAt:new Date().toISOString()},te.set(le.PRESETS,s),P.emit(r?I.PRESET_CREATED:I.PRESET_UPDATED,{type:"tool",presetName:t,preset:s[t]}),!0}function Si(t){let e=ro();return e[t]?(delete e[t],te.set(le.PRESETS,e),P.emit(I.PRESET_DELETED,{type:"tool",presetName:t}),!0):!1}function Ti(){return te.get(le.CURRENT_PRESET)||""}function _i(t){return te.set(le.CURRENT_PRESET,t||""),P.emit(I.PRESET_ACTIVATED,{type:"tool",presetName:t}),!0}function oo(t,e){let s=Es(t);if(!s)return!1;let r=te.get(le.TOOLS)||{};return r[t]=Zt({...s,id:t,enabled:e,metadata:{...s?.metadata||{},createdAt:s?.metadata?.createdAt||new Date().toISOString(),updatedAt:new Date().toISOString()}}),te.set(le.TOOLS,r),P.emit(e?I.TOOL_ENABLED:I.TOOL_DISABLED,{toolId:t,enabled:e}),!0}function ao(){let t=te.get(le.TOOLS)||{},e=te.get(le.PRESETS)||{};return JSON.stringify({version:"1.0.0",exportedAt:new Date().toISOString(),tools:t,presets:e},null,2)}function no(t,e=!1){try{let s=typeof e=="object"?!!e?.overwrite:!!e,r=JSON.parse(t);if(!r||typeof r!="object")return{success:!1,toolsImported:0,presetsImported:0,message:"\u65E0\u6548\u7684JSON\u683C\u5F0F"};let o=s?{}:te.get(le.TOOLS)||{},a=s?{}:te.get(le.PRESETS)||{},n=0,i=0;if(r.tools&&typeof r.tools=="object"){for(let[l,c]of Object.entries(r.tools))!c||typeof c!="object"||(o[l]=Zt({...c,id:l}),n+=1);te.set(le.TOOLS,o)}if(r.presets&&typeof r.presets=="object"){for(let[l,c]of Object.entries(r.presets))!c||typeof c!="object"||(a[l]={...c,name:l,updatedAt:new Date().toISOString()},i+=1);te.set(le.PRESETS,a)}return{success:!0,toolsImported:n,presetsImported:i,message:`\u6210\u529F\u5BFC\u5165 ${n} \u4E2A\u5DE5\u5177\u548C ${i} \u4E2A\u9884\u8BBE`}}catch(s){return{success:!1,toolsImported:0,presetsImported:0,message:`\u5BFC\u5165\u5931\u8D25: ${s.message}`}}}function io(){te.remove(le.TOOLS),te.remove(le.PRESETS),te.remove(le.CURRENT_PRESET)}var We,eo,le,Hd,lo=z(()=>{ze();fe();We={id:"",name:"",description:"",icon:"fa-screwdriver-wrench",order:100,category:"utility",promptTemplate:"",extractTags:[],config:{execution:{timeout:6e4,retries:3},api:{preset:"",useBypass:!1,bypassPreset:""},messages:[],context:{depth:3,includeTags:[],excludeTags:[]},automation:{enabled:!1,settleMs:1200,cooldownMs:5e3},worldbooks:{enabled:!1,selected:[]}},enabled:!0,metadata:{createdAt:null,updatedAt:null,author:"",version:"1.0.0"}},eo={},le={TOOLS:"tools",PRESETS:"tool_presets",CURRENT_PRESET:"current_tool_preset"};Hd={getAllTools:Pt,getTool:Es,saveTool:to,deleteTool:so,setToolEnabled:oo,exportTools:ao,importTools:no,resetTools:io,getToolPresets:ro,saveToolPreset:wi,deleteToolPreset:Si,getCurrentToolPreset:Ti,setCurrentToolPreset:_i,createDefaultToolDefinition:Zt,normalizeToolDefinitionToRuntimeConfig:cr}});var Fi={};pe(Fi,{TOOL_CATEGORIES:()=>Ei,TOOL_REGISTRY:()=>Ms,appendToolRuntimeHistory:()=>Bi,clearToolApiPreset:()=>Oi,default:()=>Zd,ensureToolRuntimeConfig:()=>co,getAllDefaultToolConfigs:()=>zi,getAllToolApiBindings:()=>Li,getAllToolFullConfigs:()=>yr,getEnabledTools:()=>Ki,getToolApiPreset:()=>Aa,getToolBaseConfig:()=>ks,getToolConfig:()=>ur,getToolFullConfig:()=>Z,getToolList:()=>Ri,getToolSubTabs:()=>Pi,getToolWindowState:()=>ji,hasTool:()=>_a,onPresetDeleted:()=>Ni,patchToolRuntime:()=>$t,registerTool:()=>Ci,resetToolConfig:()=>Ui,resetToolRegistry:()=>$i,saveToolConfig:()=>Fe,saveToolWindowState:()=>Wi,setToolApiPreset:()=>Di,setToolApiPresetConfig:()=>Jd,setToolBypassConfig:()=>Xd,setToolOutputMode:()=>Vd,setToolPromptTemplate:()=>Qd,unregisterTool:()=>Ii,updateToolRuntime:()=>Ea});function ts(t={}){let e=Array.isArray(t?.recentWritebackHistory)?t.recentWritebackHistory.filter(Boolean):[];return{lastRunAt:Number.isFinite(t?.lastRunAt)?t.lastRunAt:0,lastStatus:typeof t?.lastStatus=="string"?t.lastStatus:"idle",lastError:typeof t?.lastError=="string"?t.lastError:"",lastDurationMs:Number.isFinite(t?.lastDurationMs)?t.lastDurationMs:0,successCount:Number.isFinite(t?.successCount)?t.successCount:0,errorCount:Number.isFinite(t?.errorCount)?t.errorCount:0,lastMessageKey:typeof t?.lastMessageKey=="string"?t.lastMessageKey:"",lastExecutionKey:typeof t?.lastExecutionKey=="string"?t.lastExecutionKey:"",lastExecutionPath:typeof t?.lastExecutionPath=="string"?t.lastExecutionPath:"",lastWritebackStatus:typeof t?.lastWritebackStatus=="string"?t.lastWritebackStatus:"",lastFailureStage:typeof t?.lastFailureStage=="string"?t.lastFailureStage:"",lastSlotBindingKey:typeof t?.lastSlotBindingKey=="string"?t.lastSlotBindingKey:"",lastSlotRevisionKey:typeof t?.lastSlotRevisionKey=="string"?t.lastSlotRevisionKey:"",lastSlotTransactionId:typeof t?.lastSlotTransactionId=="string"?t.lastSlotTransactionId:"",lastSourceMessageId:typeof t?.lastSourceMessageId=="string"?t.lastSourceMessageId:"",lastSourceSwipeId:typeof t?.lastSourceSwipeId=="string"?t.lastSourceSwipeId:"",lastContentCommitted:t?.lastContentCommitted===!0,lastHostCommitApplied:t?.lastHostCommitApplied===!0,lastRefreshRequested:t?.lastRefreshRequested===!0,lastRefreshConfirmed:t?.lastRefreshConfirmed===!0,lastPreferredCommitMethod:typeof t?.lastPreferredCommitMethod=="string"?t.lastPreferredCommitMethod:"",lastAppliedCommitMethod:typeof t?.lastAppliedCommitMethod=="string"?t.lastAppliedCommitMethod:"",lastRefreshMethodCount:Number.isFinite(t?.lastRefreshMethodCount)?t.lastRefreshMethodCount:0,lastRefreshMethods:Array.isArray(t?.lastRefreshMethods)?t.lastRefreshMethods.filter(Boolean):[],lastRefreshConfirmChecks:Number.isFinite(t?.lastRefreshConfirmChecks)?t.lastRefreshConfirmChecks:0,lastRefreshConfirmedBy:typeof t?.lastRefreshConfirmedBy=="string"?t.lastRefreshConfirmedBy:"",lastTraceId:typeof t?.lastTraceId=="string"?t.lastTraceId:"",lastAutoRunAt:Number.isFinite(t?.lastAutoRunAt)?t.lastAutoRunAt:0,lastAutoStatus:typeof t?.lastAutoStatus=="string"?t.lastAutoStatus:"idle",lastAutoMessageId:typeof t?.lastAutoMessageId=="string"?t.lastAutoMessageId:"",lastAutoSwipeId:typeof t?.lastAutoSwipeId=="string"?t.lastAutoSwipeId:"",lastAutoRevisionKey:typeof t?.lastAutoRevisionKey=="string"?t.lastAutoRevisionKey:"",lastAutoWritebackStatus:typeof t?.lastAutoWritebackStatus=="string"?t.lastAutoWritebackStatus:"",lastAutoRefreshConfirmed:t?.lastAutoRefreshConfirmed===!0,lastAutoSkipReason:typeof t?.lastAutoSkipReason=="string"?t.lastAutoSkipReason:"",recentWritebackHistory:e}}function qd(t,e=10){let s=Number.isFinite(e)?Math.max(1,Math.min(50,Math.floor(e))):10;return Array.isArray(t)?t.length<=s?t:t.slice(t.length-s):[]}function Mi(){let t=Pt()||{};return Object.entries(t).filter(([e])=>!dr[e]).map(([e,s])=>[e,s||{}])}function wa(t={}){return t?.toolKind==="script"?"script":t?.toolKind==="ai"?"ai":t?.output?.mode==="local_transform"||t?.processor?.type?"script":"ai"}function ki(){let t=Array.isArray(Ms.tools?.subTabs)?Ms.tools.subTabs.map((s,r)=>({...s,order:Number.isFinite(s?.order)?s.order:r,toolKind:wa(s),toolGroupLabel:wa(s)==="script"?"\u811A\u672C\u5DE5\u5177":"AI \u5DE5\u5177"})):[],e=Mi().map(([s,r],o)=>{let a=cr(s,r),n=wa(a);return{id:s,name:a.name||s,icon:a.icon||"fa-screwdriver-wrench",component:"GenericToolConfigPanel",order:Number.isFinite(a.order)?a.order:100+o,isCustom:!0,description:a.description||"",toolKind:n,toolGroupLabel:n==="script"?"\u811A\u672C\u5DE5\u5177":"AI \u5DE5\u5177"}});return[...t,...e].sort((s,r)=>(s.order??0)-(r.order??0))}function Gd(t,e={}){let s=cr(t,e,{defaultOutputMode:"follow_ai"});return{...s,runtime:ts(s.runtime)}}function Ta(t){let e=dr[t];if(e)return{...e,output:{...e.output||{}},bypass:{...e.bypass||{}},worldbooks:{...e.worldbooks||{},selected:Array.isArray(e?.worldbooks?.selected)?[...e.worldbooks.selected]:[]},extraction:{...e.extraction||{}},processor:{...e.processor||{},options:{...e?.processor?.options||{}}},runtime:ts(e.runtime),extractTags:Array.isArray(e.extractTags)?[...e.extractTags]:[]};let r=(Pt()||{})[t]||null;return r?Gd(t,r):ur(t)}function ks(t){let e=Ta(t);return e?{...e,output:{...e.output||{}},automation:{...e.automation||{}},bypass:{...e.bypass||{}},worldbooks:{...e.worldbooks||{},selected:Array.isArray(e?.worldbooks?.selected)?[...e.worldbooks.selected]:[]},extraction:{...e.extraction||{},selectors:Array.isArray(e?.extraction?.selectors)?[...e.extraction.selectors]:[]},processor:{...e.processor||{},options:{...e?.processor?.options||{}}},runtime:{...e.runtime||{}},extractTags:Array.isArray(e.extractTags)?[...e.extractTags]:[]}:null}function Yd(t,e={},s=""){if(!t)return null;let r={...t,...e,id:t.id||e.id};r.output={...t.output||{},...e.output||{}},r.automation={enabled:t?.automation?.enabled===!0||e?.automation?.enabled===!0,settleMs:Number.isFinite(e?.automation?.settleMs)?e.automation.settleMs:Number.isFinite(t?.automation?.settleMs)?t.automation.settleMs:1200,cooldownMs:Number.isFinite(e?.automation?.cooldownMs)?e.automation.cooldownMs:Number.isFinite(t?.automation?.cooldownMs)?t.automation.cooldownMs:5e3},r.bypass={...t.bypass||{},...e.bypass||{}},r.worldbooks={...t.worldbooks||{},...e.worldbooks||{},selected:Array.isArray(e?.worldbooks?.selected)?[...e.worldbooks.selected]:Array.isArray(t?.worldbooks?.selected)?[...t.worldbooks.selected]:[]},r.runtime=ts({...t.runtime||{},...e.runtime||{}}),r.extraction={...t.extraction||{},...e.extraction||{}},r.processor={...t.processor||{},...e.processor||{},options:{...t?.processor?.options||{},...e?.processor?.options||{}}};let o=e?.output?.apiPreset||e?.apiPreset||r.output?.apiPreset||r.apiPreset||s||"";return r.output={...r.output||{},apiPreset:o},r.apiPreset=o,(!Array.isArray(r.extraction.selectors)||r.extraction.selectors.length===0)&&Array.isArray(r.extractTags)&&r.extractTags.length>0&&(r.extraction.selectors=[...r.extractTags]),(!Array.isArray(r.extractTags)||r.extractTags.length===0)&&(r.extractTags=Array.isArray(r.extraction.selectors)?[...r.extraction.selectors]:[]),t.isCustom?r.enabled=t.enabled!==!1:typeof e.enabled=="boolean"?r.enabled=e.enabled:r.enabled=t.enabled!==!1,r}function Ci(t,e){if(!t||typeof t!="string")return Ee.error("\u5DE5\u5177ID\u65E0\u6548"),!1;if(!e||typeof e!="object")return Ee.error("\u5DE5\u5177\u914D\u7F6E\u65E0\u6548"),!1;let s=["name","icon","component"];for(let r of s)if(!e[r])return Ee.error(` \u5DE5\u5177\u7F3A\u5C11\u5FC5\u9700\u5B57\u6BB5: ${r}`),!1;return nt[t]={id:t,...e,order:e.order??Object.keys(nt).length},Ee.log(` \u5DE5\u5177\u5DF2\u6CE8\u518C: ${t}`),!0}function Ii(t){return nt[t]?(delete nt[t],Ee.log(` \u5DE5\u5177\u5DF2\u6CE8\u9500: ${t}`),!0):(Ee.warn(` \u5DE5\u5177\u4E0D\u5B58\u5728: ${t}`),!1)}function Ri(t=!0){let e=Object.values(nt).map(s=>s.id==="tools"?{...s,subTabs:ki()}:s);return t?e.sort((s,r)=>(s.order??0)-(r.order??0)):e}function ur(t){return t==="tools"&&nt[t]?{...nt[t],subTabs:ki()}:nt[t]||null}function _a(t){return!!nt[t]}function Pi(t){let e=ur(t);return!e||!e.hasSubTabs?[]:e.subTabs||[]}function $i(){nt={...Ms},Ee.log("\u5DE5\u5177\u6CE8\u518C\u8868\u5DF2\u91CD\u7F6E")}function Di(t,e){if(!_a(t))return Ee.warn(` \u5DE5\u5177\u4E0D\u5B58\u5728: ${t}`),!1;let s=C.get(je)||{};return s[t]=e||"",C.set(je,s),Ee.log(` \u5DE5\u5177 "${t}" \u7ED1\u5B9A\u5230\u9884\u8BBE "${e||"\u5F53\u524D\u914D\u7F6E"}"`),!0}function Aa(t){return(C.get(je)||{})[t]||""}function Oi(t){let e=C.get(je)||{};delete e[t],C.set(je,e),Ee.log(` \u5DE5\u5177 "${t}" \u7684API\u9884\u8BBE\u7ED1\u5B9A\u5DF2\u6E05\u9664`)}function Li(){return C.get(je)||{}}function Ni(t){let e=C.get(je)||{},s=!1;for(let r in e)e[r]===t&&(e[r]="",s=!0,Ee.log(` \u5DE5\u5177 "${r}" \u7684API\u9884\u8BBE\u7ED1\u5B9A\u5DF2\u6E05\u9664\uFF08\u9884\u8BBE\u88AB\u5220\u9664\uFF09`));s&&C.set(je,e)}function Z(t){let e=Ta(t);if(!e)return ur(t);let r=(C.get(es)||{})[t]||{},o=Aa(t);return Yd({...e,id:t},r,o)}function co(t){if(!t)return!1;let e=Ta(t);if(!e)return!1;let s=C.get(es)||{};if(s[t])return!0;let r={promptTemplate:e.promptTemplate||"",enabled:e.enabled!==!1,extractTags:Array.isArray(e.extractTags)?[...e.extractTags]:[],apiPreset:e.apiPreset||"",output:{...e.output||{}},automation:{...e.automation||{}},bypass:{...e.bypass||{}},worldbooks:{...e.worldbooks||{},selected:Array.isArray(e?.worldbooks?.selected)?[...e.worldbooks.selected]:[]},extraction:{...e.extraction||{},selectors:Array.isArray(e?.extraction?.selectors)?[...e.extraction.selectors]:[]},processor:{...e.processor||{},options:{...e?.processor?.options||{}}},runtime:{...e.runtime||{}}};s[t]=r,C.set(es,s);let o=C.get(je)||{};return o[t]=r.output?.apiPreset||r.apiPreset||"",C.set(je,o),P.emit(I.TOOL_UPDATED,{toolId:t,config:r}),!0}function Fe(t,e,s={}){if(!t||!Z(t))return Ee.warn("\u5DE5\u5177\u4E0D\u5B58\u5728:",t),!1;let{emitEvent:r=!0}=s,o=C.get(es)||{},a=C.get(je)||{},n=e?.output?.apiPreset??e?.apiPreset??"",i=["promptTemplate","enabled","extractTags","apiPreset","output","automation","bypass","worldbooks","extraction","processor","runtime"];return o[t]={},i.forEach(l=>{if(e[l]!==void 0){if(l==="output"&&e.output){o[t][l]={...e.output,apiPreset:n};return}if(l==="apiPreset"){o[t][l]=n;return}o[t][l]=e[l]}}),o[t].apiPreset===void 0&&(o[t].apiPreset=n),!o[t].output&&e.output!==void 0&&(o[t].output={...e.output||{},apiPreset:n}),C.set(es,o),a[t]=n,C.set(je,a),r&&P.emit(I.TOOL_UPDATED,{toolId:t,config:o[t]}),Ee.log(` \u5DE5\u5177\u914D\u7F6E\u5DF2\u4FDD\u5B58: ${t}`),!0}function Vd(t,e){let s=Z(t);return s?Fe(t,{...s,output:{...s.output,mode:e}}):!1}function Jd(t,e){let s=Z(t);return s?Fe(t,{...s,apiPreset:e,output:{...s.output,apiPreset:e}}):!1}function Xd(t,e){let s=Z(t);return s?Fe(t,{...s,bypass:{...s.bypass,...e}}):!1}function Qd(t,e){let s=Z(t);return s?Fe(t,{...s,promptTemplate:e}):!1}function $t(t,e,s={}){let r=Z(t);if(!r)return!1;let{touchLastRunAt:o=!1,emitEvent:a=!1,emitRuntimeEvent:n=!0}=s,i=ts({...r.runtime||{},...e||{}});o&&(i.lastRunAt=Date.now());let l=Fe(t,{...r,runtime:i},{emitEvent:a});return l&&n&&P.emit(I.TOOL_RUNTIME_UPDATED,{toolId:t,runtime:i,previousRuntime:ts(r.runtime||{})}),l}function Bi(t,e,s={},r={}){let o=Z(t);if(!o)return!1;let{limit:a=10,emitEvent:n=!1,emitRuntimeEvent:i=!0}=r,l=ts(o.runtime||{}),c=ts(o.runtime||{}),d="recentWritebackHistory",u={id:s?.id||`hist_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,at:s?.at||Date.now(),...s};l[d]=qd([...Array.isArray(l[d])?l[d]:[],u],a),u?.traceId&&(l.lastTraceId=u.traceId);let y=Fe(t,{...o,runtime:l},{emitEvent:n});return y&&i&&P.emit(I.TOOL_RUNTIME_UPDATED,{toolId:t,runtime:l,previousRuntime:c,historyType:e,historyEntry:u}),y}function Ea(t,e,s={}){let{touchLastRunAt:r=!0,emitEvent:o=!1,emitRuntimeEvent:a=!0}=s;return $t(t,e,{touchLastRunAt:r,emitEvent:o,emitRuntimeEvent:a})}function Ui(t){if(!t||!dr[t])return Ee.warn("\u5DE5\u5177\u4E0D\u5B58\u5728:",t),!1;let e=C.get(es)||{};return delete e[t],C.set(es,e),P.emit(I.TOOL_UPDATED,{toolId:t,config:null}),Ee.log(` \u5DE5\u5177\u914D\u7F6E\u5DF2\u91CD\u7F6E: ${t}`),!0}function zi(){return{...dr}}function yr(){let t=new Set([...Object.keys(dr),...Mi().map(([e])=>e)]);return Array.from(t).map(e=>Z(e)).filter(Boolean)}function Ki(){return yr().filter(t=>t&&t.enabled)}function Wi(t,e){let s=C.get(Sa)||{};s[t]={...e,updatedAt:Date.now()},C.set(Sa,s)}function ji(t){return(C.get(Sa)||{})[t]||null}var Ee,es,je,Sa,dr,Ms,Ei,nt,Zd,Dt=z(()=>{ze();fe();re();lo();Ee=B.createScope("ToolRegistry"),es="tool_configs",je="tool_api_bindings",Sa="tool_window_states";dr={summaryTool:{id:"summaryTool",name:"\u6458\u8981\u5DE5\u5177",icon:"fa-file-lines",description:"\u751F\u6210\u5267\u60C5\u6458\u8981\u5757",enabled:!0,order:3,bypass:{enabled:!1,presetId:""},output:{mode:"follow_ai",apiPreset:"",overwrite:!0,enabled:!0},automation:{enabled:!1,settleMs:1200,cooldownMs:5e3},worldbooks:{enabled:!1,selected:[]},extraction:{enabled:!0,maxMessages:5,selectors:["boo_FM"]},promptTemplate:`\u8BF7\u6839\u636E\u4EE5\u4E0BAI\u56DE\u590D\u751F\u6210\u6458\u8981\u5757\uFF1A
...
`).trim()}filterPostResponseTools(e){return Array.isArray(e)?e.filter(s=>this.shouldRunPostResponse(s)):[]}filterAutoPostResponseTools(e){return Array.isArray(e)?e.filter(s=>this.shouldRunPostResponse(s)?s?.automation?.enabled===!0:!1):[]}filterInlineTools(e){return Array.isArray(e)?e.filter(s=>this.shouldRunInline(s)):[]}setDebugMode(e){this.debugMode=e}_log(...e){Ku.debug(e[0],e.length>1?e.slice(1):void 0)}},lt=new vo,Fu=lt});function pl(t={}){return!t||typeof t!="object"?{}:Object.entries(t).reduce((e,[s,r])=>(e[s]=r===!0,e),{})}function Gu(t,e={}){let s=e?.direction==="unescape"?"unescape":"escape",r=pl(e?.options);return Hu.reduce((o,a)=>r[a.key]!==!0?o:s==="unescape"?o.replace(a.escaped,a.unescaped):o.replace(a.plain,a.replacement),String(t||""))}function Yu(t,e={}){if((e?.direction||"en_to_zh")!=="en_to_zh")return String(t||"");let r=pl(e?.options);return qu.reduce((o,a)=>r[a.key]!==!0?o:o.replace(a.from,a.to),String(t||""))}function gl(t,e){let s=t?.processor||{},r=s?.type||"",o=String(e||"");switch(r){case yl.ESCAPE_TRANSFORM:return Gu(o,s);case yl.PUNCTUATION_TRANSFORM:return Yu(o,s);default:return o}}var Hu,qu,yl,fl=z(()=>{Hu=[{key:"newline",plain:/\r\n|\r|\n/g,escaped:/\\n/g,replacement:"\\n",unescaped:`
`},{key:"doubleQuote",plain:/"/g,escaped:/\\"/g,replacement:'\\"',unescaped:'"'},{key:"singleQuote",plain:/'/g,escaped:/\\'/g,replacement:"\\'",unescaped:"'"}],qu=[{key:"comma",from:/,/g,to:"\uFF0C"},{key:"period",from:/\./g,to:"\u3002"},{key:"exclamation",from:/!/g,to:"\uFF01"},{key:"question",from:/\?/g,to:"\uFF1F"},{key:"semicolon",from:/;/g,to:"\uFF1B"},{key:"colon",from:/:/g,to:"\uFF1A"},{key:"leftParen",from:/\(/g,to:"\uFF08"},{key:"rightParen",from:/\)/g,to:"\uFF09"}],yl={ESCAPE_TRANSFORM:"escape_transform",PUNCTUATION_TRANSFORM:"punctuation_transform"}});var Na={};pe(Na,{abortAllTasks:()=>Zu,abortTask:()=>Qu,buildToolMessages:()=>hl,clearExecutionHistory:()=>oy,createExecutionContext:()=>ly,createResult:()=>wo,enhanceMessagesWithBypass:()=>cy,executeBatch:()=>Xu,executeTool:()=>bl,executeToolWithConfig:()=>vl,executeToolsBatch:()=>yy,executorState:()=>ne,extractFailed:()=>iy,extractSuccessful:()=>ny,generateTaskId:()=>ns,getExecutionHistory:()=>ry,getExecutorStatus:()=>sy,getScheduler:()=>Os,mergeResults:()=>ay,pauseExecutor:()=>ey,resumeExecutor:()=>ty,setMaxConcurrent:()=>Ju});function wo(t,e,s,r,o,a,n=0){return{success:s,taskId:t,toolId:e,data:r,error:o,duration:a,retries:n,timestamp:Date.now(),metadata:{}}}function ns(){return`task_${Date.now()}_${Math.random().toString(36).substr(2,9)}`}function Vu(t,e={}){return{id:ns(),toolId:t,options:e,status:"pending",createdAt:Date.now(),startedAt:null,completedAt:null,retries:0,maxRetries:e.maxRetries||3}}function Os(){return Sr||(Sr=new La(ne.maxConcurrent)),Sr}function Ju(t){ne.maxConcurrent=Math.max(1,Math.min(10,t)),Sr&&(Sr.maxConcurrent=ne.maxConcurrent)}async function bl(t,e={},s){let r=Os(),o=Vu(t,e);for(;ne.isPaused;)await new Promise(a=>setTimeout(a,100));try{let a=await r.enqueue(async n=>{if(n.aborted)throw new DOMException("\u4EFB\u52A1\u5DF2\u4E2D\u6B62","AbortError");if(typeof s=="function")return await s(n,e);throw new Error("\u6267\u884C\u5668\u5FC5\u987B\u662F\u4E00\u4E2A\u51FD\u6570")},o);return ml(a),a}catch(a){let n=wo(o.id,t,!1,null,a,Date.now()-o.createdAt,o.retries);return ml(n),n}}async function Xu(t,e={}){let{failFast:s=!1,concurrency:r=ne.maxConcurrent}=e,o=[],a=Os(),n=a.maxConcurrent;a.maxConcurrent=r;try{let i=t.map(({toolId:l,options:c,executor:d})=>bl(l,c,d));if(s)for(let l of i){let c=await l;if(o.push(c),!c.success){a.abortAll();break}}else{let l=await Promise.allSettled(i);for(let c of l)c.status==="fulfilled"?o.push(c.value):o.push(wo(ns(),"unknown",!1,null,c.reason,0,0))}}finally{a.maxConcurrent=n}return o}function Qu(t){return Os().abort(t)}function Zu(){Os().abortAll(),ne.executionQueue=[]}function ey(){ne.isPaused=!0}function ty(){ne.isPaused=!1}function sy(){return{...Os().getStatus(),isPaused:ne.isPaused,activeControllers:ne.activeControllers.size,historyCount:ne.executionHistory.length}}function ml(t){ne.executionHistory.push(t),ne.executionHistory.length>100&&ne.executionHistory.shift()}function ry(t={}){let e=[...ne.executionHistory];return t.toolId&&(e=e.filter(s=>s.toolId===t.toolId)),t.success!==void 0&&(e=e.filter(s=>s.success===t.success)),t.limit&&(e=e.slice(-t.limit)),e}function oy(){ne.executionHistory=[]}function ay(t){let e={success:!0,data:[],errors:[],totalDuration:0,successCount:0,failureCount:0};for(let s of t)e.totalDuration+=s.duration,s.success?(e.successCount++,s.data!==void 0&&s.data!==null&&e.data.push(s.data)):(e.success=!1,e.failureCount++,s.error&&e.errors.push({taskId:s.taskId,toolId:s.toolId,error:s.error.message||String(s.error)}));return e}function ny(t){return t.filter(e=>e.success).map(e=>e.data)}function iy(t){return t.filter(e=>!e.success).map(e=>({taskId:e.taskId,toolId:e.toolId,error:e.error}))}function ly(t={}){return{taskId:ns(),startTime:Date.now(),signal:t.signal||null,apiConfig:t.apiConfig||null,bypassMessages:t.bypassMessages||[],context:t.context||{},metadata:t.metadata||{}}}function cy(t,e){return!e||e.length===0?t:[...e,...t]}function dy(t){return t.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function hl(t,e){let s=[],r=t.promptTemplate||"",o={"{{userMessage}}":e.input?.userMessage||"","{{lastAiMessage}}":e.input?.lastAiMessage||"","{{extractedContent}}":e.input?.extractedContent||"","{{previousToolOutput}}":e.input?.previousToolOutput||"","{{context}}":JSON.stringify(e.input?.context||{}),"{{pg}}":e.input?.context?.pg||"1","{{time}}":e.input?.context?.time||"","{{scene}}":e.input?.context?.scene||"","{{plot}}":e.input?.context?.plot||"","{{mq}}":e.input?.context?.mq||"\u2160","{{mqStatus}}":e.input?.context?.mqStatus||"\u8FDB\u884C\u4E2D","{{sq}}":e.input?.context?.sq||"1","{{sqStatus}}":e.input?.context?.sqStatus||"\u8FDB\u884C\u4E2D","{{latestSq}}":e.input?.context?.latestSq||"1","{{completed}}":e.input?.context?.completed||"\u65E0","{{defined}}":e.input?.context?.defined||"","{{status}}":e.input?.context?.status||"","{{seeds}}":e.input?.context?.seeds||"","{{name}}":e.input?.context?.name||"","{{location}}":e.input?.context?.location||"","{{condition}}":e.input?.context?.condition||"","{{equipment}}":e.input?.context?.equipment||"","{{skills}}":e.input?.context?.skills||""};for(let[a,n]of Object.entries(o))r=r.replace(new RegExp(dy(a),"g"),n);return s.push({role:"USER",content:r}),s}async function vl(t,e,s={}){let r=Z(t);if(!r)return{success:!1,taskId:ns(),toolId:t,error:"\u5DE5\u5177\u914D\u7F6E\u4E0D\u5B58\u5728",duration:0};if(!r.enabled)return{success:!1,taskId:ns(),toolId:t,error:"\u5DE5\u5177\u672A\u542F\u7528",duration:0};let o=Date.now(),a=ns();try{P.emit(I.TOOL_EXECUTION_STARTED,{toolId:t,taskId:a,context:e});let n=hl(r,e);if(typeof s.callApi=="function"){let i=r.output?.apiPreset||r.apiPreset||"",l=i?{preset:i}:null,c=await s.callApi(n,l,s.signal),d=c;r.outputMode==="separate"&&r.extractTags?.length>0&&(d=uy(c,r.extractTags));let u={success:!0,taskId:a,toolId:t,data:d,duration:Date.now()-o};return P.emit(I.TOOL_EXECUTED,{toolId:t,taskId:a,result:u}),u}else return{success:!0,taskId:a,toolId:t,data:{messages:n,config:{apiPreset:r.output?.apiPreset||r.apiPreset||"",outputMode:r.outputMode,extractTags:r.extractTags}},duration:Date.now()-o,needsExecution:!0}}catch(n){let i={success:!1,taskId:a,toolId:t,error:n.message||String(n),duration:Date.now()-o};return P.emit(I.TOOL_EXECUTION_FAILED,{toolId:t,taskId:a,error:n}),i}}function uy(t,e){let s={};for(let r of e){let o=new RegExp(`<${r}[^>]*>([\\s\\S]*?)<\\/${r}>`,"gi"),a=t.match(o);a&&(s[r]=a.map(n=>{let i=n.match(new RegExp(`<${r}[^>]*>([\\s\\S]*?)<\\/${r}>`,"i"));return i?i[1].trim():""}))}return s}async function yy(t,e,s={}){let r=[];for(let o of t){let a=Z(o);if(a&&a.enabled){let n=await vl(o,e,s);r.push(n)}}return r}var ne,La,Sr,Ba=z(()=>{Dt();fe();ne={activeControllers:new Map,executionQueue:[],runningCount:0,maxConcurrent:3,executionHistory:[],isPaused:!1};La=class{constructor(e=3){this.maxConcurrent=e,this.queue=[],this.running=new Map,this.isProcessing=!1}enqueue(e,s){return new Promise((r,o)=>{this.queue.push({executor:e,task:s,resolve:r,reject:o}),this.process()})}async process(){if(!this.isProcessing){for(this.isProcessing=!0;this.queue.length>0&&this.running.size<this.maxConcurrent;){let e=this.queue.shift();if(!e)continue;let{executor:s,task:r,resolve:o,reject:a}=e,n=new AbortController;r.abortController=n,r.status="running",r.startedAt=Date.now(),this.running.set(r.id,r),ne.activeControllers.set(r.id,n),this.executeTask(s,r,n.signal).then(i=>{r.status="completed",r.completedAt=Date.now(),o(i)}).catch(i=>{r.status=i.name==="AbortError"?"aborted":"failed",r.completedAt=Date.now(),a(i)}).finally(()=>{this.running.delete(r.id),ne.activeControllers.delete(r.id),ne.runningCount=this.running.size})}this.isProcessing=!1}}async executeTask(e,s,r){let o=Date.now(),a=null;for(let n=0;n<=s.maxRetries;n++){if(r.aborted)throw new DOMException("\u4EFB\u52A1\u5DF2\u4E2D\u6B62","AbortError");try{let i=await e(r);return wo(s.id,s.toolId,!0,i,null,Date.now()-o,n)}catch(i){if(a=i,i.name==="AbortError")throw i;n<s.maxRetries&&(await this.delay(1e3*(n+1)),s.retries=n+1)}}throw a}delay(e){return new Promise(s=>setTimeout(s,e))}abort(e){let s=ne.activeControllers.get(e);return s?(s.abort(),!0):!1}abortAll(){for(let e of ne.activeControllers.values())e.abort();ne.activeControllers.clear(),this.queue=[],this.running.clear()}getStatus(){return{pending:this.queue.length,running:this.running.size,maxConcurrent:this.maxConcurrent}}},Sr=null});async function gy(){return Ua||(Ua=Promise.resolve().then(()=>(Ba(),Na))),Ua}async function fy(t,e,s){return s&&t.output?.mode===Ge.POST_RESPONSE_API?lt.runToolPostResponse(t,e):s&&t.output?.mode===Ge.FOLLOW_AI?lt.runToolFollowAiManual(t,e):(await gy()).executeToolWithConfig(t.id,e)}function my(t,e){return e?.runSource==="MANUAL"?t.output?.mode==="local_transform"||t.processor?.type?is.MANUAL_LOCAL_TRANSFORM:t.output?.mode===Ge.POST_RESPONSE_API?is.MANUAL_POST_RESPONSE_API:is.MANUAL_COMPATIBILITY:is.MANUAL_POST_RESPONSE_API}function So(t,e){try{Ea(t,e)}catch(s){py.warn("\u66F4\u65B0\u5DE5\u5177\u8FD0\u884C\u65F6\u72B6\u6001\u5931\u8D25:",{toolId:t,error:s})}}function by(t,e,s){let r=String(t||""),o=String(e||"").trim(),a=String(s||"").trim();return!r.trim()||!o?{nextMessageText:"",replaced:!1}:r.includes(o)?{nextMessageText:r.replace(o,a).trim(),replaced:!0}:{nextMessageText:"",replaced:!1}}async function hy(t,e){let s=lt.getExtractionSnapshot(t,e),r=s?.primaryEntry||null,o=String(r?.fullMessageText||e?.lastAiMessage||"").trim(),a=String(r?.extractedText||s?.extractedRawText||s?.extractedText||"").trim(),n=Array.isArray(s?.selectors)?s.selectors:[],i=e?.traceId||`trace_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,l=e?.sessionKey||"";if(!a||!o)return{success:!1,error:"\u672A\u63D0\u53D6\u5230\u53EF\u5904\u7406\u5185\u5BB9\uFF0C\u8BF7\u5148\u68C0\u67E5\u6807\u7B7E\u6216\u6B63\u5219\u89C4\u5219",meta:{traceId:i,sessionKey:l,selectors:n,writebackStatus:de.NOT_APPLICABLE,failureStage:ve.EXTRACT_OUTPUT,extraction:s}};let c=String(gl(t,a)||"").trim(),d=by(o,a,c),u=d.replaced?d.nextMessageText:c,y=null,p=de.NOT_APPLICABLE;if(u){if(y=await Be.injectDetailed(t.id,u,{overwrite:!0,sourceMessageId:e?.sourceMessageId||e?.confirmedAssistantMessageId||e?.messageId||"",sourceSwipeId:e?.sourceSwipeId||e?.confirmedAssistantSwipeId||e?.effectiveSwipeId||"",effectiveSwipeId:e?.effectiveSwipeId||e?.confirmedAssistantSwipeId||"",slotBindingKey:e?.slotBindingKey||"",slotRevisionKey:e?.slotRevisionKey||"",slotTransactionId:e?.slotTransactionId||"",extractionSelectors:[],replaceFullMessage:d.replaced,traceId:i,sessionKey:l}),!y?.success)return{success:!1,error:y?.error||"\u672C\u5730\u5904\u7406\u5B8C\u6210\uFF0C\u4F46\u5199\u56DE\u5931\u8D25",meta:{traceId:i,sessionKey:l,selectors:n,writebackStatus:de.FAILED,failureStage:ve.INJECT_CONTEXT,writebackDetails:y,extraction:s}};p=de.SUCCESS}else p=de.SKIPPED_EMPTY_OUTPUT;return{success:!0,output:c,meta:{traceId:i,sessionKey:l,selectors:n,writebackStatus:p,failureStage:"",writebackDetails:y,extraction:s}}}async function vy(t,e){let s=Date.now(),r=t.id,o=`yyt-tool-run-${r}`,a=my(t,e),n=e?.executionKey||"";So(r,{lastStatus:"running",lastError:"",lastDurationMs:0,lastTraceId:e?.traceId||"",lastMessageKey:e?.messageId||"",lastExecutionKey:n,lastExecutionPath:a,lastWritebackStatus:"",lastFailureStage:"",lastSlotBindingKey:e?.slotBindingKey||"",lastSlotRevisionKey:e?.slotRevisionKey||"",lastSlotTransactionId:e?.slotTransactionId||"",lastSourceMessageId:e?.sourceMessageId||e?.messageId||"",lastSourceSwipeId:e?.sourceSwipeId||e?.effectiveSwipeId||"",lastContentCommitted:!1,lastHostCommitApplied:!1,lastRefreshRequested:!1,lastRefreshConfirmed:!1,lastPreferredCommitMethod:"",lastAppliedCommitMethod:"",lastRefreshMethodCount:0,lastRefreshMethods:[],lastRefreshConfirmChecks:0,lastRefreshConfirmedBy:""}),we("info",`\u6B63\u5728\u624B\u52A8\u6267\u884C ${t.name}`,{sticky:!0,noticeId:o});try{let i=a===is.MANUAL_LOCAL_TRANSFORM?await hy(t,e):await fy(t,e,!0),l=Date.now()-s;if(i?.success){let y=Z(r),p=i?.meta?.writebackDetails||{};return So(r,{lastStatus:"success",lastError:"",lastDurationMs:l,lastTraceId:e?.traceId||"",successCount:(y?.runtime?.successCount||0)+1,lastMessageKey:e?.messageId||"",lastExecutionKey:n,lastExecutionPath:a,lastWritebackStatus:i?.meta?.writebackStatus||de.NOT_APPLICABLE,lastFailureStage:i?.meta?.failureStage||"",lastSlotBindingKey:e?.slotBindingKey||"",lastSlotRevisionKey:e?.slotRevisionKey||"",lastSlotTransactionId:e?.slotTransactionId||"",lastSourceMessageId:e?.sourceMessageId||e?.messageId||"",lastSourceSwipeId:e?.sourceSwipeId||e?.effectiveSwipeId||"",lastContentCommitted:!!p.contentCommitted,lastHostCommitApplied:!!p.hostCommitApplied,lastRefreshRequested:!!p.refreshRequested,lastRefreshConfirmed:!!p.refreshConfirmed,lastPreferredCommitMethod:p?.commit?.preferredMethod||"",lastAppliedCommitMethod:p?.commit?.appliedMethod||"",lastRefreshMethodCount:Array.isArray(p?.refresh?.requestMethods)?p.refresh.requestMethods.length:0,lastRefreshMethods:Array.isArray(p?.refresh?.requestMethods)?[...p.refresh.requestMethods]:[],lastRefreshConfirmChecks:Number(p?.refresh?.confirmChecks)||0,lastRefreshConfirmedBy:p?.refresh?.confirmedBy||""}),S("success",`${t.name} \u624B\u52A8\u6267\u884C\u5B8C\u6210`),we("success",`${t.name} \u624B\u52A8\u6267\u884C\u5B8C\u6210`,{duration:3200,noticeId:o}),{success:!0,duration:l,result:i}}let c=Z(r),d=i?.error||"\u5DE5\u5177\u6267\u884C\u5931\u8D25",u=i?.meta?.writebackDetails||{};return So(r,{lastStatus:"error",lastError:d,lastDurationMs:l,lastTraceId:e?.traceId||"",errorCount:(c?.runtime?.errorCount||0)+1,lastMessageKey:e?.messageId||"",lastExecutionKey:n,lastExecutionPath:a,lastWritebackStatus:i?.meta?.writebackStatus||de.NOT_APPLICABLE,lastFailureStage:i?.meta?.failureStage||(a===is.MANUAL_COMPATIBILITY?ve.COMPATIBILITY_EXECUTE:ve.UNKNOWN),lastSlotBindingKey:e?.slotBindingKey||"",lastSlotRevisionKey:e?.slotRevisionKey||"",lastSlotTransactionId:e?.slotTransactionId||"",lastSourceMessageId:e?.sourceMessageId||e?.messageId||"",lastSourceSwipeId:e?.sourceSwipeId||e?.effectiveSwipeId||"",lastContentCommitted:!!u.contentCommitted,lastHostCommitApplied:!!u.hostCommitApplied,lastRefreshRequested:!!u.refreshRequested,lastRefreshConfirmed:!!u.refreshConfirmed,lastPreferredCommitMethod:u?.commit?.preferredMethod||"",lastAppliedCommitMethod:u?.commit?.appliedMethod||"",lastRefreshMethodCount:Array.isArray(u?.refresh?.requestMethods)?u.refresh.requestMethods.length:0,lastRefreshMethods:Array.isArray(u?.refresh?.requestMethods)?[...u.refresh.requestMethods]:[],lastRefreshConfirmChecks:Number(u?.refresh?.confirmChecks)||0,lastRefreshConfirmedBy:u?.refresh?.confirmedBy||""}),S("error",`${t.name} \u6267\u884C\u5931\u8D25\uFF1A${d}`),we("error",`${t.name} \u6267\u884C\u5931\u8D25\uFF1A${d}`,{sticky:!0,noticeId:o}),{success:!1,duration:l,error:d,result:i}}catch(i){let l=Date.now()-s,c=Z(r),d=i?.message||String(i);throw So(r,{lastStatus:"error",lastError:d,lastDurationMs:l,lastTraceId:e?.traceId||"",errorCount:(c?.runtime?.errorCount||0)+1,lastMessageKey:e?.messageId||"",lastExecutionKey:n,lastExecutionPath:a,lastWritebackStatus:de.NOT_APPLICABLE,lastFailureStage:a===is.MANUAL_COMPATIBILITY?ve.COMPATIBILITY_EXECUTE:ve.UNKNOWN,lastSlotBindingKey:e?.slotBindingKey||"",lastSlotRevisionKey:e?.slotRevisionKey||"",lastSlotTransactionId:e?.slotTransactionId||"",lastSourceMessageId:e?.sourceMessageId||e?.messageId||"",lastSourceSwipeId:e?.sourceSwipeId||e?.effectiveSwipeId||"",lastContentCommitted:!1,lastHostCommitApplied:!1,lastRefreshRequested:!1,lastRefreshConfirmed:!1,lastPreferredCommitMethod:"",lastAppliedCommitMethod:"",lastRefreshMethodCount:0,lastRefreshMethods:[],lastRefreshConfirmChecks:0,lastRefreshConfirmedBy:""}),S("error",`${t.name} \u6267\u884C\u5931\u8D25\uFF1A${d}`),we("error",`${t.name} \u6267\u884C\u5931\u8D25\uFF1A${d}`,{sticky:!0,noticeId:o}),i}}async function To(t){if(!t)return{success:!1,error:"\u7F3A\u5C11\u5DE5\u5177ID"};let e=Z(t);if(!e)return{success:!1,error:"\u5DE5\u5177\u4E0D\u5B58\u5728"};if(!e.enabled)return $t(t,{lastMessageKey:"",lastExecutionKey:"",lastExecutionPath:"",lastWritebackStatus:de.NOT_APPLICABLE,lastFailureStage:"",lastContentCommitted:!1,lastHostCommitApplied:!1,lastRefreshRequested:!1,lastRefreshConfirmed:!1,lastPreferredCommitMethod:"",lastAppliedCommitMethod:"",lastRefreshMethodCount:0,lastRefreshMethods:[],lastRefreshConfirmChecks:0,lastRefreshConfirmedBy:""},{touchLastRunAt:!1,emitEvent:!1}),we("warning",`${e.name} \u672A\u542F\u7528\uFF0C\u65E0\u6CD5\u624B\u52A8\u6267\u884C`,{duration:2800,noticeId:`yyt-tool-run-${t}`}),{success:!1,error:"\u5DE5\u5177\u672A\u542F\u7528"};let s=await rs({runSource:"MANUAL"});return vy(e,s)}async function _o(t){if(!t)return{success:!1,error:"\u7F3A\u5C11\u5DE5\u5177ID"};let e=Z(t);if(!e)return{success:!1,error:"\u5DE5\u5177\u4E0D\u5B58\u5728"};let s=await rs({runSource:"MANUAL_PREVIEW"});return lt.previewExtraction(e,s)}var py,is,Ua,za=z(()=>{Dt();xo();Is();os();fl();Se();re();py=B.createScope("ToolTrigger"),is={MANUAL_POST_RESPONSE_API:"manual_post_response_api",MANUAL_LOCAL_TRANSFORM:"manual_local_transform",MANUAL_COMPATIBILITY:"manual_compatibility"},Ua=null});var xl={};pe(xl,{TOOL_CONFIG_PANEL_STYLES:()=>Ls,createToolConfigPanel:()=>Ot,default:()=>xy});function Ot(t){let{id:e,toolId:s,postResponseHint:r,extractionPlaceholder:o,previewDialogId:a,previewTitle:n="\u6D4B\u8BD5\u63D0\u53D6\u7ED3\u679C",toolKindLabel:i="AI \u5DE5\u5177"}=t;return{id:e,toolId:s,renderSessionId:0,_beginRenderSession(l){return this.renderSessionId=(this.renderSessionId||0)+1,N(l)&&l.data("yytRenderSessionId",this.renderSessionId),this.renderSessionId},_isRenderSessionActive(l,c){return N(l)&&l.data("yytRenderSessionId")===c},_renderIfSessionActive(l,c){return this._isRenderSessionActive(l,c)?(this.renderTo(l),!0):!1},render(){let l=Z(this.toolId);if(!l)return'<div class="yyt-error">\u5DE5\u5177\u914D\u7F6E\u52A0\u8F7D\u5931\u8D25</div>';let c=this._getApiPresets(),d=l.output?.apiPreset||l.apiPreset||"",u=this._getBypassPresets(),y=l.output?.mode||"follow_ai",p=l.bypass?.enabled||!1,g=l.bypass?.presetId||"",x=l.runtime?.lastStatus||"idle",b=l.runtime?.lastRunAt?new Date(l.runtime.lastRunAt).toLocaleString():"\u672A\u8FD0\u884C",T=l.runtime?.lastError||"",A=l.extraction||{},w=l.automation||{},L=l.worldbooks||{},M=Array.isArray(this.draftSelectedWorldbooks)?this.draftSelectedWorldbooks:Array.isArray(L.selected)?L.selected:[],k=Array.isArray(this.availableWorldbooks)?this.availableWorldbooks:[],R=String(this.worldbookFilter||"").trim().toLowerCase(),ee=R?k.filter(se=>String(se||"").toLowerCase().includes(R)):k,Y=M.length===0?"\u9009\u62E9\u8981\u6CE8\u5165\u7684\u4E16\u754C\u4E66":M.length<=2?M.join("\u3001"):`\u5DF2\u9009 ${M.length} \u9879\uFF1A${M.slice(0,2).join("\u3001")} \u7B49`,U=Array.isArray(A.selectors)?A.selectors.join(`
`):"",J=y==="post_response_api"?r:"\u968F AI \u8F93\u51FA\u6A21\u5F0F\u4E0D\u4F1A\u989D\u5916\u8BF7\u6C42\u6A21\u578B\uFF0C\u4F46\u4ECD\u7136\u652F\u6301\u624B\u52A8\u6267\u884C\u4E0E\u6D4B\u8BD5\u63D0\u53D6\u3002",ke=y==="post_response_api"?"\u989D\u5916\u89E3\u6790":"\u968F AI \u8F93\u51FA",be=y==="post_response_api",Ce=d||"\u5F53\u524D\u914D\u7F6E";return`
        <div class="yyt-tool-panel" data-tool-id="${this.toolId}">
          ...
          <div class="yyt-panel-section">
            ...
            <div class="yyt-form-group">
              ...
              <div class="yyt-tool-compact-hint yyt-tool-mode-hint">${J}${be?" \u5F53\u524D\u6A21\u5F0F\u4F1A\u53C2\u4E0E\u81EA\u52A8\u89E6\u53D1\uFF0C\u4ECD\u9700\u5728\u5168\u5C40\u8BBE\u7F6E\u4E2D\u5F00\u542F\u81EA\u52A8\u5316\u3002":""}</div>
            </div>
          </div>
          ...
          <div class="yyt-panel-section">
            ...
            <div class="yyt-form-group">
              ...
              <div class="yyt-worldbook-select" id="${m}-tool-worldbook-select">
                <div class="yyt-worldbook-summary">${v(Y)}</div>
                <div class="yyt-worldbook-dropdown" id="${m}-tool-worldbook-dropdown">
                  ...
                  ${this.worldbookLoadState!=="ready"?`
                    <details class="yyt-worldbook-diagnostics">
                      ...
                      <pre class="yyt-preview-box yyt-preview-pre">${v(JSON.stringify(Zi()||{state:this.worldbookLoadState||"idle",message:"\u5C1A\u672A\u751F\u6210\u8BCA\u65AD\u4FE1\u606F"},null,2))}</pre>
                    </details>
                  `:""}
                </div>
              </div>
...
`)||"\u65E0")}</div>
      ...
      `).join(""):'<div class="yyt-tool-compact-hint yyt-worldbook-empty">\u672A\u627E\u5230\u5339\u914D\u4E16\u754C\u4E66\u3002</div>');let b=p.length===0?"\u9009\u62E9\u8981\u6CE8\u5165\u7684\u4E16\u754C\u4E66":p.length<=2?p.join("\u3001"):`\u5DF2\u9009 ${p.length} \u9879\uFF1A${p.slice(0,2).join("\u3001")} \u7B49`;l.find(".yyt-worldbook-summary").text(b)}}}var Ls,xy,ls=z(()=>{Se();Dt();Pa();rr();br();za();Ls=`
  .yyt-tool-panel {
    display: flex;
    flex-direction: column;
    gap: 16px;
...
`;xy=Ot});var cs,Ka=z(()=>{ls();cs=Ot({id:"summaryToolPanel",toolId:"summaryTool",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u8FDB\u884C\u6458\u8981\u89E3\u6790\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 boo_FM
\u6216 regex:<boo_FM>([\\s\\S]*?)</boo_FM>`,previewDialogId:"summary-extraction-preview",defaultInjectionOrder:1e4,lorebookLogTag:"SummaryToolPanel"})});var ds,Wa=z(()=>{ls();ds=Ot({id:"statusBlockPanel",toolId:"statusBlock",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u751F\u6210\u4E3B\u89D2\u72B6\u6001\u680F\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 status_block
\u6216 regex:<status_block>([\\s\\S]*?)</status_block>`,previewDialogId:"status-extraction-preview",defaultInjectionOrder:10001,lorebookLogTag:"StatusBlockPanel"})});var us,ja=z(()=>{ls();us=Ot({id:"youyouReviewPanel",toolId:"youyouReview",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u5728\u672B\u5C3E\u751F\u6210\u5C0F\u5E7D\u70B9\u8BC4\u4E0E\u5267\u60C5\u94A9\u5B50\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 youyou
\u6216 regex:<youyou>([\\s\\S]*?)</youyou>`,previewDialogId:"youyou-review-extraction-preview",previewTitle:"\u5C0F\u5E7D\u70B9\u8BC4\u63D0\u53D6\u9884\u89C8"})});function wl(t=[],e={}){return t.map(s=>({...s,checked:e?.[s.key]===!0}))}function Ao(t){let{id:e,toolId:s,previewDialogId:r,previewTitle:o="\u6D4B\u8BD5\u63D0\u53D6\u7ED3\u679C",processorDirections:a=[],processorOptions:n=[],heroHint:i="",extractionPlaceholder:l=""}=t;return{id:e,toolId:s,renderSessionId:0,_beginRenderSession(c){return this.renderSessionId=(this.renderSessionId||0)+1,N(c)&&c.data("yytRenderSessionId",this.renderSessionId),this.renderSessionId},_isRenderSessionActive(c,d){return N(c)&&c.data("yytRenderSessionId")===d},_renderIfSessionActive(c,d){return this._isRenderSessionActive(c,d)?(this.renderTo(c),!0):!1},render(){let c=Z(this.toolId);if(!c)return'<div class="yyt-error">\u5DE5\u5177\u914D\u7F6E\u52A0\u8F7D\u5931\u8D25</div>';let d=c.processor||{},u=c.extraction||{},y=c.runtime?.lastStatus||"idle",p=c.runtime?.lastRunAt?new Date(c.runtime.lastRunAt).toLocaleString():"\u672A\u8FD0\u884C",g=c.runtime?.lastError||"",x=Array.isArray(u.selectors)?u.selectors.join(`
`):"",b=c.output?.overwrite!==!1,T=wl(a,{[d.direction||a[0]?.key||""]:!0}),A=wl(n,d.options||{});return`
        <div class="yyt-tool-panel" data-tool-id="${this.toolId}">
          <div class="yyt-tool-panel-hero">
            <div class="yyt-tool-panel-hero-copy">
...
`});var ys,Ha=z(()=>{Fa();ys=Ao({id:"escapeTransformToolPanel",toolId:"escapeTransformTool",previewDialogId:"escape-transform-extraction-preview",previewTitle:"\u8F6C\u4E49\u5904\u7406\u63D0\u53D6\u9884\u89C8",heroHint:"\u4ECE\u6700\u8FD1 AI \u6D88\u606F\u63D0\u53D6\u6587\u672C\u540E\uFF0C\u5728\u672C\u5730\u6267\u884C\u8F6C\u4E49\u6216\u53BB\u8F6C\u4E49\uFF0C\u518D\u6309\u6240\u9009\u65B9\u5F0F\u5199\u56DE\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\u6216\u6B63\u5219\uFF0C\u4F8B\u5982\uFF1A
content
regex:<content>([\\s\\S]*?)</content>`,processorDirections:[{key:"escape",label:"\u8F6C\u4E49",description:"\u628A\u539F\u59CB\u5B57\u7B26\u8F6C\u6362\u6210\u8F6C\u4E49\u5E8F\u5217\u3002"},{key:"unescape",label:"\u53BB\u8F6C\u4E49",description:"\u628A\u8F6C\u4E49\u5E8F\u5217\u8FD8\u539F\u6210\u539F\u59CB\u5B57\u7B26\u3002"}],processorOptions:[{key:"doubleQuote",label:"\u53CC\u5F15\u53F7",description:'\u5904\u7406 " \u4E0E \\"\u3002'},{key:"singleQuote",label:"\u5355\u5F15\u53F7",description:"\u5904\u7406 ' \u4E0E \\'\u3002"},{key:"newline",label:"\u6362\u884C\u7B26",description:"\u5904\u7406\u6362\u884C\u4E0E \\n\u3002"}]})});var ps,qa=z(()=>{Fa();ps=Ao({id:"punctuationTransformToolPanel",toolId:"punctuationTransformTool",previewDialogId:"punctuation-transform-extraction-preview",previewTitle:"\u4E2D\u6587\u6807\u70B9\u66FF\u6362\u63D0\u53D6\u9884\u89C8",heroHint:"\u4ECE\u6700\u8FD1 AI \u6D88\u606F\u63D0\u53D6\u6587\u672C\u540E\uFF0C\u5728\u672C\u5730\u628A\u82F1\u6587\u6807\u70B9\u66FF\u6362\u6210\u4E2D\u6587\u6807\u70B9\uFF0C\u518D\u6309\u6240\u9009\u65B9\u5F0F\u5199\u56DE\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\u6216\u6B63\u5219\uFF0C\u4F8B\u5982\uFF1A
content
regex:<content>([\\s\\S]*?)</content>`,processorDirections:[{key:"en_to_zh",label:"\u82F1\u6587\u8F6C\u4E2D\u6587",description:"\u6309\u52FE\u9009\u9879\u628A\u82F1\u6587\u6807\u70B9\u66FF\u6362\u4E3A\u4E2D\u6587\u6807\u70B9\u3002"}],processorOptions:[{key:"comma",label:"\u9017\u53F7 ,",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u9017\u53F7\u3002"},{key:"period",label:"\u53E5\u53F7 .",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u53E5\u53F7\u3002"},{key:"exclamation",label:"\u611F\u53F9\u53F7 !",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u611F\u53F9\u53F7\u3002"},{key:"question",label:"\u95EE\u53F7 ?",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u95EE\u53F7\u3002"},{key:"semicolon",label:"\u5206\u53F7 ;",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5206\u53F7\u3002"},{key:"colon",label:"\u5192\u53F7 :",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5192\u53F7\u3002"},{key:"leftParen",label:"\u5DE6\u62EC\u53F7 (",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5DE6\u62EC\u53F7\u3002"},{key:"rightParen",label:"\u53F3\u62EC\u53F7 )",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u53F3\u62EC\u53F7\u3002"}]})});var gs,Ga=z(()=>{fe();br();Se();gs={id:"bypassPanel",_getActivePresetId(t){return t.find(".yyt-bypass-editor-content").data("presetId")||null},render(t){let e=F.getPresetList(),s=F.getDefaultPresetId();return`
    ...
    `},renderTo(t){let e=this.render({});t.html(e),this.bindEvents(t,{})}}});var El={};pe(El,{SettingsPanel:()=>wt,applyTheme:()=>Al,applyUiPreferences:()=>Ya,default:()=>Ty});function Ns({id:t,checked:e=!1,title:s="",hint:r=""}){return`
    <div class="yyt-toggle-row">
      <div class="yyt-toggle-label">
        <span>${s}</span>
  ...
  `}function Tl(){try{if(typeof window.parent<"u"&&window.parent&&window.parent!==window)return window.parent}catch{}return window}function Tr(){return Tl()?.document||document}function _l(t=Tr()){return t?.documentElement||document.documentElement}function Al(t,e=Tr()){let s=_l(e),r={...Sy,...Sl[t]||Sl["dark-blue"]};Object.entries(r).forEach(([o,a])=>{s.style.setProperty(o,a)}),s.setAttribute("data-yyt-theme",t)}function Ya(t={},e=Tr()){let s=_l(e),{theme:r="dark-blue",compactMode:o=!1,animationEnabled:a=!0}=t||{};Al(r,e),s.classList.toggle("yyt-compact-mode",!!o),s.classList.toggle("yyt-no-animation",!a)}var Sy,Sl,wt,Ty,Eo=z(()=>{fe();vr();re();wr();Se();Sy={"--yyt-accent":"#7bb7ff","--yyt-accent-glow":"rgba(123, 183, 255, 0.4)","--yyt-accent-soft":"rgba(123, 183, 255, 0.15)","--yyt-accent-strong":"#a5d4ff","--yyt-bg-base":"#0b0f15","--yyt-bg-gradient-1":"rgba(123, 183, 255, 0.12)","--yyt-bg-gradient-2":"rgba(155, 123, 255, 0.10)","--yyt-surface":"rgba(255, 255, 255, 0.03)","--yyt-surface-2":"rgba(255, 255, 255, 0.05)","--yyt-surface-3":"rgba(255, 255, 255, 0.075)","--yyt-surface-hover":"rgba(255, 255, 255, 0.08)","--yyt-surface-active":"rgba(255, 255, 255, 0.11)","--yyt-border":"rgba(255, 255, 255, 0.08)","--yyt-border-soft":"rgba(255, 255, 255, 0.05)","--yyt-border-strong":"rgba(255, 255, 255, 0.16)","--yyt-text":"rgba(255, 255, 255, 0.95)","--yyt-text-secondary":"rgba(255, 255, 255, 0.72)","--yyt-text-muted":"rgba(255, 255, 255, 0.5)","--yyt-focus-ring":"0 0 0 3px rgba(123, 183, 255, 0.18)","--yyt-on-accent":"#0b0f15","--yyt-control-bg":"linear-gradient(180deg, #1d2737 0%, #151d2a 100%)","--yyt-control-bg-hover":"linear-gradient(180deg, #243247 0%, #1a2638 100%)","--yyt-control-bg-active":"linear-gradient(180deg, #2a3951 0%, #1d2b3f 100%)","--yyt-control-bg-strong":"linear-gradient(180deg, #243247 0%, #192435 100%)","--yyt-control-bg-focus":"linear-gradient(180deg, #243a57 0%, #1a2a3f 100%)","--yyt-control-border":"rgba(146, 173, 212, 0.24)","--yyt-control-border-hover":"rgba(146, 173, 212, 0.36)","--yyt-control-border-focus":"rgba(123, 183, 255, 0.72)","--yyt-control-shadow":"0 12px 24px rgba(0, 0, 0, 0.24), inset 0 1px 0 rgba(255, 255, 255, 0.04)","--yyt-control-shadow-hover":"0 16px 28px rgba(0, 0, 0, 0.28), inset 0 1px 0 rgba(255, 255, 255, 0.06)","--yyt-control-shadow-focus":"0 18px 30px rgba(8, 14, 24, 0.32), inset 0 1px 0 rgba(255, 255, 255, 0.06)","--yyt-control-shadow-active":"0 10px 20px rgba(0, 0, 0, 0.22), inset 0 1px 0 rgba(255, 255, 255, 0.04)","--yyt-select-surface":"#121a26","--yyt-select-option-bg":"#192334","--yyt-select-option-hover-bg":"#233249","--yyt-select-option-selected-bg":"#2a3f60","--yyt-select-option-border":"rgba(123, 183, 255, 0.22)","--yyt-select-option-selected-border":"rgba(123, 183, 255, 0.4)","--yyt-select-dropdown-shadow":"0 24px 44px rgba(0, 0, 0, 0.52), 0 0 0 1px rgba(8, 12, 18, 0.82)","--yyt-select-arrow-color":"rgba(255, 255, 255, 0.52)"},Sl={"dark-blue":{"--yyt-on-accent":"#0b0f15"},"dark-purple":{"--yyt-accent":"#a78bfa","--yyt-accent-glow":"rgba(167, 139, 250, 0.4)","--yyt-accent-soft":"rgba(167, 139, 250, 0.15)","--yyt-accent-strong":"#c4b5fd","--yyt-bg-base":"#0f0b15","--yyt-bg-gradient-1":"rgba(167, 139, 250, 0.12)","--yyt-bg-gradient-2":"rgba(123, 183, 255, 0.10)","--yyt-on-accent":"#120b1f"},"dark-green":{"--yyt-accent":"#4ade80","--yyt-accent-glow":"rgba(74, 222, 128, 0.4)","--yyt-accent-soft":"rgba(74, 222, 128, 0.15)","--yyt-accent-strong":"#86efac","--yyt-bg-base":"#0b150f","--yyt-bg-gradient-1":"rgba(74, 222, 128, 0.12)","--yyt-bg-gradient-2":"rgba(123, 183, 255, 0.10)","--yyt-on-accent":"#0b150f"},light:{"--yyt-accent":"#3b82f6","--yyt-accent-glow":"rgba(59, 130, 246, 0.3)","--yyt-accent-soft":"rgba(59, 130, 246, 0.1)","--yyt-accent-strong":"#93c5fd","--yyt-bg-base":"#f8fafc","--yyt-bg-gradient-1":"rgba(59, 130, 246, 0.08)","--yyt-bg-gradient-2":"rgba(139, 92, 246, 0.06)","--yyt-text":"rgba(15, 23, 42, 0.95)","--yyt-text-secondary":"rgba(15, 23, 42, 0.72)","--yyt-text-muted":"rgba(15, 23, 42, 0.52)","--yyt-surface":"rgba(255, 255, 255, 0.66)","--yyt-surface-2":"rgba(255, 255, 255, 0.86)","--yyt-surface-3":"rgba(255, 255, 255, 0.94)","--yyt-surface-hover":"rgba(255, 255, 255, 0.92)","--yyt-surface-active":"rgba(255, 255, 255, 0.98)","--yyt-border":"rgba(15, 23, 42, 0.08)","--yyt-border-soft":"rgba(15, 23, 42, 0.05)","--yyt-border-strong":"rgba(15, 23, 42, 0.14)","--yyt-focus-ring":"0 0 0 3px rgba(59, 130, 246, 0.14)","--yyt-on-accent":"#0f172a","--yyt-control-bg":"linear-gradient(180deg, rgba(255, 255, 255, 0.98) 0%, rgba(241, 245, 249, 0.98) 100%)","--yyt-control-bg-hover":"linear-gradient(180deg, rgba(255, 255, 255, 1) 0%, rgba(226, 232, 240, 0.98) 100%)","--yyt-control-bg-active":"linear-gradient(180deg, rgba(239, 246, 255, 1) 0%, rgba(219, 234, 254, 0.98) 100%)","--yyt-control-bg-strong":"linear-gradient(180deg, rgba(255, 255, 255, 1) 0%, rgba(241, 245, 249, 0.98) 100%)","--yyt-control-bg-focus":"linear-gradient(180deg, rgba(239, 246, 255, 1) 0%, rgba(219, 234, 254, 0.98) 100%)","--yyt-control-border":"rgba(59, 130, 246, 0.18)","--yyt-control-border-hover":"rgba(59, 130, 246, 0.28)","--yyt-control-border-focus":"rgba(59, 130, 246, 0.58)","--yyt-control-shadow":"0 10px 22px rgba(15, 23, 42, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.75)","--yyt-control-shadow-hover":"0 12px 24px rgba(15, 23, 42, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.85)","--yyt-control-shadow-focus":"0 14px 26px rgba(59, 130, 246, 0.14), inset 0 1px 0 rgba(255, 255, 255, 0.9)","--yyt-control-shadow-active":"0 8px 18px rgba(15, 23, 42, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.85)","--yyt-select-surface":"#ffffff","--yyt-select-option-bg":"#f8fafc","--yyt-select-option-hover-bg":"#eff6ff","--yyt-select-option-selected-bg":"#dbeafe","--yyt-select-option-border":"rgba(59, 130, 246, 0.16)","--yyt-select-option-selected-border":"rgba(59, 130, 246, 0.34)","--yyt-select-dropdown-shadow":"0 18px 32px rgba(15, 23, 42, 0.12), 0 0 0 1px rgba(148, 163, 184, 0.18)","--yyt-select-arrow-color":"rgba(15, 23, 42, 0.45)"}};wt={id:"settingsPanel",render(){let t=He.getSettings(),e=t.debug?.enableDebugLog===!0,s=t.automation?.enabled===!0,r=this._getAutomationRuntime();return`
    ...
    `},_renderDebugTab(t){return`
      <div class="yyt-settings-tab-content" data-tab="debug">
        <div class="yyt-settings-section">
          ...
          <div class="yyt-form-group">
            ${Ns({id:"yyt-setting-enableDebugLog",checked:t.enableDebugLog,title:"\u542F\u7528\u8C03\u8BD5\u65E5\u5FD7",hint:"\u5F00\u542F\u540E Logger \u9762\u677F\u5C06\u8BB0\u5F55 DEBUG \u7EA7\u522B\u65E5\u5FD7\uFF0C\u5173\u95ED\u4EC5\u8BB0\u5F55 INFO \u53CA\u4EE5\u4E0A"})}
          </div>
    ...
    `},_renderMacroList(){return qe.getAvailableVariables().map(t=>`
      ...
      `).join("")},bindEvents(t){let e=$();if(!e||!N(t))return;let s=this;t.off(".yytSettings"),t.on("click.yytSettings",".yyt-settings-tab",o=>{let a=e(o.currentTarget).data("tab");t.find(".yyt-settings-tab").removeClass("yyt-active"),e(o.currentTarget).addClass("yyt-active"),t.find(".yyt-settings-tab-content").removeClass("yyt-active"),t.find(`.yyt-settings-tab-content[data-tab="${a}"]`).addClass("yyt-active")}),t.on("click.yytSettings","#yyt-settings-save",()=>{s._saveSettings(t)}),t.on("click.yytSettings","#yyt-settings-reset",()=>{confirm("\u786E\u5B9A\u8981\u91CD\u7F6E\u6240\u6709\u8BBE\u7F6E\u4E3A\u9ED8\u8BA4\u503C\u5417\uFF1F")&&(He.resetSettings(),Ya(hr.ui,Tr()),s.renderTo(t),S("success","\u8BBE\u7F6E\u5DF2\u91CD\u7F6E"))}),Ae(t,{namespace:"yytSettingsSelect",selectors:["#yyt-setting-queueStrategy","#yyt-setting-theme"]});let r=He.getDebugSettings();B.setLevel(r.enableDebugLog?G.DEBUG:G.INFO)},_saveSettings(t){let e={executor:{maxConcurrent:parseInt(t.find("#yyt-setting-maxConcurrent").val(),10)||3,maxRetries:parseInt(t.find("#yyt-setting-maxRetries").val(),10)||2,retryDelayMs:parseInt(t.find("#yyt-setting-retryDelayMs").val(),10)||5e3,requestTimeoutMs:parseInt(t.find("#yyt-setting-requestTimeoutMs").val(),10)||9e4,queueStrategy:t.find("#yyt-setting-queueStrategy").val()||"fifo"},automation:{enabled:t.find("#yyt-setting-automationEnabled").is(":checked"),settleMs:parseInt(t.find("#yyt-setting-automationSettleMs").val(),10)||1200,cooldownMs:parseInt(t.find("#yyt-setting-automationCooldownMs").val(),10)||5e3,maxConcurrentSlots:He.getSettings()?.automation?.maxConcurrentSlots||1},debug:{enableDebugLog:t.find("#yyt-setting-enableDebugLog").is(":checked"),saveExecutionHistory:t.find("#yyt-setting-saveExecutionHistory").is(":checked"),showRuntimeBadge:t.find("#yyt-setting-showRuntimeBadge").is(":checked")},ui:{theme:t.find("#yyt-setting-theme").val()||"dark-blue",compactMode:t.find("#yyt-setting-compactMode").is(":checked"),animationEnabled:t.find("#yyt-setting-animationEnabled").is(":checked")}};He.saveSettings(e),B.setLevel(e.debug.enableDebugLog?G.DEBUG:G.INFO),Ya(e.ui,Tr()),S("success","\u8BBE\u7F6E\u5DF2\u4FDD\u5B58")},_getAutomationRuntime(){try{return Tl()?.YouYouToolkit?.getAutomationRuntime?.()||null}catch{return null}},destroy(t){!$()||!N(t)||(me(t,"yytSettingsSelect"),t.off(".yytSettings"))},getStyles(){return`
      /* \u8BBE\u7F6E\u9762\u677F\u6837\u5F0F */
      .yyt-settings-panel {
        display: flex;
        flex-direction: column;
    ...
    `},renderTo(t){t.html(this.render({})),this.bindEvents(t,{})}},Ty=wt});function ie(t){return t==null?"":String(t).trim()}function Me(t){if(t!==void 0)try{return JSON.parse(JSON.stringify(t))}catch{return t}}function Bs(t={}){return{chatId:ie(t.chatId),sourceMessageId:ie(t.sourceMessageId||t.messageId),sourceSwipeId:ie(t.sourceSwipeId||t.effectiveSwipeId),effectiveSwipeId:ie(t.effectiveSwipeId||t.sourceSwipeId),slotBindingKey:ie(t.slotBindingKey),slotRevisionKey:ie(t.slotRevisionKey),slotTransactionId:ie(t.slotTransactionId),traceId:ie(t.traceId),resolvedAt:Number.isFinite(t.resolvedAt)?t.resolvedAt:Date.now()}}function Va(t={}){return{resolvedAt:Number.isFinite(t.resolvedAt)?t.resolvedAt:Date.now(),runSource:ie(t.runSource)||ct.MANUAL,traceId:ie(t.traceId),chatId:ie(t.chatId),sourceMessageId:ie(t.sourceMessageId||t.messageId),sourceSwipeId:ie(t.sourceSwipeId||t.effectiveSwipeId),effectiveSwipeId:ie(t.effectiveSwipeId||t.sourceSwipeId)||"swipe:current",slotBindingKey:ie(t.slotBindingKey),slotRevisionKey:ie(t.slotRevisionKey),slotTransactionId:ie(t.slotTransactionId),assistantContentFingerprint:ie(t.assistantContentFingerprint),assistantBaseFingerprint:ie(t.assistantBaseFingerprint),assistantText:String(t.assistantText||""),assistantBaseText:String(t.assistantBaseText||""),targetMessageIndex:Number.isFinite(t.targetMessageIndex)?t.targetMessageIndex:-1}}function Ar(t){return!t||typeof t!="object"?null:{slotBindingKey:ie(t.slotBindingKey),slotRevisionKey:ie(t.slotRevisionKey),sourceMessageId:ie(t.sourceMessageId),sourceSwipeId:ie(t.sourceSwipeId),tables:Array.isArray(t.tables)?Me(t.tables):[],updatedAt:Number.isFinite(t.updatedAt)?t.updatedAt:0,meta:t.meta&&typeof t.meta=="object"?Me(t.meta):{}}}function ko(t={},e={}){let s=Va(t);return{slotBindingKey:s.slotBindingKey,slotRevisionKey:s.slotRevisionKey,sourceMessageId:s.sourceMessageId,sourceSwipeId:s.sourceSwipeId||s.effectiveSwipeId,tables:Array.isArray(e.tables)?Me(e.tables):[],updatedAt:Number.isFinite(e.updatedAt)?e.updatedAt:Date.now(),meta:e.meta&&typeof e.meta=="object"?Me(e.meta):{}}}function Co(t){return!t||typeof t!="object"?{lastResolvedTarget:null,lastCommittedTarget:null,updatedAt:0}:{lastResolvedTarget:t.lastResolvedTarget?Bs(t.lastResolvedTarget):null,lastCommittedTarget:t.lastCommittedTarget?Bs(t.lastCommittedTarget):null,updatedAt:Number.isFinite(t.updatedAt)?t.updatedAt:0}}var Mo,Us,ct,_r,zs=z(()=>{Mo="YouYouToolkit_tableState",Us="YouYouToolkit_tableBindings",ct=Object.freeze({MANUAL:"MANUAL_TABLE",AUTO:"AUTO_TABLE"}),_r=Object.freeze({EXACT:"exact",BINDING_FALLBACK:"binding_fallback",TEMPLATE:"template",EMPTY:"empty"})});function K(t,e=""){return t==null?e:String(t).trim()||e}function Ay(t,e=!1){return t==null?e:t===!0}function Ey(t){return Array.isArray(t)?Me(t):[]}function Io(t){if(t==null)return"";if(typeof t=="string")return t;try{return JSON.stringify(t,null,2)}catch{return String(t)}}function My(t,e="col"){return K(t,"").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"")||e}function Il(t,e=new Set){let s=My(t,"col"),r=s,o=2;for(;e.has(r);)r=`${s}_${o}`,o+=1;return e.add(r),r}function ky(t=[]){let e=[],s=0;return t.forEach(r=>{let o=r&&typeof r=="object"?r:{},a=o.cells&&typeof o.cells=="object"&&!Array.isArray(o.cells)?o.cells:null,n=Array.isArray(o.cells)?o.cells:Array.isArray(o.values)?o.values:null;a&&Object.keys(a).forEach(i=>{e.includes(i)||e.push(i)}),n&&n.length>s&&(s=n.length)}),e.length>0?e.map(r=>({key:r,title:String(r)})):s>0?Array.from({length:s},(r,o)=>({key:`col_${o+1}`,title:`\u5217${o+1}`})):[]}function Qa(t,e=js){let s=K(t,e);return kl.some(r=>r.value===s)?s:e}function Cy(t={},e=0,s=new Set){let r=t&&typeof t=="object"?t:{},o=K(r.title||r.name||r.label,`\u5217${e+1}`),a=K(r.key||r.id,""),n=Il(a||o||`col_${e+1}`,s),i=[a,K(r.title,""),K(r.name,""),K(r.label,"")].filter(Boolean);return{key:n,title:o,description:K(r.description||r.note,""),type:Qa(r.type),required:r.required===!0,sourceKeys:i}}function Iy(t={},e={},s=0){let r=t.cells&&typeof t.cells=="object"&&!Array.isArray(t.cells)?t.cells:null,o=Array.isArray(t.cells)?t.cells:Array.isArray(t.values)?t.values:null;if(r){let a=[...Array.isArray(e.sourceKeys)?e.sourceKeys:[],e.key,e.title].filter(Boolean);for(let n of a)if(r[n]!==void 0)return Io(r[n])}return o&&o[s]!==void 0?Io(o[s]):""}function Ry(t={},e=[],s=0){let r=t&&typeof t=="object"?t:{},o={};return e.forEach((a,n)=>{o[a.key]=Iy(r,a,n)}),{name:K(r.name||r.title||r.label,`\u884C${s+1}`),cells:o}}function Rl(t={},e=0){let s=t&&typeof t=="object"?t:{},r=new Set,a=(Array.isArray(s.columns)&&s.columns.length>0?s.columns:ky(Array.isArray(s.rows)?s.rows:[])).map((i,l)=>Cy(i,l,r)),n=Array.isArray(s.rows)?s.rows.map((i,l)=>Ry(i,a,l)):[];return{name:K(s.name||s.title,`\u8868${e+1}`),note:K(s.note||s.description,""),columns:a.map(i=>({key:i.key,title:i.title,description:K(i.description,""),type:Qa(i.type),required:i.required===!0})),rows:n}}function Pl(t={}){let e=t&&typeof t=="object"?t:{},s=Array.isArray(e.lastErrorDetails)?e.lastErrorDetails.map(o=>K(o,"")).filter(Boolean):[],r=e.lastValidationSummary&&typeof e.lastValidationSummary=="object"?{errorCount:Number.isFinite(e.lastValidationSummary.errorCount)?e.lastValidationSummary.errorCount:0,warningCount:Number.isFinite(e.lastValidationSummary.warningCount)?e.lastValidationSummary.warningCount:0}:{errorCount:0,warningCount:0};return{lastStatus:K(e.lastStatus,Ws.IDLE),lastRunAt:Number.isFinite(e.lastRunAt)?e.lastRunAt:0,lastDurationMs:Number.isFinite(e.lastDurationMs)?e.lastDurationMs:0,lastError:K(e.lastError,""),lastErrorDetails:s,lastValidationSummary:r,successCount:Number.isFinite(e.successCount)?e.successCount:0,errorCount:Number.isFinite(e.errorCount)?e.errorCount:0,lastSourceMessageId:K(e.lastSourceMessageId,""),lastSlotRevisionKey:K(e.lastSlotRevisionKey,""),lastLoadMode:K(e.lastLoadMode,""),lastMirrorApplied:e.lastMirrorApplied===!0}}function Za(t=1,e=[]){let s=new Set((Array.isArray(e)?e:[]).map(o=>K(o?.key,"")).filter(Boolean));return{key:Il(`col_${t}`,s),title:`\u5217${t}`,description:"",type:js,required:!1}}function Py(t=[],e=1){let s={};return(Array.isArray(t)?t:[]).forEach(r=>{let o=K(r?.key,"");o&&(s[o]="")}),{name:`\u884C${e}`,cells:s}}function $l(t=1){let e=Za(1);return{name:`\u8868${t}`,note:"",columns:[e],rows:[Py([e],1)]}}function $y(){return{tables:[]}}function Dl(t=[]){return!Array.isArray(t)||t.length===0?$y():{tables:t.map((e,s)=>Rl(e,s))}}function Dy(t={}){let e=t&&typeof t=="object"?t:{};return(Array.isArray(e.tables)?e.tables:[]).map((r,o)=>Rl(r,o))}function Ol(t="",e={},s={}){let r=Qa(e?.type),o=String(t??"").trim(),a=K(s?.label,`${K(s?.tableName,"\u8868\u683C")} / ${K(s?.rowName,"\u884C")} / ${K(e?.title||e?.key,"\u5355\u5143\u683C")}`),n=[],i=[];if(e?.required===!0&&!o&&n.push(`${a} \u4E3A\u5FC5\u586B\uFF0C\u5F53\u524D\u4E3A\u7A7A\u3002`),!o)return{valid:n.length===0,errors:n,warnings:i};if(r==="number"&&!Number.isFinite(Number(o))&&n.push(`${a} \u9700\u8981\u586B\u5199\u6570\u5B57\u3002`),r==="boolean"&&!["true","false","1","0","yes","no"].includes(o.toLowerCase())&&n.push(`${a} \u9700\u8981\u586B\u5199\u5E03\u5C14\u503C\uFF08true / false\uFF09\u3002`),r==="date"&&Number.isNaN(Date.parse(o))&&n.push(`${a} \u9700\u8981\u586B\u5199\u53EF\u89E3\u6790\u7684\u65E5\u671F\u3002`),r==="json")try{JSON.parse(o)}catch(l){n.push(`${a} \u9700\u8981\u586B\u5199\u5408\u6CD5 JSON\uFF1A${l?.message||"\u89E3\u6790\u5931\u8D25"}`)}return{valid:n.length===0,errors:n,warnings:i}}function Oy(t={}){let s=Dy(t&&typeof t=="object"?t:{}),r=[];return s.forEach((o,a)=>{let n=K(o?.name,`\u8868${a+1}`),i=Array.isArray(o?.columns)?o.columns:[],l=Array.isArray(o?.rows)?o.rows:[];n||r.push(`\u8868 ${a+1} \u7F3A\u5C11\u540D\u79F0\u3002`),i.length===0&&r.push(`${n} \u81F3\u5C11\u9700\u8981\u4E00\u5217\u3002`);let c=new Set;i.forEach((d,u)=>{let y=K(d?.key,""),p=K(d?.title,`\u5217${u+1}`);if(!y){r.push(`${n} / ${p} \u7F3A\u5C11\u5185\u90E8\u540D\u3002`);return}if(c.has(y)){r.push(`${n} \u4E2D\u5B58\u5728\u91CD\u590D\u5217\u5185\u90E8\u540D\uFF1A${y}`);return}c.add(y)}),l.forEach((d,u)=>{let y=K(d?.name,`\u884C${u+1}`),p=d?.cells&&typeof d.cells=="object"&&!Array.isArray(d.cells)?d.cells:{};i.forEach((g,x)=>{let b=K(g?.key,""),T=K(g?.title||b,`\u5217${x+1}`),A=b?Io(p[b]):"",w=Ol(A,g,{label:`${n} / ${y} / ${T}`,tableName:n,rowName:y});r.push(...w.errors)})})}),{valid:r.length===0,errors:r,tables:s}}function Ks({severity:t="error",message:e="",tableIndex:s=-1,tableName:r="",columnIndex:o=-1,columnKey:a="",rowIndex:n=-1,rowName:i="",cellKey:l=""}={}){return{severity:t,message:K(e,t==="warning"?"\u5B58\u5728\u8B66\u544A\u3002":"\u5B58\u5728\u9519\u8BEF\u3002"),tableIndex:s,tableName:K(r,""),columnIndex:o,columnKey:K(a,""),rowIndex:n,rowName:K(i,""),cellKey:K(l,"")}}function St(t={}){let e=Oy(t),s=[];if(!e.valid)return{...e,warnings:[],issues:s,summary:{errorCount:e.errors.length,warningCount:0}};let r=Array.isArray(e.tables)?e.tables:[];r.forEach((n,i)=>{let l=K(n?.name,`\u8868${i+1}`),c=Array.isArray(n?.columns)?n.columns:[],d=Array.isArray(n?.rows)?n.rows:[],u=new Set;l||s.push(Ks({severity:"error",message:`\u8868 ${i+1} \u7F3A\u5C11\u540D\u79F0\u3002`,tableIndex:i,tableName:l})),c.forEach((y,p)=>{let g=K(y?.key,""),x=K(y?.title,`\u5217${p+1}`);g||s.push(Ks({severity:"error",message:`${l} / ${x} \u7F3A\u5C11\u5185\u90E8\u540D\u3002`,tableIndex:i,tableName:l,columnIndex:p,columnKey:g,cellKey:g})),g&&(u.has(g)&&s.push(Ks({severity:"error",message:`${l} \u4E2D\u5B58\u5728\u91CD\u590D\u5217\u5185\u90E8\u540D\uFF1A${g}`,tableIndex:i,tableName:l,columnIndex:p,columnKey:g,cellKey:g})),u.add(g))}),d.forEach((y,p)=>{let g=K(y?.name,`\u884C${p+1}`),x=y?.cells&&typeof y.cells=="object"&&!Array.isArray(y.cells)?y.cells:{};Object.keys(x).forEach(T=>{c.some(A=>K(A?.key,"")===T)||s.push(Ks({severity:"warning",message:`${l} / ${g} \u5305\u542B\u672A\u5B9A\u4E49\u5217 ${T}\uFF0C\u4FDD\u5B58\u540E\u4F1A\u88AB\u5FFD\u7565\u3002`,tableIndex:i,tableName:l,rowIndex:p,rowName:g,cellKey:T}))}),c.forEach((T,A)=>{let w=K(T?.key,""),L=K(T?.title||w,`\u5217${A+1}`),M=w?Io(x[w]):"",k=Ol(M,T,{label:`${l} / ${g} / ${L}`,tableName:l,rowName:g});k.errors.forEach(R=>{s.push(Ks({severity:"error",message:R,tableIndex:i,tableName:l,columnIndex:A,columnKey:w,rowIndex:p,rowName:g,cellKey:w}))}),k.warnings.forEach(R=>{s.push(Ks({severity:"warning",message:R,tableIndex:i,tableName:l,columnIndex:A,columnKey:w,rowIndex:p,rowName:g,cellKey:w}))})})})});let o=s.filter(n=>n.severity!=="warning").map(n=>n.message),a=s.filter(n=>n.severity==="warning").map(n=>n.message);return{valid:o.length===0,errors:o,warnings:a,issues:s,tables:r,summary:{errorCount:o.length,warningCount:a.length}}}function Ll(){return{tables:[],promptTemplate:Ml,apiPreset:"",mirrorToMessage:!1,mirrorTag:"yyt-table-workbench",runtime:Pl()}}function Xe(t={}){let e=Ll(),s=t&&typeof t=="object"?t:{};return{tables:Ey(s.tables),promptTemplate:K(s.promptTemplate,e.promptTemplate),apiPreset:K(s.apiPreset,""),mirrorToMessage:Ay(s.mirrorToMessage,e.mirrorToMessage),mirrorTag:K(s.mirrorTag,e.mirrorTag),runtime:Pl({...e.runtime,...s.runtime||{}})}}function en(t={}){let e=Xe(t),s=[];return Array.isArray(e.tables)||s.push("\u8868\u5B9A\u4E49\u5FC5\u987B\u662F JSON \u6570\u7EC4\u3002"),e.promptTemplate||s.push("\u586B\u8868 Prompt \u4E0D\u80FD\u4E3A\u7A7A\u3002"),e.mirrorTag||s.push("\u6B63\u6587\u955C\u50CF\u6807\u7B7E\u4E0D\u80FD\u4E3A\u7A7A\u3002"),{valid:s.length===0,errors:s,config:e}}function Qe(){let t=Ja.get(Xa,Ll());return Xe(t)}function Nl(t={}){let e=Qe(),s=Xe({...e,...t||{},runtime:t?.runtime===void 0?e.runtime:t.runtime}),r=en(s);return r.valid?(Ja.set(Xa,r.config),{success:!0,config:r.config}):{success:!1,error:r.errors.join(`
`),errors:r.errors,config:r.config}}function Er(t={}){let e=Qe(),s=Xe({...e,runtime:{...e.runtime,...t||{}}});return Ja.set(Xa,s),s.runtime}function Ly(t={}){let e=Xe(t);return`${K(e.promptTemplate,Ml)}

${_y}`.trim()}function Bl(t={}){return{id:"tableWorkbench",name:"\u586B\u8868\u5DE5\u4F5C\u53F0",promptTemplate:Ly(t),bypass:{enabled:!1}}}function Ul({apiPresets:t=[]}={}){let e=[{value:"",label:"\u5F53\u524D API \u914D\u7F6E"},...t.map(s=>({value:String(s?.name||""),label:String(s?.name||"")})).filter(s=>s.value)];return[{name:"tables",type:"tableDefinitions",label:"\u8868\u5B9A\u4E49",description:"\u901A\u8FC7\u7ED3\u6784\u5316\u7F16\u8F91\u5668\u7EF4\u62A4 tables\u3002\u9996\u6B21\u6267\u884C\u6216\u5F53\u524D\u6D88\u606F\u5C1A\u65E0\u7ED1\u5B9A state \u65F6\uFF0C\u4F1A\u4EE5\u7F16\u8BD1\u540E\u7684 tables \u4F5C\u4E3A merge base\u3002",emptyValue:[]},{name:"promptTemplate",type:"textarea",label:"\u586B\u8868 Prompt",rows:12,description:"\u53EF\u4F7F\u7528 {{lastUserMessage}}\u3001{{lastAiMessage}}\u3001{{chatHistory}}\u3001{{toolContentMacro}} \u7B49\u53D8\u91CF\u3002\u7CFB\u7EDF\u4F1A\u81EA\u52A8\u8FFD\u52A0 JSON \u8F93\u51FA\u7EA6\u675F\u3002"},{name:"apiPreset",type:"select",label:"API \u9884\u8BBE",description:"\u4E3A\u7A7A\u65F6\u4F7F\u7528\u5F53\u524D\u5168\u5C40 API \u914D\u7F6E\u3002",options:e},{name:"mirrorToMessage",type:"checkbox",label:"\u955C\u50CF\u5199\u56DE\u6B63\u6587",description:"\u628A\u5F53\u524D tables \u7684 JSON \u9884\u89C8\u955C\u50CF\u5230\u76EE\u6807 assistant \u6D88\u606F\u6B63\u6587\u4E2D\u3002"}]}var Ja,Xa,Ws,Ml,_y,kl,js,Cl,Mr=z(()=>{ze();zs();Ja=C.namespace("tableWorkbench"),Xa="config",Ws=Object.freeze({IDLE:"idle",RUNNING:"running",SUCCESS:"success",ERROR:"error"}),Ml=`\u8BF7\u6839\u636E\u5F53\u524D\u5BF9\u8BDD\u4E0E\u5F53\u524D\u8868\u683C\u57FA\u5E95\uFF0C\u66F4\u65B0\u7ED3\u6784\u5316 tables \u6570\u636E\u3002
...
- JSON \u7ED3\u6784\u5FC5\u987B\u662F\uFF1A
{
  ...
  `}function Ny(t=js){return Cl.map(e=>`
    <option value="${v(e.value)}" ${e.value===t?"selected":""}>${v(e.label)}</option>
  `).join("")}function zl(t){if(t!==void 0)try{return JSON.parse(JSON.stringify(t))}catch{return t}}function jl(t=0,e=0){return!Number.isInteger(t)||t<=0||!Number.isInteger(e)||e<0?0:Math.min(e,t-1)}function tn(t={}){let e=t&&typeof t=="object"?t:{};return Dl(Array.isArray(e.tables)?e.tables:[])}function By(t,e){if(t.type==="json"){let s=e===void 0?t.emptyValue:e;if(typeof s=="string")return s;try{return JSON.stringify(s??null,null,2)}catch{return String(s??"")}}return String(e??"")}function Uy(t={},e=""){let s=String(t.name||"").trim(),r=`yyt-table-field-${s}`,o=`${r}-value`,a=`${r}-dropdown`,n=zr(t.options||[]);return Kr({selectedValue:e,options:n,placeholder:n[0]?.label||"\u8BF7\u9009\u62E9",rootAttributes:{"data-table-custom-select":"true"},nativeAttributes:{class:"yyt-table-select-native",id:o,"data-table-field":s,"data-field-type":"select"},triggerAttributes:{id:r,"data-table-select-trigger":"true","aria-controls":a},dropdownAttributes:{id:a,"data-table-select-dropdown":"true"},optionAttributes:{"data-table-select-option":"true"}})}function zy(t={},e={},s=0){let r=t&&typeof t=="object"?t.cells:null;if(Array.isArray(r))return String(r[s]??"");if(r&&typeof r=="object"){if(r[e.key]!==void 0)return String(r[e.key]??"");if(r[e.title]!==void 0)return String(r[e.title]??"")}return""}function Ky(t={}){return[Number.isInteger(t?.tableIndex)?t.tableIndex:-1,Number.isInteger(t?.rowIndex)?t.rowIndex:-1,Number.isInteger(t?.columnIndex)?t.columnIndex:-1,String(t?.cellKey||"")].join(":")}function Wy(t={},e=6){let s=Array.isArray(t?.issues)?t.issues:[];if(!s.length)return"";let r=Number(t?.summary?.errorCount)||0,o=Number(t?.summary?.warningCount)||0,a=r>0?`\u53D1\u73B0 ${r} \u4E2A\u9519\u8BEF${o>0?`\uFF0C\u53E6\u6709 ${o} \u4E2A\u63D0\u793A`:""}`:`\u5F53\u524D\u6709 ${o} \u4E2A\u63D0\u793A`,n=s.slice(0,Math.max(1,e)).map(c=>`<li>${v(c?.message||"")}</li>`).join(""),i=s.length>e?`<li>\u8FD8\u6709 ${s.length-e} \u6761\u672A\u5C55\u5F00\uFF0C\u8BF7\u5148\u4FEE\u6B63\u4E0A\u9762\u8FD9\u4E9B\u3002</li>`:"";return`
  ...
  `}function fs(t,e=null){let s=$();if(!s||!t?.length)return e;t.find("[data-table-validation-summary]").remove(),t.find(".yyt-table-cell-error").removeClass("yyt-table-cell-error"),t.find(".yyt-has-error").removeClass("yyt-has-error");let r=e||St(Fs(t)),o=Array.isArray(r?.issues)?r.issues:[],a=new Set(o.filter(l=>l?.severity!=="warning").map(l=>Ky(l))),n=new Set(o.filter(l=>l?.severity!=="warning").map(l=>`${l?.tableIndex??-1}:${l?.columnIndex??-1}`)),i=new Set(o.filter(l=>l?.severity!=="warning").map(l=>`${l?.tableIndex??-1}`));return o.length>0&&t.prepend(Wy(r)),t.find("[data-table-editor-table]").each((l,c)=>{let d=s(c);i.has(`${l}`)&&d.addClass("yyt-has-error"),d.find("[data-table-editor-column]").each((u,y)=>{let p=s(y);n.has(`${l}:${u}`)&&(p.addClass("yyt-has-error"),p.find("[data-table-editor-column-title], [data-table-editor-column-key], [data-table-editor-column-type], [data-table-editor-column-description]").addClass("yyt-table-cell-error"))}),d.find("[data-table-editor-row]").each((u,y)=>{let p=s(y),g=!1;p.find("[data-table-editor-cell]").each((x,b)=>{let T=String(d.find(`[data-table-editor-column="${x}"] [data-table-editor-column-key]`).val()||"").trim(),A=[l,u,x,T].join(":");a.has(A)&&(g=!0,s(b).addClass("yyt-table-cell-error"))}),g&&p.addClass("yyt-has-error")})}),r}function jy(t={},e={},s=0,r=0){let o=Array.isArray(t.columns)?t.columns:[],a=kr("row",{"table-index":s,"row-index":r},{currentIndex:r,size:o.length>=0&&Array.isArray(t.rows)?t.rows.length:0});return`
      ...
      ${o.map((n,i)=>{let l=String(n?.key||"").trim();return`
        <td>
          <textarea class="yyt-textarea yyt-code-textarea-small"
                    ...
                    data-column-key="${v(l)}"
                    rows="2"
                    placeholder="${v(n.title||n.key||`\u5217${i+1}`)}">${v(zy(e,n,i))}</textarea>
        </td>
      `}).join("")}
      <td>
  ...
  `}function Kl(t={},e=0,s={}){let r=Array.isArray(t.columns)?t.columns:[],o=Array.isArray(t.rows)?t.rows:[],a=String(t?.name||"").trim(),n=s.showDeleteTable!==!1,i=kr("table",{"table-index":e},{currentIndex:e,size:Number.isInteger(s.totalTables)?s.totalTables:0}),l=n?`
      ...
      <div class="yyt-table-editor-section">
        ...
        <div class="yyt-table-editor-grid-wrap">
          <table class="yyt-table-editor-grid">
            ...
            <tbody>
              ${o.length?o.map((c,d)=>jy(t,c,e,d)).join(""):`
                <tr>
  ...
  `}function Fl(t={},e={}){let s=tn(t),r=Array.isArray(s?.tables)?s.tables:[],o=e.mode==="focused"?"focused":"full",a=jl(r.length,Number.parseInt(e.currentTableIndex,10));if(o==="focused"){let n=r[a]||null;return`
      <div class="yyt-table-editor-shell">
        ${n?Kl(n,a,{totalTables:r.length}):`
    ...
    <div class="yyt-table-editor-shell">
      ...
      <div class="yyt-table-editor-stack">
        ${r.length?r.map((n,i)=>Kl(n,i,{totalTables:r.length})).join(""):`
          <div class="yyt-table-editor-empty">\u8FD8\u6CA1\u6709\u8868\uFF0C\u5148\u65B0\u5EFA\u4E00\u5F20\u3002</div>
        `}
      </div>
    </div>
  `}function Fy(t={},e={}){let s=String(t.name||"").trim(),r=v(t.label||s),o=t.description?`<div class="yyt-table-form-field-desc">${v(t.description)}</div>`:"",a=tn({tables:Array.isArray(e[s])?e[s]:[]});return`
    <div class="yyt-table-form-field" data-table-form-item="${v(s)}">
      <label>${r}</label>
      ${sn(t,a,{description:o})}
    </div>
  `}function sn(t={},e={},s={}){let r=String(t.name||"").trim(),o=typeof s.description=="string"?s.description:t.description?`<div class="yyt-table-form-field-desc">${v(t.description)}</div>`:"",a=s.mode==="focused"?"focused":"full",n=Number.parseInt(s.currentTableIndex,10);return`
    <div class="yyt-table-editor" data-table-field="${v(r)}" data-field-type="tableDefinitions" data-table-definition-root data-table-editor-mode="${a}" data-current-table-index="${Number.isInteger(n)?n:0}">
      ${Fl(e,{mode:a,currentTableIndex:n})}
    </div>
    ${o}
  `}function Hl(t=[],e={},s={}){let r=Array.isArray(t)?t:[],o=Array.isArray(s.includeFieldNames)?new Set(s.includeFieldNames.map(i=>String(i||"").trim()).filter(Boolean)):null,a=Array.isArray(s.excludeFieldNames)?new Set(s.excludeFieldNames.map(i=>String(i||"").trim()).filter(Boolean)):null,n=r.filter(i=>{let l=String(i?.name||"").trim();return!l||o&&!o.has(l)||a&&a.has(l)?!1:i.type!=="tableDefinitions"}).map(i=>Hy(i,e)).join("");return n?`
    <div class="yyt-table-form-grid">
      ${n}
    </div>
  `:""}function Hy(t={},e={}){let s=String(t.name||"").trim();if(!s)return"";if(t.type==="tableDefinitions")return Fy(t,e);let r=e[s],o=v(t.label||s),a=t.description?`<div class="yyt-table-form-field-desc">${v(t.description)}</div>`:"",n=Number.isFinite(t.rows)?t.rows:6;return t.type==="checkbox"?`
      <div class="yyt-table-form-field" data-table-form-item="${v(s)}">
...
`});function Gy(t={},e=-1){return[t?.sourceId,t?.messageId,t?.message_id,t?.id,t?.mid,t?.mesid,t?.mes_id,t?.chat_index,t?.index,e].map(s=>X(s))}function Yy(t=[],e=""){let s=X(e);if(!s||!Array.isArray(t))return-1;for(let r=t.length-1;r>=0;r-=1){let o=t[r];if(Gy(o,r).includes(s))return r}return-1}function Ro(t={},e={}){let s=X(t?.sourceMessageId||t?.confirmedAssistantMessageId||t?.messageId);if(!s)return null;let r=Va({resolvedAt:Date.now(),runSource:e.runSource||t?.runSource||ct.MANUAL,traceId:t?.traceId||"",chatId:t?.chatId||"",sourceMessageId:s,sourceSwipeId:t?.sourceSwipeId||t?.effectiveSwipeId||"",effectiveSwipeId:t?.effectiveSwipeId||t?.sourceSwipeId||"swipe:current",slotBindingKey:t?.slotBindingKey||"",slotRevisionKey:t?.slotRevisionKey||"",slotTransactionId:t?.slotTransactionId||"",assistantContentFingerprint:t?.assistantContentFingerprint||"",assistantBaseFingerprint:t?.assistantBaseFingerprint||"",assistantText:t?.lastAiMessage||"",assistantBaseText:t?.assistantBaseText||"",targetMessageIndex:Yy(t?.chatMessages||t?.chatHistory||[],s)});return!r.slotBindingKey||!r.slotRevisionKey?null:r}async function on({runSource:t=ct.MANUAL}={}){let e=await rs({runSource:t});return Ro(e,{runSource:t})}async function Vy({messageId:t,swipeId:e="",runSource:s=ct.AUTO}={}){let r=await pr({messageId:t,swipeId:e,runSource:s});return Ro(r,{runSource:s})}async function Vl(t=null,e={}){let s=t||null;if(typeof e.resolveTarget=="function")return await e.resolveTarget(s);let r=X(e.runSource||s?.runSource)||ct.MANUAL,o=X(e.messageId||s?.sourceMessageId),a=X(e.swipeId||s?.sourceSwipeId||s?.effectiveSwipeId);return e.useMessageTarget===!0||r===ct.AUTO?o?Vy({messageId:o,swipeId:a,runSource:r}):null:on({runSource:r})}function Jl(t,e){let s=t||null,r=e||null;return!s||!r?{valid:!1,reason:"missing_target_snapshot"}:X(s.sourceMessageId)!==X(r.sourceMessageId)?{valid:!1,reason:"source_message_changed"}:X(s.sourceSwipeId||s.effectiveSwipeId)!==X(r.sourceSwipeId||r.effectiveSwipeId)?{valid:!1,reason:"source_swipe_changed"}:X(s.slotRevisionKey)!==X(r.slotRevisionKey)?{valid:!1,reason:"slot_revision_changed"}:{valid:!0,reason:"ok"}}var Po=z(()=>{Is();zs()});function ut(t){return t==null?"":String(t).trim()}function Jy(){try{if(typeof window.parent<"u"&&window.parent&&window.parent!==window)return window.parent}catch{}return window}function Xy(){try{let t=Jy(),e=t?.SillyTavern||null,s=e?.getContext?.()||null,r=Array.isArray(s?.chat)?s.chat:[],o=Array.isArray(e?.chat)?e.chat:[],a=r.length?r:o;return{topWindow:t,api:e,context:s,chat:a,contextChat:r,apiChat:o}}catch{return{topWindow:null,api:null,context:null,chat:[],contextChat:[],apiChat:[]}}}function Qy(t){if(!t||t?.is_user===!0||t?.is_system===!0)return!1;let e=String(t?.role||"").trim().toLowerCase();return e==="assistant"||e==="ai"||!e}function Zy(t=[],e=""){let s=ut(e);if(!Array.isArray(t)||!s)return-1;for(let r=t.length-1;r>=0;r-=1){let o=t[r];if(!Qy(o))continue;if([o?.sourceId,o?.message_id,o?.messageId,o?.id,o?.mes_id,o?.mid,o?.mesid,o?.chat_index,o?.index,r].map(n=>ut(n)).includes(s))return r}return-1}function an(t){let e=Xy(),s=Zy(e.chat,t?.sourceMessageId);return s<0?{runtime:e,messageIndex:s,message:null}:{runtime:e,messageIndex:s,message:e.chat[s]||null}}function Xl(t,e,s){let r=o=>{!Array.isArray(o)||e<0||e>=o.length||(o[e]={...o[e]||{},...s})};r(t?.contextChat),r(t?.apiChat)}async function Ql(t){let e=t?.context||null,s=t?.api||null,r=e?.saveChatDebounced||s?.saveChatDebounced||null,o=e?.saveChat||s?.saveChat||null;typeof r=="function"&&r.call(e||s),typeof o=="function"&&await o.call(e||s)}function ep(t){let{message:e}=an(t);return Ar(e?.[Mo])}function $o(t,e={}){let s=ep(t);return s&&ut(s.slotRevisionKey)===ut(t?.slotRevisionKey)?{loadMode:_r.EXACT,mergeBaseOnly:!1,state:s}:s&&ut(s.slotBindingKey)===ut(t?.slotBindingKey)?{loadMode:_r.BINDING_FALLBACK,mergeBaseOnly:!0,state:Ar({...s,slotRevisionKey:ut(t?.slotRevisionKey)||s.slotRevisionKey,sourceSwipeId:ut(t?.sourceSwipeId||t?.effectiveSwipeId)||s.sourceSwipeId,meta:{...s.meta||{},mergeBaseOnly:!0,fallbackFromBinding:!0,fallbackFromRevisionKey:ut(s.slotRevisionKey),requestedRevisionKey:ut(t?.slotRevisionKey)}})}:Array.isArray(e.templateTables)?{loadMode:_r.TEMPLATE,mergeBaseOnly:!1,state:ko(t,{tables:Me(e.templateTables),meta:{fromTemplate:!0}})}:{loadMode:_r.EMPTY,mergeBaseOnly:!1,state:ko(t)}}async function Zl(t){let{runtime:e,messageIndex:s,message:r}=an(t);if(!r||s<0)return{success:!1,error:"target_message_not_found"};let o={...Co(r[Us]),lastResolvedTarget:Bs(t),updatedAt:Date.now()};return r[Us]=o,Xl(e,s,r),await Ql(e),{success:!0,bindings:o}}async function ec(t,e,s={}){let r=s.skipFreshValidation===!0?t:await Vl(t,s),o=s.skipFreshValidation===!0?{valid:!0,reason:"skipped"}:Jl(t,r);if(!o.valid)return{success:!1,error:"target_changed_before_commit",validation:o};let a=r||t,{runtime:n,messageIndex:i,message:l}=an(a);if(!l||i<0)return{success:!1,error:"target_message_not_found",validation:o};let c=Ar({...ko(a),...e,slotBindingKey:a.slotBindingKey,slotRevisionKey:a.slotRevisionKey,sourceMessageId:a.sourceMessageId,sourceSwipeId:a.sourceSwipeId||a.effectiveSwipeId,updatedAt:Date.now()}),d={...Co(l[Us]),lastResolvedTarget:Bs(a),lastCommittedTarget:Bs(a),updatedAt:Date.now()};return l[Mo]=c,l[Us]=d,Xl(n,i,l),await Ql(n),{success:!0,state:c,bindings:d,validation:o,messageIndex:i,sourceMessageId:a.sourceMessageId,slotRevisionKey:a.slotRevisionKey}}function Do(t=null){let e=Be.getAssistantMessageSnapshot(t);return e?.message?{...e,tableState:Ar(e.message[Mo]),tableBindings:Co(e.message[Us])}:null}var Oo=z(()=>{os();zs();Po()});function nn(t,e=""){return t==null?e:String(t).trim()||e}function sp(t={}){return{tables:Array.isArray(t?.tables)?Me(t.tables):[]}}function rp(t={},e={}){let s=nn(e.mirrorTag,"yyt-table-workbench"),r=sp(t);return[`<${s}>`,"[\u586B\u8868\u5DE5\u4F5C\u53F0]","```json",JSON.stringify(r,null,2),"```",`</${s}>`].join(`
`)}async function tc({targetSnapshot:t,nextTables:e,config:s,loadResult:r=null}={}){let o=Xe(s),a=await ec(t,{tables:Array.isArray(e)?Me(e):[],meta:{lastLoadMode:nn(r?.loadMode,""),mergeBaseOnly:!1,updatedBy:nn(t?.runSource,"MANUAL_TABLE")}});if(!a?.success)return{success:!1,error:a?.error||"table_state_commit_failed",commitResult:a,mirrorResult:null,warning:""};let n=null,i="";if(o.mirrorToMessage){let l=rp(a.state,{mirrorTag:o.mirrorTag});n=await Be.injectDetailed(tp,l,{overwrite:!0,extractionSelectors:[o.mirrorTag],sourceMessageId:a.sourceMessageId,sourceSwipeId:t?.sourceSwipeId||t?.effectiveSwipeId,effectiveSwipeId:t?.effectiveSwipeId||t?.sourceSwipeId,slotBindingKey:t?.slotBindingKey,slotRevisionKey:t?.slotRevisionKey,slotTransactionId:t?.slotTransactionId,traceId:t?.traceId}),n?.success||(i=n?.error||"\u6B63\u6587\u955C\u50CF\u5199\u56DE\u5931\u8D25")}return{success:!0,state:a.state,bindings:a.bindings,commitResult:a,mirrorResult:n,warning:i}}var tp,sc=z(()=>{os();zs();Oo();Mr();tp="tableWorkbenchMirror"});function Ze(t,e=""){return t==null?e:String(t).trim()||e}function rc(t=[],e=8){return!Array.isArray(t)||t.length===0?"":t.slice(Math.max(t.length-e,0)).map(s=>`[${Ze(s?.role,"unknown")}] ${String(s?.content||"").trim()}`).filter(Boolean).join(`

`)}function op(t,e){return{target:{sourceMessageId:Ze(t?.sourceMessageId),sourceSwipeId:Ze(t?.sourceSwipeId||t?.effectiveSwipeId),slotBindingKey:Ze(t?.slotBindingKey),slotRevisionKey:Ze(t?.slotRevisionKey),slotTransactionId:Ze(t?.slotTransactionId)},loadMode:Ze(e?.loadMode),mergeBaseOnly:e?.mergeBaseOnly===!0,tables:Array.isArray(e?.state?.tables)?Me(e.state.tables):[]}}function ap(t=""){let e=String(t||"").trim();if(!e)return[];let s=[],r=c=>{let d=String(c||"").trim();d&&(s.includes(d)||s.push(d))};(e.match(/```(?:json)?\s*([\s\S]*?)```/gi)||[]).forEach(c=>{let d=c.replace(/^```(?:json)?\s*/i,"").replace(/```$/i,"").trim();r(d)}),r(e);let a=e.indexOf("{"),n=e.lastIndexOf("}");a>=0&&n>a&&r(e.slice(a,n+1));let i=e.indexOf("["),l=e.lastIndexOf("]");return i>=0&&l>i&&r(e.slice(i,l+1)),s}function np(t){if(Array.isArray(t))return t;if(t&&typeof t=="object"){if(Array.isArray(t.tables))return t.tables;if(t.data&&typeof t.data=="object"&&Array.isArray(t.data.tables))return t.data.tables}return null}function ip(t=""){let e=ap(t),s=[];for(let r of e)try{let o=JSON.parse(r),a=np(o);if(!Array.isArray(a)){s.push("JSON \u4E2D\u7F3A\u5C11 tables \u6570\u7EC4\u3002");continue}return{tables:Me(a),parsed:o}}catch(o){s.push(o?.message||String(o))}throw new Error(s[0]||"\u65E0\u6CD5\u4ECE\u6A21\u578B\u54CD\u5E94\u4E2D\u89E3\u6790 tables JSON\u3002")}async function lp({executionContext:t,targetSnapshot:e,loadResult:s,config:r,assistantSnapshot:o}={}){let a=Xe(r),n=Bl(a),i=op(e,s),l=Array.isArray(o?.tableState?.tables)?Me(o.tableState.tables):[],c={...t,toolName:"\u586B\u8868\u5DE5\u4F5C\u53F0",toolId:"tableWorkbench",lastAiMessage:t?.assistantBaseText||t?.lastAiMessage||"",recentMessagesText:rc(t?.chatHistory||t?.chatMessages||[]),rawRecentMessagesText:rc(t?.chatHistory||t?.chatMessages||[],20),injectedContext:o?.injectedContext||Be.getLatestMessageInjectedContext(e?.sourceMessageId),toolContentMacro:JSON.stringify(i,null,2),extractedContent:JSON.stringify(i,null,2),previousToolOutput:JSON.stringify(l,null,2)},d=await as.buildToolMessages(n,c),u=await as.buildPromptText(n,c);if(!Array.isArray(d)||d.length===0)throw new Error("\u586B\u8868\u8BF7\u6C42\u6D88\u606F\u6784\u5EFA\u5931\u8D25\u3002");return{toolConfig:n,context:c,requestPayload:i,promptText:u,messages:d}}async function cp(t,e={},s=null){let r=Xe(e),o=Ze(r.apiPreset,"");if(o){if(!Qs(o))throw new Error(`API \u9884\u8BBE\u4E0D\u5B58\u5728: ${o}`);return Qo(o,t,{},s)}return Zs(t,{},s)}async function oc(t=null){let e=Xe(t||Qe()),s=en(e),r=St({tables:Array.isArray(e.tables)?e.tables:[]});if(!s.valid||!r.valid){let n=[...s.errors,...r.errors];return Er({lastStatus:Ws.ERROR,lastRunAt:Date.now(),lastDurationMs:0,lastError:n[0]||"\u586B\u8868\u914D\u7F6E\u65E0\u6548\u3002",lastErrorDetails:n,lastValidationSummary:r.summary||{errorCount:n.length,warningCount:0},errorCount:Number(e?.runtime?.errorCount)||0}),{success:!1,error:n.join(`
`),errors:n}}let o=e.runtime||{},a=Date.now();Er({lastStatus:Ws.RUNNING,lastError:"",lastErrorDetails:[],lastValidationSummary:r.summary||{errorCount:0,warningCount:0}});try{let n=await rs({runSource:ct.MANUAL}),i=Ro(n,{runSource:ct.MANUAL});if(!i)throw new Error("\u5F53\u524D\u6CA1\u6709\u53EF\u7528\u7684 assistant \u76EE\u6807\u697C\u5C42\u3002");let l=await Zl(i);if(!l?.success)throw new Error(l?.error||"\u76EE\u6807\u89E3\u6790\u8BB0\u5F55\u5931\u8D25");let c=Do(i.sourceMessageId),d=$o(i,{templateTables:e.tables}),u=await lp({executionContext:n,targetSnapshot:i,loadResult:d,config:e,assistantSnapshot:c}),y=await cp(u.messages,e),p=ip(y),g=await tc({targetSnapshot:i,nextTables:p.tables,config:e,loadResult:d});if(!g?.success)throw new Error(g?.error||"\u7ED3\u6784\u5316\u5199\u56DE\u5931\u8D25");let x=Date.now()-a;return Er({lastStatus:Ws.SUCCESS,lastRunAt:Date.now(),lastDurationMs:x,lastError:"",lastErrorDetails:[],lastValidationSummary:r.summary||{errorCount:0,warningCount:0},successCount:(Number(o.successCount)||0)+1,errorCount:Number(o.errorCount)||0,lastSourceMessageId:Ze(i.sourceMessageId),lastSlotRevisionKey:Ze(i.slotRevisionKey),lastLoadMode:Ze(d.loadMode),lastMirrorApplied:g?.mirrorResult?.success===!0}),{success:!0,targetSnapshot:i,loadResult:d,request:u,responseText:y,parsed:p,state:g.state,bindings:g.bindings,mirrorResult:g.mirrorResult,warning:g.warning||""}}catch(n){let i=Date.now()-a;return Er({lastStatus:Ws.ERROR,lastRunAt:Date.now(),lastDurationMs:i,lastError:n?.message||String(n),lastErrorDetails:[n?.message||String(n)],lastValidationSummary:r.summary||{errorCount:0,warningCount:0},successCount:Number(o.successCount)||0,errorCount:(Number(o.errorCount)||0)+1}),{success:!1,error:n?.message||String(n),errors:[n?.message||String(n)]}}}var ac=z(()=>{Is();os();er();ho();zs();Po();Oo();Mr();sc()});function Cr(){return Ul({apiPresets:Mt()})}function Lo(t,e=""){return typeof t=="string"&&t.trim()?t.trim():e}function lc(t){return Number.isFinite(t)&&t>0?new Date(t).toLocaleString():"\u672A\u8BB0\u5F55"}function No(t){try{return JSON.stringify(t,null,2)}catch{return String(t??"")}}function et(t=[],e=0){let s=Array.isArray(t)?t.length:0;return s<=0||!Number.isInteger(e)||e<0?0:Math.min(e,s-1)}function up(t=[],e=-1,s=-1){if(!Array.isArray(t))return[];if(!Number.isInteger(e)||!Number.isInteger(s)||e<0||s<0||e>=t.length||s>=t.length||e===s)return[...t];let r=[...t],[o]=r.splice(e,1);return r.splice(s,0,o),r}function yp(t=[]){return(Array.isArray(t)?t:[]).find(e=>e?.type==="tableDefinitions")||{name:"tables",label:"\u8868\u5B9A\u4E49",description:""}}function ln(t,e={}){let s=$(),r=e&&typeof e=="object"?e:Qe();if(!s||!N(t))return r;let o={...r,runtime:r.runtime||{}},a=t.find("[data-table-definition-root]");if(a.length){let c=Fs(a);o.tables=Array.isArray(c?.tables)?c.tables:[]}let n=t.find('[data-table-field="promptTemplate"]');n.length&&(o.promptTemplate=String(n.val()||""));let i=t.find('[data-table-field="apiPreset"]');i.length&&(o.apiPreset=String(i.val()||""));let l=t.find('[data-table-field="mirrorToMessage"]');return l.length&&(o.mirrorToMessage=l.is(":checked")),o}function cc(t={}){let e=Number(t?.summary?.errorCount)||0,s=Number(t?.summary?.warningCount)||0,r=Array.isArray(t?.issues)?t.issues:[],o=e>0?`\u5F53\u524D\u8868\u683C\u6709 ${e} \u4E2A\u9519\u8BEF${s>0?`\uFF0C\u53E6\u6709 ${s} \u4E2A\u63D0\u793A`:""}`:s>0?`\u5F53\u524D\u8868\u683C\u6709 ${s} \u4E2A\u63D0\u793A`:"\u5F53\u524D\u6570\u636E\u8D28\u91CF\u6B63\u5E38",a=r.slice(0,5).map(l=>`<li>${v(l?.message||"")}</li>`).join(""),n=r.length>5?`<li>\u8FD8\u6709 ${r.length-5} \u6761\uFF0C\u8BF7\u5148\u4FEE\u6B63\u4E0A\u9762\u8FD9\u4E9B\u3002</li>`:"";return`
  ...
  `}function cn(t){if(!$()||!N(t))return;let s=Cr(),{values:r,errors:o}=rn(t,s),a=t.find("[data-table-workbench-compiled-preview]");if(a.length){if(o.length>0){a.text(o.join(`
`));return}a.text(No(r.tables||[]))}}function pp(){return`
  ...
  `}function gp(t=[],e=0){let s=et(t,e);return`
    <div>
  ...
  `}function fp(t={},e=[],s=0){let r=yp(e),o={tables:Array.isArray(t?.tables)?t.tables:[]},a=St(o),n=Array.isArray(a?.tables)?a.tables:[],i=et(n,s),l=n[i]||null,c=Lo(l?.name,n.length?`\u8868\u683C ${i+1}`:"\u672A\u9009\u62E9");return sn(r,o,{mode:"focused",currentTableIndex:i,description:""})}function mp(t={}){let e=t.runtime||{},s=Lo(e.lastStatus,"idle"),r=e.lastRunAt?lc(e.lastRunAt):"\u672A\u8FD0\u884C",o=Number.isFinite(e.lastDurationMs)&&e.lastDurationMs>0?`${e.lastDurationMs} ms`:"\u672A\u8BB0\u5F55",a=e.lastValidationSummary||{},n=`${Number(a.errorCount)||0} \u4E2A\u9519\u8BEF / ${Number(a.warningCount)||0} \u4E2A\u63D0\u793A`,i=Lo(e.lastLoadMode,"\u672A\u8BB0\u5F55"),l=e.lastMirrorApplied===!0?"\u5DF2\u5199\u56DE\u6B63\u6587":"\u672A\u5199\u56DE\u6B63\u6587",c=Lo(e.lastError,"");return`
    <div class="yyt-tool-runtime-card">
  ...
  `}function bp(t,e,s={}){let r=s.meta?`<div class="yyt-table-workbench-secondary-summary-meta">${s.meta}</div>`:"";return`
  ...
  `}function hp(t={}){let e={tables:Array.isArray(t?.tables)?t.tables:[]},s=St(e),r=qe.getVariableHelp(),o=Number(s?.summary?.errorCount)||0,a=Number(s?.summary?.warningCount)||0;return`
  ...
  `}function vp(t={},e=0){let s=Cr(),r=Array.isArray(t?.tables)?t.tables:[],o=et(r,e);return`
...
`;ms={id:"tableWorkbenchPanel",currentTableIndex:0,render({config:t}={}){let e=t&&typeof t=="object"?t:Qe();return this.currentTableIndex=et(e.tables,this.currentTableIndex),vp(e,this.currentTableIndex)},bindEvents(t){let e=$();if(!e||!N(t))return;let s=this;t.off(".yytTableWorkbench"),t.on("click.yytTableWorkbench",'[data-table-workbench-action="add-table"]',()=>{let r=t.find('[data-table-definition-root] [data-table-editor-action="add-table"]').first();r.length&&r.trigger("click")}),t.on("click.yytTableWorkbench",'[data-table-workbench-select-table] [data-table-editor-action^="move-table-"]',r=>{r.preventDefault(),r.stopPropagation();let o=e(r.currentTarget),a=String(o.attr("data-table-editor-action")||""),n=Number.parseInt(o.attr("data-table-index")||"-1",10),i=ln(t,Qe()),l=Array.isArray(i.tables)?i.tables:[];if(!Number.isInteger(n)||n<0||n>=l.length)return;let c=a==="move-table-up"?n-1:n+1;i.tables=up(l,n,c),s.currentTableIndex=et(i.tables,c),s.renderTo(t,{config:i})}),t.on("click.yytTableWorkbench","[data-table-workbench-select-table]",r=>{if(e(r.target).closest("[data-table-editor-action]").length)return;let o=Number.parseInt(e(r.currentTarget).attr("data-table-workbench-select-table")||"0",10),a=ln(t,Qe());s.currentTableIndex=et(a.tables,o),s.renderTo(t,{config:a})}),t.on("keydown.yytTableWorkbench","[data-table-workbench-select-table]",r=>{r.key!=="Enter"&&r.key!==" "||e(r.target).closest("[data-table-editor-action]").length||(r.preventDefault(),e(r.currentTarget).trigger("click"))}),t.on("click.yytTableWorkbench",'[data-table-workbench-action="save"]',()=>{let r=ic(t,{silent:!1});r?.success&&(s.currentTableIndex=et(r.config?.tables,s.currentTableIndex),s.renderTo(t,{config:r.config}))}),t.on("click.yytTableWorkbench",'[data-table-workbench-action="refresh"]',()=>{s.renderTo(t)}),t.on("click.yytTableWorkbench",'[data-table-workbench-action="run"]',async()=>{if(ic(t,{silent:!0}).success)try{let o=await oc();o?.success?o.warning?we("warning",`\u586B\u8868\u5DF2\u5B8C\u6210\uFF0C\u4F46\u6B63\u6587\u955C\u50CF\u5931\u8D25\uFF1A${o.warning}`,{duration:4200,noticeId:"yyt-table-workbench-run-result"}):we("success","\u624B\u52A8\u586B\u8868\u5B8C\u6210",{duration:2800,noticeId:"yyt-table-workbench-run-result"}):we("warning",o?.error||"\u624B\u52A8\u586B\u8868\u5931\u8D25",{duration:4e3,noticeId:"yyt-table-workbench-run-result"})}catch(o){S("error",o?.message||"\u624B\u52A8\u586B\u8868\u5931\u8D25")}finally{s.renderTo(t)}})},destroy(t){!$()||!N(t)||(Gl(t),t.off(".yytTableWorkbench"))},getStyles(){return dp},renderTo(t,{config:e}={}){if(!$()||!N(t))return;let r=e&&typeof e=="object"?e:Qe();this.currentTableIndex=et(r.tables,this.currentTableIndex),t.html(this.render({config:r})),ql(t,Cr(),{onChange:()=>{cn(t);let a=t.find("[data-table-definition-root]");a.length&&fs(a)},onTableMutation:({action:a,tableIndex:n,nextTableIndex:i,draft:l})=>{let c=ln(t,r);if(c.tables=Array.isArray(l?.tables)?l.tables:c.tables,a==="add-table"){this.currentTableIndex=et(c.tables,n),this.renderTo(t,{config:c});return}if(a==="move-table-up"||a==="move-table-down"){this.currentTableIndex=et(c.tables,i),this.renderTo(t,{config:c});return}a==="delete-table"&&(this.currentTableIndex=et(c.tables,n),this.renderTo(t,{config:c}))}}),this.bindEvents(t,{}),cn(t);let o=t.find("[data-table-definition-root]");o.length&&fs(o),xp(t)}}});function Tp(t){switch(t){case G.DEBUG:return"yyt-log-debug";case G.INFO:return"yyt-log-info";case G.WARN:return"yyt-log-warn";case G.ERROR:return"yyt-log-error";default:return""}}function _p(t){let e=new Date(t),s=r=>String(r).padStart(2,"0");return`${s(e.getHours())}:${s(e.getMinutes())}:${s(e.getSeconds())}.${String(e.getMilliseconds()).padStart(3,"0")}`}var wp,Sp,bs,un=z(()=>{re();fe();Se();wp="yyt-logger-panel",Sp=[{level:null,label:"\u5168\u90E8",icon:"fa-list"},{level:G.DEBUG,label:"DEBUG",icon:"fa-bug"},{level:G.INFO,label:"INFO",icon:"fa-circle-info"},{level:G.WARN,label:"WARN",icon:"fa-triangle-exclamation"},{level:G.ERROR,label:"ERROR",icon:"fa-circle-exclamation"}];bs={id:"loggerPanel",render(){let t=B.getStats();return`
      <div class="yyt-logger-panel" id="${wp}">
        <div class="yyt-logger-toolbar">
          <div class="yyt-logger-filter-btns" data-yyt-log-filter-group>
            ${Sp.map((e,s)=>`<button class="yyt-log-filter-btn ${s===0?"yyt-active":""}" data-level="${e.level??""}">
    ...
    `},bindEvents(t){let e=$();if(!e||!N(t))return;let s=this,r=null,o=!1,a=[],n=t.find("[data-yyt-log-list]"),i=t.find("[data-yyt-log-search]"),l=t.find("[data-yyt-log-autoscroll]"),c=t.find("[data-yyt-log-pause]");function d(p){if(!p.length){n.html('<div class="yyt-logger-empty">\u6682\u65E0\u5339\u914D\u7684\u65E5\u5FD7\u8BB0\u5F55</div>');return}n.html(p.map(g=>`
        <div class="yyt-log-entry ${Tp(g.level)}" data-log-id="${g.id}">
          <span class="yyt-log-time">${_p(g.timestamp)}</span>
    ...
    `}}});var fc={};pe(fc,{ApiPresetPanel:()=>Rt,BypassPanel:()=>gs,EscapeTransformToolPanel:()=>ys,LoggerPanel:()=>bs,MAIN_TAB_RENDERERS:()=>An,PanelState:()=>Ss,PunctuationTransformToolPanel:()=>ps,RegexExtractPanel:()=>Qt,SCRIPT_ID:()=>m,SUB_TAB_RENDERERS:()=>En,SettingsPanel:()=>wt,StatusBlockPanel:()=>ds,SummaryToolPanel:()=>cs,TableWorkbenchPanel:()=>ms,ToolManagePanel:()=>ss,UIManager:()=>nr,YouyouReviewPanel:()=>us,bindDialogEvents:()=>It,closeActiveCustomSelectDropdown:()=>Le,closeCustomSelectDropdown:()=>or,createDialogHtml:()=>Ct,default:()=>Ap,destroyEnhancedCustomSelects:()=>me,downloadJson:()=>ft,enhanceNativeSelects:()=>Ae,escapeHtml:()=>v,fillFormWithConfig:()=>Wr,getAllStyles:()=>gc,getFormApiConfig:()=>ar,getJQuery:()=>$,getTargetDocument:()=>Yt,initUI:()=>uc,isContainerValid:()=>N,normalizeCustomSelectOptions:()=>zr,openCustomSelectDropdown:()=>oi,readFileContent:()=>mt,registerComponents:()=>Bo,renderApiPanel:()=>pn,renderBypassPanel:()=>wn,renderCustomSelectControl:()=>Kr,renderEscapeTransformToolPanel:()=>vn,renderLoggerPanel:()=>_n,renderMainTab:()=>yc,renderPunctuationTransformToolPanel:()=>xn,renderRegexPanel:()=>gn,renderSettingsPanel:()=>Sn,renderStatusBlockPanel:()=>bn,renderSubTabComponent:()=>pc,renderSummaryToolPanel:()=>mn,renderTableWorkbenchPanel:()=>Tn,renderToolPanel:()=>fn,renderYouyouReviewPanel:()=>hn,repositionActiveCustomSelectDropdown:()=>da,resetJQueryCache:()=>Rd,showToast:()=>S,showTopNotice:()=>we,toggleCustomSelectDropdown:()=>Ur,uiManager:()=>ce});function Bo(){ce.register(Rt.id,Rt),ce.register(Qt.id,Qt),ce.register(ss.id,ss),ce.register(cs.id,cs),ce.register(ds.id,ds),ce.register(us.id,us),ce.register(ys.id,ys),ce.register(ps.id,ps),ce.register(gs.id,gs),ce.register(wt.id,wt),ce.register(ms.id,ms),ce.register(bs.id,bs),dc.log("\u7EC4\u4EF6\u6CE8\u518C\u5B8C\u6210")}function uc(t={}){let{autoInjectStyles:e=!0,targetDocument:s,...r}=t;ce.init(r),Bo(),e&&ce.injectStyles(s),dc.log("\u6A21\u5757\u521D\u59CB\u5316\u5B8C\u6210")}function yn(){ce.getComponent(Rt.id)||Bo()}function Ye(t,e,s={}){yn(),ce.render(t,e,s)}function pn(t){Ye(Rt.id,t)}function gn(t){Ye(Qt.id,t)}function fn(t){Ye(ss.id,t)}function mn(t){Ye(cs.id,t)}function bn(t){Ye(ds.id,t)}function hn(t){Ye(us.id,t)}function vn(t){Ye(ys.id,t)}function xn(t){Ye(ps.id,t)}function wn(t){Ye(gs.id,t)}function Sn(t){Ye(wt.id,t)}function Tn(t){Ye(ms.id,t)}function _n(t){Ye(bs.id,t)}function yc(t,e){let s=An[t];if(!s)return!1;yn();try{s.render(e)}catch{e.html(`<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>${s.failMessage}</span></div>`)}return!0}function pc(t,e){let s=En[t];if(!s)return null;yn();try{s.render(e)}catch{e.html(`<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>${s.failMessage}</span></div>`)}return t}function gc(){return ce.getAllStyles()}var dc,An,En,Ap,mc=z(()=>{re();ua();ya();va();Ma();Ka();Wa();ja();Ha();qa();Ga();Eo();dn();un();Se();ua();ya();va();Ma();Ka();Wa();ja();Ha();qa();Ga();Eo();dn();un();dc=B.createScope("UI");An=Object.freeze({apiPresets:{render:t=>pn(t),failMessage:"API \u9884\u8BBE\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},toolManage:{render:t=>fn(t),failMessage:"\u5DE5\u5177\u7BA1\u7406\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},regexExtract:{render:t=>gn(t),failMessage:"\u6B63\u5219\u63D0\u53D6\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},tableWorkbench:{render:t=>Tn(t),failMessage:"\u586B\u8868\u5DE5\u4F5C\u53F0\u52A0\u8F7D\u5931\u8D25"},bypass:{render:t=>wn(t),failMessage:"Ai\u6307\u4EE4\u9884\u8BBE\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},settings:{render:t=>Sn(t),failMessage:"\u8BBE\u7F6E\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},logger:{render:t=>_n(t),failMessage:"\u65E5\u5FD7\u9762\u677F\u52A0\u8F7D\u5931\u8D25"}}),En=Object.freeze({SummaryToolPanel:{render:t=>mn(t),failMessage:"\u6458\u8981\u5DE5\u5177\u52A0\u8F7D\u5931\u8D25"},StatusBlockPanel:{render:t=>bn(t),failMessage:"\u4E3B\u89D2\u72B6\u6001\u680F\u52A0\u8F7D\u5931\u8D25"},YouyouReviewPanel:{render:t=>hn(t),failMessage:"\u5C0F\u5E7D\u70B9\u8BC4\u52A0\u8F7D\u5931\u8D25"},EscapeTransformToolPanel:{render:t=>vn(t),failMessage:"\u8F6C\u4E49\u5904\u7406\u5DE5\u5177\u52A0\u8F7D\u5931\u8D25"},PunctuationTransformToolPanel:{render:t=>xn(t),failMessage:"\u4E2D\u6587\u6807\u70B9\u66FF\u6362\u5DE5\u5177\u52A0\u8F7D\u5931\u8D25"}});Ap={uiManager:ce,ApiPresetPanel:Rt,RegexExtractPanel:Qt,ToolManagePanel:ss,SummaryToolPanel:cs,StatusBlockPanel:ds,YouyouReviewPanel:us,EscapeTransformToolPanel:ys,PunctuationTransformToolPanel:ps,BypassPanel:gs,SettingsPanel:wt,TableWorkbenchPanel:ms,LoggerPanel:bs,registerComponents:Bo,initUI:uc,renderApiPanel:pn,renderRegexPanel:gn,renderToolPanel:fn,renderSummaryToolPanel:mn,renderStatusBlockPanel:bn,renderYouyouReviewPanel:hn,renderEscapeTransformToolPanel:vn,renderPunctuationTransformToolPanel:xn,renderBypassPanel:wn,renderSettingsPanel:Sn,renderTableWorkbenchPanel:Tn,renderLoggerPanel:_n,MAIN_TAB_RENDERERS:An,SUB_TAB_RENDERERS:En,renderMainTab:yc,renderSubTabComponent:pc,getAllStyles:gc}});var hc={};pe(hc,{WindowManager:()=>Uo,closeWindow:()=>Ip,createWindow:()=>Cp,windowManager:()=>Ue});function kp(){if(Ue.stylesInjected)return;Ue.stylesInjected=!0;let t=`
    /* ============================================================
  ...
  `,e=document.createElement("style");e.id=Mp+"_styles",e.textContent=t,(document.head||document.documentElement).appendChild(e)}function Cp(t){let{id:e,title:s="\u7A97\u53E3",content:r="",width:o=900,height:a=700,modal:n=!1,resizable:i=!0,maximizable:l=!0,startMaximized:c=!1,rememberState:d=!0,onClose:u,onReady:y}=t;kp();let p=window.jQuery||window.parent?.jQuery;if(!p)return Ep.error("jQuery not available"),null;if(Ue.isOpen(e))return Ue.bringToFront(e),Ue.getWindow(e);let g=window.innerWidth||1200,x=window.innerHeight||800,b=g<=1100,T=null,A=!1;d&&(T=Ue.getState(e),T&&!b&&(A=!0));let w,L;A&&T.width&&T.height?(w=Math.max(400,Math.min(T.width,g-40)),L=Math.max(300,Math.min(T.height,x-40))):(w=Math.max(400,Math.min(o,g-40)),L=Math.max(300,Math.min(a,x-40)));let M=Math.max(20,Math.min((g-w)/2,g-w-20)),k=Math.max(20,Math.min((x-L)/2,x-L-20)),R=l&&!b,ee=`
  ...
  `,Y=null;n&&(Y=p(`<div class="yyt-window-overlay" data-for="${e}"></div>`),p(document.body).append(Y));let U=p(ee);p(document.body).append(U),Ue.register(e,U),U.on("mousedown",()=>Ue.bringToFront(e));let J=!1,ke={left:M,top:k,width:w,height:L},be=()=>{ke={left:parseInt(U.css("left")),top:parseInt(U.css("top")),width:U.width(),height:U.height()},U.addClass("maximized"),U.find(".yyt-window-btn.maximize i").removeClass("fa-expand").addClass("fa-compress"),J=!0},Ce=()=>{U.removeClass("maximized"),U.css({left:ke.left+"px",top:ke.top+"px",width:ke.width+"px",height:ke.height+"px"}),U.find(".yyt-window-btn.maximize i").removeClass("fa-compress").addClass("fa-expand"),J=!1};U.find(".yyt-window-btn.maximize").on("click",()=>{J?Ce():be()}),(b&&l||A&&T.isMaximized&&l||c&&l)&&be(),U.find(".yyt-window-btn.close").on("click",()=>{if(d&&l){let ue={width:J?ke.width:U.width(),height:J?ke.height:U.height(),isMaximized:J};Ue.saveState(e,ue)}u&&u(),Y&&Y.remove(),U.remove(),Ue.unregister(e),p(document).off(".yytWindowDrag"+e),p(document).off(".yytWindowResize"+e)}),Y&&Y.on("click",ue=>{ue.target,Y[0]});let se=!1,Tt,Nt,Je,Bt;if(U.find(".yyt-window-header").on("mousedown",ue=>{p(ue.target).closest(".yyt-window-controls").length||J||(se=!0,Tt=ue.clientX,Nt=ue.clientY,Je=parseInt(U.css("left")),Bt=parseInt(U.css("top")),p(document.body).css("user-select","none"))}),p(document).on("mousemove.yytWindowDrag"+e,ue=>{if(!se)return;let oe=ue.clientX-Tt,yt=ue.clientY-Nt;U.css({left:Math.max(0,Je+oe)+"px",top:Math.max(0,Bt+yt)+"px"})}),p(document).on("mouseup.yytWindowDrag"+e,()=>{se&&(se=!1,p(document.body).css("user-select",""))}),i){let ue=!1,oe="",yt,tt,ye,pt,he,qs;U.find(".yyt-window-resize-handle").on("mousedown",function(_t){J||(ue=!0,oe="",p(this).hasClass("se")?oe="se":p(this).hasClass("e")?oe="e":p(this).hasClass("s")?oe="s":p(this).hasClass("w")?oe="w":p(this).hasClass("n")?oe="n":p(this).hasClass("nw")?oe="nw":p(this).hasClass("ne")?oe="ne":p(this).hasClass("sw")&&(oe="sw"),yt=_t.clientX,tt=_t.clientY,ye=U.width(),pt=U.height(),he=parseInt(U.css("left")),qs=parseInt(U.css("top")),p(document.body).css("user-select","none"),_t.stopPropagation())}),p(document).on("mousemove.yytWindowResize"+e,_t=>{if(!ue)return;let Gs=_t.clientX-yt,Ut=_t.clientY-tt,hs=400,Ys=300,zt=ye,At=pt,Kt=he,Pr=qs;if(oe.includes("e")&&(zt=Math.max(hs,ye+Gs)),oe.includes("s")&&(At=Math.max(Ys,pt+Ut)),oe.includes("w")){let Wt=ye-Gs;Wt>=hs&&(zt=Wt,Kt=he+Gs)}if(oe.includes("n")){let Wt=pt-Ut;Wt>=Ys&&(At=Wt,Pr=qs+Ut)}U.css({width:zt+"px",height:At+"px",left:Kt+"px",top:Pr+"px"})}),p(document).on("mouseup.yytWindowResize"+e,()=>{ue&&(ue=!1,p(document.body).css("user-select",""))})}return U.on("remove",()=>{p(document).off(".yytWindowDrag"+e),p(document).off(".yytWindowResize"+e)}),y&&setTimeout(()=>y(U),50),U}function Ip(t){let e=Ue.getWindow(t);if(e){let s=window.jQuery||window.parent?.jQuery;s&&(s(`.yyt-window-overlay[data-for="${t}"]`).remove(),s(document).off(".yytWindowDrag"+t),s(document).off(".yytWindowResize"+t)),e.remove(),Ue.unregister(t)}}function Rp(t){return typeof t!="string"?"":t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}var Ep,Mp,bc,Uo,Ue,vc=z(()=>{ze();re();Ep=B.createScope("WindowManager"),Mp="youyou_toolkit_window_manager",bc="window_states",Uo=class{constructor(){this.windows=new Map,this.baseZIndex=1e4,this.topZIndex=1e4,this.stylesInjected=!1}register(e,s){this.topZIndex++,this.windows.set(e,{$el:s,zIndex:this.topZIndex}),s.css("z-index",this.topZIndex)}unregister(e){this.windows.delete(e)}bringToFront(e){let s=this.windows.get(e);s&&(this.topZIndex++,s.zIndex=this.topZIndex,s.$el.css("z-index",this.topZIndex))}getWindow(e){return this.windows.get(e)?.$el||null}isOpen(e){return this.windows.has(e)}closeAll(){this.windows.forEach((e,s)=>{e.$el&&e.$el.remove()}),this.windows.clear()}saveState(e,s){let r=this.loadStates();r[e]={...s,updatedAt:Date.now()},Vs.set(bc,r)}loadStates(){return Vs.get(bc)||{}}getState(e){return this.loadStates()[e]||null}},Ue=new Uo});var Ac={};pe(Ac,{TX_PHASE:()=>Ve,ToolAutomationService:()=>Ko,Transaction:()=>zo,default:()=>Up,toolAutomationService:()=>_c});function Q(t){return t==null?"":String(t).trim()}function Cn(){try{if(typeof window.parent<"u"&&window.parent&&window.parent!==window)return window.parent}catch{}return window}function xc(){try{return Cn()?.SillyTavern||null}catch{return null}}function Wo(t){try{return t?.getContext?.()||null}catch{return null}}function Mn(t,e){if(!t)return null;let s=typeof t?.on=="function"||typeof t?.addListener=="function",r=typeof t?.off=="function"||typeof t?.removeListener=="function";return!s||!r?null:{eventSource:t,source:e,capabilities:{on:typeof t?.on=="function",off:typeof t?.off=="function",addListener:typeof t?.addListener=="function",removeListener:typeof t?.removeListener=="function"}}}function $p(t){let e=Cn(),s=Wo(t);return[Mn(t?.eventSource,"SillyTavern.eventSource"),Mn(e?.eventSource,"topWindow.eventSource"),Mn(s?.eventSource,"SillyTavern.getContext().eventSource")].filter(Boolean)[0]||{eventSource:null,source:"unavailable",capabilities:{on:!1,off:!1,addListener:!1,removeListener:!1}}}function Dp(t){let e=Wo(t);return t?.eventTypes||e?.eventTypes||Cn()?.event_types||{}}function wc(t){let e=Wo(t);return Q(e?.chatId??e?.chat_id??t?.chatId??t?.chat_id??t?.chat_filename??t?.this_chid??"chat_default")||"chat_default"}function Sc(t){let e=Wo(t);return Array.isArray(e?.chat)?e.chat:Array.isArray(t?.chat)?t.chat:[]}function Tc(t){if(!t||t?.is_user===!0||t?.is_system===!0)return!1;let e=String(t?.role||"").trim().toLowerCase();return e==="user"||e==="system"?!1:e==="assistant"||e==="ai"||!e}function Op(t,e){let s=Q(e);if(!s)return null;let r=Sc(t);for(let o=r.length-1;o>=0;o-=1){let a=r[o];if([a?.messageId,a?.message_id,a?.id,a?.mesid,a?.mid,a?.chat_index,o].map(i=>Q(i)).includes(s))return a||null}return null}function Lp(t){let e=Sc(t);if(!Array.isArray(e)||e.length===0)return null;let s=e.length-1,r=e[s]||null;if(!Tc(r))return null;let o=Q(r?.messageId??r?.message_id??r?.id??r?.mesid??r?.mid??r?.chat_index??s);return o?{messageId:o,swipeId:Q(r?.swipeId??r?.swipe_id??r?.swipe??r?.swipeIndex),message:r}:null}function kn(t){if(!t)return"";let e=String(t).trim();return e=e.replace(/([a-z0-9])([A-Z])/g,"$1_$2"),e.toUpperCase()}function Np(t){let e=String(t||"");if(e.length===0)return"0";let s=5381,r=Math.min(e.length,2e3);for(let o=0;o<r;o++)s=(s<<5)+s+e.charCodeAt(o)|0;return(s>>>0).toString(36)}function Bp(){let t=Date.now().toString(36),e=Math.random().toString(36).slice(2,8);return`tx_${t}_${e}`}var Pp,Ve,zo,Ko,_c,Up,Ec=z(()=>{vr();fe();re();Dt();xo();Is();Pp=B.createScope("ToolAutomation");Ve=Object.freeze({RECEIVED:"received",CONFIRMED:"confirmed",CONTEXT_BUILT:"context_built",REQUEST_STARTED:"request_started",REQUEST_FINISHED:"request_finished",WRITEBACK_STARTED:"writeback_started",WRITEBACK_COMMITTED:"writeback_committed",REFRESH_CONFIRMED:"refresh_confirmed",SKIPPED:"skipped",FAILED:"failed"}),zo=class{constructor({chatId:e,messageId:s,swipeId:r,sourceEvent:o,generationKey:a}){this.traceId=Bp(),this.chatId=e||"",this.messageId=s||"",this.swipeId=r||"",this.sourceEvent=o||"",this.generationKey=a||"",this.phase=Ve.RECEIVED,this.createdAt=Date.now(),this.updatedAt=Date.now(),this.verdict="",this.error=null,this.toolResults=[],this.writebackState=null,this.refreshState=null}transition(e,s={}){return this.phase=e,this.updatedAt=Date.now(),Object.assign(this,s),this}toSnapshot(){return{...this}}},Ko=class{constructor(){this._stopCallbacks=[],this._pendingTimers=new Map,this._completedGenerationKeys=new Map,this._cancelledGenerationKeys=new Map,this._slotQueues=new Map,this._activeTransactions=new Map,this._isProcessing=!1,this._currentChatId="",this._enabled=!1,this._enabledCheckedOnce=!1,this.debugMode=!1,this._transactionHistory=[],this._maxHistorySize=30,this._hostBindingStatus={initialized:!1,initAttempts:0,lastInitAt:0,lastInitResult:"idle",source:"unavailable",hasEventSource:!1,hasEventTypes:!1,eventBindings:[],retryScheduled:!1,retryDelayMs:0,lastError:""},this._initRetryTimer=null,this._messageReceivedThrottleUntil=0}setDebugMode(e){this.debugMode=e===!0}init(e={}){this.stop();let s=xc(),r=e.retryOnFailure!==!1,o=Number.isFinite(e.retryDelayMs)?e.retryDelayMs:1500,a=Number.isFinite(e.attempt)?e.attempt:1;if(this._hostBindingStatus.initAttempts=a,this._hostBindingStatus.lastInitAt=Date.now(),!s)return this._hostBindingStatus={...this._hostBindingStatus,initialized:!1,lastInitResult:"missing_api",source:"unavailable",hasEventSource:!1,hasEventTypes:!1,eventBindings:[],lastError:"\u672A\u627E\u5230\u5BBF\u4E3B API (SillyTavern)",retryScheduled:!1,retryDelayMs:0},this._log("\u521D\u59CB\u5316\u5931\u8D25: \u672A\u627E\u5230\u5BBF\u4E3B API (SillyTavern)"),!1;this._currentChatId=wc(s);let n=$p(s),i=n?.eventSource||null,l=Dp(s),c=typeof i?.on=="function"?i.on.bind(i):typeof i?.addListener=="function"?i.addListener.bind(i):null,d=typeof i?.off=="function"?i.off.bind(i):typeof i?.removeListener=="function"?i.removeListener.bind(i):null,u=!!(l&&Object.keys(l).length>0);if(this._hostBindingStatus={...this._hostBindingStatus,source:n?.source||"unavailable",hasEventSource:!!i,hasEventTypes:u,eventBindings:[],lastError:"",retryScheduled:!1,retryDelayMs:0,initialized:!1,lastInitResult:"binding"},!c||!d){let g="\u5BBF\u4E3B eventSource \u7F3A\u5C11 on/off \u65B9\u6CD5";return this._hostBindingStatus={...this._hostBindingStatus,lastInitResult:"missing_event_source",lastError:g},this._log(`\u521D\u59CB\u5316\u5931\u8D25: ${g}`,{source:this._hostBindingStatus.source}),r&&this._scheduleInitRetry(o,a+1),!1}this._log("\u5BBF\u4E3B eventTypes \u6620\u5C04:",JSON.stringify(l,null,2));let y=(g,x)=>{if(!g||typeof x!="function")return;let b=g;c(b,x),this._hostBindingStatus.eventBindings=[...this._hostBindingStatus.eventBindings,`${b} -> ${kn(b)}`],this._stopCallbacks.push(()=>{try{d(b,x)}catch(T){this._log("\u53D6\u6D88\u4E8B\u4EF6\u5931\u8D25",b,T)}}),this._log(`\u5DF2\u7ED1\u5B9A\u5BBF\u4E3B\u4E8B\u4EF6: "${b}" (\u5F52\u4E00\u5316: ${kn(b)})`)},p=(g,...x)=>{let b=kn(g),{messageId:T,swipeId:A}=this._extractIdentitiesFromArgs(x);if(this._log(`\u6536\u5230\u5BBF\u4E3B\u4E8B\u4EF6 "${g}" \u2192 "${b}"`,{messageId:T,swipeId:A,argCount:x.length}),!this._checkEnabled())return;if(b==="MESSAGE_RECEIVED"){let R=Date.now();if(R<this._messageReceivedThrottleUntil){this._log(`MESSAGE_RECEIVED \u5728\u8282\u6D41\u7A97\u53E3\u5185\uFF0C\u8DF3\u8FC7\uFF08\u5269\u4F59 ${this._messageReceivedThrottleUntil-R}ms\uFF09`);return}this._messageReceivedThrottleUntil=R+3e3}let w=null,L=T,M=A;if(L&&(w=Op(s,L)),!w){let R=Lp(s);R?.messageId&&(w=R.message,L=R.messageId,M=R.swipeId||M)}if(!L||!w){this._log(`\u4E8B\u4EF6 "${b}" \u65E0 assistant \u76EE\u6807\uFF0C\u8DF3\u8FC7`);return}if(!Tc(w)){this._log(`\u4E8B\u4EF6 "${b}" \u547D\u4E2D\u975E assistant \u6D88\u606F\uFF0C\u8DF3\u8FC7`,{messageId:L});return}let k=String(w.content||w.mes||"").trim();if(!k||k.length<5){this._log(`\u4E8B\u4EF6 "${b}" \u6D88\u606F\u8FC7\u77ED\uFF08${k.length} \u5B57\u7B26\uFF09\uFF0C\u8DF3\u8FC7`);return}if(this._isProcessing){this._log(`\u4E8B\u4EF6 "${b}" \u6B63\u5728\u5904\u7406\u4E2D\uFF0C\u8DF3\u8FC7`);return}this._scheduleMessageProcessing(L,M,{settleMs:this._getSettleMs(),sourceEvent:b})};return y(l.MESSAGE_SENT||"message_sent",()=>{this._log("MESSAGE_SENT \u2192 \u6E05\u7406\u8C03\u5EA6\u961F\u5217"),this._pendingTimers.forEach(g=>clearTimeout(g)),this._pendingTimers.clear()}),y(l.MESSAGE_RECEIVED||"message_received",(...g)=>{p(l.MESSAGE_RECEIVED||"message_received",...g)}),y(l.GENERATION_ENDED||"generation_ended",(...g)=>{p(l.GENERATION_ENDED||"generation_ended",...g)}),y(l.CHAT_CHANGED||"chat_changed",()=>{this._resetForChatChange()}),y(l.MESSAGE_DELETED||"message_deleted",g=>{this._clearMessageState(Q(g))}),this._stopCallbacks.push(P.on(I.SETTINGS_UPDATED,()=>{let g=this._enabled;this._enabled=this._evaluateEnabled(),g!==this._enabled&&this._log(`\u81EA\u52A8\u5316\u72B6\u6001\u53D8\u66F4: ${g} \u2192 ${this._enabled}`)})),this._enabled=this._evaluateEnabled(),this._enabledCheckedOnce=!1,this._hostBindingStatus={...this._hostBindingStatus,initialized:!0,lastInitResult:"ready",retryScheduled:!1,retryDelayMs:0,lastError:""},this._log("\u81EA\u52A8\u5316\u670D\u52A1\u5DF2\u521D\u59CB\u5316",{enabled:this._enabled,chatId:this._currentChatId,source:this._hostBindingStatus.source}),!0}stop(){this._stopCallbacks.forEach(e=>{try{e()}catch(s){this._log("\u505C\u6B62\u56DE\u8C03\u5931\u8D25",s)}}),this._stopCallbacks=[],this._pendingTimers.forEach(e=>clearTimeout(e)),this._pendingTimers.clear(),this._slotQueues.clear(),this._completedGenerationKeys.clear(),this._cancelledGenerationKeys.clear(),this._cancelActiveTransactions("service_stopped"),this._activeTransactions.clear(),this._isProcessing=!1,this._enabled=!1,this._enabledCheckedOnce=!1,this._initRetryTimer&&(clearTimeout(this._initRetryTimer),this._initRetryTimer=null),this._hostBindingStatus={initialized:!1,initAttempts:0,lastInitAt:0,lastInitResult:"idle",source:"unavailable",hasEventSource:!1,hasEventTypes:!1,eventBindings:[],retryScheduled:!1,retryDelayMs:0,lastError:""}}isEnabled(){return this._enabled}getRuntimeSnapshot(){return this._pruneCompletedKeys(),this._pruneCancelledKeys(),{currentChatId:this._currentChatId,enabled:this._enabled,isProcessing:this._isProcessing,pendingTimerCount:this._pendingTimers.size,queuedSlotCount:this._slotQueues.size,completedGenerationKeyCount:this._completedGenerationKeys.size,cancelledGenerationKeyCount:this._cancelledGenerationKeys.size,activeTransactionCount:this._activeTransactions.size,recentTransactions:this._transactionHistory.slice(-10).map(e=>e.toSnapshot()),hostBinding:{...this._hostBindingStatus,eventBindings:Array.isArray(this._hostBindingStatus?.eventBindings)?[...this._hostBindingStatus.eventBindings]:[]},settings:this._getAutomationSettings()}}async processCurrentAssistantMessage(e={}){let s=await pr({messageId:"",swipeId:"",runSource:"AUTO"}),r=Q(s?.sourceMessageId||s?.messageId);return r?this.processAssistantMessage(r,{force:e.force===!0,swipeId:Q(s?.sourceSwipeId),sourceEvent:e.sourceEvent||"MANUAL_CURRENT_ASSISTANT"}):{success:!1,error:"\u672A\u627E\u5230\u5F53\u524D assistant \u697C\u5C42"}}async processAssistantMessage(e,{force:s=!1,swipeId:r="",sourceEvent:o="AUTO"}={}){let a=new zo({chatId:this._currentChatId,messageId:e,swipeId:r,sourceEvent:o});try{if(!e)return this._skipTransaction(a,"missing_message_id");if(!this._checkEnabled()&&!s)return this._skipTransaction(a,"automation_disabled");a.transition(Ve.CONFIRMED);let n=await pr({messageId:e,swipeId:r,runSource:"AUTO"}),i=n?.targetAssistantMessage||null;if(!i||!n?.sourceMessageId)return this._skipTransaction(a,"assistant_message_not_found");let l=String(i.content||i.mes||"").trim();if(!l||l.length<5)return this._skipTransaction(a,"assistant_message_too_short");a.transition(Ve.CONTEXT_BUILT);let c=Np(l),d=`${Q(n.sourceMessageId)}::${c}`;if(a.generationKey=d,!s&&this._hasCompletedGeneration(d))return this._skipTransaction(a,"duplicate_generation",{generationKey:d});if(!s&&this._isGenerationCancelled(d))return this._skipTransaction(a,"cancelled_generation",{generationKey:d});let u=lt.filterAutoPostResponseTools(yr());if(!u.length)return this._skipTransaction(a,"no_auto_tools",{tools:u});let y=`${Q(n.sourceMessageId)}::${Q(n.sourceSwipeId||r)}`;return a.slotKey=y,a.slotRevisionKey=n.slotRevisionKey||"",a.sourceMessageId=n.sourceMessageId||e,a.sourceSwipeId=n.sourceSwipeId||r||"",this._enqueueSlot(y,async()=>{if(this._hasCompletedGeneration(d)&&!s)return this._skipTransaction(a,"duplicate_generation_after_queue",{generationKey:d});if(this._isGenerationCancelled(d)&&!s)return this._skipTransaction(a,"cancelled_generation_after_queue",{generationKey:d});this._isProcessing=!0,a.transition(Ve.REQUEST_STARTED);let p=new AbortController;this._registerActiveTransaction(a,{controller:p,generationKey:d,slotKey:y,sourceMessageId:n.sourceMessageId||e,sourceSwipeId:n.sourceSwipeId||r||""});try{let g=[],x=!1;for(let w of u){let L={...n,signal:p.signal,isAutoRun:!0,abortMeta:{traceId:a.traceId,generationKey:d,slotKey:y,sourceMessageId:n.sourceMessageId||e,sourceSwipeId:n.sourceSwipeId||r||""},shouldAbortWriteback:()=>this._shouldAbortAutoWriteback({traceId:a.traceId,generationKey:d}),input:{...n.input||{},lastAiMessage:n.lastAiMessage,assistantBaseText:n.assistantBaseText}},M=await lt.runToolPostResponse(w,L);g.push(M),(M?.writebackState||M?.output)&&(x=!0)}a.transition(Ve.REQUEST_FINISHED,{toolResults:g}),x&&(a.transition(Ve.WRITEBACK_STARTED),a.writebackState={messageId:n.sourceMessageId,swipeId:n.sourceSwipeId,hasOutput:!0}),this._markGenerationCompleted(d);let b=g.every(w=>w?.success!==!1),T=g.some(w=>w?.meta?.aborted===!0||w?.meta?.stale===!0||w?.error==="\u8BF7\u6C42\u5DF2\u53D6\u6D88");b&&a.transition(Ve.WRITEBACK_COMMITTED);let A=b?Ve.REFRESH_CONFIRMED:Ve.FAILED;return a.transition(A,{verdict:T?"aborted":b?"success":"partial_failure"}),this._recordTransaction(a),this._updateAutoRuntimeForResults(u,n,a,g),{success:b,traceId:a.traceId,generationKey:d,sourceEvent:o,messageId:n.sourceMessageId||e,phase:a.phase,results:g}}finally{this._unregisterActiveTransaction(a.traceId),this._isProcessing=!1}})}catch(n){return a.transition(Ve.FAILED,{error:n?.message||String(n)}),this._recordTransaction(a),this._unregisterActiveTransaction(a.traceId),this._isProcessing=!1,this._log("processAssistantMessage \u5F02\u5E38",n),{success:!1,traceId:a.traceId,error:a.error,phase:a.phase}}}_extractIdentitiesFromArgs(e){let s="",r="";for(let o of e)if(o!=null){if(typeof o=="number"&&Number.isFinite(o)&&!s){s=Q(o);continue}if(typeof o=="string"){let a=Q(o);!s&&/^\d+$/.test(a)&&(s=a);continue}typeof o=="object"&&(s||(s=Q(o.messageId??o.message_id??o.id??o.mesid??o.chat_index??o.message?.messageId??o.message?.message_id??o.message?.id??o.message?.mesid??o.message?.chat_index??o.data?.messageId??o.data?.message_id??o.data?.id??o.target?.messageId??o.target?.message_id??o.target?.id)),r||(r=Q(o.swipeId??o.swipe_id??o.swipe??o.swipeIndex??o.currentSwipe??o.message?.swipeId??o.message?.swipe_id??o.message?.swipe??o.data?.swipeId??o.data?.swipe_id??o.data?.swipe??o.target?.swipeId??o.target?.swipe_id??o.target?.swipe)))}return{messageId:s,swipeId:r}}_scheduleMessageProcessing(e,s="",r={}){let o=r.settleMs??this._getSettleMs(),a=`msg::${Q(e)}::${Q(s)}`,n=this._pendingTimers.get(a);n&&clearTimeout(n);let i=setTimeout(()=>{this._pendingTimers.delete(a),this.processAssistantMessage(e,{swipeId:s,sourceEvent:r.sourceEvent||"AUTO"}).catch(l=>{this._log("\u8C03\u5EA6\u6267\u884C\u5931\u8D25",{messageId:e,error:l})})},Math.max(0,o));this._pendingTimers.set(a,i),this._log("\u5DF2\u8C03\u5EA6\u6D88\u606F\u5904\u7406",{timerKey:a,settleMs:o,sourceEvent:r.sourceEvent})}cancelAutomation(e={}){let s=e.reason||"manual_cancel",r=Q(e.messageId),o=Q(e.slotKey),a=Q(e.traceId),n=0;for(let[i,l]of this._pendingTimers){let c=r&&i.includes(`::${r}::`),d=o&&i.includes(o);(c||d||!r&&!o&&!a)&&(clearTimeout(l),this._pendingTimers.delete(i),n+=1)}return n+=this._cancelActiveTransactions(s,{messageId:r,slotKey:o,traceId:a}),{success:n>0,cancelledCount:n,reason:s}}_hasCompletedGeneration(e){if(!e)return!1;this._pruneCompletedKeys();let s=this._completedGenerationKeys.get(e);return s?Date.now()-s<this._getDedupeWindowMs():!1}_markGenerationCompleted(e){e&&(this._completedGenerationKeys.set(e,Date.now()),this._pruneCompletedKeys())}_markGenerationCancelled(e){e&&(this._cancelledGenerationKeys.set(e,Date.now()),this._pruneCancelledKeys())}_isGenerationCancelled(e){if(!e)return!1;this._pruneCancelledKeys();let s=this._cancelledGenerationKeys.get(e);return s?Date.now()-s<this._getDedupeWindowMs():!1}_pruneCompletedKeys(){let e=Date.now()-this._getDedupeWindowMs();for(let[s,r]of this._completedGenerationKeys)(!Number.isFinite(r)||r<e)&&this._completedGenerationKeys.delete(s)}_pruneCancelledKeys(){let e=Date.now()-this._getDedupeWindowMs();for(let[s,r]of this._cancelledGenerationKeys)(!Number.isFinite(r)||r<e)&&this._cancelledGenerationKeys.delete(s)}_recordTransaction(e){this._transactionHistory.push(e),this._transactionHistory.length>this._maxHistorySize&&(this._transactionHistory=this._transactionHistory.slice(-this._maxHistorySize)),this._log(`\u4E8B\u52A1 [${e.traceId}] \u2192 ${e.phase}`,{messageId:e.messageId,generationKey:e.generationKey,verdict:e.verdict,sourceEvent:e.sourceEvent,error:e.error})}_skipTransaction(e,s,r={}){return e.transition(Ve.SKIPPED,{verdict:s,...r}),this._recordTransaction(e),Array.isArray(r?.tools)&&r.tools.length>0&&this._updateAutoRuntimeForSkip(r.tools,e,s,r),{success:!1,skipped:!0,reason:s,traceId:e.traceId,...r}}_enqueueSlot(e,s){let o=(this._slotQueues.get(e)||Promise.resolve()).catch(()=>{}).then(s).finally(()=>{this._slotQueues.get(e)===o&&this._slotQueues.delete(e)});return this._slotQueues.set(e,o),o}_registerActiveTransaction(e,s={}){e?.traceId&&this._activeTransactions.set(e.traceId,{traceId:e.traceId,generationKey:s.generationKey||e.generationKey||"",slotKey:s.slotKey||e.slotKey||"",sourceMessageId:s.sourceMessageId||e.sourceMessageId||"",sourceSwipeId:s.sourceSwipeId||e.sourceSwipeId||"",slotRevisionKey:s.slotRevisionKey||e.slotRevisionKey||"",assistantBaseFingerprint:s.assistantBaseFingerprint||"",assistantBaseText:s.assistantBaseText||"",controller:s.controller||null,cancelled:!1,cancelReason:""})}_unregisterActiveTransaction(e){e&&this._activeTransactions.delete(e)}_cancelActiveTransactions(e="manual_cancel",s={}){let r=Q(s.messageId),o=Q(s.slotKey),a=Q(s.traceId),n=0;for(let[i,l]of this._activeTransactions){let c=a&&i===a,d=r&&Q(l?.sourceMessageId)===r,u=o&&Q(l?.slotKey)===o;if(!(!c&&!d&&!u&&!(!a&&!r&&!o))){l.cancelled=!0,l.cancelReason=e,l?.generationKey&&this._markGenerationCancelled(l.generationKey);try{l?.controller?.abort?.()}catch{}n+=1}}return n}_shouldAbortAutoWriteback(e={}){let s=Q(e.traceId),r=Q(e.generationKey);if(s){let o=this._activeTransactions.get(s);if(!o||o.cancelled)return{aborted:!0,reason:"cancelled_before_host_commit"}}return r&&this._isGenerationCancelled(r)?{aborted:!0,reason:"cancelled_before_host_commit"}:!1}_updateAutoRuntimeForSkip(e,s,r,o={}){e.forEach(a=>{a?.id&&$t(a.id,{lastAutoRunAt:Date.now(),lastAutoStatus:"skipped",lastAutoMessageId:s?.sourceMessageId||s?.messageId||"",lastAutoSwipeId:s?.sourceSwipeId||s?.swipeId||"",lastAutoRevisionKey:s?.slotRevisionKey||o?.slotRevisionKey||"",lastAutoWritebackStatus:"",lastAutoRefreshConfirmed:!1,lastAutoSkipReason:r||""},{touchLastRunAt:!1,emitEvent:!1,emitRuntimeEvent:!0})})}_updateAutoRuntimeForResults(e,s,r,o=[]){e.forEach((a,n)=>{if(!a?.id)return;let i=o[n]||{},l=i?.meta?.writebackDetails||{},c=i?.meta?.aborted===!0||i?.meta?.stale===!0?"aborted":i?.success===!1?"failed":"success",d=i?.meta?.aborted===!0?i?.meta?.abortReason||(i?.meta?.stale===!0?"stale_base_changed":"cancelled_before_host_commit"):"";$t(a.id,{lastAutoRunAt:Date.now(),lastAutoStatus:c,lastAutoMessageId:s?.sourceMessageId||r?.sourceMessageId||r?.messageId||"",lastAutoSwipeId:s?.sourceSwipeId||r?.sourceSwipeId||r?.swipeId||"",lastAutoRevisionKey:s?.slotRevisionKey||r?.slotRevisionKey||"",lastAutoWritebackStatus:i?.meta?.writebackStatus||"",lastAutoRefreshConfirmed:!!l.refreshConfirmed,lastAutoSkipReason:d},{touchLastRunAt:!1,emitEvent:!1,emitRuntimeEvent:!0})})}_resetForChatChange(){let e=xc(),s=wc(e);this._log("\u804A\u5929\u5207\u6362",{from:this._currentChatId,to:s}),this._currentChatId=s,this._pendingTimers.forEach(r=>clearTimeout(r)),this._pendingTimers.clear(),this._slotQueues.clear(),this._completedGenerationKeys.clear(),this._cancelledGenerationKeys.clear(),this._cancelActiveTransactions("chat_changed"),this._activeTransactions.clear(),this._isProcessing=!1,this._messageReceivedThrottleUntil=0}_scheduleInitRetry(e,s){this._initRetryTimer&&clearTimeout(this._initRetryTimer),this._hostBindingStatus={...this._hostBindingStatus,retryScheduled:!0,retryDelayMs:e},this._initRetryTimer=setTimeout(()=>{this._initRetryTimer=null,this.init({retryOnFailure:!1,retryDelayMs:e,attempt:s})},Math.max(200,e))}_clearMessageState(e){if(e){for(let[s,r]of this._pendingTimers)(s.includes(`::${e}::`)||s.startsWith(`msg::${e}::`))&&(clearTimeout(r),this._pendingTimers.delete(s));for(let s of this._completedGenerationKeys.keys())s.startsWith(`${e}::`)&&this._completedGenerationKeys.delete(s)}}_evaluateEnabled(){return this._getAutomationSettings().enabled===!0}_checkEnabled(){if(this._enabled)return!0;if(!this._enabledCheckedOnce){this._enabledCheckedOnce=!0;let e=this._getAutomationSettings();this._log("\u26A0 \u81EA\u52A8\u5316\u672A\u542F\u7528\uFF0C\u9996\u6B21\u8BCA\u65AD:",{"automation.enabled":e.enabled,"\u5B8C\u6574 automation \u8BBE\u7F6E":e,\u63D0\u793A:"\u8BF7\u786E\u4FDD settings.automation.enabled === true"})}return!1}_getAutomationSettings(){let e=He.getSettings()?.automation||{},s=Number.isFinite(e.settleMs)?e.settleMs:800;return{enabled:e.enabled===!0,settleMs:s,dedupeWindowMs:Number.isFinite(e.dedupeWindowMs)?e.dedupeWindowMs:Math.max(1200,s+600)}}_getSettleMs(){return this._getAutomationSettings().settleMs}_getDedupeWindowMs(){return this._getAutomationSettings().dedupeWindowMs}_log(...e){Pp.log(e[0],e.length>1?e.slice(1):void 0)}},_c=new Ko,Up=_c});var Vp={};pe(Vp,{default:()=>Yp});re();var Mc={};function kc(t,e={}){let{constants:s,topLevelWindow:r,modules:o}=t,{SCRIPT_ID:a,SCRIPT_VERSION:n,MENU_ITEM_ID:i,MENU_CONTAINER_ID:l}=s,c=null,d=!1,u=B.createScope("Bootstrap");function y(...M){u.log(M.join(" "))}function p(...M){u.error(M.join(" "))}async function g(){return c||(c=(async()=>{try{return o.storageModule=await Promise.resolve().then(()=>(Un(),Bn)),o.apiConnectionModule=await Promise.resolve().then(()=>(er(),Fn)),o.presetManagerModule=await Promise.resolve().then(()=>(rr(),Yn)),o.uiModule=await Promise.resolve().then(()=>(mc(),fc)),o.regexExtractorModule=await Promise.resolve().then(()=>(Zr(),bi)),o.toolManagerModule=await Promise.resolve().then(()=>(lo(),Ai)),o.toolExecutorModule=await Promise.resolve().then(()=>(Ba(),Na)),o.windowManagerModule=await Promise.resolve().then(()=>(vc(),hc)),o.toolRegistryModule=await Promise.resolve().then(()=>(Dt(),Fi)),o.settingsServiceModule=await Promise.resolve().then(()=>(vr(),rl)),o.bypassManagerModule=await Promise.resolve().then(()=>(br(),sl)),o.variableResolverModule=await Promise.resolve().then(()=>(wr(),il)),o.contextInjectorModule=await Promise.resolve().then(()=>(os(),al)),o.toolPromptServiceModule=await Promise.resolve().then(()=>(ho(),cl)),o.toolOutputServiceModule=await Promise.resolve().then(()=>(xo(),ul)),o.toolAutomationServiceModule=await Promise.resolve().then(()=>(Ec(),Ac)),o.toolOutputServiceModule?.toolOutputService&&o.apiConnectionModule&&o.toolOutputServiceModule.toolOutputService.setApiConnection(o.apiConnectionModule),!0}catch(M){return c=null,p("\u6A21\u5757\u52A0\u8F7D\u5931\u8D25\uFF0C\u4F7F\u7528\u5185\u7F6E\u529F\u80FD:",M),p("\u5DF2\u52A0\u8F7D\u6A21\u5757:",Object.keys(o).filter(k=>o[k])),!1}})(),c)}function x(){return`
    ...
    `}async function b(){let M=`${a}-styles`,k=r.document||document;if(k.getElementById(M))return;let R="",ee=[];try{ee.push(new URL("../styles/main.css",Mc.url).href)}catch{}try{ee.push(new URL("../../styles/main.css",Mc.url).href)}catch{}ee.push("./styles/main.css");for(let U of[...new Set(ee.filter(Boolean))])try{let J=await fetch(U);if(J.ok){R=await J.text();break}}catch{}R||(y("\u65E0\u6CD5\u52A0\u8F7D\u5916\u90E8\u6837\u5F0F\u6587\u4EF6\uFF0C\u4F7F\u7528\u5185\u7F6E\u6837\u5F0F"),R=x());let Y=k.createElement("style");Y.id=M,Y.textContent=R,(k.head||k.documentElement).appendChild(Y),y("\u6837\u5F0F\u5DF2\u6CE8\u5165")}function T(){let M=r.document||document;if(o.uiModule?.getAllStyles){let k=`${a}-ui-styles`;if(!M.getElementById(k)){let R=M.createElement("style");R.id=k,R.textContent=o.uiModule.getAllStyles(),(M.head||M.documentElement).appendChild(R)}}}async function A(){try{let{applyUiPreferences:M}=await Promise.resolve().then(()=>(Eo(),El));if(o.settingsServiceModule?.settingsService){let k=o.settingsServiceModule.settingsService.getUiSettings();if(k&&k.theme){let R=r.document||document;M(k,R),y(`\u4E3B\u9898\u5DF2\u5E94\u7528: ${k.theme}`)}}}catch(M){y("\u4E3B\u9898\u52A0\u8F7D\u5931\u8D25:",M)}}function w(){let M=r.jQuery||window.jQuery;if(!M){p("jQuery \u672A\u627E\u5230\uFF0C\u5EF6\u8FDF\u91CD\u8BD5..."),setTimeout(w,1e3);return}let k=r.document||document,R=M("#extensionsMenu",k);if(!R.length){y("\u9B54\u68D2\u83DC\u5355\u672A\u627E\u5230\uFF0C\u5EF6\u8FDF\u91CD\u8BD5..."),setTimeout(w,2e3);return}if(M(`#${l}`,R).length>0){y("\u83DC\u5355\u9879\u5DF2\u5B58\u5728");return}let Y=M(`<div class="extension_container interactable" id="${l}" tabindex="0"></div>`),U=`
      <div class="list-group-item flex-container flexGap5 interactable" id="${i}" title="\u6253\u5F00 YouYou \u5DE5\u5177\u7BB1">
        <div class="fa-fw fa-solid fa-wand-magic-sparkles extensionsMenuExtensionButton"></div>
        <span>YouYou \u5DE5\u5177\u7BB1</span>
      </div>
    `,J=M(U);J.on("click",function(be){be.stopPropagation(),y("\u83DC\u5355\u9879\u88AB\u70B9\u51FB");let Ce=M("#extensionsMenuButton",k);Ce.length&&R.is(":visible")&&Ce.trigger("click"),typeof e.openPopup=="function"&&e.openPopup()}),Y.append(J),R.append(Y),y("\u83DC\u5355\u9879\u5DF2\u6DFB\u52A0\u5230\u9B54\u68D2\u533A")}async function L(){y(`\u521D\u59CB\u5316\u5F00\u59CB... \u7248\u672C: ${n}`),await b();let M=await g();if(y(M?"\u6240\u6709\u6A21\u5757\u52A0\u8F7D\u6210\u529F":"\u90E8\u5206\u6A21\u5757\u52A0\u8F7D\u5931\u8D25\uFF0C\u4F7F\u7528\u53EF\u7528\u529F\u80FD"),!d&&o.uiModule?.initUI)try{o.uiModule.initUI({services:o,autoInjectStyles:!1,targetDocument:r.document||document}),d=!0,y("UI \u88C5\u914D\u4E2D\u5FC3\u5DF2\u521D\u59CB\u5316")}catch(R){p("UI \u6A21\u5757\u521D\u59CB\u5316\u5931\u8D25:",R)}if(o.uiModule&&(T(),await A()),o.toolAutomationServiceModule?.toolAutomationService){let R=o.toolAutomationServiceModule.toolAutomationService.init();y(R?"\u81EA\u52A8\u5316\u751F\u547D\u5468\u671F\u670D\u52A1\u5DF2\u521D\u59CB\u5316":"\u81EA\u52A8\u5316\u751F\u547D\u5468\u671F\u670D\u52A1\u521D\u59CB\u5316\u672A\u5B8C\u6210\uFF0C\u7B49\u5F85\u5BBF\u4E3B\u4E8B\u4EF6\u6E90\u91CD\u8BD5")}let k=r.document||document;k.readyState==="loading"?k.addEventListener("DOMContentLoaded",()=>{setTimeout(w,1e3)}):setTimeout(w,1e3),y("\u521D\u59CB\u5316\u5B8C\u6210")}return{loadModules:g,injectStyles:b,addMenuItem:w,init:L,log:y,logError:p}}fe();Se();Se();re();var Hs=B.createScope("PromptEditor"),zp="youyou_toolkit_prompt_editor",Kp={system:"System Prompt (\u7CFB\u7EDF\u63D0\u793A\u8BCD)",ai:"AI Prompt (AI\u6307\u4EE4\u63D0\u793A\u8BCD)",user:"User Prompt (\u7528\u6237\u63D0\u793A\u8BCD)"},Wp={system:"fa-server",ai:"fa-robot",user:"fa-user"},Ir=[{id:"system_1",type:"system",role:"SYSTEM",mainSlot:"",content:"",deletable:!1,expanded:!0},{id:"ai_1",type:"ai",role:"USER",mainSlot:"A",content:"",deletable:!1,expanded:!0,isMain:!0},{id:"user_1",type:"user",role:"USER",mainSlot:"B",content:"",deletable:!1,expanded:!0,isMain2:!0}],jo=class{constructor(e={}){this.containerId=e.containerId||zp,this.segments=e.segments||[...Ir],this.onChange=e.onChange||null,this.editable=e.editable!==!1,this.showMainSlot=e.showMainSlot!==!1,this.$container=null,this.$=null}init(e){if(this.$=window.jQuery||window.parent?.jQuery,!this.$){Hs.error("jQuery not available");return}this.$container=e,this.render(),this.bindEvents()}setSegments(e){this.segments=e&&Array.isArray(e)?[...e]:[...Ir],this.$container&&(this.render(),this.bindEvents())}getSegments(){return this.segments.map(e=>({...e,content:this.getSegmentContent(e.id)}))}getSegmentContent(e){return this.$container&&this.$container.find(`[data-segment-id="${e}"] .yyt-prompt-textarea`).val()||""}render(){if(!this.$container)return;let e=`
  ...
  `}function Ic(t){return t.filter(e=>e.content&&e.content.trim()).map(e=>({role:e.role,content:e.content,deletable:e.deletable,mainSlot:e.mainSlot}))}function Rc(t){return Array.isArray(t)?t.map((e,s)=>({id:`segment_${s}_${Date.now()}`,type:e.role==="SYSTEM"?"system":e.role==="assistant"?"ai":"user",role:e.role,mainSlot:e.mainSlot||"",content:e.content||"",deletable:e.deletable!==!1,expanded:!0,isMain:e.mainSlot==="A"||e.isMain,isMain2:e.mainSlot==="B"||e.isMain2})):[...Ir]}re();function Pc(t){let{constants:e,topLevelWindow:s,modules:r,caches:o,uiState:a}=t,{SCRIPT_ID:n,SCRIPT_VERSION:i,POPUP_ID:l}=e,c=B.createScope("PopupShell"),d={cleanup:null},u={cleanups:[]},y={cleanups:[]},p={current:null};function g(){return!!a.sidebarCollapsed}function x(){a.sidebarCollapsed=!a.sidebarCollapsed;let f=a.currentPopup;if(!f)return;let h=f.querySelector(".yyt-shell-sidebar"),_=f.querySelector(".yyt-shell-workspace"),E=f.querySelector(".yyt-sidebar-toggle i");h&&h.classList.toggle("yyt-collapsed",a.sidebarCollapsed),_&&_.classList.toggle("yyt-sidebar-collapsed",a.sidebarCollapsed),E&&(E.className=a.sidebarCollapsed?"fa-solid fa-angles-right":"fa-solid fa-angles-left"),he()}function b(...f){c.log(f.join(" "))}function T(...f){c.error(f.join(" "))}function A(f){return typeof f!="string"?"":f.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function w(){return s.jQuery||window.jQuery}function L(){return s.document||document}function M(f){if(!f)return"\u672A\u9009\u62E9\u9875\u9762";let h=r.toolRegistryModule?.getToolConfig(f);if(!h)return f;if(!h.hasSubTabs)return h.name||f;let _=R(f),E=h.subTabs?.find(D=>D.id===_);return E?.name?`${h.name} / ${E.name}`:h.name||f}function k(f){if(!f)return"\u8BF7\u9009\u62E9\u5DE6\u4FA7\u5BFC\u822A\u4E2D\u7684\u9875\u9762\u8FDB\u884C\u914D\u7F6E\u6216\u6392\u67E5\u3002";let h=r.toolRegistryModule?.getToolConfig(f);if(!h)return"\u5F53\u524D\u9875\u9762\u63CF\u8FF0\u6682\u4E0D\u53EF\u7528\u3002";if(!h.hasSubTabs)return h.description||"\u5728\u8FD9\u91CC\u7BA1\u7406\u5F53\u524D\u9875\u9762\u7684\u914D\u7F6E\u548C\u64CD\u4F5C\u3002";let _=R(f);return h.subTabs?.find(D=>D.id===_)?.description||h.description||"\u5728\u8FD9\u91CC\u7BA1\u7406\u5F53\u524D\u5DE5\u5177\u7684\u6A21\u677F\u3001\u914D\u7F6E\u4E0E\u8C03\u8BD5\u80FD\u529B\u3002"}function R(f,h=""){let _=r.toolRegistryModule?.getToolConfig(f);if(!_?.hasSubTabs||!Array.isArray(_.subTabs)||_.subTabs.length===0)return"";let E=String(h||a.currentSubTab[f]||"").trim(),O=E&&_.subTabs.some(W=>W?.id===E)?E:_.subTabs[0]?.id||"";return O&&a.currentSubTab[f]!==O&&(a.currentSubTab[f]=O),O}function ee(){let f=a.currentPopup;if(!f)return;let h=M(a.currentMainTab),_=k(a.currentMainTab),E=f.querySelector(".yyt-popup-active-label");E&&(E.textContent=`\u5F53\u524D\uFF1A${h}`);let D=f.querySelector(".yyt-shell-breadcrumb");D&&(D.textContent=h);let O=f.querySelector(".yyt-shell-main-title");O&&(O.textContent=h);let W=f.querySelector(".yyt-shell-main-description");W&&(W.textContent=_)}function Y(){typeof d.cleanup=="function"&&(d.cleanup(),d.cleanup=null)}function U(){Array.isArray(u.cleanups)&&(u.cleanups.forEach(f=>{typeof f=="function"&&f()}),u.cleanups=[])}function J(){Array.isArray(y.cleanups)&&(y.cleanups.forEach(f=>{typeof f=="function"&&f()}),y.cleanups=[])}function ke(f,h){if(!f||!h)return!1;let _=f.jquery?f[0]:f,E=h.jquery?h[0]:h;return!!(_&&E&&_===E)}function be(f={}){let{container:h=null}=f,_=p.current;if(_&&!(h&&!ke(_.container,h))){try{typeof _.destroy=="function"&&_.destroy(_.container)}catch(E){T("\u9500\u6BC1\u52A8\u6001\u9762\u677F host \u5931\u8D25",E)}r.uiModule?.uiManager?.destroyContainerInstance&&r.uiModule.uiManager.destroyContainerInstance(_.container),p.current=null}}function Ce(f,h={}){p.current={key:h.key||"",container:f,destroy:typeof h.destroy=="function"?h.destroy:null}}function se(){let f=w();if(!f||!a.currentPopup)return;let h=r.toolRegistryModule?.getToolList()||[],_=f(a.currentPopup).find(".yyt-main-nav");if(!_.length)return;let E=h.map(O=>`
    ...
    `).join("");_.html(E),f(a.currentPopup).find(".yyt-main-nav-item").on("click",function(){let W=f(this).data("tab");W&&hs(W)});let D=f(a.currentPopup).find(".yyt-shell-sidebar-hint");D.length&&D.text(`${h.length} tabs`)}function Tt(){let f=w();if(!f||!a.currentPopup)return;let h=r.toolRegistryModule?.getToolList()||[],_=r.toolRegistryModule?.getToolConfig("tools"),E=Array.isArray(_?.subTabs)?_.subTabs:[],D=E.filter(j=>j?.isCustom).length,O=E.filter(j=>!j?.isCustom).length,H=f(a.currentPopup).find(".yyt-shell-sidebar-stats");H.length&&(H.find(".yyt-shell-sidebar-stat").eq(0).find(".yyt-shell-sidebar-stat-value").text(String(h.length)),H.find(".yyt-shell-sidebar-stat").eq(1).find(".yyt-shell-sidebar-stat-value").text(String(O)),H.find(".yyt-shell-sidebar-stat").eq(2).find(".yyt-shell-sidebar-stat-value").text(String(D)))}function Nt(){let f=r.toolRegistryModule?.getToolList()||[];return f.length?(f.some(h=>h.id===a.currentMainTab)||(a.currentMainTab=f[0].id),a.currentMainTab):null}async function Je(f={}){let{rebuildNavigation:h=!1,reRenderSubNav:_=!1}=f,E=w();if(!E||!a.currentPopup)return;be();let D=Nt();if(!D)return;h&&(se(),Tt());let O=r.toolRegistryModule?.getToolConfig(D),W=!!O?.hasSubTabs,H=E(a.currentPopup).find(".yyt-sub-nav"),j=E(a.currentPopup).find(".yyt-content");if(h&&j.length){let V=new Set(j.find(".yyt-tab-content").map((ge,Ie)=>E(Ie).data("tab")).get());(r.toolRegistryModule?.getToolList()||[]).forEach(ge=>{V.has(ge.id)||j.append(`<div class="yyt-tab-content" data-tab="${A(ge.id)}"></div>`)}),j.find(".yyt-tab-content").each((ge,Ie)=>{let st=E(Ie).data("tab");(r.toolRegistryModule?.getToolList()||[]).some(rt=>rt.id===st)||E(Ie).remove()})}E(a.currentPopup).find(".yyt-main-nav-item").removeClass("active"),E(a.currentPopup).find(`.yyt-main-nav-item[data-tab="${D}"]`).addClass("active"),E(a.currentPopup).find(".yyt-tab-content").removeClass("active"),E(a.currentPopup).find(`.yyt-tab-content[data-tab="${D}"]`).addClass("active"),W?(H.show(),(_||h)&&zt(D,O.subTabs)):H.hide(),await At(D),ee(),he()}function Bt(){if(!a.currentPopup)return;U();let f=()=>{if(a.currentMainTab==="apiPresets"){Je();return}a.currentMainTab==="tools"&&Je({reRenderSubNav:!0})},h=()=>{a.currentMainTab==="tools"?Je({rebuildNavigation:!0,reRenderSubNav:!0}):Tt()},_=()=>{a.currentMainTab==="tools"&&Je({rebuildNavigation:!1,reRenderSubNav:!1})},E=()=>{(a.currentMainTab==="bypass"||a.currentMainTab==="tools")&&Je({reRenderSubNav:a.currentMainTab==="tools"})};[I.PRESET_CREATED,I.PRESET_UPDATED,I.PRESET_DELETED].forEach(D=>{u.cleanups.push(P.on(D,f))}),[I.TOOL_REGISTERED,I.TOOL_UPDATED,I.TOOL_UNREGISTERED].forEach(D=>{u.cleanups.push(P.on(D,h))}),u.cleanups.push(P.on(I.TOOL_RUNTIME_UPDATED,_)),[I.BYPASS_PRESET_CREATED,I.BYPASS_PRESET_UPDATED,I.BYPASS_PRESET_DELETED].forEach(D=>{u.cleanups.push(P.on(D,E))})}function ue(f){return!!f?.closest?.(["input","textarea","select","button","a","label","summary","details",'[contenteditable="true"]',".yyt-dialog",".yyt-select-dropdown",".yyt-select-portal-layer"].join(","))}function oe(f){let h=f?.closest?.(["textarea",".yyt-preview-pre",".yyt-select-dropdown",".yyt-select-portal-layer",".yyt-dialog-body",".yyt-worldbook-list",".yyt-tool-panel",".yyt-panel-section"].join(","));return h?h.scrollHeight>h.clientHeight+2||h.scrollWidth>h.clientWidth+2:!1}function yt(f,h){return h?.closest?.(".yyt-scrollable-surface")===f}function tt(f,h){if(!f||!h)return null;let _=h.closest?.([".yyt-worldbook-list",".yyt-select-dropdown",".yyt-select-portal-layer",".yyt-dialog-body",".yyt-preview-pre",".yyt-tool-panel",".yyt-panel-section"].join(","));return _&&(_.classList?.contains("yyt-select-portal-layer")||f.contains(_))&&(_.scrollHeight>_.clientHeight+2||_.scrollWidth>_.clientWidth+2)?_:[h.closest?.(".yyt-tool-list"),h.closest?.(".yyt-settings-content"),h.closest?.(".yyt-sub-content"),h.closest?.(".yyt-tab-content.active"),f].filter(Boolean).find(D=>D!==f&&!f.contains(D)?!1:D.scrollHeight>D.clientHeight+2||D.scrollWidth>D.clientWidth+2)||f}function ye({mainTab:f=null,includeSubContent:h=!1}={}){let _=a.currentPopup;if(!_)return;let E=_.querySelector(".yyt-content");E&&(E.scrollTop=0,E.scrollLeft=0);let D=f?`.yyt-tab-content[data-tab="${f}"]`:".yyt-tab-content.active",O=_.querySelector(D);if(O&&(O.scrollTop=0,O.scrollLeft=0),!h)return;(O?.querySelectorAll(".yyt-sub-content")||[]).forEach(H=>{H.scrollTop=0,H.scrollLeft=0})}function pt(f){let h=L();if(!f||!h)return;f.classList.add("yyt-scrollable-surface");let _=!1,E=!1,D=0,O=0,W=0,H=0,j=!1,V=!1,ge=()=>{_=!1,E=!1,f.classList.remove("yyt-scroll-dragging")},Ie=q=>{q.button===0&&(ue(q.target)||yt(f,q.target)&&(j=f.scrollWidth>f.clientWidth+2,V=f.scrollHeight>f.clientHeight+2,!(!j&&!V)&&(q.stopPropagation(),_=!0,E=!1,D=q.clientX,O=q.clientY,W=f.scrollLeft,H=f.scrollTop)))},st=q=>{if(!_)return;let jt=q.clientX-D,Pe=q.clientY-O;!(Math.abs(jt)>4||Math.abs(Pe)>4)&&!E||(E=!0,f.classList.add("yyt-scroll-dragging"),j&&(f.scrollLeft=W-jt),V&&(f.scrollTop=H-Pe),q.preventDefault())},rt=()=>{ge()},Re=q=>{if(q.ctrlKey||oe(q.target)||!f.classList.contains("yyt-content")&&!yt(f,q.target))return;let Pe=tt(f,q.target);!Pe||Pe!==f&&!f.contains(Pe)||!(Pe.scrollHeight>Pe.clientHeight+2||Pe.scrollWidth>Pe.clientWidth+2)||(Math.abs(q.deltaY)>0&&(Pe.scrollTop+=q.deltaY),Math.abs(q.deltaX)>0&&(Pe.scrollLeft+=q.deltaX),q.preventDefault(),q.stopPropagation())},xe=q=>{E&&q.preventDefault()};f.addEventListener("mousedown",Ie),f.addEventListener("wheel",Re,{passive:!1}),f.addEventListener("dragstart",xe),h.addEventListener("mousemove",st),h.addEventListener("mouseup",rt),y.cleanups.push(()=>{ge(),f.classList.remove("yyt-scrollable-surface"),f.removeEventListener("mousedown",Ie),f.removeEventListener("wheel",Re),f.removeEventListener("dragstart",xe),h.removeEventListener("mousemove",st),h.removeEventListener("mouseup",rt)})}function he(){let f=a.currentPopup;if(!f)return;J();let h=[...f.querySelectorAll(".yyt-shell-sidebar .yyt-main-nav"),...f.querySelectorAll(".yyt-sub-nav"),...f.querySelectorAll(".yyt-content"),...f.querySelectorAll(".yyt-settings-content"),...f.querySelectorAll(".yyt-tool-list")];[...new Set(h)].forEach(pt)}function qs(f){return`
...
\u6216 regex:<custom_tag>([\\s\\S]*?)</custom_tag>`,previewDialogId:`${f.id}-extraction-preview`,previewTitle:`${f.name||f.id} \u63D0\u53D6\u9884\u89C8`}),o.dynamicToolPanelCache.set(f.id,E)}let D=E();D.renderTo(h),Ce(h,{key:f.id,destroy:typeof D?.destroy=="function"?O=>D.destroy(O):null}),he()}catch(E){p.current=null,T("\u81EA\u5B9A\u4E49\u5DE5\u5177\u9762\u677F\u52A0\u8F7D\u5931\u8D25:",E),h.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u81EA\u5B9A\u4E49\u5DE5\u5177\u9762\u677F\u52A0\u8F7D\u5931\u8D25</span></div>')}}}function Wt(f,h){if(!w())return;let E=r.toolRegistryModule?.getToolConfig(f);if(!E){h.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u5DE5\u5177\u914D\u7F6E\u4E0D\u5B58\u5728</span></div>');return}let D=a.currentSubTab[f]||E.subTabs?.[0]?.id||"config";h.html(`
    ...
    `),Kt(f,D)}function Oc(f,h){if(!w())return;let E=r.toolManagerModule?.getTool(f),D=r.presetManagerModule?.getAllPresets()||[],O=r.toolRegistryModule?.getToolApiPreset(f)||"",W=D.map(H=>`<option value="${A(H.name)}" ${H.name===O?"selected":""}>${A(H.name)}</option>`).join("");h.html(`
      <div class="yyt-panel">
        <div class="yyt-panel-section">
          <div class="yyt-section-title">
    ...
    `),Ae(h,{namespace:"yytPopupToolConfigSelect",selectors:["#yyt-tool-api-preset"]}),h.find("#yyt-save-tool-preset").on("click",function(){let j=h.find("#yyt-tool-api-preset").val();r.toolRegistryModule?.setToolApiPreset(f,j);let V=s.toastr;V&&V.success("API\u9884\u8BBE\u7ED1\u5B9A\u5DF2\u4FDD\u5B58","YouYou \u5DE5\u5177\u7BB1")})}async function Lc(f,h){if(!w()){h.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u63D0\u793A\u8BCD\u7F16\u8F91\u5668\u6A21\u5757\u672A\u52A0\u8F7D</span></div>');return}let D=r.toolManagerModule?.getTool(f)?.config?.messages||[],O=Rc(D)||Ir,W=new jo({containerId:`yyt-prompt-editor-${f}`,segments:O,onChange:j=>{let V=Ic(j);b("\u63D0\u793A\u8BCD\u5DF2\u66F4\u65B0:",V.length,"\u6761\u6D88\u606F")}});h.html(`<div id="yyt-prompt-editor-${f}" class="yyt-prompt-editor-container"></div>`),W.init(h.find(`#yyt-prompt-editor-${f}`));let H=Cc();if(H){let j="yyt-prompt-editor-styles",V=s.document||document;if(!V.getElementById(j)){let ge=V.createElement("style");ge.id=j,ge.textContent=H,(V.head||V.documentElement).appendChild(ge)}}}function Nc(f,h){w()&&h.html(`
      <div class="yyt-panel">
        <div class="yyt-panel-section">
          <div class="yyt-section-title">
            <i class="fa-solid fa-bookmark"></i>
    ...
    `)}function Bc(){return`
      ...
      </div>`}function Uc(f,h,_){let E=g(),D=f.map(O=>`
      <div class="yyt-main-nav-item ${O.id===a.currentMainTab?"active":""}" data-tab="${O.id}">
        <div class="yyt-main-nav-icon">
          <i class="fa-solid ${A(O.icon||"fa-file")}"></i>
        </div>
    ...
    `).join("");return`
      ...
      </div>`}function Kc(f,h){return f.map(_=>`
      <div class="yyt-tab-content ${_.id===h?"active":""}" data-tab="${_.id}">
      </div>
    `).join("")}function Wc(f){return`
      ...
      </div>`}async function jc(){if(a.currentPopup){b("\u5F39\u7A97\u5DF2\u5B58\u5728");return}let f=t?.services?.loadModules;typeof f=="function"&&await f();let h=w(),_=L();if(!h){T("jQuery \u672A\u627E\u5230\uFF0C\u65E0\u6CD5\u521B\u5EFA\u5F39\u7A97");return}let E=r.toolRegistryModule?.getToolList()||[];if(!E.length){T("\u5DE5\u5177\u5217\u8868\u4E3A\u7A7A\uFF0C\u65E0\u6CD5\u521B\u5EFA\u5F39\u7A97");return}E.some(Re=>Re.id===a.currentMainTab)||(a.currentMainTab=E[0].id);let D=r.toolRegistryModule?.getToolConfig("tools"),O=Array.isArray(D?.subTabs)?D.subTabs:[],W=O.filter(Re=>Re?.isCustom).length,H=O.filter(Re=>!Re?.isCustom).length,j=M(a.currentMainTab),V=k(a.currentMainTab);a.currentOverlay=_.createElement("div"),a.currentOverlay.className="yyt-popup-overlay",a.currentOverlay.addEventListener("click",Re=>{Re.target===a.currentOverlay&&Ut()}),_.body.appendChild(a.currentOverlay);let ge=g(),Ie=`
