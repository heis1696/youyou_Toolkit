...
`)||"\u65E0")}</div>
      ...
      `).join(""):'<div class="yyt-tool-compact-hint yyt-worldbook-empty">\u672A\u627E\u5230\u5339\u914D\u4E16\u754C\u4E66\u3002</div>');let v=p.length===0?"\u9009\u62E9\u8981\u6CE8\u5165\u7684\u4E16\u754C\u4E66":p.length<=2?p.join("\u3001"):`\u5DF2\u9009 ${p.length} \u9879\uFF1A${p.slice(0,2).join("\u3001")} \u7B49`;l.find(".yyt-worldbook-summary").text(v)}}}var Ks,ky,ys=B(()=>{Ae();Lt();Da();cr();Bs();Wa();Ks=`
  .yyt-tool-panel {
    display: flex;
    flex-direction: column;
    gap: 16px;
...
`;ky=Nt});var ps,Ka=B(()=>{ys();ps=Nt({id:"summaryToolPanel",toolId:"summaryTool",postResponseHint:"\u70B9\u51FB\u201C\u7ACB\u5373\u6267\u884C\u4E00\u6B21\u201D\u540E\uFF0C\u8C03\u7528\u989D\u5916\u6A21\u578B\u8FDB\u884C\u6458\u8981\u89E3\u6790\u3002",extractionPlaceholder:`\u6BCF\u884C\u4E00\u4E2A\u6807\u7B7E\uFF0C\u5982 boo_FM
...
regex:<content>([\\s\\S]*?)</content>`,processorDirections:[{key:"en_to_zh",label:"\u82F1\u6587\u8F6C\u4E2D\u6587",description:"\u6309\u52FE\u9009\u9879\u628A\u82F1\u6587\u6807\u70B9\u66FF\u6362\u4E3A\u4E2D\u6587\u6807\u70B9\u3002"}],processorOptions:[{key:"comma",label:"\u9017\u53F7 ,",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u9017\u53F7\u3002"},{key:"period",label:"\u53E5\u53F7 .",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u53E5\u53F7\u3002"},{key:"exclamation",label:"\u611F\u53F9\u53F7 !",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u611F\u53F9\u53F7\u3002"},{key:"question",label:"\u95EE\u53F7 ?",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u95EE\u53F7\u3002"},{key:"semicolon",label:"\u5206\u53F7 ;",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5206\u53F7\u3002"},{key:"colon",label:"\u5192\u53F7 :",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5192\u53F7\u3002"},{key:"leftParen",label:"\u5DE6\u62EC\u53F7 (",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u5DE6\u62EC\u53F7\u3002"},{key:"rightParen",label:"\u53F3\u62EC\u53F7 )",description:"\u66FF\u6362\u4E3A\u4E2D\u6587\u53F3\u62EC\u53F7\u3002"}]})});var hs,Va=B(()=>{ve();Bs();Ae();hs={id:"bypassPanel",_getActivePresetId(t){return t.find(".yyt-bypass-editor-content").data("presetId")||null},render(t){let e=H.getPresetList(),s=H.getDefaultPresetId();return`
    ...
    `},renderTo(t){let e=this.render({});t.html(e),this.bindEvents(t,{})}}});var Al={};be(Al,{SettingsPanel:()=>_t,applyTheme:()=>_l,applyUiPreferences:()=>Ja,default:()=>Ry});function Fs({id:t,checked:e=!1,title:s="",hint:r=""}){return`
    <div class="yyt-toggle-row">
      <div class="yyt-toggle-label">
        <span>${s}</span>
...
\u53EA\u8FD4\u56DE <tableEdit> \u6807\u7B7E\uFF0C\u4E0D\u8981\u9644\u52A0\u5176\u4ED6\u5185\u5BB9\u3002`});function _e(t,e=""){return typeof t=="string"&&t.trim()?t.trim():e}function rt(t,e){let s=Array.isArray(t)?t.length:0;return s<=0||!Number.isInteger(e)||e<0?0:Math.min(e,s-1)}function Op(t){try{return JSON.stringify(t,null,2)}catch{return String(t??"")}}function Dp(){return Bl({apiPresets:bt()})}function Lr(t,e){return _e(t?.aiInstructions?.[e],"")}function Lp(t={}){return{init:Lr(t,"init"),create:Lr(t,"create"),update:Lr(t,"update"),delete:Lr(t,"delete")}}function bc(t){let e=_e(t,"idle");return e==="running"?"\u8FD0\u884C\u4E2D":e==="success"?"\u6700\u8FD1\u6210\u529F":e==="error"?"\u6700\u8FD1\u5931\u8D25":"\u672A\u8FD0\u884C"}function Np(t){return t?new Date(t).toLocaleString():"\u2014"}function Bp(t){return Number.isFinite(t)&&t>0?`${(t/1e3).toFixed(t>=1e3?1:2)}s`:"\u2014"}function Up(t,e){return _e(t?.id||t?.key,`table_${e}`)}function hc(t){let e=Array.isArray(t?.columns)?t.columns.length:0,s=Array.isArray(t?.rows)?t.rows.length:0;return`${e} \u5B57\u6BB5 \xB7 ${s} \u884C`}function Ue(t,e){let s=D(),r=e&&typeof e=="object"?e:zt();if(!s||!j(t))return r;let o={...r,runtime:r.runtime||{}},a=Array.isArray(o.tables)?[...o.tables]:[],n=rt(a,o.__activeTableIndex??0);if(a[n]){let A=a[n]||{},S={...A,aiInstructions:Lp(A)},z=t.find("[data-twb-name]");z.length&&(S.name=String(z.val()||"").trim());let $=t.find("[data-twb-note]");$.length&&(S.note=String($.val()||"").trim()),t.find("[data-twb-table-instruction]").each(function(){let I=String(s(this).attr("data-twb-table-instruction")||"").trim();I&&(S.aiInstructions[I]=String(s(this).val()||"").trim())}),t.find("[data-twb-col]").length&&(S.columns=[],t.find("[data-twb-col]").each(function(){let I=s(this);S.columns.push({key:_e(I.find("[data-twb-col-key]").val(),""),title:_e(I.find("[data-twb-col-title]").val(),""),type:_e(I.find("[data-twb-col-type]").val(),"text"),required:I.find("[data-twb-col-req]").is(":checked"),description:_e(I.find("[data-twb-col-desc]").val(),"")})})),t.find("[data-twb-row]").length&&(S.rows=[],t.find("[data-twb-row]").each(function(){let I=s(this),R={};(S.columns||[]).forEach(J=>{R[J.key]=_e(I.find(`[data-twb-cell="${J.key}"]`).val(),"")}),S.rows.push({name:_e(I.find("[data-twb-row-name]").val(),""),cells:R})})),a[n]=S}let i=t.find('[data-twb-field="promptTemplate"]');i.length&&(o.promptTemplate=String(i.val()||""));let l=t.find('[data-twb-field="apiPreset"]');l.length&&(o.apiPreset=String(l.val()||""));let c=t.find('[data-twb-field="fillMode"]');c.length&&(o.fillMode=String(c.val()||""));let d=t.find('[data-twb-field="mirrorToMessage"]');d.length&&(o.mirrorToMessage=d.is(":checked"));let u=t.find('[data-twb-field="autoUpdateEnabled"]');u.length&&(o.autoUpdateEnabled=u.is(":checked"));let y=t.find('[data-twb-field="autoUpdateTrigger"]');y.length&&(o.autoUpdateTrigger=String(y.val()||"assistantMessage"));let p=t.find('[data-twb-field="runScope"]:checked');p.length&&(o.runScope=String(p.val()||"enabled"));let f=t.find('[data-twb-field="promptPreset"]');f.length&&(o.promptPreset=String(f.val()||""));let x=t.find('[data-twb-field="bypassEnabled"]'),v=String(o.promptPreset||"");o.bypass={...o.bypass||{},enabled:x.length?x.is(":checked"):o.bypass?.enabled===!0,presetId:v};let _=t.find('[data-twb-field="activeTemplate"]');return _.length&&(o.activeTemplate=String(_.val()||"")),o.tables=a,o}function ln(t){let e=_e(t,"idle");return`<span class="yyt-tool-runtime-badge yyt-status-${b(e)}">${b(bc(e))}</span>`}function jp(t){return`
    ...
    </header>`}function zp(t){let e=t?.runtime||{};return`
    <article class="yyt-panel-section yyt-twb-card yyt-twb-runtime-card">
      ...
      <div class="yyt-twb-metrics">
        <div><span>\u6700\u8FD1\u8FD0\u884C</span><strong>${b(Np(e.lastRunAt))}</strong></div>
        <div><span>\u8017\u65F6</span><strong>${b(Bp(e.lastDurationMs))}</strong></div>
    ...
    </article>`}function Kp(t){let e=bt(),s=Tr()||[],r=t?.bypass?.enabled===!0,o=_e(t?.bypass?.presetId||t?.promptPreset,"");return`
    <article class="yyt-panel-section yyt-twb-card">
      <div class="yyt-twb-card-header">
    ...
    </article>`}function Fp(t){let e=sn();return`
    ...
    </article>`}function Hp(t){let e=Array.isArray(t.tables)?t.tables:[],s=_e(t.runScope,"enabled");return`
    <article class="yyt-panel-section yyt-twb-card yyt-twb-manual-card">
      ...
      <div class="yyt-twb-table-chip-list">
        ${e.length?e.map((r,o)=>`<label class="yyt-twb-table-chip"><input type="checkbox" data-twb-run-table="${b(Up(r,o))}"><span>${b(_e(r?.name,`\u8868\u683C ${o+1}`))}</span></label>`).join(""):'<span class="yyt-twb-muted">\u8FD8\u6CA1\u6709\u53EF\u66F4\u65B0\u7684\u8868\u683C\u3002</span>'}
      </div>
    ...
    </article>`}function qp(t){let e=Array.isArray(t.tables)?t.tables:[],s=xs({tables:e});return`
    ...
    </section>`}function Jp(t){let e=Array.isArray(t?.columns)?t.columns:[];return`
    <section class="yyt-panel-section yyt-twb-editor-section">
      <div class="yyt-twb-section-header">
    ...
    </section>`}function Xp(t,e){let s=t?.key||"",r=t?.title||s,o=e?.cells&&e.cells[s]!==void 0?e.cells[s]:"",a=t?.required?" *":"";return t?.type==="boolean"?`
      <label class="yyt-twb-field">
        <span>${b(r)}${a}</span>
        ...
        <div class="yyt-twb-row-list">
          ${r.map((o,a)=>{let n=mc(e,o,a);return`
              <article class="yyt-twb-row-card${n?` row-${n}`:""}" data-twb-row data-twb-ri="${a}">
                ...
                <div class="yyt-twb-row-fields">${s.map(i=>Xp(i,o)).join("")}</div>
              </article>`}).join("")}
        </div>`:`
    ...
    </section>`}function ef(t,e,s){let o=(xs({tables:Array.isArray(s.tables)?s.tables:[]}).issues||[]).filter(a=>a.tableIndex===e);return`
...
`))}</div>`:'<div class="yyt-twb-muted">\u6682\u65E0\u6821\u9A8C\u95EE\u9898\u3002</div>'}
    ...
    </section>`}function tf(t){let e={tables:Array.isArray(t.tables)?t.tables:[]},r=xs(e)?.summary?.errorCount||0;return`
    <section class="yyt-twb-editor-section yyt-twb-diagnostics">
      <details>
    ...
    </section>`}function sf(t,e,s,r){let a=(Array.isArray(t.tables)?t.tables:[])[e]||null;return!s||!a?'<aside class="yyt-twb-editor-drawer"></aside>':`
    <aside class="yyt-twb-editor-drawer is-open">
      <div class="yyt-twb-editor">
        <header class="yyt-twb-editor-header">
          <div><h3>\u914D\u7F6E\u8868\u683C\uFF1A${b(_e(a.name,`\u8868\u683C ${e+1}`))}</h3><p>${b(hc(a))} \xB7 ${b(bc(t?.runtime?.lastStatus))}</p></div>
    ...
    </aside>`}var Pp,Ss,cn=B(()=>{Ae();ys();Wl();Fl();Ir();cr();Bs();Or();gc();Pp=`${Ks} ${Kl()}
...
`;Ss={id:"tableWorkbenchPanel",currentTableIndex:0,editorOpen:!1,lastDiff:null,pendingTemplateApplyId:"",render({config:t}={}){let e=t&&typeof t=="object"?t:zt(),s=Array.isArray(e.tables)?e.tables:[];this.currentTableIndex=rt(s,e.__activeTableIndex??this.currentTableIndex);let r=this.currentTableIndex;return`
    ...
    `},bindEvents(t){let e=D();if(!e||!j(t))return;let s=this,r=null,o=!1,a=[],n=t.find("[data-yyt-log-list]"),i=t.find("[data-yyt-log-search]"),l=t.find("[data-yyt-log-autoscroll]"),c=t.find("[data-yyt-log-pause]");function d(p){if(!p.length){n.html('<div class="yyt-logger-empty">\u6682\u65E0\u5339\u914D\u7684\u65E5\u5FD7\u8BB0\u5F55</div>');return}n.html(p.map(f=>`
        <div class="yyt-log-entry ${af(f.level)}" data-log-id="${f.id}">
          <span class="yyt-log-time">${nf(f.timestamp)}</span>
    ...
    `}}});var _c={};be(_c,{ApiPresetPanel:()=>Pt,BypassPanel:()=>hs,EscapeTransformToolPanel:()=>ms,LoggerPanel:()=>Ts,MAIN_TAB_RENDERERS:()=>_n,PanelState:()=>Ms,PunctuationTransformToolPanel:()=>bs,RegexExtractPanel:()=>ss,SCRIPT_ID:()=>m,SUB_TAB_RENDERERS:()=>An,SettingsPanel:()=>_t,StatusBlockPanel:()=>fs,SummaryToolPanel:()=>ps,TableWorkbenchPanel:()=>Ss,ToolManagePanel:()=>ns,UIManager:()=>yr,YouyouReviewPanel:()=>gs,bindDialogEvents:()=>Rt,closeActiveCustomSelectDropdown:()=>je,closeCustomSelectDropdown:()=>dr,createDialogHtml:()=>$t,default:()=>lf,destroyEnhancedCustomSelects:()=>xe,downloadJson:()=>ht,enhanceNativeSelects:()=>ke,escapeHtml:()=>b,fillFormWithConfig:()=>Vr,getAllStyles:()=>Tc,getFormApiConfig:()=>ur,getJQuery:()=>D,getTargetDocument:()=>Ct,initUI:()=>xc,isContainerValid:()=>j,normalizeCustomSelectOptions:()=>Gr,openCustomSelectDropdown:()=>ri,readFileContent:()=>vt,registerComponents:()=>zo,renderApiPanel:()=>yn,renderBypassPanel:()=>xn,renderCustomSelectControl:()=>Yr,renderEscapeTransformToolPanel:()=>hn,renderLoggerPanel:()=>Tn,renderMainTab:()=>wc,renderPunctuationTransformToolPanel:()=>vn,renderRegexPanel:()=>pn,renderSettingsPanel:()=>wn,renderStatusBlockPanel:()=>mn,renderSubTabComponent:()=>Sc,renderSummaryToolPanel:()=>gn,renderTableWorkbenchPanel:()=>Sn,renderToolPanel:()=>fn,renderYouyouReviewPanel:()=>bn,repositionActiveCustomSelectDropdown:()=>pa,resetJQueryCache:()=>jd,showToast:()=>w,showTopNotice:()=>le,toggleCustomSelectDropdown:()=>qr,uiManager:()=>pe});function zo(){pe.register(Pt.id,Pt),pe.register(ss.id,ss),pe.register(ns.id,ns),pe.register(ps.id,ps),pe.register(fs.id,fs),pe.register(gs.id,gs),pe.register(ms.id,ms),pe.register(bs.id,bs),pe.register(hs.id,hs),pe.register(_t.id,_t),pe.register(Ss.id,Ss),pe.register(Ts.id,Ts),vc.log("\u7EC4\u4EF6\u6CE8\u518C\u5B8C\u6210")}function xc(t={}){let{autoInjectStyles:e=!0,targetDocument:s,...r}=t;pe.init(r),zo(),e&&pe.injectStyles(s),vc.log("\u6A21\u5757\u521D\u59CB\u5316\u5B8C\u6210")}function un(){pe.getComponent(Pt.id)||zo()}function et(t,e,s={}){un(),pe.render(t,e,s)}function yn(t){et(Pt.id,t)}function pn(t){et(ss.id,t)}function fn(t){et(ns.id,t)}function gn(t){et(ps.id,t)}function mn(t){et(fs.id,t)}function bn(t){et(gs.id,t)}function hn(t){et(ms.id,t)}function vn(t){et(bs.id,t)}function xn(t){et(hs.id,t)}function wn(t){et(_t.id,t)}function Sn(t){et(Ss.id,t)}function Tn(t){et(Ts.id,t)}function wc(t,e){let s=_n[t];if(!s)return!1;un();try{s.render(e)}catch{e.html(`<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>${s.failMessage}</span></div>`)}return!0}function Sc(t,e){let s=An[t];if(!s)return null;un();try{s.render(e)}catch{e.html(`<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>${s.failMessage}</span></div>`)}return t}function Tc(){return pe.getAllStyles()}var vc,_n,An,lf,Ac=B(()=>{ae();fa();ga();Sa();Ca();Ka();Fa();Ha();Ga();Ya();Va();Po();cn();dn();Ae();fa();ga();Sa();Ca();Ka();Fa();Ha();Ga();Ya();Va();Po();cn();dn();vc=N.createScope("UI");_n=Object.freeze({apiPresets:{render:t=>yn(t),failMessage:"API \u9884\u8BBE\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},toolManage:{render:t=>fn(t),failMessage:"\u5DE5\u5177\u7BA1\u7406\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},regexExtract:{render:t=>pn(t),failMessage:"\u6B63\u5219\u63D0\u53D6\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},tableWorkbench:{render:t=>Sn(t),failMessage:"\u586B\u8868\u5DE5\u4F5C\u53F0\u52A0\u8F7D\u5931\u8D25"},bypass:{render:t=>xn(t),failMessage:"Ai\u6307\u4EE4\u9884\u8BBE\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},settings:{render:t=>wn(t),failMessage:"\u8BBE\u7F6E\u9762\u677F\u52A0\u8F7D\u5931\u8D25"},logger:{render:t=>Tn(t),failMessage:"\u65E5\u5FD7\u9762\u677F\u52A0\u8F7D\u5931\u8D25"}}),An=Object.freeze({SummaryToolPanel:{render:t=>gn(t),failMessage:"\u6458\u8981\u5DE5\u5177\u52A0\u8F7D\u5931\u8D25"},StatusBlockPanel:{render:t=>mn(t),failMessage:"\u4E3B\u89D2\u72B6\u6001\u680F\u52A0\u8F7D\u5931\u8D25"},YouyouReviewPanel:{render:t=>bn(t),failMessage:"\u5C0F\u5E7D\u70B9\u8BC4\u52A0\u8F7D\u5931\u8D25"},EscapeTransformToolPanel:{render:t=>hn(t),failMessage:"\u8F6C\u4E49\u5904\u7406\u5DE5\u5177\u52A0\u8F7D\u5931\u8D25"},PunctuationTransformToolPanel:{render:t=>vn(t),failMessage:"\u4E2D\u6587\u6807\u70B9\u66FF\u6362\u5DE5\u5177\u52A0\u8F7D\u5931\u8D25"}});lf={uiManager:pe,ApiPresetPanel:Pt,RegexExtractPanel:ss,ToolManagePanel:ns,SummaryToolPanel:ps,StatusBlockPanel:fs,YouyouReviewPanel:gs,EscapeTransformToolPanel:ms,PunctuationTransformToolPanel:bs,BypassPanel:hs,SettingsPanel:_t,TableWorkbenchPanel:Ss,LoggerPanel:Ts,registerComponents:zo,initUI:xc,renderApiPanel:yn,renderRegexPanel:pn,renderToolPanel:fn,renderSummaryToolPanel:gn,renderStatusBlockPanel:mn,renderYouyouReviewPanel:bn,renderEscapeTransformToolPanel:hn,renderPunctuationTransformToolPanel:vn,renderBypassPanel:xn,renderSettingsPanel:wn,renderTableWorkbenchPanel:Sn,renderLoggerPanel:Tn,MAIN_TAB_RENDERERS:_n,SUB_TAB_RENDERERS:An,renderMainTab:wc,renderSubTabComponent:Sc,getAllStyles:Tc}});var Ic={};be(Ic,{WindowManager:()=>Wo,closeWindow:()=>pf,createWindow:()=>yf,windowManager:()=>Fe});function uf(){if(Fe.stylesInjected)return;Fe.stylesInjected=!0;let t=`
    /* ============================================================
  ...
  `,e=document.createElement("style");e.id=df+"_styles",e.textContent=t,(document.head||document.documentElement).appendChild(e)}function yf(t){let{id:e,title:s="\u7A97\u53E3",content:r="",width:o=900,height:a=700,modal:n=!1,resizable:i=!0,maximizable:l=!0,startMaximized:c=!1,rememberState:d=!0,onClose:u,onReady:y}=t;uf();let p=window.jQuery||window.parent?.jQuery;if(!p)return cf.error("jQuery not available"),null;if(Fe.isOpen(e))return Fe.bringToFront(e),Fe.getWindow(e);let f=window.innerWidth||1200,x=window.innerHeight||800,v=f<=1100,_=null,A=!1;d&&(_=Fe.getState(e),_&&!v&&(A=!0));let S,z;A&&_.width&&_.height?(S=Math.max(400,Math.min(_.width,f-40)),z=Math.max(300,Math.min(_.height,x-40))):(S=Math.max(400,Math.min(o,f-40)),z=Math.max(300,Math.min(a,x-40)));let $=Math.max(20,Math.min((f-S)/2,f-S-20)),I=Math.max(20,Math.min((x-z)/2,x-z-20)),R=l&&!v,J=`
...
\u6216 regex:<custom_tag>([\\s\\S]*?)</custom_tag>`,previewDialogId:`${g.id}-extraction-preview`,previewTitle:`${g.name||g.id} \u63D0\u53D6\u9884\u89C8`}),o.dynamicToolPanelCache.set(g.id,E)}let O=E();O.renderTo(h),Re(h,{key:g.id,destroy:typeof O?.destroy=="function"?L=>O.destroy(L):null}),Se()}catch(E){p.current=null,_("\u81EA\u5B9A\u4E49\u5DE5\u5177\u9762\u677F\u52A0\u8F7D\u5931\u8D25:",E),h.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u81EA\u5B9A\u4E49\u5DE5\u5177\u9762\u677F\u52A0\u8F7D\u5931\u8D25</span></div>')}}}function Gt(g,h){if(!S())return;let E=r.toolRegistryModule?.getToolConfig(g);if(!E){h.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u5DE5\u5177\u914D\u7F6E\u4E0D\u5B58\u5728</span></div>');return}let O=a.currentSubTab[g]||E.subTabs?.[0]?.id||"config";h.html(`
    ...
    `),ke(h,{namespace:"yytPopupToolConfigSelect",selectors:["#yyt-tool-api-preset"]}),h.find("#yyt-save-tool-preset").on("click",function(){let F=h.find("#yyt-tool-api-preset").val();r.toolRegistryModule?.setToolApiPreset(g,F);let X=s.toastr;X&&X.success("API\u9884\u8BBE\u7ED1\u5B9A\u5DF2\u4FDD\u5B58","YouYou \u5DE5\u5177\u7BB1")})}async function Hc(g,h){if(!S()){h.html('<div class="yyt-empty-state-small"><i class="fa-solid fa-exclamation-triangle"></i><span>\u63D0\u793A\u8BCD\u7F16\u8F91\u5668\u6A21\u5757\u672A\u52A0\u8F7D</span></div>');return}let O=r.toolManagerModule?.getTool(g)?.config?.messages||[],L=jc(O)||Nr,K=new qo({containerId:`yyt-prompt-editor-${g}`,segments:L,onChange:F=>{let X=Uc(F);v("\u63D0\u793A\u8BCD\u5DF2\u66F4\u65B0:",X.length,"\u6761\u6D88\u606F")}});h.html(`<div id="yyt-prompt-editor-${g}" class="yyt-prompt-editor-container"></div>`),K.init(h.find(`#yyt-prompt-editor-${g}`));let q=Bc();if(q){let F="yyt-prompt-editor-styles",X=s.document||document;if(!X.getElementById(F)){let he=X.createElement("style");he.id=F,he.textContent=q,(X.head||X.documentElement).appendChild(he)}}}function qc(g,h){S()&&h.html(`
      <div class="yyt-panel">
        <div class="yyt-panel-section">
          <div class="yyt-section-title">
            <i class="fa-solid fa-bookmark"></i>
