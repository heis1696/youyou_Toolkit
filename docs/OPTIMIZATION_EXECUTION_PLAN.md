...
## 十四、2026-03-24 后续专项补修建议

当前总施工方案已经完成，但在自动触发链主问题修复后，又识别出一组更细粒度的剩余风险，主要集中在：

1. `GENERATION_STARTED` baseline 写入竞态
2. `MESSAGE_RECEIVED` 带 `messageId` 的历史消息重放风险
3. API 文档与验收文档之间的少量语义串层

这类问题已经不适合继续塞回 Phase 1~5 的总方案章节中，因此后续若继续施工，建议转入独立专项文档：
...
- **本总方案文档** 继续负责“大阶段”结构收敛
- **专项加固文档** 负责“自动触发链残余风险”的后续精修

如果后续继续推进自动触发链补修，应以该专项文档为准，而不是继续修改本总方案主体结构。
